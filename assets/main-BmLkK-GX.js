import"./modulepreload-polyfill-B5Qt9EMX.js";import{P as p,a as lt,r as ct,H as A,g as Ne,i as ln,b as cn,c as dn}from"./index-D84Ls8co.js";import{s as te,a as dt,u as un,g as ut,b as He,c as hn,d as ht,p as pn,e as Fe,h as mn,f as fn,F as $,i as C,j as fe,k as gn,n as pt,l as yn,m as bn,r as wn}from"./main-blocks-COusPVmW.js";import{c as y}from"./config-DmeTTinz.js";import{c as I,u as _n,a as vn}from"./debrief-Bn10aC_K.js";import{c as kn,a as Tn,s as S,b as mt,h as xe,d as ge,r as j,e as Ae,f as $e,g as Ce,i as xn,j as Ge,o as En,k as In}from"./pattern-8GUrvjHu.js";var Sn="2.1.0";const On={name:"html-button-response",version:Sn,parameters:{stimulus:{type:p.HTML_STRING,default:void 0},choices:{type:p.STRING,default:void 0,array:!0},button_html:{type:p.FUNCTION,default:function(t,e){return`<button class="jspsych-btn">${t}</button>`}},prompt:{type:p.HTML_STRING,default:null},stimulus_duration:{type:p.INT,default:null},trial_duration:{type:p.INT,default:null},button_layout:{type:p.STRING,default:"grid"},grid_rows:{type:p.INT,default:1},grid_columns:{type:p.INT,default:null},response_ends_trial:{type:p.BOOL,default:!0},enable_button_after:{type:p.INT,default:0}},data:{rt:{type:p.INT},response:{type:p.INT},stimulus:{type:p.HTML_STRING}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class P{constructor(e){this.jsPsych=e}static{this.info=On}trial(e,n){const o=document.createElement("div");o.id="jspsych-html-button-response-stimulus",o.innerHTML=n.stimulus,e.appendChild(o);const r=document.createElement("div");if(r.id="jspsych-html-button-response-btngroup",n.button_layout==="grid"){if(r.classList.add("jspsych-btn-group-grid"),n.grid_rows===null&&n.grid_columns===null)throw new Error("You cannot set `grid_rows` to `null` without providing a value for `grid_columns`.");const c=n.grid_columns===null?Math.ceil(n.choices.length/n.grid_rows):n.grid_columns,h=n.grid_rows===null?Math.ceil(n.choices.length/n.grid_columns):n.grid_rows;r.style.gridTemplateColumns=`repeat(${c}, 1fr)`,r.style.gridTemplateRows=`repeat(${h}, 1fr)`}else n.button_layout==="flex"&&r.classList.add("jspsych-btn-group-flex");for(const[c,h]of n.choices.entries()){r.insertAdjacentHTML("beforeend",n.button_html(h,c));const m=r.lastChild;m.dataset.choice=c.toString(),m.addEventListener("click",()=>{u(c)})}e.appendChild(r),n.prompt!==null&&e.insertAdjacentHTML("beforeend",n.prompt);var a=performance.now(),s={rt:null,button:null};const l=()=>{var c={rt:s.rt,stimulus:n.stimulus,response:s.button};this.jsPsych.finishTrial(c)};function u(c){var h=performance.now(),m=Math.round(h-a);s.button=parseInt(c),s.rt=m,o.classList.add("responded");for(const _ of r.children)_.setAttribute("disabled","disabled");n.response_ends_trial&&l()}if(n.stimulus_duration!==null&&this.jsPsych.pluginAPI.setTimeout(()=>{o.style.visibility="hidden"},n.stimulus_duration),n.enable_button_after>0){for(var i=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),d=0;d<i.length;d++)i[d].setAttribute("disabled","disabled");this.jsPsych.pluginAPI.setTimeout(()=>{for(var c=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),h=0;h<c.length;h++)c[h].removeAttribute("disabled")},n.enable_button_after)}n.trial_duration!==null&&this.jsPsych.pluginAPI.setTimeout(l,n.trial_duration)}simulate(e,n,o,r){n=="data-only"&&(r(),this.simulate_data_only(e,o)),n=="visual"&&this.simulate_visual(e,o,r)}create_simulation_data(e,n){const o={stimulus:e.stimulus,rt:this.jsPsych.randomization.sampleExGaussian(500,50,.006666666666666667,!0)+e.enable_button_after,response:this.jsPsych.randomization.randomInt(0,e.choices.length-1)},r=this.jsPsych.pluginAPI.mergeSimulationData(o,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,r),r}simulate_data_only(e,n){const o=this.create_simulation_data(e,n);this.jsPsych.finishTrial(o)}simulate_visual(e,n,o){const r=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),o(),r.rt!==null&&this.jsPsych.pluginAPI.clickTarget(a.querySelector(`#jspsych-html-button-response-btngroup [data-choice="${r.response}"]`),r.rt)}}let We=!1,M=[];const Ee=new Map;let ne=!1,Ie=!1;function Pn(t){!t||typeof t!="string"||M[M.length-1]!==t&&(M.push(t),M.length>32&&M.shift())}function ft(t){const e=typeof t?.data=="function"?null:t?.data??null;return typeof e?.phase=="string"?e.phase:null}function jn(t,e){return t&&typeof t=="object"&&typeof t!="function"?{...t,hidden_nav_step:e}:(...n)=>({...typeof t=="function"?t(...n):{},hidden_nav_step:e})}function v(t,e){!t||typeof t!="string"||typeof e!="function"||Ee.set(t,e)}function b(t,e=ft(t)){if(!e||typeof e!="string")return t;const n=t?.on_load;return t.data=jn(t?.data,e),t._hidden_nav_checkpoint=!0,t.on_load=(...o)=>{Pn(e),n?.(...o)},t}function W(t,e){v(t,e)}function U(t){return b(t,ft(t))}function Ln(){const t=Ie;return Ie=!1,t}function Nn(t){const e=t?.timeline?.getLatestNode?.();return e&&typeof e.getDataParameter=="function"?e:null}function An(t){try{const e=Nn(t);if(!e)return null;const n=e.getDataParameter?.()??{},o=typeof n.hidden_nav_step=="string"?n.hidden_nav_step:null;return{node:e,stepId:o,phase:typeof n.phase=="string"?n.phase:null}}catch{return null}}function $n(t){const e=t?.description?.type?.info?.name??null;return e==="html-button-response"?{response:0}:e==="survey-html-form"?{response:{}}:{}}function Cn(t){const e=M.slice();if(t)for(;e[e.length-1]===t;)e.pop();return{trimmedHistory:e,prevStepId:e[e.length-1]??null}}function Ue(t,e){const n=t?.parent?.description?.timeline;if(!Array.isArray(n))return!1;const o=n.indexOf(t.description);return o<0?!1:(n.splice(o+1,0,...e),!0)}function Rn(){return function(e){if(e?._hidden_nav_checkpoint===!0){ne&&(ne=!1),te(!1);return}if(!ne){te(!1);return}!e||typeof e!="object"||(e.trial_duration=0,e.choices="NO_KEYS")}}function Dn(t){if(We||typeof document>"u")return;const e=n=>{const o=n.target&&n.target.tagName||"";if(o==="INPUT"||o==="TEXTAREA"||n.target?.isContentEditable||n.metaKey||n.ctrlKey||n.altKey)return;const r=n.key?.toLowerCase?.();if(r!=="u"&&r!=="r")return;const a=An(t);if(!a)return;n.preventDefault(),n.stopPropagation(),dt();const s=$n(a.node),l=!!a.stepId;if(r==="u"){Ie=!0,l||(ne=!0),te(!0),t.finishTrial({...s,phase:a.phase,hidden_nav:"forward",hidden_nav_step:a.stepId??null});return}const{trimmedHistory:u,prevStepId:i}=Cn(a.stepId),d=i?Ee.get(i):null;if(!d)return;let c=!1;if(l){const h=Ee.get(a.stepId);if(!h)return;c=Ue(a.node,[d(),h()])}else c=Ue(a.node,[d()]);c&&(M=u,ne=!1,l?te(!1):te(!0),t.finishTrial({...s,phase:a.phase,hidden_nav:"back",hidden_nav_step:a.stepId??null,hidden_nav_target_step:i}))};document.addEventListener("keydown",e,!0),We=!0}const Mn="online-2101803-v1",zn=`
...
`;function gt(){const t="consent";let e=!1;const n={type:P,stimulus:zn,choices:["I consent — begin","I do not consent — exit"],button_html:(o,r)=>`<button class="jspsych-btn" data-idx="${r}"${r===0?" disabled":""}>${o}</button>`,on_load:()=>{e=!1;const o=document.getElementById("consent-checkbox"),r=document.querySelector('button.jspsych-btn[data-idx="0"]');!o||!r||o.addEventListener("change",()=>{e=o.checked,r.disabled=!o.checked})},on_finish:async o=>{o.consented=o.response===0,o.consent_acknowledged=e,o.consent_version=Mn,o.consented&&await un()},data:{phase:"consent"}};return v(t,gt),b(n,t)}function qn(){return{timeline:[{type:P,stimulus:`
          <h2>Thank you</h2>
        ...
        `,choices:["Close"],on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Consent declined.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"consent"}).last(1).values()[0];return t?t.consented===!1:!1}}}var Yn="2.1.0";const Bn={name:"survey-html-form",version:Yn,parameters:{html:{type:p.HTML_STRING,default:null},preamble:{type:p.HTML_STRING,default:null},button_label:{type:p.STRING,default:"Continue"},autofocus:{type:p.STRING,default:""},dataAsArray:{type:p.BOOL,default:!1},autocomplete:{type:p.BOOL,default:!1}},data:{response:{type:p.OBJECT},rt:{type:p.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class X{constructor(e){this.jsPsych=e}static{this.info=Bn}trial(e,n){var o="";if(n.preamble!==null&&(o+='<div id="jspsych-survey-html-form-preamble" class="jspsych-survey-html-form-preamble">'+n.preamble+"</div>"),n.autocomplete?o+='<form id="jspsych-survey-html-form">':o+='<form id="jspsych-survey-html-form" autocomplete="off">',o+=n.html,o+='<input type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" value="'+n.button_label+'"></input>',o+="</form>",e.innerHTML=o,n.autofocus!==""){var r=e.querySelectorAll("#"+n.autofocus);r.length===0?console.warn("No element found with id: "+n.autofocus):r.length>1?console.warn('The id "'+n.autofocus+'" is not unique so autofocus will not work.'):r[0].focus()}e.querySelector("#jspsych-survey-html-form").addEventListener("submit",u=>{u.preventDefault();var i=performance.now(),d=Math.round(i-a),c=e.querySelector("#jspsych-survey-html-form"),h=s(c);n.dataAsArray||(h=l(h));var m={rt:d,response:h};this.jsPsych.finishTrial(m)});var a=performance.now();function s(u){for(var i=[],d=0;d<u.elements.length;d++){var c=u.elements[d];if(!(!c.name||c.disabled||c.type==="file"||c.type==="reset"||c.type==="submit"||c.type==="button"))if(c.type==="select-multiple")for(var h=0;h<c.options.length;h++)c.options[h].selected&&i.push({name:c.name,value:c.options[h].value});else(c.type!=="checkbox"&&c.type!=="radio"||c.checked)&&i.push({name:c.name,value:c.value})}return i}function l(u){for(var i={},d=0;d<u.length;d++)i[u[d].name]=u[d].value;return i}}}function Hn(){if(typeof window>"u"||typeof window.matchMedia!="function")return"unknown";try{if(window.matchMedia("(prefers-color-scheme: dark)").matches)return"dark";if(window.matchMedia("(prefers-color-scheme: light)").matches)return"light"}catch{}return"unknown"}const Fn=`
  <style>
...
`;function yt(){const t="demographics",e={type:X,preamble:`
      <h2>Demographics</h2>
    ...
    `,button_label:"Continue",data:{phase:"demographics"},on_load:()=>{const n=Hn(),o=document.querySelector('input[name="color_scheme_detected"]');o&&(o.value=n);const r=document.querySelector('select[name="color_scheme"]');r&&(n==="light"||n==="dark")&&(r.value=n)}};return v(t,yt),b(e,t)}var Gn="2.1.0";const Wn={name:"call-function",version:Gn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class we{constructor(e){this.jsPsych=e}static{this.info=Wn}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=s=>{o=s,r()};n.func(a)}else o=n.func(),r()}}function Un({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,s=[];return/\biphone\b/.test(r)&&s.push("iphone"),/\bipod\b/.test(r)&&s.push("ipod"),/\bipad\b/.test(r)&&s.push("ipad"),/macintosh/.test(r)&&a>1&&s.push("ipad_macos_disguised"),/android/.test(r)&&s.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&s.push("mobile_ua"),e===!1&&n===!1&&s.push("no_hover_no_fine_pointer"),{isDesktop:s.length===0,reasons:s,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Kn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function Vn(){return{type:we,async:!1,func:()=>Un(Kn()),data:{phase:"desktop_gate"}}}function Jn(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Se="display-colour-locked";function Xn(){if(typeof document>"u")return!1;const t=document.documentElement;return t.classList.contains(Se)?!1:(t.classList.add(Se),!0)}function Oe(){return typeof document>"u"?!1:document.documentElement.classList.contains(Se)}const Ke="display_mode_check",Qn=`
  <h2>Display check</h2>
...
`;function bt(){const t={type:P,stimulus:Qn,choices:["Continue"],on_load:()=>{const e=document.getElementById("display-colour-lock-btn"),n=document.getElementById("display-colour-lock-status"),o=()=>{!e||!n||(e.disabled=!0,e.style.opacity="0.55",e.style.cursor="default",e.textContent="Light mode forced",n.style.display="inline")};Oe()?o():e&&e.addEventListener("click",()=>{Xn(),o()})},on_finish:e=>{e.display_colour_locked=Oe()},data:{phase:"display_mode_check"}};return v(Ke,bt),b(t,Ke)}const Zn=85.6,Pe=1.5,je=12,eo=100,to=1100,pe=320,no=2,Ve="screen_calibration",Je="screen_calibration_retry_hint",oo=`
  ...
  <input id="cc-slider" type="range" min="${eo}" max="${to}" value="${pe}"
...
`;function wt(){const t={type:P,stimulus:oo,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),o=()=>{const r=parseInt(e.value,10);n.style.width=`${r}px`,n.style.height=`${r*(53.98/85.6)}px`};e.addEventListener("input",o),o()},on_finish:e=>{const n=document.getElementById("cc-slider"),o=n?parseInt(n.value,10):pe,r=o/Zn;e.cc_px_width=o,e.px_per_mm=r,e.px_per_mm_in_bounds=r>=Pe&&r<=je,e.px_per_mm_min=Pe,e.px_per_mm_max=je,e.display_colour_locked=Oe(),document.documentElement.style.setProperty("--mm",`${r}px`)},data:{phase:"screen_calibration"}};return v(Ve,wt),b(t,Ve)}function ao(){return{type:we,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=Pe&&t.px_per_mm<=je),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function _t(){const t={type:P,stimulus:ro,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Je,_t),b(t,Je)}function so(t){return{timeline:[_t()],conditional_function:()=>t.count>=1}}function io({maxAttempts:t=no}={}){const e={count:0};return{timeline:[so(e),wt(),ao(),lo(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function lo(t,e){return{type:we,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],o=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:o,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const co="72vh",uo="#000",ho="50rem",po="95vw",mo="72rem",vt=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${co};
  color: ${uo};
`.replace(/\s+/g," ").trim(),kt=`${vt} width: ${ho}; max-width: 94vw;`,fo=`${vt} width: ${po}; max-width: ${mo}; align-items: center;`,Tt=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim(),go=`
  ...
  min-height: 0;
  width: 100%;
`.replace(/\s+/g," ").trim();function xt({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${It(n.trim())}"`:"";return`
    <div style="${`${kt} min-height: auto; padding-top: 0.4rem; padding-bottom: 0.4rem; font-size: 0.95rem; line-height: 1.5;`}">
      <div style="flex: 0 0 auto; width: 100%; margin: 0 0 0.5rem; display: flex; align-items: center; justify-content: center;">
        <h2 style="${Re}">${t}</h2>
      </div>
      <div style="${go}" data-voiceover-target${o}>${e}</div>
    </div>
  `}const De=50,L=De/2,Et=De*Math.SQRT2/2+1,Le=Et-L+.5,de=De+2*Le,Xe={cx:35,cy:15},Qe={cx:15,cy:35},yo=2.5,bo=2.5,Ze=100,wo=30,_o=12,vo=12,ko=[1,2,3,7,10,11,12,13,14,17,21,22,23],ue=10,To="#FFFFFF",xo=.33;function Eo(t,e,n){const r=n*.382,a=[];for(let s=0;s<10;s++){const l=s%2===0?n:r,u=-Math.PI/2+s*Math.PI/5;a.push(`${t+l*Math.cos(u)},${e+l*Math.sin(u)}`)}return a.join(" ")}const Io=Eo(Qe.cx,Qe.cy,bo),So="rgba(0, 0, 0, 0.229)",Oo="rgba(0, 0, 0, 0.55)",et="#000",tt="rgba(0, 0, 0, 0.85)";function Po(t,{arrowAngleDeg:e=wo}={}){const n=new Set(t),o=n.has("tone")||n.has("qmark"),r=n.has("pattern"),a=`<circle cx="${L}" cy="${L}" r="${Et}" fill="none" stroke="${So}" stroke-width="0.5" />`,s=o||r?"":`<circle cx="${L}" cy="${L}" r="0.65" fill="${Oo}" />`,l=r?ko.map(f=>{const w=f%5,x=Math.floor(f/5),g=w*ue,N=x*ue;return`<rect x="${g}" y="${N}" width="${ue}" height="${ue}" fill="${To}" opacity="${xo}" />`}).join(""):"",u=n.has("dot")?`<circle cx="${Xe.cx}" cy="${Xe.cy}" r="${yo}" fill="${et}" />`:"",i=n.has("star")?`<polygon points="${Io}" fill="${et}" />`:"",d=n.has("tone")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${tt}" font-size="${_o}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",c=n.has("qmark")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${tt}" font-size="${vo}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
    <svg viewBox="${-Le} ${-Le} ${de} ${de}"
         width="100%" height="100%" style="display: block; overflow: visible;">
      ${a}${l}${s}${u}${i}${d}${c}
    </svg>
  `,m=(e/360).toFixed(6),_=n.has("arrow")?`<img src="${jo()}" alt="rotation cue"
            style="position: absolute; top: 50%; left: 50%; width: ${Ze}px; height: ${Ze}px;
  ...
  `}function jo(){return"./assets/rotation-arrow.png"}function k({title:t,body:e,narration:n,exemplar:o=[],arrowAngleDeg:r}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${It(n.trim())}"`:"",s=Po(o,typeof r=="number"?{arrowAngleDeg:r}:{});return`
    <div style="${kt} align-items: center;">
      <div style="${Tt}">
        <h2 style="${Re}">${t}</h2>
      </div>
  ...
  `}function It(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Lo=xt({title:"Sit comfortably for the study",body:`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Ao(){const t=b({type:P,stimulus:Lo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:P,stimulus:No,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function St(){const t="speaker_volume_instruction",e={type:P,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=Z;const l=Promise.resolve();He(Z/100);const u=document.getElementById("tac-slider"),i=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const g=Number(u.value);a=g,i&&(i.textContent=`${g}%`),He(g/100)});const d=document.getElementById("tac-yes-btn");if(d&&d.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await l,e)return;const c=hn(),h=ht(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+qo)/1e3,f=Yo/1e3,w=[];for(let g=0;g<h.length;g++)w.push(document.getElementById(`tac-box-${g}`));let x=c.currentTime+Bo/1e3;try{for(let g=0;g<Ho&&!e;g++){r=g+1;for(let N=0;N<h.length&&!e;N++){const D=x;if(pn(N,{when:D}),await ke(c,D),e)break;const K=w[N];K&&K.classList.add("playing"),await ke(c,D+m),K&&K.classList.remove("playing"),x=D+_}e||(await ke(c,x+f),x+=f)}}catch{}if(!o&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{dt();const u=ut();u.current&&!u.current._state?.finished&&u.current.cancel(),l.tones_audible=o&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,jt),b(s,t)}function Wo(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"tone_audibility_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Tone audibility failed.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"tone_audibility_and_comfort"}).last(1).values()[0];return t?t.tones_audible===!1:!1}}}function Uo(){return[Vn(),Jn(),gt(),qn(),yt(),Ao(),bt(),io(),St(),Pt(),zo(),jt(),Wo()]}var Ko="2.1.0";const Vo={name:"instructions",version:Ko,parameters:{pages:{type:p.HTML_STRING,default:void 0,array:!0},key_forward:{type:p.KEY,default:"ArrowRight"},key_backward:{type:p.KEY,default:"ArrowLeft"},allow_backward:{type:p.BOOL,default:!0},allow_keys:{type:p.BOOL,default:!0},show_clickable_nav:{type:p.BOOL,default:!1},show_page_number:{type:p.BOOL,default:!1},page_label:{type:p.STRING,default:"Page"},button_label_previous:{type:p.STRING,default:"Previous"},button_label_next:{type:p.STRING,default:"Next"},on_page_change:{type:p.FUNCTION,pretty_name:"Page change callback",default:function(t){}}},data:{view_history:{type:p.COMPLEX,array:!0,nested:{page_index:{type:p.INT},viewing_time:{type:p.INT}}},rt:{type:p.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class re{constructor(e){this.jsPsych=e}static{this.info=Vo}trial(e,n){var o=0,r=[],a=performance.now(),s=a;function l(){this.id==="jspsych-instructions-back"?d():this.id==="jspsych-instructions-next"&&i()}function u(){var f=n.pages[o],w="";if(n.show_page_number&&(w="<span style='margin: 0 1em;' class='jspsych-instructions-pagenum'>"+n.page_label+" "+(o+1)+"/"+n.pages.length+"</span>"),n.show_clickable_nav){var x="<div class='jspsych-instructions-nav' style='padding: 10px 0px;'>";if(n.allow_backward){var g=o>0?"":"disabled='disabled'";x+="<button id='jspsych-instructions-back' class='jspsych-btn' style='margin-right: 5px;' "+g+">&lt; "+n.button_label_previous+"</button>"}n.pages.length>1&&n.show_page_number&&(x+=w),x+="<button id='jspsych-instructions-next' class='jspsych-btn'style='margin-left: 5px;'>"+n.button_label_next+" &gt;</button></div>",f+=x,e.innerHTML=f,o!=0&&n.allow_backward&&e.querySelector("#jspsych-instructions-back").addEventListener("click",l,{once:!0}),e.querySelector("#jspsych-instructions-next").addEventListener("click",l,{once:!0})}else n.show_page_number&&n.pages.length>1&&(f+="<div class='jspsych-instructions-pagenum'>"+w+"</div>"),e.innerHTML=f}function i(){c(),o++,o>=n.pages.length?h():u(),n.on_page_change(o)}function d(){c(),o--,u(),n.on_page_change(o)}function c(){var f=performance.now(),w=Math.round(f-s);r.push({page_index:o,viewing_time:w}),s=f}const h=()=>{n.allow_keys&&this.jsPsych.pluginAPI.cancelKeyboardResponse(_);var f={view_history:r,rt:Math.round(performance.now()-a)};this.jsPsych.finishTrial(f)},m=f=>{_=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1,allow_held_key:!1}),this.jsPsych.pluginAPI.compareKeys(f.key,n.key_backward)&&o!==0&&n.allow_backward&&d(),this.jsPsych.pluginAPI.compareKeys(f.key,n.key_forward)&&i()};if(u(),n.allow_keys)var _=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1})}simulate(e,n,o,r){n=="data-only"&&(r(),this.simulate_data_only(e,o)),n=="visual"&&this.simulate_visual(e,o,r)}create_simulation_data(e,n){let o=0,r=0,a=[];if(!n.data?.view_history&&!n.data?.rt)for(;o!==e.pages.length;){const u=Math.round(this.jsPsych.randomization.sampleExGaussian(3e3,300,.0033333333333333335));a.push({page_index:o,viewing_time:u}),r+=u,o==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?o++:o--}if(!n.data?.view_history&&n.data?.rt){for(r=n.data.rt;o!==e.pages.length;)a.push({page_index:o,viewing_time:null}),o==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?o++:o--;const u=n.data.rt/a.length;let i=0;for(const h of a){const m=Math.round(this.jsPsych.randomization.sampleExGaussian(u,u/10,1/(u/10)));h.viewing_time=m,i+=m}const d=n.data.rt-i,c=Math.round(d/a.length);for(const h of a)h.viewing_time+=c}if(n.data?.view_history&&!n.data?.rt){a=n.data.view_history,r=0;for(const u of n.data.view_history)r+=u.viewing_time}const s={view_history:a,rt:r},l=this.jsPsych.pluginAPI.mergeSimulationData(s,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,l),l}simulate_data_only(e,n){const o=this.create_simulation_data(e,n);this.jsPsych.finishTrial(o)}simulate_visual(e,n,o){const r=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),o();const s=d=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_forward,d):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-next"),d)},l=d=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_backward,d):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-back"),d)};let u=0,i=0;for(let d=0;d<r.view_history.length;d++)d==r.view_history.length-1?s(i+r.view_history[d].viewing_time):(r.view_history[d+1].page_index>u&&s(i+r.view_history[d].viewing_time),r.view_history[d+1].page_index<u&&l(i+r.view_history[d].viewing_time),i+=r.view_history[d].viewing_time,u=r.view_history[d+1].page_index)}}const Lt='<span style="color: #0DE72E;"><strong>green</strong></span>',Nt='<span style="color: #FF1818;"><strong>red</strong></span>',At=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function $t(){const t=y.memory.set_size,e="Task 1 — Remember the dots",n=[k({title:e,body:`
      ...
      `,narration:`After the dots, we test your memory ${t} times. Each time, a black dot appears for 3 seconds in some location. Press Yes, the right arrow, if a dot was shown in that location. Press No, the left arrow, if it was not. Keep your eyes on the centre of the circle throughout.`,exemplar:["qmark"]}),k({title:e,body:`
        ...
        ${Lt} for correct or
        ${Nt} for incorrect while it is still on screen.</p>
        ${I("Press <kbd>Space</kbd> for the Task 1 demonstration.")}
      `,narration:"You have 3 seconds for each test. Aim for accuracy first, but don't dwell. If you answer in time, the dot turns green for correct or red for incorrect while it is still on screen. Press Space for the Task 1 demonstration.",exemplar:["qmark"]})],o={type:re,pages:n,...At,data:{phase:"instructions_memory_d_only"}};return W(o.data.phase,$t),U(o)}function Ct(){const t=y.memory.set_size,e="Task 2 — Remember the tones",n=[k({title:e,body:`
      ...
      `,narration:"You have 3 seconds for each test. If you answer in time, the central question mark turns green for correct or red for incorrect. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 2 demonstration.",exemplar:["tone"]})],o={type:re,pages:n,...At,data:{phase:"instructions_memory_t_only"}};return W(o.data.phase,Ct),U(o)}const Jo='<span style="color: #0DE72E;"><strong>green</strong></span>',Xo='<span style="color: #FF1818;"><strong>red</strong></span>',Qo='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',Zo=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Rt(){const t=y.imagery.stars_per_trial,e="Task 3 — Picture the pattern",n=[k({title:e,body:`
      ...
      `,narration:`Then ${t} bright stars will flash inside the circle, one at a time. For each star, decide whether it lands on the rotated pattern you are picturing. Press On-pattern, the right arrow, if the star falls on your pictured pattern. Press Not on-pattern, the left arrow, if it does not.`,exemplar:["star"]}),k({title:e,body:`
        ...
        ${Jo} for correct or
        ${Xo} for incorrect while it is still on screen.</p>
        <p>Be honest about your mental picture — if it's fuzzy, just do
        your best.</p>
        ${I("Press <kbd>Space</kbd> for the Task 3 demonstration.")}
      `,narration:"You have 3 seconds for each star. Aim for accuracy first, but don't dwell. If you answer in time, the star turns green for correct or red for incorrect while it is still on screen. Be honest about your mental picture — if it's fuzzy, just do your best. Press Space for the Task 3 demonstration.",exemplar:["star"]})],o={type:re,pages:n,...Zo,data:{phase:"instructions_imagery_i_only"}};return W(o.data.phase,Rt),U(o)}const Dt='<span style="color: #0DE72E;"><strong>green</strong></span>',Mt='<span style="color: #FF1818;"><strong>red</strong></span>',zt='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',qt=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Yt(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,o="Task 4 — Dots and pattern together",r=[k({title:o,body:`
      ...
      `,narration:`Then ${n} things appear inside the circle one at a time, mixed together. ${e} stars — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} dots — remember which locations they appear in, for the dot tests at the end of the trial.`,exemplar:["star","dot"]}),k({title:o,body:`
        ...
        ${Dt} for correct or ${Mt} for incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the dot tests begin. Press Space for the Task 4 demonstration.",exemplar:["pattern"]})],a={type:re,pages:r,...qt,data:{phase:"instructions_dual_i_d"}};return W(a.data.phase,Yt),U(a)}function Bt(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,o="Task 5 — Tones and pattern together",r=[k({title:o,body:`
      ...
      `,narration:`Then ${n} things happen one at a time, mixed together. ${e} stars inside the circle — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} tones — remember each tone you hear, for the tone tests at the end of the trial.`,exemplar:["star","tone"]}),k({title:o,body:`
        ...
        mark turns ${Dt} for correct or ${Mt} for
        incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 5 demonstration.",exemplar:["pattern"]})],a={type:re,pages:r,...qt,data:{phase:"instructions_dual_i_t"}};return W(a.data.phase,Bt),U(a)}const er=4,Ht=1e3*er,tr=2e3,nr=400,E=500,T=400,q=1200,or=700,rr=450,ar=220,Y=1500,Me=1e3,sr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function ze(){return Ne().pick(sr)}const ir="./assets/rotation-arrow.png";function lr(t,e){return`
    <style>
      ...
      /* Wiggle = exaggerated up-then-down arc so the press demonstration
       * reads at-a-glance on a busy demo column (buttons, key caps, watch-
       * and-listen banner, caption box all share the viewport).
       * 0 → -1.1rem peak rise: the hand lifts noticeably off the key cap.
       * 55 → +0.4rem rebound: the hand lands past the resting line to
       * sell the downward press, then settles. The arc is paired with a
       * subtle scale pulse so the gesture has a second cue (size) on top
       * of vertical motion — helps it survive against the surrounding
       * animations (button-press flash, voiceover word-reveal). */
      @keyframes demo-hand-wiggle {
        0%   { transform: translateY(0) scale(1); }
        30%  { transform: translateY(-1.1rem) scale(1.18); }
        58%  { transform: translateY(0.4rem) scale(0.94); }
        100% { transform: translateY(0) scale(1); }
      }
      .demo-hand.is-pressing {
        animation: demo-hand-wiggle 440ms cubic-bezier(0.4, 1.4, 0.5, 1);
      }
    ...
    <div class="demo-frame" style="${fo}">
      <div style="${Tt}">
        <h2 style="${Re}">Demonstration of Task ${t} — ${e}</h2>
      </div>
  ...
  `}function cr(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const o=mn(e);o?(fn(),t.currentNarration=ut().speak(o)):t.currentNarration=null},async wait(e){return await Fe(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let o=!1;const r=()=>{o||(o=!0,n())};e.done.then(r).catch(r);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),r())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await Fe(nr),t.cancelled)?!1:(this.setCaption(e),!0)},async narrate(e){return!(!await this.advanceCaption(e)||!await this.awaitNarration())}}}function dr(t,e){const n=y.imagery.rotation_arrow_size_px,o=document.createElement("img");return o.src=ir,o.alt="rotation cue",o.className="rotation-arrow-cue demo-arrow",o.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none","filter: brightness(0) saturate(100%) drop-shadow(1px 0 0 #fff) drop-shadow(-1px 0 0 #fff) drop-shadow(0 1px 0 #fff) drop-shadow(0 -1px 0 #fff)"].join("; ")+";"),t.wrapper.appendChild(o),o}function he(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function qe(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),xn(t),Ge(t),!await e.awaitNarration()||!await e.wait(1e3)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;xe(t);const s=dr(t,n);return!await e.awaitNarration()||!await e.wait(600)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(he(s),!1):(he(s),mt(t,n),Ge(t),!await e.awaitNarration()||!await e.wait(1500)?!1:(xe(t),!0))}function ae(){const t=En(),e=In();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function B({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `;const o=n.querySelector(".demo-buttons-container"),r=n.querySelector('button[data-side="left"]'),a=n.querySelector('button[data-side="right"]'),s=n.querySelector('.demo-btn-key[data-side="left"]'),l=n.querySelector('.demo-btn-key[data-side="right"]'),u=n.querySelector('.demo-hand[data-side="left"]'),i=n.querySelector('.demo-hand[data-side="right"]');return{container:o,leftBtn:r,rightBtn:a,leftKey:s,rightKey:l,leftHand:u,rightHand:i}}function z(){const t=document.getElementById("demo-buttons-row");t&&(t.innerHTML="")}function se(){const t=document.getElementById("demo-watch-banner-row");return t?(t.innerHTML=`
    <div class="demo-watch-banner" role="status" aria-live="polite">
      Just watch and listen, don't respond yet
    </div>
  `,!0):!1}function Ft(){const t=document.getElementById("demo-watch-banner-row");t&&(t.innerHTML="")}function ur(t){t&&(t.leftHand?.classList.add("is-visible"),t.rightHand?.classList.add("is-visible"))}async function H(t,e,n){if(!t)return!0;if(ur(t),!await n.wait(or))return!1;const o=e==="right"?t.rightHand:t.leftHand;if(o&&(o.classList.remove("is-pressing"),o.offsetWidth,o.classList.add("is-pressing")),!await n.wait(Math.min(rr,220)))return!1;const r=e==="right"?t.rightBtn:t.leftBtn;return r&&(r.classList.remove("demo-btn-pressed"),r.offsetWidth,r.classList.add("demo-btn-pressed")),!!await n.wait(ar)}function F(t){t&&(t.leftHand?.classList.remove("is-visible","is-pressing"),t.rightHand?.classList.remove("is-visible","is-pressing"))}const R=Object.freeze({left:"No",right:"Yes"}),V=Object.freeze({left:"Not on-pattern",right:"On-pattern"});function G({pressedLabel:t,correctLabel:e,isCorrect:n,stimulusName:o}){const r=`<span style="color: ${$}; font-weight: 600;">correct</span>`,a=`<span style="color: ${C}; font-weight: 600;">incorrect</span>`;return n?`We chose <strong>${t}</strong> — that was the ${r} answer, so the ${o} turns green.`:`We chose <strong>${t}</strong> — that was ${a}; the ${r} answer was <strong>${e}</strong>, so the ${o} turns red.`}async function hr(t,e){const{memCells:n,fillerCells:o,probeCells:r}=ae();if(se(),!await e.narrate("Memorize the locations of the dots that will appear inside the circle one at a time.")||!await e.advanceCaption("")||!await e.wait(E))return;for(let l=0;l<3;l++){const u=ge(t,n[l]);if(!await e.wait(Ht)||(j(u),!await e.wait(T)))return;const i=Ae(t,o[l],{visible:!1});if(!await e.wait(Me))return;j(i)}if(!await e.narrate("Hold the dots in mind for a moment.")||(S(t,"?"),!await e.wait(T)))return;const a=B({leftLabel:"No",rightLabel:"Yes"}),s=2;for(let l=0;l<r.length;l++){const u=r[l],i=u.isTarget?"right":"left",d=l===s?i==="right"?"left":"right":i;if(!await e.narrate(`Test ${l+1} of 3: was a dot just shown in this location?`)||!await e.wait(E))return;const c=ge(t,u.cell);if(!await e.wait(q)||!await H(a,d,e))return;const h=d===i;if(c.setAttribute("fill",h?$:C),!await e.wait(Y)||!await e.narrate(G({pressedLabel:R[d],correctLabel:R[i],isCorrect:h,stimulusName:"dot"}))||(F(a),j(c),!await e.wait(T)))return}S(t,"")}async function pr(t,e){const{memCells:n,fillerCells:o,probeCells:r}=ae();if(se(),!await e.narrate("Memorize each of the tones that will play one at a time.")||!await e.advanceCaption("")||!await e.wait(E))return;for(let l=0;l<3;l++){if(await fe(n[l]).catch(()=>{}),!await e.wait(T))return;const u=Ae(t,o[l],{visible:!1});if(!await e.wait(Me))return;j(u)}if(!await e.narrate("Hold the tones in mind for a moment.")||(S(t,"?"),!await e.wait(T)))return;const a=B({leftLabel:"No",rightLabel:"Yes"}),s=2;for(let l=0;l<r.length;l++){const u=r[l],i=u.isTarget?"right":"left",d=l===s?i==="right"?"left":"right":i;if(!await e.wait(E)||(await fe(u.cell).catch(()=>{}),!await e.wait(T))||!await e.narrate(`Test ${l+1} of 3: was that tone one of the ones you just heard?`)||!await e.wait(q)||!await H(a,d,e))return;const c=d===i;if(S(t,"?",{color:c?$:C}),!await e.wait(Y)||!await e.narrate(G({pressedLabel:R[d],correctLabel:R[i],isCorrect:c,stimulusName:"question mark"}))||(F(a),S(t,"?"),!await e.wait(T)))return}S(t,"")}async function mr(t,e){const n=ze();if(se(),!await e.narrate("Picture the pattern, turn it in your mind, then judge whether each star falls on the rotated pattern.")||!await qe(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 3 stars will appear inside the circle. For each star, decide whether it falls <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const o=B({leftLabel:"Not on-pattern",rightLabel:"On-pattern"}),{fillerCells:r,starCells:a}=ae(),s=2;for(let l=0;l<3;l++){const u=Ae(t,r[l],{visible:!1});if(!await e.wait(Me))return;j(u);const i=a[l],d=i.isOn?"right":"left",c=l===s?d==="right"?"left":"right":d;if(!await e.wait(E))return;const h=$e(t,i.cell);if(!await e.wait(q)||!await H(o,c,e))return;const m=c===d;if(Ce(h,m?$:C),!await e.wait(Y)||!await e.narrate(G({pressedLabel:V[c],correctLabel:V[d],isCorrect:m,stimulusName:"star"}))||(F(o),j(h),!await e.wait(T)))return}}async function fr(t,e){const n=ze();if(se(),!await e.narrate("Picture the rotated pattern, memorize the dot locations, and judge whether each star falls on the rotated pattern.")||!await qe(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 6 things appear inside the circle, mixed together: 3 dots to remember, 3 stars to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{memCells:o,starCells:r,probeCells:a}=ae(),s=2;for(let i=0;i<3;i++){if(z(),!await e.wait(E))return;const d=ge(t,o[i]);if(!await e.wait(Ht)||(j(d),!await e.wait(T)))return;const c=r[i],h=c.isOn?"right":"left",m=i===s?h==="right"?"left":"right":h,_=B({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await e.wait(E))return;const f=$e(t,c.cell);if(!await e.wait(q)||!await H(_,m,e))return;const w=m===h;if(Ce(f,w?$:C),!await e.wait(Y)||!await e.narrate(G({pressedLabel:V[m],correctLabel:V[h],isCorrect:w,stimulusName:"star"}))||(F(_),j(f),!await e.wait(T)))return}if(z(),!await e.narrate("The question mark means the dot tests begin. You may let the picture go and focus on the dots."))return;const l=B({leftLabel:"No",rightLabel:"Yes"});if(S(t,"?"),!await e.wait(T))return;const u=2;for(let i=0;i<a.length;i++){const d=a[i],c=d.isTarget?"right":"left",h=i===u?c==="right"?"left":"right":c;if(!await e.narrate(`Dot test ${i+1} of 3: was a dot shown in this location?`)||!await e.wait(E))return;const m=ge(t,d.cell);if(!await e.wait(q)||!await H(l,h,e))return;const _=h===c;if(m.setAttribute("fill",_?$:C),!await e.wait(Y)||!await e.narrate(G({pressedLabel:R[h],correctLabel:R[c],isCorrect:_,stimulusName:"dot"}))||(F(l),j(m),!await e.wait(T)))return}S(t,"")}async function gr(t,e){const n=ze();if(se(),!await e.narrate("Picture the rotated pattern, memorize each tone, and judge whether each star falls on the rotated pattern.")||!await qe(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 6 things happen, mixed together: 3 tones to remember, 3 stars (inside the circle) to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{memCells:o,starCells:r,probeCells:a}=ae(),s=2;for(let i=0;i<3;i++){if(z(),!await e.wait(E)||(await fe(o[i]).catch(()=>{}),!await e.wait(T)))return;const d=r[i],c=d.isOn?"right":"left",h=i===s?c==="right"?"left":"right":c,m=B({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await e.wait(E))return;const _=$e(t,d.cell);if(!await e.wait(q)||!await H(m,h,e))return;const f=h===c;if(Ce(_,f?$:C),!await e.wait(Y)||!await e.narrate(G({pressedLabel:V[h],correctLabel:V[c],isCorrect:f,stimulusName:"star"}))||(F(m),j(_),!await e.wait(T)))return}if(z(),!await e.narrate("The question mark means the tone tests begin. You may let the picture go and focus on the tones."))return;const l=B({leftLabel:"No",rightLabel:"Yes"});if(S(t,"?"),!await e.wait(T))return;const u=2;for(let i=0;i<a.length;i++){const d=a[i],c=d.isTarget?"right":"left",h=i===u?c==="right"?"left":"right":c;if(!await e.wait(E)||(await fe(d.cell).catch(()=>{}),!await e.wait(T))||!await e.narrate(`Tone test ${i+1} of 3: was that tone one of the ones you just heard?`)||!await e.wait(q)||!await H(l,h,e))return;const m=h===c;if(S(t,"?",{color:m?$:C}),!await e.wait(Y)||!await e.narrate(G({pressedLabel:R[h],correctLabel:R[c],isCorrect:m,stimulusName:"question mark"}))||(F(l),S(t,"?"),!await e.wait(T)))return}S(t,"")}const yr=3;async function br(t,e){if(t.state.cancelled)return!1;Ft();const n=document.getElementById("demo-buttons-row");if(!n)return!1;n.innerHTML=`
    <div class="demo-buttons-container" style="
      position: relative;
      display: inline-flex;
      align-items: center;
  ...
  `;const o=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${o} Click the button below to watch it again. When you are ready to start the practice, press the <kbd>Space</kbd> key.`)?new Promise(r=>{let a=!1;const s=i=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(c=>c.removeEventListener("click",l)),r(i)},l=i=>{const d=i.currentTarget.getAttribute("data-side");s(d==="right")};n.querySelectorAll(".demo-replay-btn").forEach(i=>i.addEventListener("click",l));const u=setInterval(()=>{t.state.cancelled&&(clearInterval(u),s(!1)),a&&clearInterval(u)},100)}):!1}function ie(t){return async function(n,o){let r=0;for(;!o.state.cancelled;){try{await t(n,o)}catch(l){console.error("[demo] mini-trial error",l);return}if(o.state.cancelled)return;o.state.spaceArmed=!0;const a=yr-r;if(a<=0){if(Ft(),!await o.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;z();return}if(!await br(o,a)){await o.advanceCaption("Press Space when you are ready to start the practice."),z();return}r+=1;try{Tn(n),z(),S(n,""),n.rotor.style.transition="",mt(n,0),xe(n)}catch{}if(!await o.advanceCaption("Replaying the demonstration…")||!await o.wait(tr))return}}}const wr=ie(hr),_r=ie(pr),vr=ie(mr),kr=ie(fr),Tr=ie(gr);function le({phase:t,taskNumber:e,title:n,run:o,factory:r}){const a={type:A,stimulus:lr(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const s=document.getElementById("demo-mount");if(!s)return;const l=kn({rotation_deg:0,fixation:"",background_shade:"gray"});s.appendChild(l.wrapper);const u=cr(),i=window.jsPsych?.getCurrentTrial?.();i&&typeof i=="object"&&(i._demo_state=u.state);let d=!0;const c=h=>{if(d){if(h.key==="ArrowLeft"||h.key==="ArrowRight"){h.preventDefault(),h.stopPropagation();return}if(h.key===" "||h.code==="Space"){if(h.preventDefault(),h.stopPropagation(),!u.state.spaceArmed)return;d=!1,document.removeEventListener("keydown",c,!0),u.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",c,!0),i&&typeof i=="object"&&(i._demo_keydown_handler=c),o(l,u).catch(h=>{console.error(`[demo:${t}] schedule error`,h)})},on_finish:()=>{const s=window.jsPsych?.getCurrentTrial?.();s?._demo_state&&(s._demo_state.cancelled=!0),s?._demo_keydown_handler&&(document.removeEventListener("keydown",s._demo_keydown_handler,!0),s._demo_keydown_handler=null)},data:{phase:t}};return W(t,r),U(a)}function Gt(){return le({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:wr,factory:Gt})}function Wt(){return le({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:_r,factory:Wt})}function Ut(){return le({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:vr,factory:Ut})}function Kt(){return le({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:kr,factory:Kt})}function Vt(){return le({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:Tr,factory:Vt})}const Te=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function rt(t){return typeof t!="string"?"":t.trim().toLowerCase()}function me(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:X,preamble:"<h2>Quick check</h2>",html:`
    ...
    `,button_label:"Continue",on_finish:o=>{const r=o.response?.response??"",a=rt(r);o.attention_check_id=t.id,o.attention_check_raw=r,o.attention_check_passed=a===rt(t.expected_answer)},data:{phase:"attention_check"}};return v(e,()=>me(t)),b(n,e)}function xr(t,e=y.attention_checks.instruction_max_failures){const n=(t??[]).filter(a=>a?.phase==="attention_check"),o=n.filter(a=>a.attention_check_passed===!0).length,r=n.filter(a=>a.attention_check_passed===!1).length;return{total:n.length,passed:o,failed:r,exceededThreshold:r>e,threshold:e,ids:n.map(a=>a.attention_check_id)}}function Jt(){const t="attention_check_summary",e={type:X,preamble:"<h2>Thanks — moving on.</h2>",html:`
      <div style="max-width: 36rem; margin: 0 auto;">
        <p>Press <strong>Continue</strong> to proceed to the main task.</p>
      </div>
    `,button_label:"Continue",on_finish:n=>{const o=window.jsPsych?.data?.get().values()??[],r=xr(o);n.phase="attention_check_summary",n.attention_total=r.total,n.attention_passed=r.passed,n.attention_failed=r.failed,n.attention_excluded=r.exceededThreshold,n.attention_threshold=r.threshold}};return v(t,Jt),b(e,t)}const at=Object.freeze(["d_only","t_only","i_only","i_d","i_t"]);function st(t){let e=0,n=0;for(const o of t)typeof o.probe_correct=="boolean"&&(n+=1,o.probe_correct&&(e+=1)),typeof o.star_correct=="boolean"&&(n+=1,o.star_correct&&(e+=1));return{correct:e,total:n,accuracy:n>0?e/n:0}}function ee({trialType:t,trialsPerType:e,sequencePoolLabelPrefix:n,prng:o}={}){if(!at.includes(t))throw new Error(`singleTypePractice: unknown trialType '${t}'; expected one of ${at.join(", ")}`);const r=e??y.blocks.practice_trials_per_type,a=o??Ne(),s=gn({blockLabel:"practice",countsByType:{[t]:r},sequencePoolLabelPrefix:n??"practice",runLengthCap:Math.max(1,r),prng:a});return{schedule:s.schedule,trialParams:s.trialParams,nodes:s.nodes}}function Er({acc:t,passed:e,willRetry:n,criterion:o}){return Ir({acc:t,passed:e,willRetry:n,criterion:o})}function Ir({acc:t,passed:e,willRetry:n,criterion:o}){const r=Math.round(t.accuracy*100),a=Math.round(o*100),s=e?'<h2 style="color:#0a7c4d;">Practice complete</h2>':'<h2 style="color:#b3261e;">Practice — keep going</h2>',l=e?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
  ...
  `}function Xt(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:A,stimulus:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return v(t,Zt),b(e,t)}function en(){const t=J.map(o=>{const r=o.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
    ...
    `,button_label:"Continue",on_finish:o=>{o.phase="music_experience",o.music_experience_responses=J.reduce((r,a)=>{const s=o.response?.[a.id];return r[a.id]=s===""||s===null||s===void 0?null:String(s),r},{})}};return v(e,en),b(n,e)}function Nr(){return[Zt(),en()]}function tn(){const t="questionnaire_intro",e={type:A,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,tn),b(e,t)}function Ar(){return[tn(),...Lr(),...Nr()]}function nn(){const t="main_a_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{pt()}};return v(t,nn),b(e,t)}function on(){const t="main_b_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,on),b(e,t)}function rn(){const t="end_of_task_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{yn(),pt()}};return v(t,rn),b(e,t)}const O=ln(),$r=cn();function Cr(){if(ht(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}Cr();const _e=dn({display_element:void 0,on_trial_start:Rn(),on_data_update:t=>{lt(t).catch(e=>{console.error("[runner] storage append failed",e),ct(e)})},on_finish:()=>{const t=_e.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:O.params.session_id,prolific_pid:O.params.prolific_pid,study_id:O.params.study_id,is_preview:O.params.is_preview,is_pilot_run:O.is_pilot_run,pilot_label:O.pilot_label,prng_seed_uint32:O.prng_seed_uint32,schema_version:O.schema_version,build_id:O.build_id}),console.info("[runner] session",O,"visibility",Mo())}});window.jsPsych=_e;Dn(_e);const it=bn(),Rr=[...Uo(),...Sr(),nn(),...it.mainA.nodes,wn(),on(),...it.mainB.nodes,rn(),...Ar(),_n({session:O}),vn()];$r.then(()=>_e.run(Rr)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-BmLkK-GX.js.map
