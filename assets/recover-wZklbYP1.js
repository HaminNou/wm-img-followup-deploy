import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as f}from"./config-DSJqK44t.js";import{c as b,g as w,d as y,e as $,f as v,h as _,p as x,u as I}from"./uploader-B9P4wRfj.js";const P=document.getElementById("mount");function d(s){P.innerHTML=`<h2>Data Recovery</h2>${s}`}function r(s){return String(s).replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[t])}async function S(){let s;try{s=(await b()).kind}catch{d(`
...
//# sourceMappingURL=recover-wZklbYP1.js.map
