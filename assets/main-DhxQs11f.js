...
`;function yt(){const t="demographics",e={type:X,preamble:`
    ...
    `,button_label:"Continue",data:{phase:"demographics"},on_load:()=>{const n=Hn(),o=document.querySelector('input[name="color_scheme_detected"]');o&&(o.value=n);const r=document.querySelector('select[name="color_scheme"]');r&&(n==="light"||n==="dark")&&(r.value=n)}};return v(t,yt),b(e,t)}var Gn="2.1.0";const Wn={name:"call-function",version:Gn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class we{constructor(e){this.jsPsych=e}static{this.info=Wn}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{o=i,r()};n.func(a)}else o=n.func(),r()}}function Un({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,i=[];return/\biphone\b/.test(r)&&i.push("iphone"),/\bipod\b/.test(r)&&i.push("ipod"),/\bipad\b/.test(r)&&i.push("ipad"),/macintosh/.test(r)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(r)&&i.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Kn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function Vn(){return{type:we,async:!1,func:()=>Un(Kn()),data:{phase:"desktop_gate"}}}function Jn(){return{timeline:[{type:P,stimulus:`
...
`.replace(/\s+/g," ").trim();function xt({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${It(n.trim())}"`:"";return`
  ...
  `}function jo(){return"./assets/rotation-arrow.png"}function k({title:t,body:e,narration:n,exemplar:o=[],arrowAngleDeg:r}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${It(n.trim())}"`:"",i=Po(o,typeof r=="number"?{arrowAngleDeg:r}:{});return`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Ao(){const t=b({type:P,stimulus:Lo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:P,stimulus:No,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function St(){const t="speaker_volume_instruction",e={type:P,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=Z;const l=Promise.resolve();He(Z/100);const u=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const g=Number(u.value);a=g,s&&(s.textContent=`${g}%`),He(g/100)});const d=document.getElementById("tac-yes-btn");if(d&&d.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await l,e)return;const c=hn(),h=ht(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+qo)/1e3,f=Yo/1e3,w=[];for(let g=0;g<h.length;g++)w.push(document.getElementById(`tac-box-${g}`));let x=c.currentTime+Bo/1e3;try{for(let g=0;g<Ho&&!e;g++){r=g+1;for(let N=0;N<h.length&&!e;N++){const D=x;if(pn(N,{when:D}),await ke(c,D),e)break;const K=w[N];K&&K.classList.add("playing"),await ke(c,D+m),K&&K.classList.remove("playing"),x=D+_}e||(await ke(c,x+f),x+=f)}}catch{}if(!o&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{dt();const u=ut();u.current&&!u.current._state?.finished&&u.current.cancel(),l.tones_audible=o&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,jt),b(i,t)}function Wo(){return{timeline:[{type:P,stimulus:`
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 5 demonstration.",exemplar:["pattern"]})],a={type:re,pages:r,...qt,data:{phase:"instructions_dual_i_t"}};return W(a.data.phase,Bt),U(a)}const er=4,Ht=1e3*er,tr=2e3,nr=400,E=500,T=400,q=1200,or=700,rr=450,ar=220,Y=1500,Me=1e3,ir=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function ze(){return Ne().pick(ir)}const sr="./assets/rotation-arrow.png";function lr(t,e){return`
    <style>
  ...
  `;const o=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${o} Click the button below to watch it again. When you are ready to start the practice, press the <kbd>Space</kbd> key.`)?new Promise(r=>{let a=!1;const i=s=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(c=>c.removeEventListener("click",l)),r(s)},l=s=>{const d=s.currentTarget.getAttribute("data-side");i(d==="right")};n.querySelectorAll(".demo-replay-btn").forEach(s=>s.addEventListener("click",l));const u=setInterval(()=>{t.state.cancelled&&(clearInterval(u),i(!1)),a&&clearInterval(u)},100)}):!1}function se(t){return async function(n,o){let r=0;for(;!o.state.cancelled;){try{await t(n,o)}catch(l){console.error("[demo] mini-trial error",l);return}if(o.state.cancelled)return;o.state.spaceArmed=!0;const a=yr-r;if(a<=0){if(Ft(),!await o.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;z();return}if(!await br(o,a)){await o.advanceCaption("Press Space when you are ready to start the practice."),z();return}r+=1;try{Tn(n),z(),S(n,""),n.rotor.style.transition="",mt(n,0),xe(n)}catch{}if(!await o.advanceCaption("Replaying the demonstration…")||!await o.wait(tr))return}}}const wr=se(hr),_r=se(pr),vr=se(mr),kr=se(fr),Tr=se(gr);function le({phase:t,taskNumber:e,title:n,run:o,factory:r}){const a={type:A,stimulus:lr(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const i=document.getElementById("demo-mount");if(!i)return;const l=kn({rotation_deg:0,fixation:"",background_shade:"gray"});i.appendChild(l.wrapper);const u=cr(),s=window.jsPsych?.getCurrentTrial?.();s&&typeof s=="object"&&(s._demo_state=u.state);let d=!0;const c=h=>{if(d){if(h.key==="ArrowLeft"||h.key==="ArrowRight"){h.preventDefault(),h.stopPropagation();return}if(h.key===" "||h.code==="Space"){if(h.preventDefault(),h.stopPropagation(),!u.state.spaceArmed)return;d=!1,document.removeEventListener("keydown",c,!0),u.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",c,!0),s&&typeof s=="object"&&(s._demo_keydown_handler=c),o(l,u).catch(h=>{console.error(`[demo:${t}] schedule error`,h)})},on_finish:()=>{const i=window.jsPsych?.getCurrentTrial?.();i?._demo_state&&(i._demo_state.cancelled=!0),i?._demo_keydown_handler&&(document.removeEventListener("keydown",i._demo_keydown_handler,!0),i._demo_keydown_handler=null)},data:{phase:t}};return W(t,r),U(a)}function Gt(){return le({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:wr,factory:Gt})}function Wt(){return le({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:_r,factory:Wt})}function Ut(){return le({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:vr,factory:Ut})}function Kt(){return le({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:kr,factory:Kt})}function Vt(){return le({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:Tr,factory:Vt})}const Te=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function rt(t){return typeof t!="string"?"":t.trim().toLowerCase()}function me(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:X,preamble:"<h2>Quick check</h2>",html:`
    ...
    `,button_label:"Continue",on_finish:n=>{const o=window.jsPsych?.data?.get().values()??[],r=xr(o);n.phase="attention_check_summary",n.attention_total=r.total,n.attention_passed=r.passed,n.attention_failed=r.failed,n.attention_excluded=r.exceededThreshold,n.attention_threshold=r.threshold}};return v(t,Jt),b(e,t)}const at=Object.freeze(["d_only","t_only","i_only","i_d","i_t"]);function it(t){let e=0,n=0;for(const o of t)typeof o.probe_correct=="boolean"&&(n+=1,o.probe_correct&&(e+=1)),typeof o.star_correct=="boolean"&&(n+=1,o.star_correct&&(e+=1));return{correct:e,total:n,accuracy:n>0?e/n:0}}function ee({trialType:t,trialsPerType:e,sequencePoolLabelPrefix:n,prng:o}={}){if(!at.includes(t))throw new Error(`singleTypePractice: unknown trialType '${t}'; expected one of ${at.join(", ")}`);const r=e??y.blocks.practice_trials_per_type,a=o??Ne(),i=gn({blockLabel:"practice",countsByType:{[t]:r},sequencePoolLabelPrefix:n??"practice",runLengthCap:Math.max(1,r),prng:a});return{schedule:i.schedule,trialParams:i.trialParams,nodes:i.nodes}}function Er({acc:t,passed:e,willRetry:n,criterion:o}){return Ir({acc:t,passed:e,willRetry:n,criterion:o})}function Ir({acc:t,passed:e,willRetry:n,criterion:o}){const r=Math.round(t.accuracy*100),a=Math.round(o*100),i=e?'<h2 style="color:#0a7c4d;">Practice complete</h2>':'<h2 style="color:#b3261e;">Practice — keep going</h2>',l=e?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
  ...
  `}function Xt(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:A,stimulus:`
    ...
    `,button_label:"Continue",on_finish:o=>{o.phase="music_experience",o.music_experience_responses=J.reduce((r,a)=>{const i=o.response?.[a.id];return r[a.id]=i===""||i===null||i===void 0?null:String(i),r},{})}};return v(e,en),b(n,e)}function Nr(){return[Zt(),en()]}function tn(){const t="questionnaire_intro",e={type:A,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `});
//# sourceMappingURL=main-DhxQs11f.js.map
