...
`.replace(/\s+/g," ").trim(),xo=`
  ...
  min-height: 0;
  width: 100%;
`.replace(/\s+/g," ").trim();function jt({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${At(n.trim())}"`:"";return`
  ...
  `}const Be=50,L=Be/2,Lt=Be*Math.SQRT2/2+1,Ae=Lt-L+.5,ce=Be+2*Ae,et={cx:35,cy:15},tt={cx:15,cy:35},Eo=2.5,Io=2.5,nt=100,Po=30,So=12,Oo=12,jo=[1,2,3,7,10,11,12,13,14,17,21,22,23],de=10,Lo="#FFFFFF",Ao=.33;function No(t,e,n){const r=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:r,u=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(u)},${e+l*Math.sin(u)}`)}return a.join(" ")}const $o=No(tt.cx,tt.cy,Io),Co="rgba(0, 0, 0, 0.229)",Ro="rgba(0, 0, 0, 0.55)",ot="#000",rt="rgba(0, 0, 0, 0.85)";function Do(t,{arrowAngleDeg:e=Po}={}){const n=new Set(t),o=n.has("tone")||n.has("qmark"),r=n.has("pattern"),a=`<circle cx="${L}" cy="${L}" r="${Lt}" fill="none" stroke="${Co}" stroke-width="0.5" />`,i=o||r?"":`<circle cx="${L}" cy="${L}" r="0.65" fill="${Ro}" />`,l=r?jo.map(f=>{const w=f%5,x=Math.floor(f/5),g=w*de,N=x*de;return`<rect x="${g}" y="${N}" width="${de}" height="${de}" fill="${Lo}" opacity="${Ao}" />`}).join(""):"",u=n.has("dot")?`<circle cx="${et.cx}" cy="${et.cy}" r="${Eo}" fill="${ot}" />`:"",s=n.has("star")?`<polygon points="${$o}" fill="${ot}" />`:"",c=n.has("tone")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${rt}" font-size="${So}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",d=n.has("qmark")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${rt}" font-size="${Oo}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
  ...
  `}function zo(){return"./assets/rotation-arrow.png"}function k({title:t,body:e,narration:n,exemplar:o=[],arrowAngleDeg:r}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${At(n.trim())}"`:"",i=Do(o,typeof r=="number"?{arrowAngleDeg:r}:{});return`
  ...
  `}function At(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Mo=jt({title:"Sit comfortably for the study",body:`
  ...
  `}function on(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:A,stimulus:`
    ...
    `,choices:[" "],data:{phase:"instructions_overview"}};return D(o.data.phase,on),z(o)}function rn(){const t=Math.round(y.practice.accuracy_criterion*100),e={type:A,stimulus:`
    ...
    `,button_label:"Continue",on_finish:o=>{o.phase="music_experience",o.music_experience_responses=J.reduce((r,a)=>{const i=o.response?.[a.id];return r[a.id]=i===""||i===null||i===void 0?null:String(i),r},{})}};return v(e,ln),b(n,e)}function Br(){return[sn(),ln()]}function cn(){const t="questionnaire_intro",e={type:A,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,cn),b(e,t)}function Yr(){return[cn(),...qr(),...Br()]}function dn(){const t="main_a_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{pt()}};return v(t,dn),b(e,t)}function un(){const t="main_b_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,un),b(e,t)}function hn(){const t="end_of_task_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `});
//# sourceMappingURL=main-CFQi8HnU.js.map
