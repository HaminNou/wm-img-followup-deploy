...
`;function _t(){const t="consent";let e=!1;const n={type:O,stimulus:Un,choices:["I consent — begin","I do not consent — exit"],button_html:(o,r)=>`<button class="jspsych-btn" data-idx="${r}"${r===0?" disabled":""}>${o}</button>`,on_load:()=>{e=!1;const o=document.getElementById("consent-checkbox"),r=document.querySelector('button.jspsych-btn[data-idx="0"]');!o||!r||o.addEventListener("change",()=>{e=o.checked,r.disabled=!o.checked})},on_finish:async o=>{o.consented=o.response===0,o.consent_acknowledged=e,o.consent_version=Wn,o.consented&&await gn()},data:{phase:"consent"}};return v(t,_t),b(n,t)}function Kn(){return{timeline:[{type:O,stimulus:`
          <h2>Thank you</h2>
...
`;function vt(){const t="demographics",e={type:X,preamble:`
    ...
    `,button_label:"Continue",data:{phase:"demographics"},on_finish:n=>{const o=n.response??{},r=o.date_of_birth;if(r){const i=new Date(r),l=new Date;let u=l.getFullYear()-i.getFullYear();const s=l.getMonth()-i.getMonth();(s<0||s===0&&l.getDate()<i.getDate())&&u--,n.computed_age=u,n.age_disqualified=u<Oe||u>Pe}else n.computed_age=null,n.age_disqualified=!1;const a=o.medication;n.medication_disqualified=a==="yes",n.demographics_disqualified=n.age_disqualified||n.medication_disqualified}};return v(t,vt),b(e,t)}function Qn(){const t=En(),e=In(t);return{timeline:[{type:O,stimulus:()=>{const n=window.jsPsych?.data?.get().filter({phase:"demographics"}).last(1).values()[0],o=n?.age_disqualified,r=n?.medication_disqualified;let a="";o&&r?a="Our eligibility criteria require participants to be between "+Oe+" and "+Pe+" years of age and not currently taking medication that may affect attention, vision, or sensory processing. Based on your responses, you do not meet these requirements.":o?a="Our eligibility criteria require participants to be between "+Oe+" and "+Pe+" years of age. Based on the date of birth you provided, you do not meet this requirement.":a="Our eligibility criteria require that participants are not currently taking medication that may affect attention, vision, or sensory processing. Based on your response, you do not meet this requirement.";const i=e?'<p style="margin-top: 1rem; opacity: 0.7; font-size: 0.9em;">This is a test build. The Prolific redirect is not active.</p>':'<p style="margin-top: 1rem;">You will be redirected to Prolific in a few seconds.</p>';return'<div style="max-width: 36rem; margin: 0 auto; text-align: center;"><h2>Thank you for your interest</h2><p style="font-size: 1.05rem; line-height: 1.6;">'+a+'</p><p style="line-height: 1.6;">We sincerely appreciate your willingness to participate. Please return this study on Prolific so the slot can be made available to another participant.</p>'+i+"</div>"},choices:["Return to Prolific"],data:{phase:"demographics_disqualification"},on_finish:()=>{!e&&t&&(window.location.href=t),typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Participant disqualified at demographics screening.")}}],conditional_function:()=>window.jsPsych?.data?.get().filter({phase:"demographics"}).last(1).values()[0]?.demographics_disqualified===!0}}var Zn="2.1.0";const eo={name:"call-function",version:Zn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class be{constructor(e){this.jsPsych=e}static{this.info=eo}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{o=i,r()};n.func(a)}else o=n.func(),r()}}function to({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,i=[];return/\biphone\b/.test(r)&&i.push("iphone"),/\bipod\b/.test(r)&&i.push("ipod"),/\bipad\b/.test(r)&&i.push("ipad"),/macintosh/.test(r)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(r)&&i.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function no(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function oo(){return{type:be,async:!1,func:()=>to(no()),data:{phase:"desktop_gate"}}}function ro(){return{timeline:[{type:O,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const je="display-colour-locked";function ao(){if(typeof document>"u")return!1;const t=document.documentElement;return t.classList.contains(je)?!1:(t.classList.add(je),!0)}function Le(){return typeof document>"u"?!1:document.documentElement.classList.contains(je)}const Ze="display_mode_check",io=`
  <h2>Display check</h2>
...
`.replace(/\s+/g," ").trim();function Ot({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${jt(n.trim())}"`:"";return`
  ...
  `}const He=50,L=He/2,Pt=He*Math.SQRT2/2+1,$e=Pt-L+.5,ce=He+2*$e,nt={cx:35,cy:15},ot={cx:15,cy:35},Eo=2.5,Io=2.5,rt=100,So=30,Oo=12,Po=12,jo=[1,2,3,7,10,11,12,13,14,17,21,22,23],de=10,Lo="#FFFFFF",Ao=.33;function No(t,e,n){const r=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:r,u=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(u)},${e+l*Math.sin(u)}`)}return a.join(" ")}const $o=No(ot.cx,ot.cy,Io),Co="rgba(0, 0, 0, 0.229)",Ro="rgba(0, 0, 0, 0.55)",at="#000",it="rgba(0, 0, 0, 0.85)";function Do(t,{arrowAngleDeg:e=So}={}){const n=new Set(t),o=n.has("tone")||n.has("qmark"),r=n.has("pattern"),a=`<circle cx="${L}" cy="${L}" r="${Pt}" fill="none" stroke="${Co}" stroke-width="0.5" />`,i=o||r?"":`<circle cx="${L}" cy="${L}" r="0.65" fill="${Ro}" />`,l=r?jo.map(f=>{const w=f%5,x=Math.floor(f/5),g=w*de,N=x*de;return`<rect x="${g}" y="${N}" width="${de}" height="${de}" fill="${Lo}" opacity="${Ao}" />`}).join(""):"",u=n.has("dot")?`<circle cx="${nt.cx}" cy="${nt.cy}" r="${Eo}" fill="${at}" />`:"",s=n.has("star")?`<polygon points="${$o}" fill="${at}" />`:"",d=n.has("tone")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${it}" font-size="${Oo}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",c=n.has("qmark")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${it}" font-size="${Po}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
    <svg viewBox="${-$e} ${-$e} ${ce} ${ce}"
         width="100%" height="100%" style="display: block; overflow: visible;">
      ${a}${l}${i}${u}${s}${d}${c}
    </svg>
  `,m=(e/360).toFixed(6),_=n.has("arrow")?`<img src="${zo()}" alt="rotation cue"
            style="position: absolute; top: 50%; left: 50%; width: ${rt}px; height: ${rt}px;
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Bo(){const t=b({type:O,stimulus:Mo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:O,stimulus:qo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function Lt(){const t="speaker_volume_instruction",e={type:O,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=Z;const l=Promise.resolve();Ke(Z/100);const u=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const g=Number(u.value);a=g,s&&(s.textContent=`${g}%`),Ke(g/100)});const d=document.getElementById("tac-yes-btn");if(d&&d.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await l,e)return;const c=yn(),h=mt(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+Ko)/1e3,f=Vo/1e3,w=[];for(let g=0;g<h.length;g++)w.push(document.getElementById(`tac-box-${g}`));let x=c.currentTime+Jo/1e3;try{for(let g=0;g<Xo&&!e;g++){r=g+1;for(let N=0;N<h.length&&!e;N++){const M=x;if(bn(N,{when:M}),await Te(c,M),e)break;const K=w[N];K&&K.classList.add("playing"),await Te(c,M+m),K&&K.classList.remove("playing"),x=M+_}e||(await Te(c,x+f),x+=f)}}catch{}if(!o&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{pt();const u=Re();u.current&&!u.current._state?.finished&&u.current.cancel(),l.tones_audible=o&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,$t),b(i,t)}function er(){return{timeline:[{type:O,stimulus:`
      ...
      `,narration:`After the ${n} things, we test your tone memory ${t} times. Each test plays a tone. Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. You have 3 seconds for each star and each tone test. If you answer in time, the star or central question mark turns green for correct or red for incorrect.`,exemplar:["qmark"]}),k({title:o,body:`
        ...
        <p>Please make sure your audio volume is still at the level you
        set earlier.</p>
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier.",exemplar:["pattern"]})],a={type:re,pages:r,...Ft,data:{phase:"instructions_dual_i_t"}};return D(a.data.phase,Wt),z(a)}const lr=4,Ut=1e3*lr,cr=2e3,dr=400,E=500,T=400,Y=1200,ur=700,hr=450,pr=220,H=1500,Fe=1e3,mr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function Ge(){return Ce().pick(mr)}const fr="./assets/rotation-arrow.png";function gr(t,e){return`
    <style>
    ...
    <div class="demo-frame" style="${To}">
      <div style="${St}">
        <h2 style="${Ye}">Demonstration of Task ${t} — ${e}</h2>
      </div>
  ...
  `}function tn(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:A,stimulus:`
    ...
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{ft()}};return v(t,ln),b(e,t)}function cn(){const t="main_b_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `});
//# sourceMappingURL=main-CnUFgVsI.js.map
