import"./modulepreload-polyfill-B5Qt9EMX.js";import{P as p,a as Ze,r as et,H as P,g as Pe,i as Gt,b as Ut,c as Vt}from"./index-Bz6dieJX.js";import{s as X,a as tt,u as Kt,g as nt,b as ze,c as Jt,d as ot,p as Xt,e as Re,h as Qt,f as Zt,F as I,i as S,j as ce,k as en,l as tn,m as nn,r as on}from"./main-blocks-dw67JRqh.js";import{c as y}from"./config-zUhCg_tb.js";import{u as rn,c as an}from"./debrief-DfHPYObw.js";import{c as sn,a as ln,s as T,b as rt,h as Te,d as ue,r as E,e as Ie,f as Se,g as Ne,i as cn,j as Me,o as un,k as dn}from"./pattern-CJtvzC-V.js";var hn="2.1.0";const pn={name:"html-button-response",version:hn,parameters:{stimulus:{type:p.HTML_STRING,default:void 0},choices:{type:p.STRING,default:void 0,array:!0},button_html:{type:p.FUNCTION,default:function(t,e){return`<button class="jspsych-btn">${t}</button>`}},prompt:{type:p.HTML_STRING,default:null},stimulus_duration:{type:p.INT,default:null},trial_duration:{type:p.INT,default:null},button_layout:{type:p.STRING,default:"grid"},grid_rows:{type:p.INT,default:1},grid_columns:{type:p.INT,default:null},response_ends_trial:{type:p.BOOL,default:!0},enable_button_after:{type:p.INT,default:0}},data:{rt:{type:p.INT},response:{type:p.INT},stimulus:{type:p.HTML_STRING}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class j{constructor(e){this.jsPsych=e}static{this.info=pn}trial(e,n){const o=document.createElement("div");o.id="jspsych-html-button-response-stimulus",o.innerHTML=n.stimulus,e.appendChild(o);const r=document.createElement("div");if(r.id="jspsych-html-button-response-btngroup",n.button_layout==="grid"){if(r.classList.add("jspsych-btn-group-grid"),n.grid_rows===null&&n.grid_columns===null)throw new Error("You cannot set `grid_rows` to `null` without providing a value for `grid_columns`.");const c=n.grid_columns===null?Math.ceil(n.choices.length/n.grid_rows):n.grid_columns,h=n.grid_rows===null?Math.ceil(n.choices.length/n.grid_columns):n.grid_rows;r.style.gridTemplateColumns=`repeat(${c}, 1fr)`,r.style.gridTemplateRows=`repeat(${h}, 1fr)`}else n.button_layout==="flex"&&r.classList.add("jspsych-btn-group-flex");for(const[c,h]of n.choices.entries()){r.insertAdjacentHTML("beforeend",n.button_html(h,c));const m=r.lastChild;m.dataset.choice=c.toString(),m.addEventListener("click",()=>{d(c)})}e.appendChild(r),n.prompt!==null&&e.insertAdjacentHTML("beforeend",n.prompt);var a=performance.now(),u={rt:null,button:null};const s=()=>{var c={rt:u.rt,stimulus:n.stimulus,response:u.button};this.jsPsych.finishTrial(c)};function d(c){var h=performance.now(),m=Math.round(h-a);u.button=parseInt(c),u.rt=m,o.classList.add("responded");for(const _ of r.children)_.setAttribute("disabled","disabled");n.response_ends_trial&&s()}if(n.stimulus_duration!==null&&this.jsPsych.pluginAPI.setTimeout(()=>{o.style.visibility="hidden"},n.stimulus_duration),n.enable_button_after>0){for(var i=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),l=0;l<i.length;l++)i[l].setAttribute("disabled","disabled");this.jsPsych.pluginAPI.setTimeout(()=>{for(var c=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),h=0;h<c.length;h++)c[h].removeAttribute("disabled")},n.enable_button_after)}n.trial_duration!==null&&this.jsPsych.pluginAPI.setTimeout(s,n.trial_duration)}simulate(e,n,o,r){n=="data-only"&&(r(),this.simulate_data_only(e,o)),n=="visual"&&this.simulate_visual(e,o,r)}create_simulation_data(e,n){const o={stimulus:e.stimulus,rt:this.jsPsych.randomization.sampleExGaussian(500,50,.006666666666666667,!0)+e.enable_button_after,response:this.jsPsych.randomization.randomInt(0,e.choices.length-1)},r=this.jsPsych.pluginAPI.mergeSimulationData(o,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,r),r}simulate_data_only(e,n){const o=this.create_simulation_data(e,n);this.jsPsych.finishTrial(o)}simulate_visual(e,n,o){const r=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),o(),r.rt!==null&&this.jsPsych.pluginAPI.clickTarget(a.querySelector(`#jspsych-html-button-response-btngroup [data-choice="${r.response}"]`),r.rt)}}let De=!1,A=[];const xe=new Map;let Q=!1,Oe=!1;function mn(t){!t||typeof t!="string"||A[A.length-1]!==t&&(A.push(t),A.length>32&&A.shift())}function at(t){const e=typeof t?.data=="function"?null:t?.data??null;return typeof e?.phase=="string"?e.phase:null}function fn(t,e){return t&&typeof t=="object"&&typeof t!="function"?{...t,hidden_nav_step:e}:(...n)=>({...typeof t=="function"?t(...n):{},hidden_nav_step:e})}function v(t,e){!t||typeof t!="string"||typeof e!="function"||xe.set(t,e)}function w(t,e=at(t)){if(!e||typeof e!="string")return t;const n=t?.on_load;return t.data=fn(t?.data,e),t._hidden_nav_checkpoint=!0,t.on_load=(...o)=>{mn(e),n?.(...o)},t}function B(t,e){v(t,e)}function Y(t){return w(t,at(t))}function yn(){const t=Oe;return Oe=!1,t}function gn(t){const e=t?.timeline?.getLatestNode?.();return e&&typeof e.getDataParameter=="function"?e:null}function bn(t){try{const e=gn(t);if(!e)return null;const n=e.getDataParameter?.()??{},o=typeof n.hidden_nav_step=="string"?n.hidden_nav_step:null;return{node:e,stepId:o,phase:typeof n.phase=="string"?n.phase:null}}catch{return null}}function wn(t){const e=t?.description?.type?.info?.name??null;return e==="html-button-response"?{response:0}:e==="survey-html-form"?{response:{}}:{}}function vn(t){const e=A.slice();if(t)for(;e[e.length-1]===t;)e.pop();return{trimmedHistory:e,prevStepId:e[e.length-1]??null}}function Be(t,e){const n=t?.parent?.description?.timeline;if(!Array.isArray(n))return!1;const o=n.indexOf(t.description);return o<0?!1:(n.splice(o+1,0,...e),!0)}function _n(){return function(e){if(e?._hidden_nav_checkpoint===!0){Q&&(Q=!1),X(!1);return}if(!Q){X(!1);return}!e||typeof e!="object"||(e.trial_duration=0,e.choices="NO_KEYS")}}function kn(t){if(De||typeof document>"u")return;const e=n=>{const o=n.target&&n.target.tagName||"";if(o==="INPUT"||o==="TEXTAREA"||n.target?.isContentEditable||n.metaKey||n.ctrlKey||n.altKey)return;const r=n.key?.toLowerCase?.();if(r!=="u"&&r!=="r")return;const a=bn(t);if(!a)return;n.preventDefault(),n.stopPropagation(),tt();const u=wn(a.node),s=!!a.stepId;if(r==="u"){Oe=!0,s||(Q=!0),X(!0),t.finishTrial({...u,phase:a.phase,hidden_nav:"forward",hidden_nav_step:a.stepId??null});return}const{trimmedHistory:d,prevStepId:i}=vn(a.stepId),l=i?xe.get(i):null;if(!l)return;let c=!1;if(s){const h=xe.get(a.stepId);if(!h)return;c=Be(a.node,[l(),h()])}else c=Be(a.node,[l()]);c&&(A=d,Q=!1,s?X(!1):X(!0),t.finishTrial({...u,phase:a.phase,hidden_nav:"back",hidden_nav_step:a.stepId??null,hidden_nav_target_step:i}))};document.addEventListener("keydown",e,!0),De=!0}const Tn="online-2101803-v1",xn=`
...
`;function it(){const t="consent";let e=!1;const n={type:j,stimulus:xn,choices:["I consent — begin","I do not consent — exit"],button_html:(o,r)=>`<button class="jspsych-btn" data-idx="${r}"${r===0?" disabled":""}>${o}</button>`,on_load:()=>{e=!1;const o=document.getElementById("consent-checkbox"),r=document.querySelector('button.jspsych-btn[data-idx="0"]');!o||!r||o.addEventListener("change",()=>{e=o.checked,r.disabled=!o.checked})},on_finish:async o=>{o.consented=o.response===0,o.consent_acknowledged=e,o.consent_version=Tn,o.consented&&await Kt()},data:{phase:"consent"}};return v(t,it),w(n,t)}function On(){return{timeline:[{type:j,stimulus:`
          <h2>Thank you</h2>
        ...
        `,choices:["Close"],on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Consent declined.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"consent"}).last(1).values()[0];return t?t.consented===!1:!1}}}var En="2.1.0";const jn={name:"survey-html-form",version:En,parameters:{html:{type:p.HTML_STRING,default:null},preamble:{type:p.HTML_STRING,default:null},button_label:{type:p.STRING,default:"Continue"},autofocus:{type:p.STRING,default:""},dataAsArray:{type:p.BOOL,default:!1},autocomplete:{type:p.BOOL,default:!1}},data:{response:{type:p.OBJECT},rt:{type:p.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class U{constructor(e){this.jsPsych=e}static{this.info=jn}trial(e,n){var o="";if(n.preamble!==null&&(o+='<div id="jspsych-survey-html-form-preamble" class="jspsych-survey-html-form-preamble">'+n.preamble+"</div>"),n.autocomplete?o+='<form id="jspsych-survey-html-form">':o+='<form id="jspsych-survey-html-form" autocomplete="off">',o+=n.html,o+='<input type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" value="'+n.button_label+'"></input>',o+="</form>",e.innerHTML=o,n.autofocus!==""){var r=e.querySelectorAll("#"+n.autofocus);r.length===0?console.warn("No element found with id: "+n.autofocus):r.length>1?console.warn('The id "'+n.autofocus+'" is not unique so autofocus will not work.'):r[0].focus()}e.querySelector("#jspsych-survey-html-form").addEventListener("submit",d=>{d.preventDefault();var i=performance.now(),l=Math.round(i-a),c=e.querySelector("#jspsych-survey-html-form"),h=u(c);n.dataAsArray||(h=s(h));var m={rt:l,response:h};this.jsPsych.finishTrial(m)});var a=performance.now();function u(d){for(var i=[],l=0;l<d.elements.length;l++){var c=d.elements[l];if(!(!c.name||c.disabled||c.type==="file"||c.type==="reset"||c.type==="submit"||c.type==="button"))if(c.type==="select-multiple")for(var h=0;h<c.options.length;h++)c.options[h].selected&&i.push({name:c.name,value:c.options[h].value});else(c.type!=="checkbox"&&c.type!=="radio"||c.checked)&&i.push({name:c.name,value:c.value})}return i}function s(d){for(var i={},l=0;l<d.length;l++)i[d[l].name]=d[l].value;return i}}}const Pn=`
  <style>
...
`;function st(){const t="demographics",e={type:U,preamble:`
      <h2>Demographics</h2>
    ...
    `,button_label:"Continue",data:{phase:"demographics"}};return v(t,st),w(e,t)}var In="2.1.0";const Sn={name:"call-function",version:In,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class pe{constructor(e){this.jsPsych=e}static{this.info=Sn}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=u=>{o=u,r()};n.func(a)}else o=n.func(),r()}}function Nn({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,u=[];return/\biphone\b/.test(r)&&u.push("iphone"),/\bipod\b/.test(r)&&u.push("ipod"),/\bipad\b/.test(r)&&u.push("ipad"),/macintosh/.test(r)&&a>1&&u.push("ipad_macos_disguised"),/android/.test(r)&&u.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&u.push("mobile_ua"),e===!1&&n===!1&&u.push("no_hover_no_fine_pointer"),{isDesktop:u.length===0,reasons:u,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Cn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function An(){return{type:pe,async:!1,func:()=>Nn(Cn()),data:{phase:"desktop_gate"}}}function Ln(){return{timeline:[{type:j,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const qn=85.6,Ee=1.5,je=12,$n=100,zn=1100,se=320,Rn=2,Ye="screen_calibration",He="screen_calibration_retry_hint",Mn=`
  ...
  <div id="cc-stage" style="margin: 1.5rem auto; height: 14rem; position: relative;">
    <div id="cc-rect"
         style="position: absolute; left: 50%; top: 1rem; transform: translateX(-50%);
                width: ${se}px; height: ${se*(53.98/85.6)}px; border: 2px solid #fff; border-radius: 6px;
                background: linear-gradient(135deg, #1f3a8a 0%, #1e40af 100%);">
    </div>
  </div>
  <input id="cc-slider" type="range" min="${$n}" max="${zn}" value="${se}"
...
`;function lt(){const t={type:j,stimulus:Mn,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),o=()=>{const r=parseInt(e.value,10);n.style.width=`${r}px`,n.style.height=`${r*(53.98/85.6)}px`};e.addEventListener("input",o),o()},on_finish:e=>{const n=document.getElementById("cc-slider"),o=n?parseInt(n.value,10):se,r=o/qn;e.cc_px_width=o,e.px_per_mm=r,e.px_per_mm_in_bounds=r>=Ee&&r<=je,e.px_per_mm_min=Ee,e.px_per_mm_max=je,document.documentElement.style.setProperty("--mm",`${r}px`)},data:{phase:"screen_calibration"}};return v(Ye,lt),w(t,Ye)}function Bn(){return{type:pe,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=Ee&&t.px_per_mm<=je),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function ct(){const t={type:j,stimulus:Dn,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(He,ct),w(t,He)}function Yn(t){return{timeline:[ct()],conditional_function:()=>t.count>=1}}function Hn({maxAttempts:t=Rn}={}){const e={count:0};return{timeline:[Yn(e),lt(),Bn(),Fn(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function Fn(t,e){return{type:pe,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],o=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:o,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const Wn="88vh",Gn="40rem",Un="95vw",Vn="72rem",ut=`
  margin: 0 auto;
  display: flex;
  ...
  padding: 0.5rem 0;
  min-height: ${Wn};
`.replace(/\s+/g," ").trim(),Kn=`${ut} width: ${Gn}; max-width: 90vw;`,Jn=`${ut} width: ${Un}; max-width: ${Vn}; align-items: center;`,dt=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim(),Xn=`
  ...
  min-height: 0;
  width: 100%;
`.replace(/\s+/g," ").trim();function g({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${Qn(n.trim())}"`:"";return`
    <div style="${Kn}">
      <div style="${dt}">
        <h2 style="${ht}">${t}</h2>
      </div>
      <div style="${Xn}" data-voiceover-target${o}>${e}</div>
    </div>
  `}function Qn(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Zn=g({title:"Sit comfortably for the study",body:`
    ...
    `,button_label:"Enter fullscreen",data:{phase:"enter_fullscreen"}};return v(t,ft),w(e,t)}function so(){return{type:pe,async:!1,func:()=>(ao(),{recording:!0}),data:{phase:"visibility_recorder_start"}}}const lo=200,co=500,uo=50,ho=10,K=50,po="#60a5fa";function we(t,e){return new Promise(n=>{const o=()=>{const r=(e-t.currentTime)*1e3;if(r<=0){n();return}setTimeout(o,Math.min(r,10))};o()})}function mo(t){const e=[];for(let n=0;n<t;n++)e.push(`<div class="tac-box" id="tac-box-${n}" data-idx="${n}">${n+1}</div>`);return e.join("")}function yt(){const t="tone_audibility_and_comfort";let e=!1,n=!1,o=!1,r=0,a=K;const u={type:j,stimulus:`
      ...
      <div class="tac-slider-wrap">
        ...
        <div class="tac-slider-readout">
          <span>quieter</span>
          <span id="tac-slider-readout">${K}%</span>
          <span>louder</span>
        </div>
      </div>
    `,choices:["I'm comfortable — continue"],button_html:s=>`<button class="jspsych-btn" id="tac-yes-btn">${s}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=K;const s=Promise.resolve();ze(K/100);const d=document.getElementById("tac-slider"),i=document.getElementById("tac-slider-readout");d&&d.addEventListener("input",()=>{const f=Number(d.value);a=f,i&&(i.textContent=`${f}%`),ze(f/100)});const l=document.getElementById("tac-yes-btn");if(l&&l.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await s,e)return;const c=Jt(),h=ot(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+lo)/1e3,b=co/1e3,k=[];for(let f=0;f<h.length;f++)k.push(document.getElementById(`tac-box-${f}`));let x=c.currentTime+uo/1e3;try{for(let f=0;f<ho&&!e;f++){r=f+1;for(let H=0;H<h.length&&!e;H++){const C=x;if(Xt(H,{when:C}),await we(c,C),e)break;const F=k[H];F&&F.classList.add("playing"),await we(c,C+m),F&&F.classList.remove("playing"),x=C+_}e||(await we(c,x+b),x+=b)}}catch{}if(!o&&!e){n=!0;const f=document.getElementById("tac-yes-btn");f&&f.click()}},on_finish:s=>{tt();const d=nt();d.current&&!d.current._state?.finished&&d.current.cancel(),s.tones_audible=o&&!n,s.user_playback_pct=a,s.user_playback_gain=a/100,s.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,yt),w(u,t)}function fo(){return{timeline:[{type:j,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"tone_audibility_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Tone audibility failed.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"tone_audibility_and_comfort"}).last(1).values()[0];return t?t.tones_audible===!1:!1}}}function yo(){return[An(),Ln(),it(),On(),st(),to(),Hn(),pt(),ft(),so(),yt(),fo()]}var go="2.1.0";const bo={name:"instructions",version:go,parameters:{pages:{type:p.HTML_STRING,default:void 0,array:!0},key_forward:{type:p.KEY,default:"ArrowRight"},key_backward:{type:p.KEY,default:"ArrowLeft"},allow_backward:{type:p.BOOL,default:!0},allow_keys:{type:p.BOOL,default:!0},show_clickable_nav:{type:p.BOOL,default:!1},show_page_number:{type:p.BOOL,default:!1},page_label:{type:p.STRING,default:"Page"},button_label_previous:{type:p.STRING,default:"Previous"},button_label_next:{type:p.STRING,default:"Next"},on_page_change:{type:p.FUNCTION,pretty_name:"Page change callback",default:function(t){}}},data:{view_history:{type:p.COMPLEX,array:!0,nested:{page_index:{type:p.INT},viewing_time:{type:p.INT}}},rt:{type:p.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class Z{constructor(e){this.jsPsych=e}static{this.info=bo}trial(e,n){var o=0,r=[],a=performance.now(),u=a;function s(){this.id==="jspsych-instructions-back"?l():this.id==="jspsych-instructions-next"&&i()}function d(){var b=n.pages[o],k="";if(n.show_page_number&&(k="<span style='margin: 0 1em;' class='jspsych-instructions-pagenum'>"+n.page_label+" "+(o+1)+"/"+n.pages.length+"</span>"),n.show_clickable_nav){var x="<div class='jspsych-instructions-nav' style='padding: 10px 0px;'>";if(n.allow_backward){var f=o>0?"":"disabled='disabled'";x+="<button id='jspsych-instructions-back' class='jspsych-btn' style='margin-right: 5px;' "+f+">&lt; "+n.button_label_previous+"</button>"}n.pages.length>1&&n.show_page_number&&(x+=k),x+="<button id='jspsych-instructions-next' class='jspsych-btn'style='margin-left: 5px;'>"+n.button_label_next+" &gt;</button></div>",b+=x,e.innerHTML=b,o!=0&&n.allow_backward&&e.querySelector("#jspsych-instructions-back").addEventListener("click",s,{once:!0}),e.querySelector("#jspsych-instructions-next").addEventListener("click",s,{once:!0})}else n.show_page_number&&n.pages.length>1&&(b+="<div class='jspsych-instructions-pagenum'>"+k+"</div>"),e.innerHTML=b}function i(){c(),o++,o>=n.pages.length?h():d(),n.on_page_change(o)}function l(){c(),o--,d(),n.on_page_change(o)}function c(){var b=performance.now(),k=Math.round(b-u);r.push({page_index:o,viewing_time:k}),u=b}const h=()=>{n.allow_keys&&this.jsPsych.pluginAPI.cancelKeyboardResponse(_);var b={view_history:r,rt:Math.round(performance.now()-a)};this.jsPsych.finishTrial(b)},m=b=>{_=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1,allow_held_key:!1}),this.jsPsych.pluginAPI.compareKeys(b.key,n.key_backward)&&o!==0&&n.allow_backward&&l(),this.jsPsych.pluginAPI.compareKeys(b.key,n.key_forward)&&i()};if(d(),n.allow_keys)var _=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1})}simulate(e,n,o,r){n=="data-only"&&(r(),this.simulate_data_only(e,o)),n=="visual"&&this.simulate_visual(e,o,r)}create_simulation_data(e,n){let o=0,r=0,a=[];if(!n.data?.view_history&&!n.data?.rt)for(;o!==e.pages.length;){const d=Math.round(this.jsPsych.randomization.sampleExGaussian(3e3,300,.0033333333333333335));a.push({page_index:o,viewing_time:d}),r+=d,o==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?o++:o--}if(!n.data?.view_history&&n.data?.rt){for(r=n.data.rt;o!==e.pages.length;)a.push({page_index:o,viewing_time:null}),o==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?o++:o--;const d=n.data.rt/a.length;let i=0;for(const h of a){const m=Math.round(this.jsPsych.randomization.sampleExGaussian(d,d/10,1/(d/10)));h.viewing_time=m,i+=m}const l=n.data.rt-i,c=Math.round(l/a.length);for(const h of a)h.viewing_time+=c}if(n.data?.view_history&&!n.data?.rt){a=n.data.view_history,r=0;for(const d of n.data.view_history)r+=d.viewing_time}const u={view_history:a,rt:r},s=this.jsPsych.pluginAPI.mergeSimulationData(u,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,s),s}simulate_data_only(e,n){const o=this.create_simulation_data(e,n);this.jsPsych.finishTrial(o)}simulate_visual(e,n,o){const r=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),o();const u=l=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_forward,l):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-next"),l)},s=l=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_backward,l):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-back"),l)};let d=0,i=0;for(let l=0;l<r.view_history.length;l++)l==r.view_history.length-1?u(i+r.view_history[l].viewing_time):(r.view_history[l+1].page_index>d&&u(i+r.view_history[l].viewing_time),r.view_history[l+1].page_index<d&&s(i+r.view_history[l].viewing_time),i+=r.view_history[l].viewing_time,d=r.view_history[l+1].page_index)}}const gt='<span style="color: #34d399;"><strong>green</strong></span>',bt='<span style="color: #f87171;"><strong>red</strong></span>',wt=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function vt(){const t=y.memory.set_size,e="Task 1 — Remember the dots",n=[g({title:e,body:`
      ...
      `,narration:`After the dots, we will test your memory ${t} times. Each time, a black dot will be shown for 3 seconds, and you have to say whether the dot was shown in that location. Just keep watching the centre of the circle, and remember each dot whenever it appears.`}),g({title:e,body:`
      ...
      `,narration:"Now for the responses. Press Yes if you remember you saw a dot in that location. Press No if you did not. You will have 3 seconds to provide your response. Try to get it right rather than answer quickly, but please don't take too long either."}),g({title:e,body:`
        ...
        ${gt} if you were correct or
        ${bt} if you were not. This colour change happens while
      ...
      `,narration:`After the ${t} tones, we will play ${t} more tones, one at a time. Each time, decide whether that tone was one of the ones you just heard. You don't need to look at anything during this task — just keep your eyes on the centre of the circle, and listen for each tone whenever it plays.`}),g({title:e,body:`
        ...
        it turns ${gt} if you were correct or
        ${bt} if you were not, so you can learn from each
        test.</p>
      ...
      `,narration:"One quick reminder. Please make sure your audio volume is still at the level you set earlier. When you're ready, press Space to see a demonstration of Task 2."})],o={type:Z,pages:n,...wt,data:{phase:"instructions_memory_t_only"}};return B(o.data.phase,_t),Y(o)}const wo='<span style="color: #34d399;"><strong>green</strong></span>',vo='<span style="color: #f87171;"><strong>red</strong></span>',_o='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',ko=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function kt(){const t=y.imagery.stars_per_trial,e="Task 3 — Picture the pattern",n=[g({title:e,body:`
      ...
      `,narration:`Then ${t} bright stars will flash inside the circle, one at a time. For each star, decide whether it lands in a location that would be covered by the rotated pattern you are picturing. Press On-pattern if the star falls on your pictured pattern. Press Not on-pattern if it does not.`}),g({title:e,body:`
        ...
        ${wo} if you were correct or
        ${vo} if you were not. This colour change happens while
      ...
      `,narration:`Then ${n} things will appear inside the circle one at a time, all mixed together. ${e} stars — for each star, decide whether it lands in a location that would be covered by the rotated pattern you are picturing, just like Task 3. Press On-pattern if the star falls on your pictured pattern, or Not on-pattern if it does not. And ${t} dots — try to remember which locations the dots appear in, so you can answer the dot tests at the end of the trial, just like Task 1.`}),g({title:o,body:`
        ...
        ${Tt} if you were correct or
        ${xt} if you were not while it is still on the screen,
      ...
      `,narration:`Then ${n} things will happen one at a time, all mixed together. ${e} stars inside the circle — for each star, decide whether it lands in a location that would be covered by the rotated pattern you are picturing. Press On-pattern if the star falls on your pictured pattern, or Not on-pattern if it does not. And ${t} tones — try to remember each tone you hear, so you can answer the tone tests at the end of the trial, just like Task 2.`}),g({title:o,body:`
        ...
        mark can turn ${Tt} if you were correct or
        ${xt} if you were not while it is still on the screen,
        so you can learn from each response.</p>
      ...
      `,narration:"One last thing, and this is very important. Keep the picture of the rotated pattern in your mind during the entire trial. The only moment you may let the picture go is when the central question mark appears — that is when the tone tests begin, and at that point you can drop the image and focus only on the tone tests. Please make sure your audio volume is still at the level you set earlier. When you're ready, press Space to see a demonstration of Task 5."})],a={type:Z,pages:r,...Et,data:{phase:"instructions_dual_i_t"}};return B(a.data.phase,Pt),Y(a)}const ee=4,de=1e3*ee,me=1500*ee,To=4e3*ee,xo=2e3*ee,Oo=8e3,fe=2e3*ee,Eo=2e3,te=2500,ye=1200,jo=400,Po=700,Ge=450,Io=220,L=3e3,q=1500,$=2800,z=2500,Ce=1e3,So=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function Ae(){return Pe().pick(So)}const No="./assets/rotation-arrow.png";function Co(t,e){return`
    <style>
  ...
  `}function Ao(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const o=Qt(e);o?(Zt(),t.currentNarration=nt().speak(o)):t.currentNarration=null},async wait(e){return await Re(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let o=!1;const r=()=>{o||(o=!0,n())};e.done.then(r).catch(r);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),r())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await Re(jo),t.cancelled)?!1:(this.setCaption(e),!0)}}}function Lo(t,e){const n=y.imagery.rotation_arrow_size_px,o=document.createElement("img");return o.src=No,o.alt="rotation cue",o.className="rotation-arrow-cue demo-arrow",o.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none"].join("; ")+";"),t.wrapper.appendChild(o),o}function ve(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function Le(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),cn(t),Me(t),!await e.wait(To)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;Te(t);const o=Lo(t,n);return!await e.wait(xo)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(ve(o),!1):(ve(o),rt(t,n),Me(t),await e.wait(Oo)?(Te(t),!0):!1)}function ne(){const t=un(),e=dn();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function oe({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `;const o=n.querySelector(".demo-buttons-container"),r=n.querySelector('[data-side="left"]'),a=n.querySelector('[data-side="right"]'),u=n.querySelector(".demo-hand");return{container:o,leftBtn:r,rightBtn:a,hand:u}}function It(t,e,n){if(!t?.leftBtn||!t?.rightBtn)return!1;const o=t.leftBtn.querySelector(".demo-btn-label"),r=t.rightBtn.querySelector(".demo-btn-label");return o&&(o.textContent=e),r&&(r.textContent=n),!0}function _e(){const t=document.getElementById("demo-buttons-row");t&&(t.innerHTML="")}function Ue(t,e){if(!t?.container||!t?.hand)return;const n=e==="right"?t.rightBtn:t.leftBtn;if(!n)return;const o=t.container.getBoundingClientRect(),r=n.getBoundingClientRect(),a=r.left+r.width/2-o.left,u=r.bottom-o.top+4;t.hand.style.left=`${a}px`,t.hand.style.top=`${u}px`}async function R(t,e,n){if(!t)return!0;if(Ue(t,e==="right"?"left":"right"),t.hand.style.transition="none",t.hand.style.opacity="0",t.hand.offsetWidth,t.hand.style.transition="opacity 200ms ease-out",t.hand.style.opacity="0.95",!await n.wait(Po)||(t.hand.style.transition=`left ${Ge}ms ease-in-out`,Ue(t,e),!await n.wait(Ge)))return!1;const o=e==="right"?t.rightBtn:t.leftBtn;return o&&(o.classList.remove("demo-btn-pressed"),o.offsetWidth,o.classList.add("demo-btn-pressed")),!!await n.wait(Io)}function M(t){t?.hand&&(t.hand.style.transition="opacity 200ms ease-in",t.hand.style.opacity="0")}const N=Object.freeze({left:"No",right:"Yes"}),W=Object.freeze({left:"Not on-pattern",right:"On-pattern"});function D({pressedLabel:t,correctLabel:e,isCorrect:n,stimulusName:o}){const r=`<span style="color: ${I}; font-weight: 600;">correct</span>`,a=`<span style="color: ${S}; font-weight: 600;">incorrect</span>`;return n?`We chose <strong>${t}</strong> — that was the ${r} answer, so the ${o} turns green.`:`We chose <strong>${t}</strong> — that was ${a}; the ${r} answer was <strong>${e}</strong>, so the ${o} turns red.`}async function qo(t,e){const{memCells:n,fillerCells:o,probeCells:r}=ne(),a=oe({leftLabel:"No",rightLabel:"Yes"});if(e.setCaption("Watch as dots appear one at a time. Try to remember the location of each dot."),!await e.wait(te))return;for(let s=0;s<3;s++){let d;if(s===0?d="Dot 1 — remember its location.":s===2?d="Last dot — remember its location.":d=`Dot ${s+1} — keep tracking each location.`,!await e.advanceCaption(d)||!await e.wait(ye))return;const i=ue(t,n[s]);if(!await e.wait(de)||(E(i),!await e.wait(me-de))||!await e.advanceCaption(""))return;const l=Ie(t,o[s],{visible:!1});if(!await e.wait(Ce))return;E(l)}if(!await e.advanceCaption("Hold the dots in mind for a moment.")||(T(t,"?"),!await e.wait(fe)))return;const u=2;for(let s=0;s<r.length;s++){const d=r[s],i=d.isTarget?"right":"left",l=s===u?i==="right"?"left":"right":i;if(!await e.advanceCaption(`Test ${s+1} of 3: was a dot just shown in this location?`))return;const c=ue(t,d.cell);if(!await e.wait($)||!await R(a,l,e))return;const h=l===i;if(c.setAttribute("fill",h?I:S),!await e.wait(q)||!await e.advanceCaption(D({pressedLabel:N[l],correctLabel:N[i],isCorrect:h,stimulusName:"dot"}))||!await e.wait(L)||(M(a),E(c),!await e.wait(z)))return}T(t,"")}async function $o(t,e){const{memCells:n,fillerCells:o,probeCells:r}=ne(),a=oe({leftLabel:"No",rightLabel:"Yes"});if(e.setCaption("Listen as tones play one at a time."),!await e.wait(te))return;for(let s=0;s<3;s++){let d;if(s===0?d="Tone 1 — listen and try to remember it.":s===2?d="Last tone — keep remembering each one.":d=`Tone ${s+1} — keep listening for each tone.`,!await e.advanceCaption(d)||!await e.wait(ye)||(ce(n[s]).catch(()=>{}),!await e.wait(me))||!await e.advanceCaption(""))return;const i=Ie(t,o[s],{visible:!1});if(!await e.wait(Ce))return;E(i)}if(!await e.advanceCaption("Hold the tones in mind for a moment.")||(T(t,"?"),!await e.wait(fe)))return;const u=2;for(let s=0;s<r.length;s++){const d=r[s],i=d.isTarget?"right":"left",l=s===u?i==="right"?"left":"right":i;if(!await e.advanceCaption(`Test ${s+1} of 3: was this tone one of the ones you just heard?`)||!await e.wait($)||(ce(d.cell).catch(()=>{}),!await R(a,l,e)))return;const c=l===i;if(T(t,"?",{color:c?I:S}),!await e.wait(q)||!await e.advanceCaption(D({pressedLabel:N[l],correctLabel:N[i],isCorrect:c,stimulusName:"question mark"}))||!await e.wait(L)||(M(a),T(t,"?"),!await e.wait(z)))return}T(t,"")}async function zo(t,e){const n=Ae(),o=oe({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await Le(t,e,n)||!await e.advanceCaption("Now keep picturing the turned pattern. 3 stars will appear inside the circle. For each star, decide whether it falls <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(te))return;const{fillerCells:r,starCells:a}=ne(),u=2;for(let s=0;s<3;s++){if(!await e.advanceCaption(""))return;const d=Ie(t,r[s],{visible:!1});if(!await e.wait(Ce))return;E(d);const i=a[s],l=i.isOn?"right":"left",c=s===u?l==="right"?"left":"right":l;if(!await e.advanceCaption(`Star ${s+1} of 3 — judge it against your turned pattern.`))return;const h=Se(t,i.cell);if(!await e.wait($)||!await R(o,c,e))return;const m=c===l;if(Ne(h,m?I:S),!await e.wait(q)||!await e.advanceCaption(D({pressedLabel:W[c],correctLabel:W[l],isCorrect:m,stimulusName:"star"}))||!await e.wait(L)||(M(o),E(h),!await e.wait(z)))return}}async function Ro(t,e){const n=Ae(),o=oe({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await Le(t,e,n)||!await e.advanceCaption("Now keep picturing the turned pattern. 6 things appear inside the circle, mixed together: 3 dots to remember, 3 stars to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(te))return;const{memCells:r,starCells:a,probeCells:u}=ne(),s=2;for(let i=0;i<3;i++){if(!await e.advanceCaption(`Dot ${i+1} — remember its location.`)||!await e.wait(ye))return;const l=ue(t,r[i]);if(!await e.wait(de)||(E(l),!await e.wait(me-de)))return;const c=a[i],h=c.isOn?"right":"left",m=i===s?h==="right"?"left":"right":h;if(!await e.advanceCaption(`Star ${i+1} — judge it against your turned pattern.`))return;const _=Se(t,c.cell);if(!await e.wait($)||!await R(o,m,e))return;const b=m===h;if(Ne(_,b?I:S),!await e.wait(q)||!await e.advanceCaption(D({pressedLabel:W[m],correctLabel:W[h],isCorrect:b,stimulusName:"star"}))||!await e.wait(L)||(M(o),E(_),!await e.wait(z)))return}if(!await e.advanceCaption("When the question mark appears, the dot tests begin. You may let the picture go now and focus on the dots.")||(It(o,"No","Yes"),T(t,"?"),!await e.wait(fe)))return;const d=2;for(let i=0;i<u.length;i++){const l=u[i],c=l.isTarget?"right":"left",h=i===d?c==="right"?"left":"right":c;if(!await e.advanceCaption(`Dot test ${i+1} of 3: was a dot shown in this location?`))return;const m=ue(t,l.cell);if(!await e.wait($)||!await R(o,h,e))return;const _=h===c;if(m.setAttribute("fill",_?I:S),!await e.wait(q)||!await e.advanceCaption(D({pressedLabel:N[h],correctLabel:N[c],isCorrect:_,stimulusName:"dot"}))||!await e.wait(L)||(M(o),E(m),!await e.wait(z)))return}T(t,"")}async function Mo(t,e){const n=Ae(),o=oe({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await Le(t,e,n)||!await e.advanceCaption("Now keep picturing the turned pattern. 6 things happen, mixed together: 3 tones to remember, 3 stars (inside the circle) to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(te))return;const{memCells:r,starCells:a,probeCells:u}=ne(),s=2;for(let i=0;i<3;i++){if(!await e.advanceCaption(`Tone ${i+1} — listen and remember it.`)||!await e.wait(ye)||(ce(r[i]).catch(()=>{}),!await e.wait(me)))return;const l=a[i],c=l.isOn?"right":"left",h=i===s?c==="right"?"left":"right":c;if(!await e.advanceCaption(`Star ${i+1} — judge it against your turned pattern.`))return;const m=Se(t,l.cell);if(!await e.wait($)||!await R(o,h,e))return;const _=h===c;if(Ne(m,_?I:S),!await e.wait(q)||!await e.advanceCaption(D({pressedLabel:W[h],correctLabel:W[c],isCorrect:_,stimulusName:"star"}))||!await e.wait(L)||(M(o),E(m),!await e.wait(z)))return}if(!await e.advanceCaption("When the question mark appears, the tone tests begin. You may let the picture go now and focus on the tones.")||(It(o,"No","Yes"),T(t,"?"),!await e.wait(fe)))return;const d=2;for(let i=0;i<u.length;i++){const l=u[i],c=l.isTarget?"right":"left",h=i===d?c==="right"?"left":"right":c;if(!await e.advanceCaption(`Tone test ${i+1} of 3: was this tone one of the ones you just heard?`)||!await e.wait($)||(ce(l.cell).catch(()=>{}),!await R(o,h,e)))return;const m=h===c;if(T(t,"?",{color:m?I:S}),!await e.wait(q)||!await e.advanceCaption(D({pressedLabel:N[h],correctLabel:N[c],isCorrect:m,stimulusName:"question mark"}))||!await e.wait(L)||(M(o),T(t,"?"),!await e.wait(z)))return}T(t,"")}const Do=3;async function Bo(t,e){if(t.state.cancelled)return!1;const n=document.getElementById("demo-buttons-row");if(!n)return!1;n.innerHTML=`
    <div class="demo-buttons-container" style="
      position: relative;
      display: inline-flex;
      align-items: center;
  ...
  `;const o=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${o} Click the button below to watch it again. When you are ready to start the practice, press the <kbd>Space</kbd> key.`)?new Promise(r=>{let a=!1;const u=i=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(c=>c.removeEventListener("click",s)),r(i)},s=i=>{const l=i.currentTarget.getAttribute("data-side");u(l==="right")};n.querySelectorAll(".demo-replay-btn").forEach(i=>i.addEventListener("click",s));const d=setInterval(()=>{t.state.cancelled&&(clearInterval(d),u(!1)),a&&clearInterval(d)},100)}):!1}function re(t){return async function(n,o){let r=0;for(;!o.state.cancelled;){try{await t(n,o)}catch(s){console.error("[demo] mini-trial error",s);return}if(o.state.cancelled)return;o.state.spaceArmed=!0;const a=Do-r;if(a<=0){if(!await o.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;_e();return}if(!await Bo(o,a)){await o.advanceCaption("Press Space when you are ready to start the practice."),_e();return}r+=1;try{ln(n),_e(),T(n,""),n.rotor.style.transition="",rt(n,0),Te(n)}catch{}if(!await o.advanceCaption("Replaying the demonstration…")||!await o.wait(Eo))return}}}const Yo=re(qo),Ho=re($o),Fo=re(zo),Wo=re(Ro),Go=re(Mo);function ae({phase:t,taskNumber:e,title:n,run:o,factory:r}){const a={type:P,stimulus:Co(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const u=document.getElementById("demo-mount");if(!u)return;const s=sn({rotation_deg:0,fixation:""});u.appendChild(s.wrapper);const d=Ao(),i=window.jsPsych?.getCurrentTrial?.();i&&typeof i=="object"&&(i._demo_state=d.state);let l=!0;const c=h=>{if(l){if(h.key==="ArrowLeft"||h.key==="ArrowRight"){h.preventDefault(),h.stopPropagation();return}if(h.key===" "||h.code==="Space"){if(h.preventDefault(),h.stopPropagation(),!d.state.spaceArmed)return;l=!1,document.removeEventListener("keydown",c,!0),d.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",c,!0),i&&typeof i=="object"&&(i._demo_keydown_handler=c),o(s,d).catch(h=>{console.error(`[demo:${t}] schedule error`,h)})},on_finish:()=>{const u=window.jsPsych?.getCurrentTrial?.();u?._demo_state&&(u._demo_state.cancelled=!0),u?._demo_keydown_handler&&(document.removeEventListener("keydown",u._demo_keydown_handler,!0),u._demo_keydown_handler=null)},data:{phase:t}};return B(t,r),Y(a)}function St(){return ae({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:Yo,factory:St})}function Nt(){return ae({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:Ho,factory:Nt})}function Ct(){return ae({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:Fo,factory:Ct})}function At(){return ae({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:Wo,factory:At})}function Lt(){return ae({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:Go,factory:Lt})}const ke=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function Ve(t){return typeof t!="string"?"":t.trim().toLowerCase()}function le(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:U,preamble:"<h2>Quick check</h2>",html:`
    ...
    `,button_label:"Continue",on_finish:o=>{const r=o.response?.response??"",a=Ve(r);o.attention_check_id=t.id,o.attention_check_raw=r,o.attention_check_passed=a===Ve(t.expected_answer)},data:{phase:"attention_check"}};return v(e,()=>le(t)),w(n,e)}function Uo(t,e=y.attention_checks.instruction_max_failures){const n=(t??[]).filter(a=>a?.phase==="attention_check"),o=n.filter(a=>a.attention_check_passed===!0).length,r=n.filter(a=>a.attention_check_passed===!1).length;return{total:n.length,passed:o,failed:r,exceededThreshold:r>e,threshold:e,ids:n.map(a=>a.attention_check_id)}}function qt(){const t="attention_check_summary",e={type:U,preamble:"<h2>Thanks — moving on.</h2>",html:`
      <div style="max-width: 36rem; margin: 0 auto;">
        <p>Press <strong>Continue</strong> to proceed to the main task.</p>
      </div>
    `,button_label:"Continue",on_finish:n=>{const o=window.jsPsych?.data?.get().values()??[],r=Uo(o);n.phase="attention_check_summary",n.attention_total=r.total,n.attention_passed=r.passed,n.attention_failed=r.failed,n.attention_excluded=r.exceededThreshold,n.attention_threshold=r.threshold}};return v(t,qt),w(e,t)}const Ke=Object.freeze(["d_only","t_only","i_only","i_d","i_t"]);function Je(t){let e=0,n=0;for(const o of t)typeof o.probe_correct=="boolean"&&(n+=1,o.probe_correct&&(e+=1)),typeof o.star_correct=="boolean"&&(n+=1,o.star_correct&&(e+=1));return{correct:e,total:n,accuracy:n>0?e/n:0}}function J({trialType:t,trialsPerType:e,sequencePoolLabelPrefix:n,prng:o}={}){if(!Ke.includes(t))throw new Error(`singleTypePractice: unknown trialType '${t}'; expected one of ${Ke.join(", ")}`);const r=e??y.blocks.practice_trials_per_type,a=o??Pe(),u=en({blockLabel:"practice",countsByType:{[t]:r},sequencePoolLabelPrefix:n??"practice",runLengthCap:Math.max(1,r),prng:a});return{schedule:u.schedule,trialParams:u.trialParams,nodes:u.nodes}}function Vo({acc:t,passed:e,willRetry:n,criterion:o}){return Ko({acc:t,passed:e,willRetry:n,criterion:o})}function Ko({acc:t,passed:e,willRetry:n,criterion:o}){const r=Math.round(t.accuracy*100),a=Math.round(o*100),u=e?'<h2 style="color:#34d399;">Practice complete</h2>':'<h2 style="color:#f87171;">Practice — keep going</h2>',s=e?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
  ...
  `}function $t(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:P,stimulus:`
    ...
    `,choices:[" "],data:{phase:"instructions_overview"}};return B(o.data.phase,$t),Y(o)}function Jo({trialsPerType:t,accuracyCriterion:e,maxLoops:n,prng:o}={}){if(ke.length!==3)throw new Error(`assembleInstructionsAndPractice: expected exactly 3 attention-check items, got ${ke.length}`);const[r,a,u]=ke,s=t??y.blocks.practice_trials_per_type,d=e??y.practice.accuracy_criterion,i=n??y.practice.max_loops,l=o??Pe(),c=J({trialType:"d_only",trialsPerType:s,prng:l}),h=J({trialType:"t_only",trialsPerType:s,prng:l}),m=J({trialType:"i_only",trialsPerType:s,prng:l}),_=J({trialType:"i_d",trialsPerType:s,prng:l}),b=J({trialType:"i_t",trialsPerType:s,prng:l});let k=0,x=0,f=null;const H={type:P,stimulus:"",choices:"NO_KEYS",trial_duration:0,on_start:()=>{k+=1,x=window.jsPsych?.data?.get().count()??0},data:()=>({phase:"practice_iteration_start",practice_iteration:k})};function C(){const ie="practice_feedback",qe={type:P,stimulus:()=>{const Wt=(window.jsPsych?.data?.get().values()??[]).slice(x),V=Je(Wt),be=V.accuracy>=d,$e=!be&&k<=i;return f={accuracy:V.accuracy,correct:V.correct,total:V.total,passed:be,willRetry:$e,attemptCount:k},Vo({acc:V,passed:be,willRetry:$e,criterion:d})},choices:[" "],data:()=>({phase:"practice_feedback",practice_iteration:k,iteration_accuracy:f?.accuracy??null,iteration_correct:f?.correct??null,iteration_total:f?.total??null,iteration_passed:f?.passed??null})};return v(ie,C),w(qe,ie)}const F=C(),Ft={timeline:[H,vt(),St(),...c.nodes,_t(),Nt(),...h.nodes,le(r),kt(),Ct(),...m.nodes,le(a),jt(),At(),..._.nodes,Pt(),Lt(),...b.nodes,le(u),F],loop_function:function(ie){return!(yn()||Je(ie.values()).accuracy>=d||k>i)}};return[$t(),Ft,qt()]}const Xo=Object.freeze([Object.freeze({value:1,label:'No image at all; you only "know" that you are thinking of the object'}),Object.freeze({value:2,label:"Vague and dim"}),Object.freeze({value:3,label:"Moderately clear and vivid"}),Object.freeze({value:4,label:"Clear and reasonably vivid"}),Object.freeze({value:5,label:"Perfectly clear and as vivid as normal vision"})]),he=Object.freeze([Object.freeze({id:"vviq_v1_relative",preamble:"Think of some relative or friend whom you frequently see (but who is not with you at present) and consider carefully the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q01",text:"The exact contour of face, head, shoulders and body."}),Object.freeze({id:"vviq_q02",text:"Characteristic poses of head, attitudes of body, etc."}),Object.freeze({id:"vviq_q03",text:"The precise carriage, length of step, etc. in walking."}),Object.freeze({id:"vviq_q04",text:"The different colours worn in some familiar clothes."})])}),Object.freeze({id:"vviq_v2_sunrise",preamble:"Think of the rising sun. Consider carefully the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q05",text:"The sun is rising above the horizon into a hazy sky."}),Object.freeze({id:"vviq_q06",text:"The sky clears and surrounds the sun with blueness."}),Object.freeze({id:"vviq_q07",text:"Clouds. A storm blows up, with flashes of lightning."}),Object.freeze({id:"vviq_q08",text:"A rainbow appears."})])}),Object.freeze({id:"vviq_v3_shop",preamble:"Think of the front of a shop which you often go to. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q09",text:"The overall appearance of the shop from the opposite side of the road."}),Object.freeze({id:"vviq_q10",text:"A window display including colours, shape and details of individual items for sale."}),Object.freeze({id:"vviq_q11",text:"You are near the entrance. The colour, shape and details of the door."}),Object.freeze({id:"vviq_q12",text:"You enter the shop and go to the counter. The counter assistant serves you. Money changes hands."})])}),Object.freeze({id:"vviq_v4_country",preamble:"Think of a country scene which involves trees, mountains and a lake. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q13",text:"The contours of the landscape."}),Object.freeze({id:"vviq_q14",text:"The colour and shape of the trees."}),Object.freeze({id:"vviq_q15",text:"The colour and shape of the lake."}),Object.freeze({id:"vviq_q16",text:"A strong wind blows on the tree and on the lake causing waves."})])}),Object.freeze({id:"vviq_v5_highway",preamble:"Think of being driven in a fast-moving car by a relative or friend along a major highway. Consider the picture that comes into your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q17",text:"You observe the heavy traffic travelling at maximum speed around your car. The overall appearance of vehicles, their colours, sizes and shapes."}),Object.freeze({id:"vviq_q18",text:"Your car accelerates to overtake the traffic directly in front of you. You see an urgent expression on the face of the driver and the people in the other vehicles as you pass."}),Object.freeze({id:"vviq_q19",text:"A large truck is flashing its headlight directly behind. Your car quickly moves over to let the truck pass. The driver signals with a friendly wave."}),Object.freeze({id:"vviq_q20",text:"You see a broken-down vehicle beside the road. Its lights are flashing. The driver is looking concerned and she is using a mobile phone."})])}),Object.freeze({id:"vviq_v6_beach",preamble:"Think of the beach by the ocean on a warm summer’s day. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q21",text:"The overall appearance and colour of the water, surf, and sky."}),Object.freeze({id:"vviq_q22",text:"Bathers are swimming and splashing about in the water. Some are playing with a brightly coloured beach ball."}),Object.freeze({id:"vviq_q23",text:"An ocean liner crosses the horizon. It leaves a trail of smoke in the blue sky."}),Object.freeze({id:"vviq_q24",text:"A beautiful air balloon appears with four people aboard. The balloon drifts past you, almost directly overhead. The passengers wave and smile. You wave and smile back at them."})])}),Object.freeze({id:"vviq_v7_railway",preamble:"Think of a railway station. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q25",text:"The overall appearance of the station viewed from in front of the main entrance."}),Object.freeze({id:"vviq_q26",text:"You walk into the station. The colour, shape and details of the entrance hall."}),Object.freeze({id:"vviq_q27",text:"You approach the ticket office, go to a vacant counter and purchase your ticket."}),Object.freeze({id:"vviq_q28",text:"You walk to the platform and observe other passengers and the railway lines. A train arrives. You climb aboard."})])}),Object.freeze({id:"vviq_v8_garden",preamble:"Finally, think of a garden with lawns, bushes, flowers and shrubs. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q29",text:"The overall appearance and design of the garden."}),Object.freeze({id:"vviq_q30",text:"The colour and shape of the bushes and shrubs."}),Object.freeze({id:"vviq_q31",text:"The colour and appearance of the flowers."}),Object.freeze({id:"vviq_q32",text:"Some birds fly down onto the lawn and start pecking for food."})])})]),Xe=he.reduce((t,e)=>t+e.items.length,0);if(Xe!==32)throw new Error(`VVIQ_VIGNETTES must contain exactly 32 items, got ${Xe}`);function zt(t){const e=t.items.map(a=>{const u=Xo.map(s=>`<option value="${s.value}">${s.value} — ${s.label}</option>`).join("");return`
        ...
        </tr>`}).join(""),n=he.findIndex(a=>a.id===t.id)+1,o=t.id,r={type:U,preamble:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return v(t,Rt),w(e,t)}function Mt(){const t=G.map(o=>{const r=o.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
      ...
      </tr>`}).join(""),e="music_experience",n={type:U,preamble:`
    ...
    `,button_label:"Continue",on_finish:o=>{o.phase="music_experience",o.music_experience_responses=G.reduce((r,a)=>{const u=o.response?.[a.id];return r[a.id]=u===""||u===null||u===void 0?null:String(u),r},{})}};return v(e,Mt),w(n,e)}function Zo(){return[Rt(),Mt()]}function Dt(){const t="questionnaire_intro",e={type:P,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,Dt),w(e,t)}function er(){return[Dt(),...Qo(),...Zo()]}function Bt(){const t="main_a_intro",e={type:P,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_a_intro"}};return v(t,Bt),w(e,t)}function Yt(){const t="main_b_intro",e={type:P,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,Yt),w(e,t)}function Ht(){const t="end_of_task_intro",e={type:P,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{tn()}};return v(t,Ht),w(e,t)}const O=Gt(),tr=Ut();function nr(){if(ot(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}nr();const ge=Vt({display_element:void 0,on_trial_start:_n(),on_data_update:t=>{Ze(t).catch(e=>{console.error("[runner] storage append failed",e),et(e)})},on_finish:()=>{const t=ge.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:O.params.session_id,prolific_pid:O.params.prolific_pid,study_id:O.params.study_id,is_preview:O.params.is_preview,is_pilot_run:O.is_pilot_run,pilot_label:O.pilot_label,prng_seed_uint32:O.prng_seed_uint32,schema_version:O.schema_version,build_id:O.build_id}),console.info("[runner] session",O,"visibility",io())}});window.jsPsych=ge;kn(ge);const Qe=nn(),or=[...yo(),...Jo(),Bt(),...Qe.mainA.nodes,on(),Yt(),...Qe.mainB.nodes,Ht(),...er(),rn({session:O}),an()];tr.then(()=>ge.run(or)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-DHjs4vwn.js.map
