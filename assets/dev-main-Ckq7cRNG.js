import"./modulepreload-polyfill-B5Qt9EMX.js";import{i as a,b as d,c as r,a as l,H as i}from"./index-DYJhehk_.js";import{c as p}from"./config-_8Yl_G_G.js";import{r as c,t as m}from"./main-blocks-BmFzr8c_.js";import"./pattern-BsPo95Cs.js";const e=a(),h=d(),t=r({display_element:void 0,on_data_update:o=>{l(o).catch(s=>{console.error("[dev-main] storage append failed",s)})},on_finish:()=>{t.data.get().addProperties({session_id:e.params.session_id,prolific_pid:e.params.prolific_pid,study_id:e.params.study_id,is_preview:e.params.is_preview,is_pilot_run:e.is_pilot_run,pilot_label:e.pilot_label,prng_seed_uint32:e.prng_seed_uint32,schema_version:e.schema_version,build_id:e.build_id,dev_entry:"dev-main"}),console.info("[dev-main] session finished",e),console.info("[dev-main] data accessible at window.jsPsych.data.get()")}});window.jsPsych=t;const y={type:i,stimulus:`
    <div style="max-width: 36rem; margin: 0 auto; text-align: left;">
      ...
      conditions. No calibration, instructions, practice, or VVIQ — straight
  ...
  `,choices:[" "],data:{phase:"main_b_intro"}},u={type:i,stimulus:`
    <div style="max-width: 36rem; margin: 0 auto;">
      ...
      Main A → Main B → VVIQ), open <code>/</code> instead of
      <code>/dev-main.html</code>.</p>
      <p>Press <kbd>Space</kbd> to close.</p>
    </div>
  `,choices:[" "],data:{phase:"dev_main_end"}},n=c(),v=[y,_,...n.mainA.nodes,m({durationS:5,blockLabel:"dev_inter_block"}),b,...n.mainB.nodes,u];h.then(()=>t.run(v));
//# sourceMappingURL=dev-main-Ckq7cRNG.js.map
