import"./modulepreload-polyfill-B5Qt9EMX.js";import{i as p,a as c,H as n}from"./index-Vh1_s8Sq.js";import{c as m,a as u}from"./uploader-CTeutibu.js";import{u as _,a as h}from"./debrief-DbGCmbzK.js";import{c as e}from"./config--mJAAK4S.js";const f=new Date().toISOString().replace(/[:.]/g,"-"),t=`SMOKE_TEST_${f}`,s=5;async function g(){await m();const o=p({prolific_pid:t,study_id:"smoke_test",session_id:t,is_preview:!0},{is_pilot_run:!1,pilot_label:"smoke_test",source:"smoke-test"}),a=c({on_data_update:r=>{u(r).catch(i=>console.error("[smoke-test] storage write failed",i))}});window.jsPsych=a;const d={type:n,stimulus:`
  ...
  `});
//# sourceMappingURL=smoke-test-CwXSl9EB.js.map
