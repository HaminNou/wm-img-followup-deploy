import"./modulepreload-polyfill-B5Qt9EMX.js";import{P as p,a as dt,r as ut,H as $,g as Ne,i as dn,b as un,c as hn}from"./index-D84Ls8co.js";import{s as te,a as ht,u as pn,g as pt,b as Ge,c as mn,d as mt,p as fn,F as $e,e as Ae,f as We,h as gn,i as yn,j as A,k as C,l as fe,m as bn,n as ft,o as wn,q as _n,r as vn}from"./main-blocks-B00PDtMc.js";import{c as y}from"./config-DmeTTinz.js";import{c as I,u as kn,a as Tn}from"./debrief-TljHxqxy.js";import{c as xn,a as En,s as S,b as gt,h as xe,d as ge,r as j,e as Ce,f as Re,g as De,i as In,j as Ue,o as Sn,k as On}from"./pattern-8GUrvjHu.js";var Pn="2.1.0";const jn={name:"html-button-response",version:Pn,parameters:{stimulus:{type:p.HTML_STRING,default:void 0},choices:{type:p.STRING,default:void 0,array:!0},button_html:{type:p.FUNCTION,default:function(t,e){return`<button class="jspsych-btn">${t}</button>`}},prompt:{type:p.HTML_STRING,default:null},stimulus_duration:{type:p.INT,default:null},trial_duration:{type:p.INT,default:null},button_layout:{type:p.STRING,default:"grid"},grid_rows:{type:p.INT,default:1},grid_columns:{type:p.INT,default:null},response_ends_trial:{type:p.BOOL,default:!0},enable_button_after:{type:p.INT,default:0}},data:{rt:{type:p.INT},response:{type:p.INT},stimulus:{type:p.HTML_STRING}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class P{constructor(e){this.jsPsych=e}static{this.info=jn}trial(e,n){const o=document.createElement("div");o.id="jspsych-html-button-response-stimulus",o.innerHTML=n.stimulus,e.appendChild(o);const r=document.createElement("div");if(r.id="jspsych-html-button-response-btngroup",n.button_layout==="grid"){if(r.classList.add("jspsych-btn-group-grid"),n.grid_rows===null&&n.grid_columns===null)throw new Error("You cannot set `grid_rows` to `null` without providing a value for `grid_columns`.");const c=n.grid_columns===null?Math.ceil(n.choices.length/n.grid_rows):n.grid_columns,h=n.grid_rows===null?Math.ceil(n.choices.length/n.grid_columns):n.grid_rows;r.style.gridTemplateColumns=`repeat(${c}, 1fr)`,r.style.gridTemplateRows=`repeat(${h}, 1fr)`}else n.button_layout==="flex"&&r.classList.add("jspsych-btn-group-flex");for(const[c,h]of n.choices.entries()){r.insertAdjacentHTML("beforeend",n.button_html(h,c));const m=r.lastChild;m.dataset.choice=c.toString(),m.addEventListener("click",()=>{u(c)})}e.appendChild(r),n.prompt!==null&&e.insertAdjacentHTML("beforeend",n.prompt);var a=performance.now(),s={rt:null,button:null};const l=()=>{var c={rt:s.rt,stimulus:n.stimulus,response:s.button};this.jsPsych.finishTrial(c)};function u(c){var h=performance.now(),m=Math.round(h-a);s.button=parseInt(c),s.rt=m,o.classList.add("responded");for(const _ of r.children)_.setAttribute("disabled","disabled");n.response_ends_trial&&l()}if(n.stimulus_duration!==null&&this.jsPsych.pluginAPI.setTimeout(()=>{o.style.visibility="hidden"},n.stimulus_duration),n.enable_button_after>0){for(var i=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),d=0;d<i.length;d++)i[d].setAttribute("disabled","disabled");this.jsPsych.pluginAPI.setTimeout(()=>{for(var c=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),h=0;h<c.length;h++)c[h].removeAttribute("disabled")},n.enable_button_after)}n.trial_duration!==null&&this.jsPsych.pluginAPI.setTimeout(l,n.trial_duration)}simulate(e,n,o,r){n=="data-only"&&(r(),this.simulate_data_only(e,o)),n=="visual"&&this.simulate_visual(e,o,r)}create_simulation_data(e,n){const o={stimulus:e.stimulus,rt:this.jsPsych.randomization.sampleExGaussian(500,50,.006666666666666667,!0)+e.enable_button_after,response:this.jsPsych.randomization.randomInt(0,e.choices.length-1)},r=this.jsPsych.pluginAPI.mergeSimulationData(o,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,r),r}simulate_data_only(e,n){const o=this.create_simulation_data(e,n);this.jsPsych.finishTrial(o)}simulate_visual(e,n,o){const r=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),o(),r.rt!==null&&this.jsPsych.pluginAPI.clickTarget(a.querySelector(`#jspsych-html-button-response-btngroup [data-choice="${r.response}"]`),r.rt)}}let Ke=!1,M=[];const Ee=new Map;let ne=!1,Ie=!1;function Ln(t){!t||typeof t!="string"||M[M.length-1]!==t&&(M.push(t),M.length>32&&M.shift())}function yt(t){const e=typeof t?.data=="function"?null:t?.data??null;return typeof e?.phase=="string"?e.phase:null}function Nn(t,e){return t&&typeof t=="object"&&typeof t!="function"?{...t,hidden_nav_step:e}:(...n)=>({...typeof t=="function"?t(...n):{},hidden_nav_step:e})}function v(t,e){!t||typeof t!="string"||typeof e!="function"||Ee.set(t,e)}function b(t,e=yt(t)){if(!e||typeof e!="string")return t;const n=t?.on_load;return t.data=Nn(t?.data,e),t._hidden_nav_checkpoint=!0,t.on_load=(...o)=>{Ln(e),n?.(...o)},t}function W(t,e){v(t,e)}function U(t){return b(t,yt(t))}function $n(){const t=Ie;return Ie=!1,t}function An(t){const e=t?.timeline?.getLatestNode?.();return e&&typeof e.getDataParameter=="function"?e:null}function Cn(t){try{const e=An(t);if(!e)return null;const n=e.getDataParameter?.()??{},o=typeof n.hidden_nav_step=="string"?n.hidden_nav_step:null;return{node:e,stepId:o,phase:typeof n.phase=="string"?n.phase:null}}catch{return null}}function Rn(t){const e=t?.description?.type?.info?.name??null;return e==="html-button-response"?{response:0}:e==="survey-html-form"?{response:{}}:{}}function Dn(t){const e=M.slice();if(t)for(;e[e.length-1]===t;)e.pop();return{trimmedHistory:e,prevStepId:e[e.length-1]??null}}function Ve(t,e){const n=t?.parent?.description?.timeline;if(!Array.isArray(n))return!1;const o=n.indexOf(t.description);return o<0?!1:(n.splice(o+1,0,...e),!0)}function Mn(){return function(e){if(e?._hidden_nav_checkpoint===!0){ne&&(ne=!1),te(!1);return}if(!ne){te(!1);return}!e||typeof e!="object"||(e.trial_duration=0,e.choices="NO_KEYS")}}function zn(t){if(Ke||typeof document>"u")return;const e=n=>{const o=n.target&&n.target.tagName||"";if(o==="INPUT"||o==="TEXTAREA"||n.target?.isContentEditable||n.metaKey||n.ctrlKey||n.altKey)return;const r=n.key?.toLowerCase?.();if(r!=="u"&&r!=="r")return;const a=Cn(t);if(!a)return;n.preventDefault(),n.stopPropagation(),ht();const s=Rn(a.node),l=!!a.stepId;if(r==="u"){Ie=!0,l||(ne=!0),te(!0),t.finishTrial({...s,phase:a.phase,hidden_nav:"forward",hidden_nav_step:a.stepId??null});return}const{trimmedHistory:u,prevStepId:i}=Dn(a.stepId),d=i?Ee.get(i):null;if(!d)return;let c=!1;if(l){const h=Ee.get(a.stepId);if(!h)return;c=Ve(a.node,[d(),h()])}else c=Ve(a.node,[d()]);c&&(M=u,ne=!1,l?te(!1):te(!0),t.finishTrial({...s,phase:a.phase,hidden_nav:"back",hidden_nav_step:a.stepId??null,hidden_nav_target_step:i}))};document.addEventListener("keydown",e,!0),Ke=!0}const qn="online-2101803-v1",Yn=`
...
`;function bt(){const t="consent";let e=!1;const n={type:P,stimulus:Yn,choices:["I consent — begin","I do not consent — exit"],button_html:(o,r)=>`<button class="jspsych-btn" data-idx="${r}"${r===0?" disabled":""}>${o}</button>`,on_load:()=>{e=!1;const o=document.getElementById("consent-checkbox"),r=document.querySelector('button.jspsych-btn[data-idx="0"]');!o||!r||o.addEventListener("change",()=>{e=o.checked,r.disabled=!o.checked})},on_finish:async o=>{o.consented=o.response===0,o.consent_acknowledged=e,o.consent_version=qn,o.consented&&await pn()},data:{phase:"consent"}};return v(t,bt),b(n,t)}function Bn(){return{timeline:[{type:P,stimulus:`
          <h2>Thank you</h2>
...
`;function wt(){const t="demographics",e={type:X,preamble:`
    ...
    `,button_label:"Continue",data:{phase:"demographics"},on_load:()=>{const n=Gn(),o=document.querySelector('input[name="color_scheme_detected"]');o&&(o.value=n);const r=document.querySelector('select[name="color_scheme"]');r&&(n==="light"||n==="dark")&&(r.value=n)}};return v(t,wt),b(e,t)}var Un="2.1.0";const Kn={name:"call-function",version:Un,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class we{constructor(e){this.jsPsych=e}static{this.info=Kn}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=s=>{o=s,r()};n.func(a)}else o=n.func(),r()}}function Vn({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,s=[];return/\biphone\b/.test(r)&&s.push("iphone"),/\bipod\b/.test(r)&&s.push("ipod"),/\bipad\b/.test(r)&&s.push("ipad"),/macintosh/.test(r)&&a>1&&s.push("ipad_macos_disguised"),/android/.test(r)&&s.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&s.push("mobile_ua"),e===!1&&n===!1&&s.push("no_hover_no_fine_pointer"),{isDesktop:s.length===0,reasons:s,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Jn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function Xn(){return{type:we,async:!1,func:()=>Vn(Jn()),data:{phase:"desktop_gate"}}}function Qn(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Se="display-colour-locked";function Zn(){if(typeof document>"u")return!1;const t=document.documentElement;return t.classList.contains(Se)?!1:(t.classList.add(Se),!0)}function Oe(){return typeof document>"u"?!1:document.documentElement.classList.contains(Se)}const Je="display_mode_check",eo=`
  <h2>Display check</h2>
...
`;function _t(){const t={type:P,stimulus:eo,choices:["Continue"],on_load:()=>{const e=document.getElementById("display-colour-lock-btn"),n=document.getElementById("display-colour-lock-status"),o=()=>{!e||!n||(e.disabled=!0,e.style.opacity="0.55",e.style.cursor="default",e.textContent="Light mode forced",n.style.display="inline")};Oe()?o():e&&e.addEventListener("click",()=>{Zn(),o()})},on_finish:e=>{e.display_colour_locked=Oe()},data:{phase:"display_mode_check"}};return v(Je,_t),b(t,Je)}const to=85.6,Pe=1.5,je=12,no=100,oo=1100,pe=320,ro=2,Xe="screen_calibration",Qe="screen_calibration_retry_hint",ao=`
  ...
  <input id="cc-slider" type="range" min="${no}" max="${oo}" value="${pe}"
...
`;function vt(){const t={type:P,stimulus:ao,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),o=()=>{const r=parseInt(e.value,10);n.style.width=`${r}px`,n.style.height=`${r*(53.98/85.6)}px`};e.addEventListener("input",o),o()},on_finish:e=>{const n=document.getElementById("cc-slider"),o=n?parseInt(n.value,10):pe,r=o/to;e.cc_px_width=o,e.px_per_mm=r,e.px_per_mm_in_bounds=r>=Pe&&r<=je,e.px_per_mm_min=Pe,e.px_per_mm_max=je,e.display_colour_locked=Oe(),document.documentElement.style.setProperty("--mm",`${r}px`)},data:{phase:"screen_calibration"}};return v(Xe,vt),b(t,Xe)}function io(){return{type:we,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=Pe&&t.px_per_mm<=je),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function kt(){const t={type:P,stimulus:so,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Qe,kt),b(t,Qe)}function lo(t){return{timeline:[kt()],conditional_function:()=>t.count>=1}}function co({maxAttempts:t=ro}={}){const e={count:0};return{timeline:[lo(e),vt(),io(),uo(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function uo(t,e){return{type:we,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],o=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:o,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const ho="72vh",po="#000",mo="50rem",fo="95vw",go="72rem",Tt=`
  margin: 0 auto;
  display: flex;
...
`.replace(/\s+/g," ").trim();function It({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${Ot(n.trim())}"`:"";return`
  ...
  `}const ze=50,L=ze/2,St=ze*Math.SQRT2/2+1,Le=St-L+.5,de=ze+2*Le,Ze={cx:35,cy:15},et={cx:15,cy:35},wo=2.5,_o=2.5,tt=100,vo=30,ko=12,To=12,xo=[1,2,3,7,10,11,12,13,14,17,21,22,23],ue=10,Eo="#FFFFFF",Io=.33;function So(t,e,n){const r=n*.382,a=[];for(let s=0;s<10;s++){const l=s%2===0?n:r,u=-Math.PI/2+s*Math.PI/5;a.push(`${t+l*Math.cos(u)},${e+l*Math.sin(u)}`)}return a.join(" ")}const Oo=So(et.cx,et.cy,_o),Po="rgba(0, 0, 0, 0.229)",jo="rgba(0, 0, 0, 0.55)",nt="#000",ot="rgba(0, 0, 0, 0.85)";function Lo(t,{arrowAngleDeg:e=vo}={}){const n=new Set(t),o=n.has("tone")||n.has("qmark"),r=n.has("pattern"),a=`<circle cx="${L}" cy="${L}" r="${St}" fill="none" stroke="${Po}" stroke-width="0.5" />`,s=o||r?"":`<circle cx="${L}" cy="${L}" r="0.65" fill="${jo}" />`,l=r?xo.map(f=>{const w=f%5,x=Math.floor(f/5),g=w*ue,N=x*ue;return`<rect x="${g}" y="${N}" width="${ue}" height="${ue}" fill="${Eo}" opacity="${Io}" />`}).join(""):"",u=n.has("dot")?`<circle cx="${Ze.cx}" cy="${Ze.cy}" r="${wo}" fill="${nt}" />`:"",i=n.has("star")?`<polygon points="${Oo}" fill="${nt}" />`:"",d=n.has("tone")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${ot}" font-size="${ko}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",c=n.has("qmark")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${ot}" font-size="${To}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
    <svg viewBox="${-Le} ${-Le} ${de} ${de}"
         width="100%" height="100%" style="display: block; overflow: visible;">
      ${a}${l}${s}${u}${i}${d}${c}
    </svg>
  `,m=(e/360).toFixed(6),_=n.has("arrow")?`<img src="${No()}" alt="rotation cue"
            style="position: absolute; top: 50%; left: 50%; width: ${tt}px; height: ${tt}px;
  ...
  `}function No(){return"./assets/rotation-arrow.png"}function k({title:t,body:e,narration:n,exemplar:o=[],arrowAngleDeg:r}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${Ot(n.trim())}"`:"",s=Lo(o,typeof r=="number"?{arrowAngleDeg:r}:{});return`
  ...
  `}function Ot(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const $o=It({title:"Sit comfortably for the study",body:`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Co(){const t=b({type:P,stimulus:$o,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:P,stimulus:Ao,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function Pt(){const t="speaker_volume_instruction",e={type:P,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=Z;const l=Promise.resolve();Ge(Z/100);const u=document.getElementById("tac-slider"),i=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const g=Number(u.value);a=g,i&&(i.textContent=`${g}%`),Ge(g/100)});const d=document.getElementById("tac-yes-btn");if(d&&d.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await l,e)return;const c=mn(),h=mt(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+Bo)/1e3,f=Ho/1e3,w=[];for(let g=0;g<h.length;g++)w.push(document.getElementById(`tac-box-${g}`));let x=c.currentTime+Fo/1e3;try{for(let g=0;g<Go&&!e;g++){r=g+1;for(let N=0;N<h.length&&!e;N++){const D=x;if(fn(N,{when:D}),await ke(c,D),e)break;const K=w[N];K&&K.classList.add("playing"),await ke(c,D+m),K&&K.classList.remove("playing"),x=D+_}e||(await ke(c,x+f),x+=f)}}catch{}if(!o&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{ht();const u=pt();u.current&&!u.current._state?.finished&&u.current.cancel(),l.tones_audible=o&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,Nt),b(s,t)}function Ko(){return{timeline:[{type:P,stimulus:`
      ...
      `,narration:`After the dots, we test your memory ${t} times. Each time, a black dot appears for 3 seconds in some location. Press Yes, the right arrow, if a dot was shown in that location. Press No, the left arrow, if it was not. Keep your eyes on the centre of the circle throughout.`,exemplar:["qmark"]}),k({title:e,body:`
        ...
        ${$t} for correct or
        ${At} for incorrect while it is still on screen.</p>
        ${I("Press <kbd>Space</kbd> for the Task 1 demonstration.")}
      `,narration:"You have 3 seconds for each test. Aim for accuracy first, but don't dwell. If you answer in time, the dot turns green for correct or red for incorrect while it is still on screen. Press Space for the Task 1 demonstration.",exemplar:["qmark"]})],o={type:re,pages:n,...Ct,data:{phase:"instructions_memory_d_only"}};return W(o.data.phase,Rt),U(o)}function Dt(){const t=y.memory.set_size,e="Task 2 — Remember the tones",n=[k({title:e,body:`
      ...
      `,narration:"You have 3 seconds for each test. If you answer in time, the central question mark turns green for correct or red for incorrect. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 2 demonstration.",exemplar:["tone"]})],o={type:re,pages:n,...Ct,data:{phase:"instructions_memory_t_only"}};return W(o.data.phase,Dt),U(o)}const Qo=`<span style="color: ${$e};"><strong>green</strong></span>`,Zo=`<span style="color: ${Ae};"><strong>red</strong></span>`,er='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',tr=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Mt(){const t=y.imagery.stars_per_trial,e="Task 3 — Picture the pattern",n=[k({title:e,body:`
      ...
      `,narration:`Then ${n} things appear inside the circle one at a time, mixed together. ${e} stars — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} dots — remember which locations they appear in, for the dot tests at the end of the trial.`,exemplar:["star","dot"]}),k({title:o,body:`
        ...
        ${zt} for correct or ${qt} for incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the dot tests begin. Press Space for the Task 4 demonstration.",exemplar:["pattern"]})],a={type:re,pages:r,...Bt,data:{phase:"instructions_dual_i_d"}};return W(a.data.phase,Ht),U(a)}function Ft(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,o="Task 5 — Tones and pattern together",r=[k({title:o,body:`
      ...
      `,narration:`Then ${n} things happen one at a time, mixed together. ${e} stars inside the circle — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} tones — remember each tone you hear, for the tone tests at the end of the trial.`,exemplar:["star","tone"]}),k({title:o,body:`
        ...
        mark turns ${zt} for correct or ${qt} for
        incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 5 demonstration.",exemplar:["pattern"]})],a={type:re,pages:r,...Bt,data:{phase:"instructions_dual_i_t"}};return W(a.data.phase,Ft),U(a)}const nr=4,Gt=1e3*nr,or=2e3,rr=400,E=500,T=400,q=1200,ar=700,sr=450,ir=220,Y=1500,qe=1e3,lr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function Ye(){return Ne().pick(lr)}const cr="./assets/rotation-arrow.png";function dr(t,e){return`
    <style>
    ...
    <div class="demo-frame" style="${yo}">
      <div style="${Et}">
        <h2 style="${Me}">Demonstration of Task ${t} — ${e}</h2>
      </div>
  ...
  `}function ur(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const o=gn(e);o?(yn(),t.currentNarration=pt().speak(o)):t.currentNarration=null},async wait(e){return await We(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let o=!1;const r=()=>{o||(o=!0,n())};e.done.then(r).catch(r);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),r())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await We(rr),t.cancelled)?!1:(this.setCaption(e),!0)},async narrate(e){return!(!await this.advanceCaption(e)||!await this.awaitNarration())}}}function hr(t,e){const n=y.imagery.rotation_arrow_size_px,o=document.createElement("img");return o.src=cr,o.alt="rotation cue",o.className="rotation-arrow-cue demo-arrow",o.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none","filter: brightness(0) saturate(100%) drop-shadow(1px 0 0 #fff) drop-shadow(-1px 0 0 #fff) drop-shadow(0 1px 0 #fff) drop-shadow(0 -1px 0 #fff)"].join("; ")+";"),t.wrapper.appendChild(o),o}function he(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function Be(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),In(t),Ue(t),!await e.awaitNarration()||!await e.wait(1e3)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;xe(t);const s=hr(t,n);return!await e.awaitNarration()||!await e.wait(600)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(he(s),!1):(he(s),gt(t,n),Ue(t),!await e.awaitNarration()||!await e.wait(1500)?!1:(xe(t),!0))}function ae(){const t=Sn(),e=On();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function B({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `;const o=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${o} Click the button below to watch it again. When you are ready to start the practice, press the <kbd>Space</kbd> key.`)?new Promise(r=>{let a=!1;const s=i=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(c=>c.removeEventListener("click",l)),r(i)},l=i=>{const d=i.currentTarget.getAttribute("data-side");s(d==="right")};n.querySelectorAll(".demo-replay-btn").forEach(i=>i.addEventListener("click",l));const u=setInterval(()=>{t.state.cancelled&&(clearInterval(u),s(!1)),a&&clearInterval(u)},100)}):!1}function ie(t){return async function(n,o){let r=0;for(;!o.state.cancelled;){try{await t(n,o)}catch(l){console.error("[demo] mini-trial error",l);return}if(o.state.cancelled)return;o.state.spaceArmed=!0;const a=wr-r;if(a<=0){if(Wt(),!await o.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;z();return}if(!await _r(o,a)){await o.advanceCaption("Press Space when you are ready to start the practice."),z();return}r+=1;try{En(n),z(),S(n,""),n.rotor.style.transition="",gt(n,0),xe(n)}catch{}if(!await o.advanceCaption("Replaying the demonstration…")||!await o.wait(or))return}}}const vr=ie(mr),kr=ie(fr),Tr=ie(gr),xr=ie(yr),Er=ie(br);function le({phase:t,taskNumber:e,title:n,run:o,factory:r}){const a={type:$,stimulus:dr(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const s=document.getElementById("demo-mount");if(!s)return;const l=xn({rotation_deg:0,fixation:"",background_shade:"gray"});s.appendChild(l.wrapper);const u=ur(),i=window.jsPsych?.getCurrentTrial?.();i&&typeof i=="object"&&(i._demo_state=u.state);let d=!0;const c=h=>{if(d){if(h.key==="ArrowLeft"||h.key==="ArrowRight"){h.preventDefault(),h.stopPropagation();return}if(h.key===" "||h.code==="Space"){if(h.preventDefault(),h.stopPropagation(),!u.state.spaceArmed)return;d=!1,document.removeEventListener("keydown",c,!0),u.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",c,!0),i&&typeof i=="object"&&(i._demo_keydown_handler=c),o(l,u).catch(h=>{console.error(`[demo:${t}] schedule error`,h)})},on_finish:()=>{const s=window.jsPsych?.getCurrentTrial?.();s?._demo_state&&(s._demo_state.cancelled=!0),s?._demo_keydown_handler&&(document.removeEventListener("keydown",s._demo_keydown_handler,!0),s._demo_keydown_handler=null)},data:{phase:t}};return W(t,r),U(a)}function Ut(){return le({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:vr,factory:Ut})}function Kt(){return le({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:kr,factory:Kt})}function Vt(){return le({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:Tr,factory:Vt})}function Jt(){return le({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:xr,factory:Jt})}function Xt(){return le({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:Er,factory:Xt})}const Te=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function st(t){return typeof t!="string"?"":t.trim().toLowerCase()}function me(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:X,preamble:"<h2>Quick check</h2>",html:`
  ...
  `}function Zt(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:$,stimulus:`
    ...
    `,button_label:"Continue",on_finish:o=>{o.phase="music_experience",o.music_experience_responses=J.reduce((r,a)=>{const s=o.response?.[a.id];return r[a.id]=s===""||s===null||s===void 0?null:String(s),r},{})}};return v(e,nn),b(n,e)}function Ar(){return[tn(),nn()]}function on(){const t="questionnaire_intro",e={type:$,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,on),b(e,t)}function Cr(){return[on(),...$r(),...Ar()]}function rn(){const t="main_a_intro",e={type:$,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{ft()}};return v(t,rn),b(e,t)}function an(){const t="main_b_intro",e={type:$,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,an),b(e,t)}function sn(){const t="end_of_task_intro",e={type:$,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{wn(),ft()}};return v(t,sn),b(e,t)}const O=dn(),Rr=un();function Dr(){if(mt(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}Dr();const _e=hn({display_element:void 0,on_trial_start:Mn(),on_data_update:t=>{dt(t).catch(e=>{console.error("[runner] storage append failed",e),ut(e)})},on_finish:()=>{const t=_e.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:O.params.session_id,prolific_pid:O.params.prolific_pid,study_id:O.params.study_id,is_preview:O.params.is_preview,is_pilot_run:O.is_pilot_run,pilot_label:O.pilot_label,prng_seed_uint32:O.prng_seed_uint32,schema_version:O.schema_version,build_id:O.build_id}),console.info("[runner] session",O,"visibility",qo())}});window.jsPsych=_e;zn(_e);const ct=_n(),Mr=[...Vo(),...Pr(),rn(),...ct.mainA.nodes,vn(),an(),...ct.mainB.nodes,sn(),...Cr(),kn({session:O}),Tn()];Rr.then(()=>_e.run(Mr)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-BDTRlc1n.js.map
