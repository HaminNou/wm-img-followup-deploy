...
`.replace(/\s+/g," ").trim();function g({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${io(n.trim())}"`:"";return`
  ...
  `}function Mt(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:P,stimulus:`
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{pn()}};return _(t,Gt),b(e,t)}const Ze=dn(),yr=[...Oo(),...Io(),...cr(),Ft(),...Ze.mainA.nodes,hn(),Wt(),...Ze.mainB.nodes,Gt(),...pr(),mn({session:O}),fn()];mr.then(()=>ge.run(yr)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-oUnWz0uq.js.map
