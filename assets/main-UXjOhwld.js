...
`;function bt(){const t="consent";let e=!1;const n={type:O,stimulus:Hn,choices:["I consent — begin","I do not consent — exit"],button_html:(o,r)=>`<button class="jspsych-btn" data-idx="${r}"${r===0?" disabled":""}>${o}</button>`,on_load:()=>{e=!1;const o=document.getElementById("consent-checkbox"),r=document.querySelector('button.jspsych-btn[data-idx="0"]');!o||!r||o.addEventListener("change",()=>{e=o.checked,r.disabled=!o.checked})},on_finish:async o=>{o.consented=o.response===0,o.consent_acknowledged=e,o.consent_version=Yn,o.consented&&await mn()},data:{phase:"consent"}};return v(t,bt),b(n,t)}function Fn(){return{timeline:[{type:O,stimulus:`
          <h2>Thank you</h2>
...
`;function wt(){const t="demographics",e={type:X,preamble:`
    ...
    `,button_label:"Continue",data:{phase:"demographics"}};return v(t,wt),b(e,t)}var Kn="2.1.0";const Vn={name:"call-function",version:Kn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class be{constructor(e){this.jsPsych=e}static{this.info=Vn}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{o=i,r()};n.func(a)}else o=n.func(),r()}}function Jn({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,i=[];return/\biphone\b/.test(r)&&i.push("iphone"),/\bipod\b/.test(r)&&i.push("ipod"),/\bipad\b/.test(r)&&i.push("ipad"),/macintosh/.test(r)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(r)&&i.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Xn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function Qn(){return{type:be,async:!1,func:()=>Jn(Xn()),data:{phase:"desktop_gate"}}}function Zn(){return{timeline:[{type:O,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Oe="display-colour-locked";function eo(){if(typeof document>"u")return!1;const t=document.documentElement;return t.classList.contains(Oe)?!1:(t.classList.add(Oe),!0)}function Pe(){return typeof document>"u"?!1:document.documentElement.classList.contains(Oe)}const Xe="display_mode_check",to=`
  <h2>Display check</h2>
...
`;function _t(){const t={type:O,stimulus:to,choices:["Continue"],button_html:(e,n)=>`<button class="jspsych-btn" data-idx="${n}" disabled aria-disabled="true" style="opacity: 0.55; cursor: not-allowed;">${e}</button>`,on_load:()=>{const e=document.getElementById("display-colour-lock-btn"),n=document.getElementById("display-colour-lock-status"),o=document.getElementById("display-mode-gate-hint"),r=document.querySelector('button.jspsych-btn[data-idx="0"]'),a=()=>{r&&(r.disabled=!1,r.setAttribute("aria-disabled","false"),r.style.opacity="",r.style.cursor=""),o&&(o.style.display="none")},i=()=>{e&&(e.disabled=!0,e.setAttribute("aria-disabled","true"),e.style.opacity="0.55",e.style.cursor="default",e.textContent="Light mode forced"),n&&(n.style.visibility="visible"),a(),r&&typeof r.focus=="function"&&r.focus()};Pe()?i():e&&e.addEventListener("click",()=>{eo(),i()})},on_finish:e=>{e.display_colour_locked=Pe()},data:{phase:"display_mode_check"}};return v(Xe,_t),b(t,Xe)}const no=85.6,je=1.5,Le=12,oo=100,ro=1100,he=320,ao=2,Qe="screen_calibration",Ze="screen_calibration_retry_hint",io=`
  ...
  <input id="cc-slider" type="range" min="${oo}" max="${ro}" value="${he}"
...
`;function vt(){const t={type:O,stimulus:io,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),o=()=>{const r=parseInt(e.value,10);n.style.width=`${r}px`,n.style.height=`${r*(53.98/85.6)}px`};e.addEventListener("input",o),o()},on_finish:e=>{const n=document.getElementById("cc-slider"),o=n?parseInt(n.value,10):he,r=o/no;e.cc_px_width=o,e.px_per_mm=r,e.px_per_mm_in_bounds=r>=je&&r<=Le,e.px_per_mm_min=je,e.px_per_mm_max=Le,e.display_colour_locked=Pe(),document.documentElement.style.setProperty("--mm",`${r}px`)},data:{phase:"screen_calibration"}};return v(Qe,vt),b(t,Qe)}function lo(){return{type:be,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=je&&t.px_per_mm<=Le),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function kt(){const t={type:O,stimulus:so,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Ze,kt),b(t,Ze)}function co(t){return{timeline:[kt()],conditional_function:()=>t.count>=1}}function uo({maxAttempts:t=ao}={}){const e={count:0};return{timeline:[co(e),vt(),lo(),ho(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function ho(t,e){return{type:be,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],o=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:o,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const po="72vh",mo="#000",fo="50rem",go="95vw",yo="72rem",Tt=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${po};
  color: ${mo};
`.replace(/\s+/g," ").trim(),xt=`${Tt} width: ${fo}; max-width: 94vw;`,bo=`${Tt} width: ${go}; max-width: ${yo}; align-items: center;`,Et=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim();function It({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${Ot(n.trim())}"`:"";return`
    <div style="${`${xt} min-height: auto; padding-top: 0.4rem; padding-bottom: 0.4rem; font-size: 0.95rem; line-height: 1.5;`}">
      ...
      <div style="${wo}" data-voiceover-target${o}>${e}</div>
    </div>
  `}const Be=50,L=Be/2,St=Be*Math.SQRT2/2+1,Ne=St-L+.5,ce=Be+2*Ne,et={cx:35,cy:15},tt={cx:15,cy:35},_o=2.5,vo=2.5,nt=100,ko=30,To=12,xo=12,Eo=[1,2,3,7,10,11,12,13,14,17,21,22,23],de=10,Io="#FFFFFF",So=.33;function Oo(t,e,n){const r=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:r,u=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(u)},${e+l*Math.sin(u)}`)}return a.join(" ")}const Po=Oo(tt.cx,tt.cy,vo),jo="rgba(0, 0, 0, 0.229)",Lo="rgba(0, 0, 0, 0.55)",ot="#000",rt="rgba(0, 0, 0, 0.85)";function No(t,{arrowAngleDeg:e=ko}={}){const n=new Set(t),o=n.has("tone")||n.has("qmark"),r=n.has("pattern"),a=`<circle cx="${L}" cy="${L}" r="${St}" fill="none" stroke="${jo}" stroke-width="0.5" />`,i=o||r?"":`<circle cx="${L}" cy="${L}" r="0.65" fill="${Lo}" />`,l=r?Eo.map(f=>{const w=f%5,x=Math.floor(f/5),g=w*de,A=x*de;return`<rect x="${g}" y="${A}" width="${de}" height="${de}" fill="${Io}" opacity="${So}" />`}).join(""):"",u=n.has("dot")?`<circle cx="${et.cx}" cy="${et.cy}" r="${_o}" fill="${ot}" />`:"",s=n.has("star")?`<polygon points="${Po}" fill="${ot}" />`:"",d=n.has("tone")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${rt}" font-size="${To}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",c=n.has("qmark")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${rt}" font-size="${xo}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
  ...
  `}function Ao(){return"./assets/rotation-arrow.png"}function k({title:t,body:e,narration:n,exemplar:o=[],arrowAngleDeg:r}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${Ot(n.trim())}"`:"",i=No(o,typeof r=="number"?{arrowAngleDeg:r}:{});return`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Ro(){const t=b({type:O,stimulus:$o,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:O,stimulus:Co,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function Pt(){const t="speaker_volume_instruction",e={type:O,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=Z;const l=Promise.resolve();We(Z/100);const u=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const g=Number(u.value);a=g,s&&(s.textContent=`${g}%`),We(g/100)});const d=document.getElementById("tac-yes-btn");if(d&&d.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await l,e)return;const c=fn(),h=ht(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+Ho)/1e3,f=Fo/1e3,w=[];for(let g=0;g<h.length;g++)w.push(document.getElementById(`tac-box-${g}`));let x=c.currentTime+Go/1e3;try{for(let g=0;g<Wo&&!e;g++){r=g+1;for(let A=0;A<h.length&&!e;A++){const M=x;if(gn(A,{when:M}),await Te(c,M),e)break;const K=w[A];K&&K.classList.add("playing"),await Te(c,M+m),K&&K.classList.remove("playing"),x=M+_}e||(await Te(c,x+f),x+=f)}}catch{}if(!o&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{ut();const u=$e();u.current&&!u.current._state?.finished&&u.current.cancel(),l.tones_audible=o&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,Nt),b(i,t)}function Vo(){return{timeline:[{type:O,stimulus:`
      ...
      `,narration:"You have 3 seconds for each test. Aim for accuracy first, but don't dwell. If you answer in time, the dot turns green for correct or red for incorrect while it is still on screen.",exemplar:["qmark"]})],o={type:re,pages:n,...Ct,data:{phase:"instructions_memory_d_only"}};return z(o.data.phase,Rt),D(o)}function zt(){const t=y.memory.set_size,e="Task 2 — Remember the tones",n=[k({title:e,body:`
      ...
      `,narration:`Then we play ${t} more tones, one at a time. For each one: Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. Keep your eyes on the centre of the circle and listen.`,exemplar:["qmark"]}),k({title:e,body:`
        ...
        set earlier.</p>
      `,narration:"You have 3 seconds for each test. If you answer in time, the central question mark turns green for correct or red for incorrect. Please make sure your audio volume is still at the level you set earlier.",exemplar:["tone"]})],o={type:re,pages:n,...Ct,data:{phase:"instructions_memory_t_only"}};return z(o.data.phase,zt),D(o)}const Zo=`<span style="color: ${Ce};"><strong>green</strong></span>`,er=`<span style="color: ${Re};"><strong>red</strong></span>`,tr='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',nr=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Dt(){const t=y.imagery.stars_per_trial,e="Task 3 — Picture the pattern",n=[k({title:e,body:`
      ...
      `,narration:`After the ${n} things, we test your tone memory ${t} times. Each test plays a tone. Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. You have 3 seconds for each star and each tone test. If you answer in time, the star or central question mark turns green for correct or red for incorrect.`,exemplar:["qmark"]}),k({title:o,body:`
        ...
        <p>Please make sure your audio volume is still at the level you
        set earlier.</p>
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier.",exemplar:["pattern"]})],a={type:re,pages:r,...Yt,data:{phase:"instructions_dual_i_t"}};return z(a.data.phase,Ft),D(a)}const or=4,Gt=1e3*or,rr=2e3,ar=400,E=500,T=400,Y=1200,ir=700,sr=450,lr=220,H=1500,Ye=1e3,cr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function He(){return Ae().pick(cr)}const dr="./assets/rotation-arrow.png";function ur(t,e){return`
    <style>
  ...
  `}function hr(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setSpaceArmed(e){const n=!!e;t.spaceArmed=n;const o=typeof document<"u"?document.getElementById("demo-hint"):null;o&&(o.style.opacity=n?"1":"0",o.setAttribute("aria-hidden",n?"false":"true"))},setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const o=yn(e);o?(bn(),t.currentNarration=$e().speak(o)):t.currentNarration=null},async wait(e){return await Ue(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let o=!1;const r=()=>{o||(o=!0,n())};e.done.then(r).catch(r);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),r())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await Ue(ar),t.cancelled)?!1:(this.setCaption(e),!0)},async narrate(e){return!(!await this.advanceCaption(e)||!await this.awaitNarration())}}}function pr(t,e){const n=y.imagery.rotation_arrow_size_px,o=document.createElement("img");return o.src=dr,o.alt="rotation cue",o.className="rotation-arrow-cue demo-arrow",o.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none","filter: brightness(0) saturate(100%) drop-shadow(1px 0 0 #fff) drop-shadow(-1px 0 0 #fff) drop-shadow(0 1px 0 #fff) drop-shadow(0 -1px 0 #fff)"].join("; ")+";"),t.wrapper.appendChild(o),o}function ue(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function Fe(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),On(t),Ke(t),!await e.awaitNarration()||!await e.wait(1e3)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;Ee(t);const i=pr(t,n);return!await e.awaitNarration()||!await e.wait(600)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(ue(i),!1):(ue(i),gt(t,n),Ke(t),!await e.awaitNarration()||!await e.wait(1500)?!1:(Ee(t),!0))}function ae(){const t=Pn(),e=jn();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function F({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `}function Zt(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:N,stimulus:`
    ...
    `,choices:[" "],data:{phase:"instructions_overview"}};return z(o.data.phase,Zt),D(o)}function en(){const t=Math.round(y.practice.accuracy_criterion*100),e={type:N,stimulus:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return v(t,nn),b(e,t)}function on(){const t=J.map(o=>{const r=o.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
    ...
    `,button_label:"Continue",on_finish:o=>{o.phase="music_experience",o.music_experience_responses=J.reduce((r,a)=>{const i=o.response?.[a.id];return r[a.id]=i===""||i===null||i===void 0?null:String(i),r},{})}};return v(e,on),b(n,e)}function Cr(){return[nn(),on()]}function rn(){const t="questionnaire_intro",e={type:N,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,rn),b(e,t)}function Rr(){return[rn(),...$r(),...Cr()]}function an(){const t="main_a_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{pt()}};return v(t,an),b(e,t)}function sn(){const t="main_b_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,sn),b(e,t)}function ln(){const t="end_of_task_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{_n(),pt()}};return v(t,ln),b(e,t)}const S=hn(),zr=Tn();function Dr(){if(ht(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}Dr();const we=pn({display_element:void 0,on_trial_start:qn(),on_data_update:t=>{mt(t).catch(e=>{console.error("[runner] storage append failed",e),ft(e)})},on_finish:()=>{const t=we.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:S.params.session_id,prolific_pid:S.params.prolific_pid,study_id:S.params.study_id,is_preview:S.params.is_preview,is_pilot_run:S.is_pilot_run,pilot_label:S.pilot_label,prng_seed_uint32:S.prng_seed_uint32,schema_version:S.schema_version,build_id:S.build_id}),console.info("[runner] session",S,"visibility",Bo())}});window.jsPsych=we;new URLSearchParams(window.location.search).has("devnav")&&Bn(we);const dt=vn(),Mr=[...Jo(),...jr(),an(),...dt.mainA.nodes,kn({session:S}),sn(),...dt.mainB.nodes,ln(),...Rr(),xn({session:S}),En()];zr.then(()=>we.run(Mr)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-UXjOhwld.js.map
