import"./modulepreload-polyfill-B5Qt9EMX.js";import{c as R,i as S,j as D,d as M,e as O,f as z,s as q,k as T,o as $}from"./pattern-qBNY6Iin.js";import{c as A}from"./config-DIVOXAZU.js";const I="./assets/rotation-arrow.png",k="#34d399",_=188,w=188,P=1.97,B="rgba(255, 255, 255, 0.7)",L="rgba(255, 255, 255, 0.88)",U="rgba(255, 255, 255, 0.86)",Q="rgba(255, 255, 255, 0.72)",G=2.2,X=2.1,Y=2.7,j=44,H=7,W=54,K=4,V=-10;function J(){const e=document.createElement("style");e.textContent=`
    #figure-board {
      width: 2720px;
      margin: 0 auto;
...
//# sourceMappingURL=figure-board-DpCGdAF2.js.map
