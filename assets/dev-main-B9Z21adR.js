import"./modulepreload-polyfill-B5Qt9EMX.js";import{i as a,b as d,c as r,a as l,H as i}from"./index-D84Ls8co.js";import{c as p}from"./config-DmeTTinz.js";import{q as c,r as m}from"./main-blocks-B00PDtMc.js";import"./pattern-8GUrvjHu.js";const e=a(),h=d(),o=r({display_element:void 0,on_data_update:t=>{l(t).catch(s=>{console.error("[dev-main] storage append failed",s)})},on_finish:()=>{o.data.get().addProperties({session_id:e.params.session_id,prolific_pid:e.params.prolific_pid,study_id:e.params.study_id,is_preview:e.params.is_preview,is_pilot_run:e.is_pilot_run,pilot_label:e.pilot_label,prng_seed_uint32:e.prng_seed_uint32,schema_version:e.schema_version,build_id:e.build_id,dev_entry:"dev-main"}),console.info("[dev-main] session finished",e),console.info("[dev-main] data accessible at window.jsPsych.data.get()")}});window.jsPsych=o;const y={type:i,stimulus:`
...
//# sourceMappingURL=dev-main-B9Z21adR.js.map
