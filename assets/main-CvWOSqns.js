...
`;function bt(){const t="consent";let e=!1;const n={type:O,stimulus:Un,choices:["I consent — begin","I do not consent — exit"],button_html:(o,r)=>`<button class="jspsych-btn" data-idx="${r}"${r===0?" disabled":""}>${o}</button>`,on_load:()=>{e=!1;const o=document.getElementById("consent-checkbox"),r=document.querySelector('button.jspsych-btn[data-idx="0"]');!o||!r||o.addEventListener("change",()=>{e=o.checked,r.disabled=!o.checked})},on_finish:async o=>{o.consented=o.response===0,o.consent_acknowledged=e,o.consent_version=Wn,o.consented&&await gn()},data:{phase:"consent"}};return v(t,bt),b(n,t)}function Kn(){return{timeline:[{type:O,stimulus:`
          <h2>Thank you</h2>
...
`;function vt(){const t="demographics",e={type:X,preamble:`
      <h2>Demographics</h2>
    ...
    `,button_label:"Continue",data:{phase:"demographics"},on_finish:n=>{const o=n.response??{},r=o.date_of_birth;if(r){const l=new Date(r),u=new Date;let s=u.getFullYear()-l.getFullYear();const c=u.getMonth()-l.getMonth();(c<0||c===0&&u.getDate()<l.getDate())&&s--,n.computed_age=s,n.age_disqualified=s<wt||s>_t}else n.computed_age=null,n.age_disqualified=!1;const a=o.medication;n.medication_disqualified=a==="yes";const i=o.hearing;n.hearing_disqualified=i!=="no_impairment"&&i!==void 0&&i!=="",n.demographics_disqualified=n.age_disqualified||n.medication_disqualified||n.hearing_disqualified}};return v(t,vt),b(e,t)}function Qn(){const t=En(),e=In(t);return{timeline:[{type:O,stimulus:()=>{const n=window.jsPsych?.data?.get().filter({phase:"demographics"}).last(1).values()[0],o=n?.age_disqualified,r=n?.medication_disqualified,a=n?.hearing_disqualified,i=[];o&&i.push("be between "+wt+" and "+_t+" years of age"),a&&i.push("have normal hearing without impairment, as the study involves auditory stimuli that require accurate tone perception"),r&&i.push("not be currently taking medication that may affect attention, vision, or sensory processing");let l="";i.length===1?l="Our eligibility criteria require participants to "+i[0]+". Based on your response, you do not meet this requirement.":l="Our eligibility criteria require participants to "+i.slice(0,-1).join("; ")+"; and "+i[i.length-1]+". Based on your responses, you do not meet these requirements.";const u=e?'<p style="margin-top: 1rem; opacity: 0.7; font-size: 0.9em;">This is a test build. The Prolific redirect is not active.</p>':'<p style="margin-top: 1rem;">You will be redirected to Prolific in a few seconds.</p>';return'<div style="max-width: 36rem; margin: 0 auto; text-align: center;"><h2>Thank you for your interest</h2><p style="font-size: 1.05rem; line-height: 1.6;">'+l+'</p><p style="line-height: 1.6;">We sincerely appreciate your willingness to participate. Please return this study on Prolific so the slot can be made available to another participant.</p>'+u+"</div>"},choices:["Return to Prolific"],data:{phase:"demographics_disqualification"},on_finish:()=>{!e&&t&&(window.location.href=t),typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Participant disqualified at demographics screening.")}}],conditional_function:()=>window.jsPsych?.data?.get().filter({phase:"demographics"}).last(1).values()[0]?.demographics_disqualified===!0}}var Zn="2.1.0";const eo={name:"call-function",version:Zn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class be{constructor(e){this.jsPsych=e}static{this.info=eo}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{o=i,r()};n.func(a)}else o=n.func(),r()}}function to({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,i=[];return/\biphone\b/.test(r)&&i.push("iphone"),/\bipod\b/.test(r)&&i.push("ipod"),/\bipad\b/.test(r)&&i.push("ipad"),/macintosh/.test(r)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(r)&&i.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function no(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function oo(){return{type:be,async:!1,func:()=>to(no()),data:{phase:"desktop_gate"}}}function ro(){return{timeline:[{type:O,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Oe="display-colour-locked";function ao(){if(typeof document>"u")return!1;const t=document.documentElement;return t.classList.contains(Oe)?!1:(t.classList.add(Oe),!0)}function Pe(){return typeof document>"u"?!1:document.documentElement.classList.contains(Oe)}const Xe="display_mode_check",io=`
  <h2>Display check</h2>
...
`;function Tt(){const t={type:O,stimulus:ho,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),o=()=>{const r=parseInt(e.value,10);n.style.width=`${r}px`,n.style.height=`${r*(53.98/85.6)}px`};e.addEventListener("input",o),o()},on_finish:e=>{const n=document.getElementById("cc-slider"),o=n?parseInt(n.value,10):he,r=o/so;e.cc_px_width=o,e.px_per_mm=r,e.px_per_mm_in_bounds=r>=je&&r<=Le,e.px_per_mm_min=je,e.px_per_mm_max=Le,e.display_colour_locked=Pe(),document.documentElement.style.setProperty("--mm",`${r}px`)},data:{phase:"screen_calibration"}};return v(Qe,Tt),b(t,Qe)}function mo(){return{type:be,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=je&&t.px_per_mm<=Le),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function xt(){const t={type:O,stimulus:po,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Ze,xt),b(t,Ze)}function fo(t){return{timeline:[xt()],conditional_function:()=>t.count>=1}}function go({maxAttempts:t=uo}={}){const e={count:0};return{timeline:[fo(e),Tt(),mo(),yo(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function yo(t,e){return{type:be,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],o=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:o,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const bo="72vh",wo="#000",_o="50rem",vo="95vw",ko="72rem",Et=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${bo};
  color: ${wo};
`.replace(/\s+/g," ").trim(),It=`${Et} width: ${_o}; max-width: 94vw;`,To=`${Et} width: ${vo}; max-width: ${ko}; align-items: center;`,St=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim(),xo=`
  ...
  min-height: 0;
  width: 100%;
`.replace(/\s+/g," ").trim();function Ot({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${jt(n.trim())}"`:"";return`
    <div style="${`${It} min-height: auto; padding-top: 0.4rem; padding-bottom: 0.4rem; font-size: 0.95rem; line-height: 1.5;`}">
  ...
  `}const Be=50,L=Be/2,Pt=Be*Math.SQRT2/2+1,Ae=Pt-L+.5,ce=Be+2*Ae,et={cx:35,cy:15},tt={cx:15,cy:35},Eo=2.5,Io=2.5,nt=100,So=30,Oo=12,Po=12,jo=[1,2,3,7,10,11,12,13,14,17,21,22,23],de=10,Lo="#FFFFFF",Ao=.33;function No(t,e,n){const r=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:r,u=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(u)},${e+l*Math.sin(u)}`)}return a.join(" ")}const $o=No(tt.cx,tt.cy,Io),Co="rgba(0, 0, 0, 0.229)",Ro="rgba(0, 0, 0, 0.55)",ot="#000",rt="rgba(0, 0, 0, 0.85)";function Do(t,{arrowAngleDeg:e=So}={}){const n=new Set(t),o=n.has("tone")||n.has("qmark"),r=n.has("pattern"),a=`<circle cx="${L}" cy="${L}" r="${Pt}" fill="none" stroke="${Co}" stroke-width="0.5" />`,i=o||r?"":`<circle cx="${L}" cy="${L}" r="0.65" fill="${Ro}" />`,l=r?jo.map(f=>{const w=f%5,x=Math.floor(f/5),g=w*de,N=x*de;return`<rect x="${g}" y="${N}" width="${de}" height="${de}" fill="${Lo}" opacity="${Ao}" />`}).join(""):"",u=n.has("dot")?`<circle cx="${et.cx}" cy="${et.cy}" r="${Eo}" fill="${ot}" />`:"",s=n.has("star")?`<polygon points="${$o}" fill="${ot}" />`:"",c=n.has("tone")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${rt}" font-size="${Oo}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",d=n.has("qmark")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${rt}" font-size="${Po}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
  ...
  `}function zo(){return"./assets/rotation-arrow.png"}function k({title:t,body:e,narration:n,exemplar:o=[],arrowAngleDeg:r}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${jt(n.trim())}"`:"",i=Do(o,typeof r=="number"?{arrowAngleDeg:r}:{});return`
    <div style="${It} align-items: center;">
      <div style="${St}">
        <h2 style="${qe}">${t}</h2>
      </div>
  ...
  `}function jt(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Mo=Ot({title:"Sit comfortably for the study",body:`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Bo(){const t=b({type:O,stimulus:Mo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:O,stimulus:qo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function Lt(){const t="speaker_volume_instruction",e={type:O,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=Z;const l=Promise.resolve();We(Z/100);const u=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const g=Number(u.value);a=g,s&&(s.textContent=`${g}%`),We(g/100)});const c=document.getElementById("tac-yes-btn");if(c&&c.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await l,e)return;const d=yn(),h=ht(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+Ko)/1e3,f=Vo/1e3,w=[];for(let g=0;g<h.length;g++)w.push(document.getElementById(`tac-box-${g}`));let x=d.currentTime+Jo/1e3;try{for(let g=0;g<Xo&&!e;g++){r=g+1;for(let N=0;N<h.length&&!e;N++){const M=x;if(bn(N,{when:M}),await Te(d,M),e)break;const K=w[N];K&&K.classList.add("playing"),await Te(d,M+m),K&&K.classList.remove("playing"),x=M+_}e||(await Te(d,x+f),x+=f)}}catch{}if(!o&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{ut();const u=$e();u.current&&!u.current._state?.finished&&u.current.cancel(),l.tones_audible=o&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,$t),b(i,t)}function er(){return{timeline:[{type:O,stimulus:`
      ...
      `,narration:`After the dots, we test your memory ${t} times. Each time, a black dot appears for 3 seconds in some location. Press Yes, the right arrow, if a dot was shown in that location. Press No, the left arrow, if it was not. Keep your eyes on the centre of the circle throughout.`,exemplar:["qmark"]}),k({title:e,body:`
        ...
        ${Ct} for correct or
        ${Rt} for incorrect while it is still on screen.</p>
      `,narration:"You have 3 seconds for each test. Aim for accuracy first, but don't dwell. If you answer in time, the dot turns green for correct or red for incorrect while it is still on screen.",exemplar:["qmark"]})],o={type:re,pages:n,...Dt,data:{phase:"instructions_memory_d_only"}};return D(o.data.phase,zt),z(o)}function Mt(){const t=y.memory.set_size,e="Task 2 — Remember the tones",n=[k({title:e,body:`
      ...
      `,narration:`Then we play ${t} more tones, one at a time. For each one: Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. Keep your eyes on the centre of the circle and listen.`,exemplar:["qmark"]}),k({title:e,body:`
        ...
        set earlier.</p>
      `,narration:"You have 3 seconds for each test. If you answer in time, the central question mark turns green for correct or red for incorrect. Please make sure your audio volume is still at the level you set earlier.",exemplar:["tone"]})],o={type:re,pages:n,...Dt,data:{phase:"instructions_memory_t_only"}};return D(o.data.phase,Mt),z(o)}const rr=`<span style="color: ${Ce};"><strong>green</strong></span>`,ar=`<span style="color: ${Re};"><strong>red</strong></span>`,ir='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',sr=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function qt(){const t=y.imagery.stars_per_trial,e="Task 3 — Picture the pattern",n=[k({title:e,body:`
      ...
      `,narration:`Then ${t} bright stars will flash inside the circle, one at a time. For each star, decide whether it lands on the rotated pattern you are picturing. Press On-pattern, the right arrow, if the star falls on your pictured pattern. Press Not on-pattern, the left arrow, if it does not.`,exemplar:["star"]}),k({title:e,body:`
        ...
        your best.</p>
      `,narration:"You have 3 seconds for each star. Aim for accuracy first, but don't dwell. If you answer in time, the star turns green for correct or red for incorrect while it is still on screen. Be honest about your mental picture — if it's fuzzy, just do your best.",exemplar:["star"]})],o={type:re,pages:n,...sr,data:{phase:"instructions_imagery_i_only"}};return D(o.data.phase,qt),z(o)}const Bt=`<span style="color: ${Ce};"><strong>green</strong></span>`,Yt=`<span style="color: ${Re};"><strong>red</strong></span>`,Ht='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',Ft=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Gt(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,o="Task 4 — Dots and pattern together",r=[k({title:o,body:`
      ...
      `,narration:`Then ${n} things appear inside the circle one at a time, mixed together. ${e} stars — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} dots — remember which locations they appear in, for the dot tests at the end of the trial.`,exemplar:["star","dot"]}),k({title:o,body:`
        ...
        ${Bt} for correct or ${Yt} for incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the dot tests begin.",exemplar:["pattern"]})],a={type:re,pages:r,...Ft,data:{phase:"instructions_dual_i_d"}};return D(a.data.phase,Gt),z(a)}function Wt(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,o="Task 5 — Tones and pattern together",r=[k({title:o,body:`
      ...
      `,narration:`Then ${n} things happen one at a time, mixed together. ${e} stars inside the circle — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} tones — remember each tone you hear, for the tone tests at the end of the trial.`,exemplar:["star","tone"]}),k({title:o,body:`
        ...
        mark turns ${Bt} for correct or ${Yt} for
        incorrect.</p>
      `,narration:`After the ${n} things, we test your tone memory ${t} times. Each test plays a tone. Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. You have 3 seconds for each star and each tone test. If you answer in time, the star or central question mark turns green for correct or red for incorrect.`,exemplar:["qmark"]}),k({title:o,body:`
        ...
        <p>Please make sure your audio volume is still at the level you
        set earlier.</p>
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier.",exemplar:["pattern"]})],a={type:re,pages:r,...Ft,data:{phase:"instructions_dual_i_t"}};return D(a.data.phase,Wt),z(a)}const lr=4,Ut=1e3*lr,cr=2e3,dr=400,E=500,T=400,Y=1200,ur=700,hr=450,pr=220,H=1500,Ye=1e3,mr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function He(){return Ne().pick(mr)}const fr="./assets/rotation-arrow.png";function gr(t,e){return`
    <style>
  ...
  `}function tn(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:A,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
        ...
        ${P("Press <kbd>Space</kbd> to begin.")}
      </div>
    `,choices:[" "],data:{phase:"instructions_overview"}};return D(o.data.phase,tn),z(o)}function nn(){const t=Math.round(y.practice.accuracy_criterion*100),e={type:A,stimulus:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return v(t,rn),b(e,t)}function an(){const t=J.map(o=>{const r=o.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
    ...
    `,button_label:"Continue",on_finish:o=>{o.phase="music_experience",o.music_experience_responses=J.reduce((r,a)=>{const i=o.response?.[a.id];return r[a.id]=i===""||i===null||i===void 0?null:String(i),r},{})}};return v(e,an),b(n,e)}function qr(){return[rn(),an()]}function sn(){const t="questionnaire_intro",e={type:A,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,sn),b(e,t)}function Br(){return[sn(),...Mr(),...qr()]}function ln(){const t="main_a_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
        ...
        <div data-voiceover-target>
          ...
          what to expect.</p>
          ${P("Press <kbd>Space</kbd> to begin Block 1.")}
        </div>
      </div>
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{pt()}};return v(t,ln),b(e,t)}function cn(){const t="main_b_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
        ...
        <div data-voiceover-target>
          ...
          and 40.</p>
          ${P("Press <kbd>Space</kbd> to begin Block 2.")}
        </div>
      </div>
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,cn),b(e,t)}function dn(){const t="end_of_task_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{kn(),pt()}};return v(t,dn),b(e,t)}const S=mn(),Yr=Sn();function Hr(){if(ht(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}Hr();const we=fn({display_element:void 0,on_trial_start:Fn(),on_data_update:t=>{mt(t).catch(e=>{console.error("[runner] storage append failed",e),ft(e)})},on_finish:()=>{const t=we.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:S.params.session_id,prolific_pid:S.params.prolific_pid,study_id:S.params.study_id,is_preview:S.params.is_preview,is_pilot_run:S.is_pilot_run,pilot_label:S.pilot_label,prng_seed_uint32:S.prng_seed_uint32,schema_version:S.schema_version,build_id:S.build_id}),console.info("[runner] session",S,"visibility",Wo())}});window.jsPsych=we;new URLSearchParams(window.location.search).has("devnav")&&Gn(we);const dt=Tn(),Fr=[...tr(),...Cr(),ln(),...dt.mainA.nodes,xn({session:S}),cn(),...dt.mainB.nodes,dn(),...Br(),On({session:S}),Pn()];Yr.then(()=>we.run(Fr)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-CvWOSqns.js.map
