import"./modulepreload-polyfill-B5Qt9EMX.js";import{P as p,a as it,r as st,H as N,g as Pe,i as on,b as an,c as sn}from"./index-D84Ls8co.js";import{s as ee,a as lt,u as ln,g as ct,b as qe,c as cn,d as ut,p as un,e as Be,h as dn,f as hn,F as A,i as $,j as me,k as pn,n as dt,l as mn,m as fn,r as gn}from"./main-blocks-Coy6r1wb.js";import{c as y}from"./config-DmeTTinz.js";import{u as yn,c as bn}from"./debrief-17g16ZH3.js";import{c as wn,a as _n,s as I,b as ht,h as Te,d as fe,r as O,e as je,f as Le,g as Ne,i as vn,j as Ye,o as kn,k as Tn}from"./pattern-8GUrvjHu.js";var xn="2.1.0";const En={name:"html-button-response",version:xn,parameters:{stimulus:{type:p.HTML_STRING,default:void 0},choices:{type:p.STRING,default:void 0,array:!0},button_html:{type:p.FUNCTION,default:function(t,e){return`<button class="jspsych-btn">${t}</button>`}},prompt:{type:p.HTML_STRING,default:null},stimulus_duration:{type:p.INT,default:null},trial_duration:{type:p.INT,default:null},button_layout:{type:p.STRING,default:"grid"},grid_rows:{type:p.INT,default:1},grid_columns:{type:p.INT,default:null},response_ends_trial:{type:p.BOOL,default:!0},enable_button_after:{type:p.INT,default:0}},data:{rt:{type:p.INT},response:{type:p.INT},stimulus:{type:p.HTML_STRING}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class P{constructor(e){this.jsPsych=e}static{this.info=En}trial(e,n){const r=document.createElement("div");r.id="jspsych-html-button-response-stimulus",r.innerHTML=n.stimulus,e.appendChild(r);const o=document.createElement("div");if(o.id="jspsych-html-button-response-btngroup",n.button_layout==="grid"){if(o.classList.add("jspsych-btn-group-grid"),n.grid_rows===null&&n.grid_columns===null)throw new Error("You cannot set `grid_rows` to `null` without providing a value for `grid_columns`.");const c=n.grid_columns===null?Math.ceil(n.choices.length/n.grid_rows):n.grid_columns,h=n.grid_rows===null?Math.ceil(n.choices.length/n.grid_columns):n.grid_rows;o.style.gridTemplateColumns=`repeat(${c}, 1fr)`,o.style.gridTemplateRows=`repeat(${h}, 1fr)`}else n.button_layout==="flex"&&o.classList.add("jspsych-btn-group-flex");for(const[c,h]of n.choices.entries()){o.insertAdjacentHTML("beforeend",n.button_html(h,c));const m=o.lastChild;m.dataset.choice=c.toString(),m.addEventListener("click",()=>{d(c)})}e.appendChild(o),n.prompt!==null&&e.insertAdjacentHTML("beforeend",n.prompt);var a=performance.now(),i={rt:null,button:null};const l=()=>{var c={rt:i.rt,stimulus:n.stimulus,response:i.button};this.jsPsych.finishTrial(c)};function d(c){var h=performance.now(),m=Math.round(h-a);i.button=parseInt(c),i.rt=m,r.classList.add("responded");for(const _ of o.children)_.setAttribute("disabled","disabled");n.response_ends_trial&&l()}if(n.stimulus_duration!==null&&this.jsPsych.pluginAPI.setTimeout(()=>{r.style.visibility="hidden"},n.stimulus_duration),n.enable_button_after>0){for(var s=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),u=0;u<s.length;u++)s[u].setAttribute("disabled","disabled");this.jsPsych.pluginAPI.setTimeout(()=>{for(var c=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),h=0;h<c.length;h++)c[h].removeAttribute("disabled")},n.enable_button_after)}n.trial_duration!==null&&this.jsPsych.pluginAPI.setTimeout(l,n.trial_duration)}simulate(e,n,r,o){n=="data-only"&&(o(),this.simulate_data_only(e,r)),n=="visual"&&this.simulate_visual(e,r,o)}create_simulation_data(e,n){const r={stimulus:e.stimulus,rt:this.jsPsych.randomization.sampleExGaussian(500,50,.006666666666666667,!0)+e.enable_button_after,response:this.jsPsych.randomization.randomInt(0,e.choices.length-1)},o=this.jsPsych.pluginAPI.mergeSimulationData(r,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,o),o}simulate_data_only(e,n){const r=this.create_simulation_data(e,n);this.jsPsych.finishTrial(r)}simulate_visual(e,n,r){const o=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),r(),o.rt!==null&&this.jsPsych.pluginAPI.clickTarget(a.querySelector(`#jspsych-html-button-response-btngroup [data-choice="${o.response}"]`),o.rt)}}let Fe=!1,D=[];const xe=new Map;let te=!1,Ee=!1;function In(t){!t||typeof t!="string"||D[D.length-1]!==t&&(D.push(t),D.length>32&&D.shift())}function pt(t){const e=typeof t?.data=="function"?null:t?.data??null;return typeof e?.phase=="string"?e.phase:null}function Sn(t,e){return t&&typeof t=="object"&&typeof t!="function"?{...t,hidden_nav_step:e}:(...n)=>({...typeof t=="function"?t(...n):{},hidden_nav_step:e})}function k(t,e){!t||typeof t!="string"||typeof e!="function"||xe.set(t,e)}function w(t,e=pt(t)){if(!e||typeof e!="string")return t;const n=t?.on_load;return t.data=Sn(t?.data,e),t._hidden_nav_checkpoint=!0,t.on_load=(...r)=>{In(e),n?.(...r)},t}function G(t,e){k(t,e)}function W(t){return w(t,pt(t))}function On(){const t=Ee;return Ee=!1,t}function Pn(t){const e=t?.timeline?.getLatestNode?.();return e&&typeof e.getDataParameter=="function"?e:null}function jn(t){try{const e=Pn(t);if(!e)return null;const n=e.getDataParameter?.()??{},r=typeof n.hidden_nav_step=="string"?n.hidden_nav_step:null;return{node:e,stepId:r,phase:typeof n.phase=="string"?n.phase:null}}catch{return null}}function Ln(t){const e=t?.description?.type?.info?.name??null;return e==="html-button-response"?{response:0}:e==="survey-html-form"?{response:{}}:{}}function Nn(t){const e=D.slice();if(t)for(;e[e.length-1]===t;)e.pop();return{trimmedHistory:e,prevStepId:e[e.length-1]??null}}function He(t,e){const n=t?.parent?.description?.timeline;if(!Array.isArray(n))return!1;const r=n.indexOf(t.description);return r<0?!1:(n.splice(r+1,0,...e),!0)}function An(){return function(e){if(e?._hidden_nav_checkpoint===!0){te&&(te=!1),ee(!1);return}if(!te){ee(!1);return}!e||typeof e!="object"||(e.trial_duration=0,e.choices="NO_KEYS")}}function $n(t){if(Fe||typeof document>"u")return;const e=n=>{const r=n.target&&n.target.tagName||"";if(r==="INPUT"||r==="TEXTAREA"||n.target?.isContentEditable||n.metaKey||n.ctrlKey||n.altKey)return;const o=n.key?.toLowerCase?.();if(o!=="u"&&o!=="r")return;const a=jn(t);if(!a)return;n.preventDefault(),n.stopPropagation(),lt();const i=Ln(a.node),l=!!a.stepId;if(o==="u"){Ee=!0,l||(te=!0),ee(!0),t.finishTrial({...i,phase:a.phase,hidden_nav:"forward",hidden_nav_step:a.stepId??null});return}const{trimmedHistory:d,prevStepId:s}=Nn(a.stepId),u=s?xe.get(s):null;if(!u)return;let c=!1;if(l){const h=xe.get(a.stepId);if(!h)return;c=He(a.node,[u(),h()])}else c=He(a.node,[u()]);c&&(D=d,te=!1,l?ee(!1):ee(!0),t.finishTrial({...i,phase:a.phase,hidden_nav:"back",hidden_nav_step:a.stepId??null,hidden_nav_target_step:s}))};document.addEventListener("keydown",e,!0),Fe=!0}const Rn="online-2101803-v1",Cn=`
...
`;function mt(){const t="consent";let e=!1;const n={type:P,stimulus:Cn,choices:["I consent — begin","I do not consent — exit"],button_html:(r,o)=>`<button class="jspsych-btn" data-idx="${o}"${o===0?" disabled":""}>${r}</button>`,on_load:()=>{e=!1;const r=document.getElementById("consent-checkbox"),o=document.querySelector('button.jspsych-btn[data-idx="0"]');!r||!o||r.addEventListener("change",()=>{e=r.checked,o.disabled=!r.checked})},on_finish:async r=>{r.consented=r.response===0,r.consent_acknowledged=e,r.consent_version=Rn,r.consented&&await ln()},data:{phase:"consent"}};return k(t,mt),w(n,t)}function Dn(){return{timeline:[{type:P,stimulus:`
          <h2>Thank you</h2>
...
`;function ft(){const t="demographics",e={type:J,preamble:`
    ...
    `,button_label:"Continue",data:{phase:"demographics"}};return k(t,ft),w(e,t)}var Bn="2.1.0";const Yn={name:"call-function",version:Bn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class be{constructor(e){this.jsPsych=e}static{this.info=Yn}trial(e,n){let r;const o=()=>{const a={value:r};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{r=i,o()};n.func(a)}else r=n.func(),o()}}function Fn({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:r=0}={}){const o=String(t).toLowerCase(),a=Number.isFinite(r)?r:0,i=[];return/\biphone\b/.test(o)&&i.push("iphone"),/\bipod\b/.test(o)&&i.push("ipod"),/\bipad\b/.test(o)&&i.push("ipad"),/macintosh/.test(o)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(o)&&i.push("android"),/mobile/.test(o)&&!/iphone|ipad|ipod|android/.test(o)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Hn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const r=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:r}}function Gn(){return{type:be,async:!1,func:()=>Fn(Hn()),data:{phase:"desktop_gate"}}}function Wn(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Un=85.6,Ie=1.5,Se=12,Kn=100,Vn=1100,he=320,Jn=2,Ge="screen_calibration",We="screen_calibration_retry_hint",Xn=`
  ...
  <input id="cc-slider" type="range" min="${Kn}" max="${Vn}" value="${he}"
...
`;function gt(){const t={type:P,stimulus:Xn,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),r=()=>{const o=parseInt(e.value,10);n.style.width=`${o}px`,n.style.height=`${o*(53.98/85.6)}px`};e.addEventListener("input",r),r()},on_finish:e=>{const n=document.getElementById("cc-slider"),r=n?parseInt(n.value,10):he,o=r/Un;e.cc_px_width=r,e.px_per_mm=o,e.px_per_mm_in_bounds=o>=Ie&&o<=Se,e.px_per_mm_min=Ie,e.px_per_mm_max=Se,document.documentElement.style.setProperty("--mm",`${o}px`)},data:{phase:"screen_calibration"}};return k(Ge,gt),w(t,Ge)}function Zn(){return{type:be,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=Ie&&t.px_per_mm<=Se),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function yt(){const t={type:P,stimulus:Qn,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return k(We,yt),w(t,We)}function er(t){return{timeline:[yt()],conditional_function:()=>t.count>=1}}function tr({maxAttempts:t=Jn}={}){const e={count:0};return{timeline:[er(e),gt(),Zn(),nr(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function nr(t,e){return{type:be,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],r=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:r,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const rr="72vh",or="#000",ar="50rem",ir="95vw",sr="72rem",bt=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${rr};
  color: ${or};
`.replace(/\s+/g," ").trim(),wt=`${bt} width: ${ar}; max-width: 94vw;`,lr=`${bt} width: ${ir}; max-width: ${sr}; align-items: center;`,_t=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim();function vt({title:t,body:e,narration:n}){const r=typeof n=="string"&&n.trim()?` data-voiceover-script="${Tt(n.trim())}"`:"";return`
    <div style="${`${wt} min-height: auto; padding-top: 0.4rem; padding-bottom: 0.4rem; font-size: 0.95rem; line-height: 1.5;`}">
      ...
      <div style="${cr}" data-voiceover-target${r}>${e}</div>
    </div>
  `}const $e=50,j=$e/2,kt=$e*Math.SQRT2/2+1,Oe=kt-j+.5,ce=$e+2*Oe,Ue={cx:35,cy:15},Ke={cx:15,cy:35},ur=2.5,dr=2.5,Ve=100,hr=30,pr=12,mr=12,fr=[1,2,3,7,10,11,12,13,14,17,21,22,23],ue=10,gr="#FFFFFF",yr=.33;function br(t,e,n){const o=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:o,d=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(d)},${e+l*Math.sin(d)}`)}return a.join(" ")}const wr=br(Ke.cx,Ke.cy,dr),_r="rgba(0, 0, 0, 0.229)",vr="rgba(0, 0, 0, 0.55)",Je="#000",Xe="rgba(0, 0, 0, 0.85)";function kr(t,{arrowAngleDeg:e=hr}={}){const n=new Set(t),r=n.has("tone")||n.has("qmark"),o=n.has("pattern"),a=`<circle cx="${j}" cy="${j}" r="${kt}" fill="none" stroke="${_r}" stroke-width="0.5" />`,i=r||o?"":`<circle cx="${j}" cy="${j}" r="0.65" fill="${vr}" />`,l=o?fr.map(f=>{const b=f%5,x=Math.floor(f/5),g=b*ue,L=x*ue;return`<rect x="${g}" y="${L}" width="${ue}" height="${ue}" fill="${gr}" opacity="${yr}" />`}).join(""):"",d=n.has("dot")?`<circle cx="${Ue.cx}" cy="${Ue.cy}" r="${ur}" fill="${Je}" />`:"",s=n.has("star")?`<polygon points="${wr}" fill="${Je}" />`:"",u=n.has("tone")?`<text x="${j}" y="${j}" text-anchor="middle" dominant-baseline="central" fill="${Xe}" font-size="${pr}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",c=n.has("qmark")?`<text x="${j}" y="${j}" text-anchor="middle" dominant-baseline="central" fill="${Xe}" font-size="${mr}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
    <svg viewBox="${-Oe} ${-Oe} ${ce} ${ce}"
         width="100%" height="100%" style="display: block; overflow: visible;">
      ${a}${l}${i}${d}${s}${u}${c}
    </svg>
  `,m=(e/360).toFixed(6),_=n.has("arrow")?`<img src="${Tr()}" alt="rotation cue"
  ...
  `}function Tr(){return"./assets/rotation-arrow.png"}function v({title:t,body:e,narration:n,exemplar:r=[],arrowAngleDeg:o}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${Tt(n.trim())}"`:"",i=kr(r,typeof o=="number"?{arrowAngleDeg:o}:{});return`
  ...
  `}function Tt(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const xr=vt({title:"Sit comfortably for the study",body:`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Ir(){const t=w({type:P,stimulus:xr,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=w({type:P,stimulus:Er,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function xt(){const t="speaker_volume_instruction",e={type:P,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,r=!1,o=0,a=Q;const l=Promise.resolve();qe(Q/100);const d=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");d&&d.addEventListener("input",()=>{const g=Number(d.value);a=g,s&&(s.textContent=`${g}%`),qe(g/100)});const u=document.getElementById("tac-yes-btn");if(u&&u.addEventListener("click",()=>{n||(r=!0),e=!0},{capture:!0}),await l,e)return;const c=cn(),h=ut(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+Ar)/1e3,f=$r/1e3,b=[];for(let g=0;g<h.length;g++)b.push(document.getElementById(`tac-box-${g}`));let x=c.currentTime+Rr/1e3;try{for(let g=0;g<Cr&&!e;g++){o=g+1;for(let L=0;L<h.length&&!e;L++){const C=x;if(un(L,{when:C}),await ve(c,C),e)break;const U=b[L];U&&U.classList.add("playing"),await ve(c,C+m),U&&U.classList.remove("playing"),x=C+_}e||(await ve(c,x+f),x+=f)}}catch{}if(!r&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{lt();const d=ct();d.current&&!d.current._state?.finished&&d.current.cancel(),l.tones_audible=r&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=o},data:{phase:"tone_audibility_and_comfort"}};return k(t,St),w(i,t)}function zr(){return{timeline:[{type:P,stimulus:`
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 5 demonstration.",exemplar:["pattern"]})],a={type:re,pages:o,...Dt,data:{phase:"instructions_dual_i_t"}};return G(a.data.phase,zt),W(a)}const Ur=4,qt=1e3*Ur,Kr=2e3,Vr=400,E=500,T=400,z=1200,Jr=700,et=450,Xr=220,q=1500,Re=1e3,Qr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function Ce(){return Pe().pick(Qr)}const Zr="./assets/rotation-arrow.png";function eo(t,e){return`
    <style>
  ...
  `}function to(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const r=dn(e);r?(hn(),t.currentNarration=ct().speak(r)):t.currentNarration=null},async wait(e){return await Be(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let r=!1;const o=()=>{r||(r=!0,n())};e.done.then(o).catch(o);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),o())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await Be(Vr),t.cancelled)?!1:(this.setCaption(e),!0)},async narrate(e){return!(!await this.advanceCaption(e)||!await this.awaitNarration())}}}function no(t,e){const n=y.imagery.rotation_arrow_size_px,r=document.createElement("img");return r.src=Zr,r.alt="rotation cue",r.className="rotation-arrow-cue demo-arrow",r.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none","filter: brightness(0) saturate(100%)"].join("; ")+";"),t.wrapper.appendChild(r),r}function de(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function De(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),vn(t),Ye(t),!await e.awaitNarration()||!await e.wait(1e3)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;Te(t);const i=no(t,n);return!await e.awaitNarration()||!await e.wait(600)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(de(i),!1):(de(i),ht(t,n),Ye(t),!await e.awaitNarration()||!await e.wait(1500)?!1:(Te(t),!0))}function oe(){const t=kn(),e=Tn();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function B({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `;const r=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${r} Click the button below to watch it again. When you are ready to start the practice, press the <kbd>Space</kbd> key.`)?new Promise(o=>{let a=!1;const i=s=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(c=>c.removeEventListener("click",l)),o(s)},l=s=>{const u=s.currentTarget.getAttribute("data-side");i(u==="right")};n.querySelectorAll(".demo-replay-btn").forEach(s=>s.addEventListener("click",l));const d=setInterval(()=>{t.state.cancelled&&(clearInterval(d),i(!1)),a&&clearInterval(d)},100)}):!1}function ie(t){return async function(n,r){let o=0;for(;!r.state.cancelled;){try{await t(n,r)}catch(l){console.error("[demo] mini-trial error",l);return}if(r.state.cancelled)return;r.state.spaceArmed=!0;const a=lo-o;if(a<=0){if(Bt(),!await r.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;M();return}if(!await co(r,a)){await r.advanceCaption("Press Space when you are ready to start the practice."),M();return}o+=1;try{_n(n),M(),I(n,""),n.rotor.style.transition="",ht(n,0),Te(n)}catch{}if(!await r.advanceCaption("Replaying the demonstration…")||!await r.wait(Kr))return}}}const uo=ie(ro),ho=ie(oo),po=ie(ao),mo=ie(io),fo=ie(so);function se({phase:t,taskNumber:e,title:n,run:r,factory:o}){const a={type:N,stimulus:eo(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const i=document.getElementById("demo-mount");if(!i)return;const l=wn({rotation_deg:0,fixation:"",background_shade:"gray"});i.appendChild(l.wrapper);const d=to(),s=window.jsPsych?.getCurrentTrial?.();s&&typeof s=="object"&&(s._demo_state=d.state);let u=!0;const c=h=>{if(u){if(h.key==="ArrowLeft"||h.key==="ArrowRight"){h.preventDefault(),h.stopPropagation();return}if(h.key===" "||h.code==="Space"){if(h.preventDefault(),h.stopPropagation(),!d.state.spaceArmed)return;u=!1,document.removeEventListener("keydown",c,!0),d.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",c,!0),s&&typeof s=="object"&&(s._demo_keydown_handler=c),r(l,d).catch(h=>{console.error(`[demo:${t}] schedule error`,h)})},on_finish:()=>{const i=window.jsPsych?.getCurrentTrial?.();i?._demo_state&&(i._demo_state.cancelled=!0),i?._demo_keydown_handler&&(document.removeEventListener("keydown",i._demo_keydown_handler,!0),i._demo_keydown_handler=null)},data:{phase:t}};return G(t,o),W(a)}function Yt(){return se({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:uo,factory:Yt})}function Ft(){return se({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:ho,factory:Ft})}function Ht(){return se({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:po,factory:Ht})}function Gt(){return se({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:mo,factory:Gt})}function Wt(){return se({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:fo,factory:Wt})}const ke=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function nt(t){return typeof t!="string"?"":t.trim().toLowerCase()}function pe(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:J,preamble:"<h2>Quick check</h2>",html:`
    ...
    `,button_label:"Continue",on_finish:r=>{const o=r.response?.response??"",a=nt(o);r.attention_check_id=t.id,r.attention_check_raw=o,r.attention_check_passed=a===nt(t.expected_answer)},data:{phase:"attention_check"}};return k(e,()=>pe(t)),w(n,e)}function go(t,e=y.attention_checks.instruction_max_failures){const n=(t??[]).filter(a=>a?.phase==="attention_check"),r=n.filter(a=>a.attention_check_passed===!0).length,o=n.filter(a=>a.attention_check_passed===!1).length;return{total:n.length,passed:r,failed:o,exceededThreshold:o>e,threshold:e,ids:n.map(a=>a.attention_check_id)}}function Ut(){const t="attention_check_summary",e={type:J,preamble:"<h2>Thanks — moving on.</h2>",html:`
      <div style="max-width: 36rem; margin: 0 auto;">
        <p>Press <strong>Continue</strong> to proceed to the main task.</p>
      </div>
    `,button_label:"Continue",on_finish:n=>{const r=window.jsPsych?.data?.get().values()??[],o=go(r);n.phase="attention_check_summary",n.attention_total=o.total,n.attention_passed=o.passed,n.attention_failed=o.failed,n.attention_excluded=o.exceededThreshold,n.attention_threshold=o.threshold}};return k(t,Ut),w(e,t)}const rt=Object.freeze(["d_only","t_only","i_only","i_d","i_t"]);function ot(t){let e=0,n=0;for(const r of t)typeof r.probe_correct=="boolean"&&(n+=1,r.probe_correct&&(e+=1)),typeof r.star_correct=="boolean"&&(n+=1,r.star_correct&&(e+=1));return{correct:e,total:n,accuracy:n>0?e/n:0}}function Z({trialType:t,trialsPerType:e,sequencePoolLabelPrefix:n,prng:r}={}){if(!rt.includes(t))throw new Error(`singleTypePractice: unknown trialType '${t}'; expected one of ${rt.join(", ")}`);const o=e??y.blocks.practice_trials_per_type,a=r??Pe(),i=pn({blockLabel:"practice",countsByType:{[t]:o},sequencePoolLabelPrefix:n??"practice",runLengthCap:Math.max(1,o),prng:a});return{schedule:i.schedule,trialParams:i.trialParams,nodes:i.nodes}}function yo({acc:t,passed:e,willRetry:n,criterion:r}){return bo({acc:t,passed:e,willRetry:n,criterion:r})}function bo({acc:t,passed:e,willRetry:n,criterion:r}){const o=Math.round(t.accuracy*100),a=Math.round(r*100),i=e?'<h2 style="color:#0a7c4d;">Practice complete</h2>':'<h2 style="color:#b3261e;">Practice — keep going</h2>',l=e?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
  ...
  `}function Kt(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),r={type:N,stimulus:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return k(t,Jt),w(e,t)}function Xt(){const t=V.map(r=>{const o=r.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
    ...
    `,button_label:"Continue",on_finish:r=>{r.phase="music_experience",r.music_experience_responses=V.reduce((o,a)=>{const i=r.response?.[a.id];return o[a.id]=i===""||i===null||i===void 0?null:String(i),o},{})}};return k(e,Xt),w(n,e)}function xo(){return[Jt(),Xt()]}function Qt(){const t="questionnaire_intro",e={type:N,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return k(t,Qt),w(e,t)}function Eo(){return[Qt(),...To(),...xo()]}function Zt(){const t="main_a_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{dt()}};return k(t,Zt),w(e,t)}function en(){const t="main_b_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return k(t,en),w(e,t)}function tn(){const t="end_of_task_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{mn(),dt()}};return k(t,tn),w(e,t)}const S=on(),Io=an();function So(){if(ut(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}So();const we=sn({display_element:void 0,on_trial_start:An(),on_data_update:t=>{it(t).catch(e=>{console.error("[runner] storage append failed",e),st(e)})},on_finish:()=>{const t=we.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:S.params.session_id,prolific_pid:S.params.prolific_pid,study_id:S.params.study_id,is_preview:S.params.is_preview,is_pilot_run:S.is_pilot_run,pilot_label:S.pilot_label,prng_seed_uint32:S.prng_seed_uint32,schema_version:S.schema_version,build_id:S.build_id}),console.info("[runner] session",S,"visibility",Lr())}});window.jsPsych=we;$n(we);const at=fn(),Oo=[...qr(),...wo(),Zt(),...at.mainA.nodes,gn(),en(),...at.mainB.nodes,tn(),...Eo(),yn({session:S}),bn()];Io.then(()=>we.run(Oo)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-BqwO_S5q.js.map
