...
`;function bt(){const t="consent";let e=!1;const n={type:O,stimulus:Yn,choices:["I consent — begin","I do not consent — exit"],button_html:(r,o)=>`<button class="jspsych-btn" data-idx="${o}"${o===0?" disabled":""}>${r}</button>`,on_load:()=>{e=!1;const r=document.getElementById("consent-checkbox"),o=document.querySelector('button.jspsych-btn[data-idx="0"]');!r||!o||r.addEventListener("change",()=>{e=r.checked,o.disabled=!r.checked})},on_finish:async r=>{r.consented=r.response===0,r.consent_acknowledged=e,r.consent_version=Bn,r.consented&&await mn()},data:{phase:"consent"}};return v(t,bt),b(n,t)}function Hn(){return{timeline:[{type:O,stimulus:`
          <h2>Thank you</h2>
...
`;function wt(){const t="demographics",e={type:X,preamble:`
    ...
    `,button_label:"Continue",data:{phase:"demographics"}};return v(t,wt),b(e,t)}var Un="2.1.0";const Kn={name:"call-function",version:Un,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class be{constructor(e){this.jsPsych=e}static{this.info=Kn}trial(e,n){let r;const o=()=>{const a={value:r};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{r=i,o()};n.func(a)}else r=n.func(),o()}}function Vn({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:r=0}={}){const o=String(t).toLowerCase(),a=Number.isFinite(r)?r:0,i=[];return/\biphone\b/.test(o)&&i.push("iphone"),/\bipod\b/.test(o)&&i.push("ipod"),/\bipad\b/.test(o)&&i.push("ipad"),/macintosh/.test(o)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(o)&&i.push("android"),/mobile/.test(o)&&!/iphone|ipad|ipod|android/.test(o)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Jn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const r=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:r}}function Xn(){return{type:be,async:!1,func:()=>Vn(Jn()),data:{phase:"desktop_gate"}}}function Qn(){return{timeline:[{type:O,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Oe="display-colour-locked";function Zn(){if(typeof document>"u")return!1;const t=document.documentElement;return t.classList.contains(Oe)?!1:(t.classList.add(Oe),!0)}function Pe(){return typeof document>"u"?!1:document.documentElement.classList.contains(Oe)}const Xe="display_mode_check",er=`
  <h2>Display check</h2>
...
`;function _t(){const t={type:O,stimulus:er,choices:["Continue"],button_html:(e,n)=>`<button class="jspsych-btn" data-idx="${n}" disabled aria-disabled="true" style="opacity: 0.55; cursor: not-allowed;">${e}</button>`,on_load:()=>{const e=document.getElementById("display-colour-lock-btn"),n=document.getElementById("display-colour-lock-status"),r=document.getElementById("display-mode-gate-hint"),o=document.querySelector('button.jspsych-btn[data-idx="0"]'),a=()=>{o&&(o.disabled=!1,o.setAttribute("aria-disabled","false"),o.style.opacity="",o.style.cursor=""),r&&(r.style.display="none")},i=()=>{e&&(e.disabled=!0,e.setAttribute("aria-disabled","true"),e.style.opacity="0.55",e.style.cursor="default",e.textContent="Light mode forced"),n&&(n.style.visibility="visible"),a(),o&&typeof o.focus=="function"&&o.focus()};Pe()?i():e&&e.addEventListener("click",()=>{Zn(),i()})},on_finish:e=>{e.display_colour_locked=Pe()},data:{phase:"display_mode_check"}};return v(Xe,_t),b(t,Xe)}const tr=85.6,je=1.5,Le=12,nr=100,rr=1100,he=320,or=2,Qe="screen_calibration",Ze="screen_calibration_retry_hint",ar=`
  ...
  <input id="cc-slider" type="range" min="${nr}" max="${rr}" value="${he}"
...
`;function vt(){const t={type:O,stimulus:ar,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),r=()=>{const o=parseInt(e.value,10);n.style.width=`${o}px`,n.style.height=`${o*(53.98/85.6)}px`};e.addEventListener("input",r),r()},on_finish:e=>{const n=document.getElementById("cc-slider"),r=n?parseInt(n.value,10):he,o=r/tr;e.cc_px_width=r,e.px_per_mm=o,e.px_per_mm_in_bounds=o>=je&&o<=Le,e.px_per_mm_min=je,e.px_per_mm_max=Le,e.display_colour_locked=Pe(),document.documentElement.style.setProperty("--mm",`${o}px`)},data:{phase:"screen_calibration"}};return v(Qe,vt),b(t,Qe)}function sr(){return{type:be,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=je&&t.px_per_mm<=Le),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function kt(){const t={type:O,stimulus:ir,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Ze,kt),b(t,Ze)}function lr(t){return{timeline:[kt()],conditional_function:()=>t.count>=1}}function cr({maxAttempts:t=or}={}){const e={count:0};return{timeline:[lr(e),vt(),sr(),dr(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function dr(t,e){return{type:be,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],r=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:r,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const ur="72vh",hr="#000",pr="50rem",mr="95vw",fr="72rem",Tt=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${ur};
  color: ${hr};
`.replace(/\s+/g," ").trim(),xt=`${Tt} width: ${pr}; max-width: 94vw;`,gr=`${Tt} width: ${mr}; max-width: ${fr}; align-items: center;`,Et=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim(),yr=`
  ...
  min-height: 0;
  width: 100%;
`.replace(/\s+/g," ").trim();function It({title:t,body:e,narration:n}){const r=typeof n=="string"&&n.trim()?` data-voiceover-script="${Ot(n.trim())}"`:"";return`
    <div style="${`${xt} min-height: auto; padding-top: 0.4rem; padding-bottom: 0.4rem; font-size: 0.95rem; line-height: 1.5;`}">
      ...
      <div style="${yr}" data-voiceover-target${r}>${e}</div>
    </div>
  `}const Be=50,j=Be/2,St=Be*Math.SQRT2/2+1,Ne=St-j+.5,ce=Be+2*Ne,et={cx:35,cy:15},tt={cx:15,cy:35},br=2.5,wr=2.5,nt=100,_r=30,vr=12,kr=12,Tr=[1,2,3,7,10,11,12,13,14,17,21,22,23],de=10,xr="#FFFFFF",Er=.33;function Ir(t,e,n){const o=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:o,u=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(u)},${e+l*Math.sin(u)}`)}return a.join(" ")}const Sr=Ir(tt.cx,tt.cy,wr),Or="rgba(0, 0, 0, 0.229)",Pr="rgba(0, 0, 0, 0.55)",rt="#000",ot="rgba(0, 0, 0, 0.85)";function jr(t,{arrowAngleDeg:e=_r}={}){const n=new Set(t),r=n.has("tone")||n.has("qmark"),o=n.has("pattern"),a=`<circle cx="${j}" cy="${j}" r="${St}" fill="none" stroke="${Or}" stroke-width="0.5" />`,i=r||o?"":`<circle cx="${j}" cy="${j}" r="0.65" fill="${Pr}" />`,l=o?Tr.map(f=>{const w=f%5,x=Math.floor(f/5),g=w*de,N=x*de;return`<rect x="${g}" y="${N}" width="${de}" height="${de}" fill="${xr}" opacity="${Er}" />`}).join(""):"",u=n.has("dot")?`<circle cx="${et.cx}" cy="${et.cy}" r="${br}" fill="${rt}" />`:"",s=n.has("star")?`<polygon points="${Sr}" fill="${rt}" />`:"",d=n.has("tone")?`<text x="${j}" y="${j}" text-anchor="middle" dominant-baseline="central" fill="${ot}" font-size="${vr}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",c=n.has("qmark")?`<text x="${j}" y="${j}" text-anchor="middle" dominant-baseline="central" fill="${ot}" font-size="${kr}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
    <svg viewBox="${-Ne} ${-Ne} ${ce} ${ce}"
         width="100%" height="100%" style="display: block; overflow: visible;">
      ${a}${l}${i}${u}${s}${d}${c}
    </svg>
  `,m=(e/360).toFixed(6),_=n.has("arrow")?`<img src="${Lr()}" alt="rotation cue"
  ...
  `}function Lr(){return"./assets/rotation-arrow.png"}function k({title:t,body:e,narration:n,exemplar:r=[],arrowAngleDeg:o}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${Ot(n.trim())}"`:"",i=jr(r,typeof o=="number"?{arrowAngleDeg:o}:{});return`
  ...
  `}function Ot(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Nr=It({title:"Sit comfortably for the study",body:`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function $r(){const t=b({type:O,stimulus:Nr,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:O,stimulus:Ar,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function Pt(){const t="speaker_volume_instruction",e={type:O,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,r=!1,o=0,a=Z;const l=Promise.resolve();We(Z/100);const u=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const g=Number(u.value);a=g,s&&(s.textContent=`${g}%`),We(g/100)});const d=document.getElementById("tac-yes-btn");if(d&&d.addEventListener("click",()=>{n||(r=!0),e=!0},{capture:!0}),await l,e)return;const c=fn(),h=mt(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+Br)/1e3,f=Yr/1e3,w=[];for(let g=0;g<h.length;g++)w.push(document.getElementById(`tac-box-${g}`));let x=c.currentTime+Hr/1e3;try{for(let g=0;g<Fr&&!e;g++){o=g+1;for(let N=0;N<h.length&&!e;N++){const D=x;if(gn(N,{when:D}),await Te(c,D),e)break;const K=w[N];K&&K.classList.add("playing"),await Te(c,D+m),K&&K.classList.remove("playing"),x=D+_}e||(await Te(c,x+f),x+=f)}}catch{}if(!r&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{pt();const u=$e();u.current&&!u.current._state?.finished&&u.current.cancel(),l.tones_audible=r&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=o},data:{phase:"tone_audibility_and_comfort"}};return v(t,Nt),b(i,t)}function Ur(){return{timeline:[{type:O,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"tone_audibility_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Tone audibility failed.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"tone_audibility_and_comfort"}).last(1).values()[0];return t?t.tones_audible===!1:!1}}}function Kr(){return[Xn(),Qn(),bt(),Hn(),wt(),$r(),_t(),cr(),Pt(),Lt(),qr(),Nt(),Ur()]}var Vr="2.1.0";const Jr={name:"instructions",version:Vr,parameters:{pages:{type:p.HTML_STRING,default:void 0,array:!0},key_forward:{type:p.KEY,default:"ArrowRight"},key_backward:{type:p.KEY,default:"ArrowLeft"},allow_backward:{type:p.BOOL,default:!0},allow_keys:{type:p.BOOL,default:!0},show_clickable_nav:{type:p.BOOL,default:!1},show_page_number:{type:p.BOOL,default:!1},page_label:{type:p.STRING,default:"Page"},button_label_previous:{type:p.STRING,default:"Previous"},button_label_next:{type:p.STRING,default:"Next"},on_page_change:{type:p.FUNCTION,pretty_name:"Page change callback",default:function(t){}}},data:{view_history:{type:p.COMPLEX,array:!0,nested:{page_index:{type:p.INT},viewing_time:{type:p.INT}}},rt:{type:p.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class oe{constructor(e){this.jsPsych=e}static{this.info=Jr}trial(e,n){var r=0,o=[],a=performance.now(),i=a;function l(){this.id==="jspsych-instructions-back"?d():this.id==="jspsych-instructions-next"&&s()}function u(){var f=n.pages[r],w="";if(n.show_page_number&&(w="<span style='margin: 0 1em;' class='jspsych-instructions-pagenum'>"+n.page_label+" "+(r+1)+"/"+n.pages.length+"</span>"),n.show_clickable_nav){var x="<div class='jspsych-instructions-nav' style='padding: 10px 0px;'>";if(n.allow_backward){var g=r>0?"":"disabled='disabled'";x+="<button id='jspsych-instructions-back' class='jspsych-btn' style='margin-right: 5px;' "+g+">&lt; "+n.button_label_previous+"</button>"}n.pages.length>1&&n.show_page_number&&(x+=w),x+="<button id='jspsych-instructions-next' class='jspsych-btn'style='margin-left: 5px;'>"+n.button_label_next+" &gt;</button></div>",f+=x,e.innerHTML=f,r!=0&&n.allow_backward&&e.querySelector("#jspsych-instructions-back").addEventListener("click",l,{once:!0}),e.querySelector("#jspsych-instructions-next").addEventListener("click",l,{once:!0})}else n.show_page_number&&n.pages.length>1&&(f+="<div class='jspsych-instructions-pagenum'>"+w+"</div>"),e.innerHTML=f}function s(){c(),r++,r>=n.pages.length?h():u(),n.on_page_change(r)}function d(){c(),r--,u(),n.on_page_change(r)}function c(){var f=performance.now(),w=Math.round(f-i);o.push({page_index:r,viewing_time:w}),i=f}const h=()=>{n.allow_keys&&this.jsPsych.pluginAPI.cancelKeyboardResponse(_);var f={view_history:o,rt:Math.round(performance.now()-a)};this.jsPsych.finishTrial(f)},m=f=>{_=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1,allow_held_key:!1}),this.jsPsych.pluginAPI.compareKeys(f.key,n.key_backward)&&r!==0&&n.allow_backward&&d(),this.jsPsych.pluginAPI.compareKeys(f.key,n.key_forward)&&s()};if(u(),n.allow_keys)var _=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1})}simulate(e,n,r,o){n=="data-only"&&(o(),this.simulate_data_only(e,r)),n=="visual"&&this.simulate_visual(e,r,o)}create_simulation_data(e,n){let r=0,o=0,a=[];if(!n.data?.view_history&&!n.data?.rt)for(;r!==e.pages.length;){const u=Math.round(this.jsPsych.randomization.sampleExGaussian(3e3,300,.0033333333333333335));a.push({page_index:r,viewing_time:u}),o+=u,r==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?r++:r--}if(!n.data?.view_history&&n.data?.rt){for(o=n.data.rt;r!==e.pages.length;)a.push({page_index:r,viewing_time:null}),r==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?r++:r--;const u=n.data.rt/a.length;let s=0;for(const h of a){const m=Math.round(this.jsPsych.randomization.sampleExGaussian(u,u/10,1/(u/10)));h.viewing_time=m,s+=m}const d=n.data.rt-s,c=Math.round(d/a.length);for(const h of a)h.viewing_time+=c}if(n.data?.view_history&&!n.data?.rt){a=n.data.view_history,o=0;for(const u of n.data.view_history)o+=u.viewing_time}const i={view_history:a,rt:o},l=this.jsPsych.pluginAPI.mergeSimulationData(i,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,l),l}simulate_data_only(e,n){const r=this.create_simulation_data(e,n);this.jsPsych.finishTrial(r)}simulate_visual(e,n,r){const o=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),r();const i=d=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_forward,d):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-next"),d)},l=d=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_backward,d):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-back"),d)};let u=0,s=0;for(let d=0;d<o.view_history.length;d++)d==o.view_history.length-1?i(s+o.view_history[d].viewing_time):(o.view_history[d+1].page_index>u&&i(s+o.view_history[d].viewing_time),o.view_history[d+1].page_index<u&&l(s+o.view_history[d].viewing_time),s+=o.view_history[d].viewing_time,u=o.view_history[d+1].page_index)}}const At=`<span style="color: ${Ce};"><strong>green</strong></span>`,$t=`<span style="color: ${Re};"><strong>red</strong></span>`,Ct=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Rt(){const t=y.memory.set_size,e="Task 1 — Remember the dots",n=[k({title:e,body:`
      ...
      `,narration:"You have 3 seconds for each test. Aim for accuracy first, but don't dwell. If you answer in time, the dot turns green for correct or red for incorrect while it is still on screen.",exemplar:["qmark"]})],r={type:oe,pages:n,...Ct,data:{phase:"instructions_memory_d_only"}};return W(r.data.phase,Rt),U(r)}function Dt(){const t=y.memory.set_size,e="Task 2 — Remember the tones",n=[k({title:e,body:`
      ...
      `,narration:`Then we play ${t} more tones, one at a time. For each one: Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. Keep your eyes on the centre of the circle and listen.`,exemplar:["qmark"]}),k({title:e,body:`
        ...
        set earlier.</p>
      `,narration:"You have 3 seconds for each test. If you answer in time, the central question mark turns green for correct or red for incorrect. Please make sure your audio volume is still at the level you set earlier.",exemplar:["tone"]})],r={type:oe,pages:n,...Ct,data:{phase:"instructions_memory_t_only"}};return W(r.data.phase,Dt),U(r)}const Xr=`<span style="color: ${Ce};"><strong>green</strong></span>`,Qr=`<span style="color: ${Re};"><strong>red</strong></span>`,Zr='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',eo=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function zt(){const t=y.imagery.stars_per_trial,e="Task 3 — Picture the pattern",n=[k({title:e,body:`
      ...
      `,narration:"You have 3 seconds for each star. Aim for accuracy first, but don't dwell. If you answer in time, the star turns green for correct or red for incorrect while it is still on screen. Be honest about your mental picture — if it's fuzzy, just do your best.",exemplar:["star"]})],r={type:oe,pages:n,...eo,data:{phase:"instructions_imagery_i_only"}};return W(r.data.phase,zt),U(r)}const Mt=`<span style="color: ${Ce};"><strong>green</strong></span>`,qt=`<span style="color: ${Re};"><strong>red</strong></span>`,Bt='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',Yt=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Ht(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,r="Task 4 — Dots and pattern together",o=[k({title:r,body:`
        ...
        turn it.</p>
      `,narration:"Task 4 combines Task 3, the pattern, with Task 1, the dots. Each trial begins with the arrow: turn the pattern in your mind and hold the turned pattern for the whole trial. You'll have 5 seconds to imagine and turn it.",exemplar:["arrow"]}),k({title:r,body:`
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the dot tests begin.",exemplar:["pattern"]})],a={type:oe,pages:o,...Yt,data:{phase:"instructions_dual_i_d"}};return W(a.data.phase,Ht),U(a)}function Ft(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,r="Task 5 — Tones and pattern together",o=[k({title:r,body:`
        <p>Task 5 combines Task 3 (the pattern) with Task 2 (the tones).
        Each trial begins with the <strong>arrow</strong>: turn the
        pattern in your mind and hold the turned pattern for the whole
        trial. You'll have <strong>5 seconds</strong> to imagine and
        turn it.</p>
      `,narration:"Task 5 combines Task 3, the pattern, with Task 2, the tones. Each trial begins with the arrow: turn the pattern in your mind and hold the turned pattern for the whole trial. You'll have 5 seconds to imagine and turn it.",exemplar:["arrow"]}),k({title:r,body:`
      ...
      `,narration:`After the ${n} things, we test your tone memory ${t} times. Each test plays a tone. Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. You have 3 seconds for each star and each tone test. If you answer in time, the star or central question mark turns green for correct or red for incorrect.`,exemplar:["qmark"]}),k({title:r,body:`
        ...
        <p>Please make sure your audio volume is still at the level you
        set earlier.</p>
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier.",exemplar:["pattern"]})],a={type:oe,pages:o,...Yt,data:{phase:"instructions_dual_i_t"}};return W(a.data.phase,Ft),U(a)}const to=4,Gt=1e3*to,no=2e3,ro=400,E=500,T=400,q=1200,oo=700,ao=450,io=220,B=1500,Ye=1e3,so=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function He(){return Ae().pick(so)}const lo="./assets/rotation-arrow.png";function co(t,e){return`
    <style>
  ...
  `}function uo(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setSpaceArmed(e){const n=!!e;t.spaceArmed=n;const r=typeof document<"u"?document.getElementById("demo-hint"):null;r&&(r.style.opacity=n?"1":"0",r.setAttribute("aria-hidden",n?"false":"true"))},setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const r=yn(e);r?(bn(),t.currentNarration=$e().speak(r)):t.currentNarration=null},async wait(e){return await Ue(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let r=!1;const o=()=>{r||(r=!0,n())};e.done.then(o).catch(o);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),o())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await Ue(ro),t.cancelled)?!1:(this.setCaption(e),!0)},async narrate(e){return!(!await this.advanceCaption(e)||!await this.awaitNarration())}}}function ho(t,e){const n=y.imagery.rotation_arrow_size_px,r=document.createElement("img");return r.src=lo,r.alt="rotation cue",r.className="rotation-arrow-cue demo-arrow",r.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none","filter: brightness(0) saturate(100%) drop-shadow(1px 0 0 #fff) drop-shadow(-1px 0 0 #fff) drop-shadow(0 1px 0 #fff) drop-shadow(0 -1px 0 #fff)"].join("; ")+";"),t.wrapper.appendChild(r),r}function ue(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function Fe(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),Sn(t),Ke(t),!await e.awaitNarration()||!await e.wait(1e3)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;Ee(t);const i=ho(t,n);return!await e.awaitNarration()||!await e.wait(600)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(ue(i),!1):(ue(i),gt(t,n),Ke(t),!await e.awaitNarration()||!await e.wait(1500)?!1:(Ee(t),!0))}function ae(){const t=On(),e=Pn();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function Y({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `;const r=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${r} Click the button below to watch it again.`)?new Promise(o=>{let a=!1;const i=s=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(c=>c.removeEventListener("click",l)),o(s)},l=s=>{const d=s.currentTarget.getAttribute("data-side");i(d==="right")};n.querySelectorAll(".demo-replay-btn").forEach(s=>s.addEventListener("click",l));const u=setInterval(()=>{t.state.cancelled&&(clearInterval(u),i(!1)),a&&clearInterval(u)},100)}):!1}function se(t){return async function(n,r){let o=0;for(;!r.state.cancelled;){try{await t(n,r)}catch(l){console.error("[demo] mini-trial error",l);return}if(r.state.cancelled)return;r.setSpaceArmed(!0);const a=wo-o;if(a<=0){if(Wt(),!await r.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;M();return}if(!await _o(r,a)){await r.advanceCaption("Press Space when you are ready to start the practice."),M();return}o+=1,r.setSpaceArmed(!1);try{In(n),M(),I(n,""),n.rotor.style.transition="",gt(n,0),Ee(n)}catch{}if(!await r.advanceCaption("Replaying the demonstration…")||!await r.wait(no))return}}}const vo=se(mo),ko=se(fo),To=se(go),xo=se(yo),Eo=se(bo);function le({phase:t,taskNumber:e,title:n,run:r,factory:o}){const a={type:A,stimulus:co(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const i=document.getElementById("demo-mount");if(!i)return;const l=En({rotation_deg:0,fixation:"",background_shade:"gray"});i.appendChild(l.wrapper);const u=uo(),s=window.jsPsych?.getCurrentTrial?.();s&&typeof s=="object"&&(s._demo_state=u.state);let d=!0;const c=h=>{if(d){if(h.key==="ArrowLeft"||h.key==="ArrowRight"){h.preventDefault(),h.stopPropagation();return}if(h.key===" "||h.code==="Space"){if(h.preventDefault(),h.stopPropagation(),!u.state.spaceArmed)return;d=!1,document.removeEventListener("keydown",c,!0),u.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",c,!0),s&&typeof s=="object"&&(s._demo_keydown_handler=c),r(l,u).catch(h=>{console.error(`[demo:${t}] schedule error`,h)})},on_finish:()=>{const i=window.jsPsych?.getCurrentTrial?.();i?._demo_state&&(i._demo_state.cancelled=!0),i?._demo_keydown_handler&&(document.removeEventListener("keydown",i._demo_keydown_handler,!0),i._demo_keydown_handler=null);try{$e().cancel()}catch{}},data:{phase:t}};return W(t,o),U(a)}function Ut(){return le({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:vo,factory:Ut})}function Kt(){return le({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:ko,factory:Kt})}function Vt(){return le({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:To,factory:Vt})}function Jt(){return le({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:xo,factory:Jt})}function Xt(){return le({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:Eo,factory:Xt})}const xe=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function st(t){return typeof t!="string"?"":t.trim().toLowerCase()}function pe(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:X,preamble:"<h2>Quick check</h2>",html:`
    ...
    `,button_label:"Continue",on_finish:r=>{const o=r.response?.response??"",a=st(o);r.attention_check_id=t.id,r.attention_check_raw=o,r.attention_check_passed=a===st(t.expected_answer)},data:{phase:"attention_check"}};return v(e,()=>pe(t)),b(n,e)}function Io(t,e=y.attention_checks.instruction_max_failures){const n=(t??[]).filter(a=>a?.phase==="attention_check"),r=n.filter(a=>a.attention_check_passed===!0).length,o=n.filter(a=>a.attention_check_passed===!1).length;return{total:n.length,passed:r,failed:o,exceededThreshold:o>e,threshold:e,ids:n.map(a=>a.attention_check_id)}}function Qt(){const t="attention_check_summary",e={type:X,preamble:"<h2>Thanks — moving on.</h2>",html:`
      <div style="max-width: 36rem; margin: 0 auto;">
        <p>Press <strong>Continue</strong> to proceed to the main task.</p>
      </div>
    `,button_label:"Continue",on_finish:n=>{const r=window.jsPsych?.data?.get().values()??[],o=Io(r);n.phase="attention_check_summary",n.attention_total=o.total,n.attention_passed=o.passed,n.attention_failed=o.failed,n.attention_excluded=o.exceededThreshold,n.attention_threshold=o.threshold}};return v(t,Qt),b(e,t)}const lt=Object.freeze(["d_only","t_only","i_only","i_d","i_t"]);function ct(t){let e=0,n=0;for(const r of t)typeof r.probe_correct=="boolean"&&(n+=1,r.probe_correct&&(e+=1)),typeof r.star_correct=="boolean"&&(n+=1,r.star_correct&&(e+=1));return{correct:e,total:n,accuracy:n>0?e/n:0}}function ee({trialType:t,trialsPerType:e,sequencePoolLabelPrefix:n,prng:r}={}){if(!lt.includes(t))throw new Error(`singleTypePractice: unknown trialType '${t}'; expected one of ${lt.join(", ")}`);const o=e??y.blocks.practice_trials_per_type,a=r??Ae(),i=wn({blockLabel:"practice",countsByType:{[t]:o},sequencePoolLabelPrefix:n??"practice",runLengthCap:Math.max(1,o),prng:a});return{schedule:i.schedule,trialParams:i.trialParams,nodes:i.nodes}}function So({acc:t,passed:e,willRetry:n,criterion:r}){return Oo({acc:t,passed:e,willRetry:n,criterion:r})}function Oo({acc:t,passed:e,willRetry:n,criterion:r}){const o=Math.round(t.accuracy*100),a=Math.round(r*100),i=e?'<h2 style="color:#0a7c4d;">Practice complete</h2>':'<h2 style="color:#b3261e;">Practice — keep going</h2>',l=e?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
  ...
  `}function Zt(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),r={type:A,stimulus:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return v(t,tn),b(e,t)}function nn(){const t=J.map(r=>{const o=r.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
    ...
    `,button_label:"Continue",on_finish:r=>{r.phase="music_experience",r.music_experience_responses=J.reduce((o,a)=>{const i=r.response?.[a.id];return o[a.id]=i===""||i===null||i===void 0?null:String(i),o},{})}};return v(e,nn),b(n,e)}function $o(){return[tn(),nn()]}function rn(){const t="questionnaire_intro",e={type:A,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,rn),b(e,t)}function Co(){return[rn(),...Ao(),...$o()]}function on(){const t="main_a_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{ft()}};return v(t,on),b(e,t)}function an(){const t="main_b_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,an),b(e,t)}function sn(){const t="end_of_task_intro",e={type:A,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{_n(),ft()}};return v(t,sn),b(e,t)}const S=un(),Ro=hn();function Do(){if(mt(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}Do();const we=pn({display_element:void 0,on_trial_start:Mn(),on_data_update:t=>{ut(t).catch(e=>{console.error("[runner] storage append failed",e),ht(e)})},on_finish:()=>{const t=we.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:S.params.session_id,prolific_pid:S.params.prolific_pid,study_id:S.params.study_id,is_preview:S.params.is_preview,is_pilot_run:S.is_pilot_run,pilot_label:S.pilot_label,prng_seed_uint32:S.prng_seed_uint32,schema_version:S.schema_version,build_id:S.build_id}),console.info("[runner] session",S,"visibility",Mr())}});window.jsPsych=we;qn(we);const dt=vn(),zo=[...Kr(),...Po(),on(),...dt.mainA.nodes,kn(),an(),...dt.mainB.nodes,sn(),...Co(),Tn({session:S}),xn()];Ro.then(()=>we.run(zo)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-CLUtqreI.js.map
