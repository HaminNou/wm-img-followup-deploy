import"./modulepreload-polyfill-B5Qt9EMX.js";import{P as h,a as ot,r as at,H as N,g as Oe,i as tn,b as nn,c as rn}from"./index-Bz6dieJX.js";import{s as Q,a as it,u as on,g as st,b as qe,c as an,d as lt,p as sn,e as ze,h as ln,f as cn,F as A,i as $,j as de,k as un,l as dn,m as pn,r as hn}from"./main-blocks-hXBN66_V.js";import{c as g}from"./config-zUhCg_tb.js";import{u as mn,c as fn}from"./debrief-pGFuma2H.js";import{c as yn,a as gn,s as O,b as ct,h as _e,d as pe,r as S,e as Ie,f as Se,g as Pe,i as bn,j as Me,o as wn,k as _n}from"./pattern-CJtvzC-V.js";var vn="2.1.0";const kn={name:"html-button-response",version:vn,parameters:{stimulus:{type:h.HTML_STRING,default:void 0},choices:{type:h.STRING,default:void 0,array:!0},button_html:{type:h.FUNCTION,default:function(t,e){return`<button class="jspsych-btn">${t}</button>`}},prompt:{type:h.HTML_STRING,default:null},stimulus_duration:{type:h.INT,default:null},trial_duration:{type:h.INT,default:null},button_layout:{type:h.STRING,default:"grid"},grid_rows:{type:h.INT,default:1},grid_columns:{type:h.INT,default:null},response_ends_trial:{type:h.BOOL,default:!0},enable_button_after:{type:h.INT,default:0}},data:{rt:{type:h.INT},response:{type:h.INT},stimulus:{type:h.HTML_STRING}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class P{constructor(e){this.jsPsych=e}static{this.info=kn}trial(e,n){const r=document.createElement("div");r.id="jspsych-html-button-response-stimulus",r.innerHTML=n.stimulus,e.appendChild(r);const o=document.createElement("div");if(o.id="jspsych-html-button-response-btngroup",n.button_layout==="grid"){if(o.classList.add("jspsych-btn-group-grid"),n.grid_rows===null&&n.grid_columns===null)throw new Error("You cannot set `grid_rows` to `null` without providing a value for `grid_columns`.");const c=n.grid_columns===null?Math.ceil(n.choices.length/n.grid_rows):n.grid_columns,p=n.grid_rows===null?Math.ceil(n.choices.length/n.grid_columns):n.grid_rows;o.style.gridTemplateColumns=`repeat(${c}, 1fr)`,o.style.gridTemplateRows=`repeat(${p}, 1fr)`}else n.button_layout==="flex"&&o.classList.add("jspsych-btn-group-flex");for(const[c,p]of n.choices.entries()){o.insertAdjacentHTML("beforeend",n.button_html(p,c));const m=o.lastChild;m.dataset.choice=c.toString(),m.addEventListener("click",()=>{d(c)})}e.appendChild(o),n.prompt!==null&&e.insertAdjacentHTML("beforeend",n.prompt);var a=performance.now(),i={rt:null,button:null};const l=()=>{var c={rt:i.rt,stimulus:n.stimulus,response:i.button};this.jsPsych.finishTrial(c)};function d(c){var p=performance.now(),m=Math.round(p-a);i.button=parseInt(c),i.rt=m,r.classList.add("responded");for(const w of o.children)w.setAttribute("disabled","disabled");n.response_ends_trial&&l()}if(n.stimulus_duration!==null&&this.jsPsych.pluginAPI.setTimeout(()=>{r.style.visibility="hidden"},n.stimulus_duration),n.enable_button_after>0){for(var s=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),u=0;u<s.length;u++)s[u].setAttribute("disabled","disabled");this.jsPsych.pluginAPI.setTimeout(()=>{for(var c=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),p=0;p<c.length;p++)c[p].removeAttribute("disabled")},n.enable_button_after)}n.trial_duration!==null&&this.jsPsych.pluginAPI.setTimeout(l,n.trial_duration)}simulate(e,n,r,o){n=="data-only"&&(o(),this.simulate_data_only(e,r)),n=="visual"&&this.simulate_visual(e,r,o)}create_simulation_data(e,n){const r={stimulus:e.stimulus,rt:this.jsPsych.randomization.sampleExGaussian(500,50,.006666666666666667,!0)+e.enable_button_after,response:this.jsPsych.randomization.randomInt(0,e.choices.length-1)},o=this.jsPsych.pluginAPI.mergeSimulationData(r,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,o),o}simulate_data_only(e,n){const r=this.create_simulation_data(e,n);this.jsPsych.finishTrial(r)}simulate_visual(e,n,r){const o=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),r(),o.rt!==null&&this.jsPsych.pluginAPI.clickTarget(a.querySelector(`#jspsych-html-button-response-btngroup [data-choice="${o.response}"]`),o.rt)}}let De=!1,q=[];const ve=new Map;let Z=!1,ke=!1;function Tn(t){!t||typeof t!="string"||q[q.length-1]!==t&&(q.push(t),q.length>32&&q.shift())}function ut(t){const e=typeof t?.data=="function"?null:t?.data??null;return typeof e?.phase=="string"?e.phase:null}function xn(t,e){return t&&typeof t=="object"&&typeof t!="function"?{...t,hidden_nav_step:e}:(...n)=>({...typeof t=="function"?t(...n):{},hidden_nav_step:e})}function v(t,e){!t||typeof t!="string"||typeof e!="function"||ve.set(t,e)}function b(t,e=ut(t)){if(!e||typeof e!="string")return t;const n=t?.on_load;return t.data=xn(t?.data,e),t._hidden_nav_checkpoint=!0,t.on_load=(...r)=>{Tn(e),n?.(...r)},t}function F(t,e){v(t,e)}function H(t){return b(t,ut(t))}function En(){const t=ke;return ke=!1,t}function On(t){const e=t?.timeline?.getLatestNode?.();return e&&typeof e.getDataParameter=="function"?e:null}function In(t){try{const e=On(t);if(!e)return null;const n=e.getDataParameter?.()??{},r=typeof n.hidden_nav_step=="string"?n.hidden_nav_step:null;return{node:e,stepId:r,phase:typeof n.phase=="string"?n.phase:null}}catch{return null}}function Sn(t){const e=t?.description?.type?.info?.name??null;return e==="html-button-response"?{response:0}:e==="survey-html-form"?{response:{}}:{}}function Pn(t){const e=q.slice();if(t)for(;e[e.length-1]===t;)e.pop();return{trimmedHistory:e,prevStepId:e[e.length-1]??null}}function Ye(t,e){const n=t?.parent?.description?.timeline;if(!Array.isArray(n))return!1;const r=n.indexOf(t.description);return r<0?!1:(n.splice(r+1,0,...e),!0)}function jn(){return function(e){if(e?._hidden_nav_checkpoint===!0){Z&&(Z=!1),Q(!1);return}if(!Z){Q(!1);return}!e||typeof e!="object"||(e.trial_duration=0,e.choices="NO_KEYS")}}function Ln(t){if(De||typeof document>"u")return;const e=n=>{const r=n.target&&n.target.tagName||"";if(r==="INPUT"||r==="TEXTAREA"||n.target?.isContentEditable||n.metaKey||n.ctrlKey||n.altKey)return;const o=n.key?.toLowerCase?.();if(o!=="u"&&o!=="r")return;const a=In(t);if(!a)return;n.preventDefault(),n.stopPropagation(),it();const i=Sn(a.node),l=!!a.stepId;if(o==="u"){ke=!0,l||(Z=!0),Q(!0),t.finishTrial({...i,phase:a.phase,hidden_nav:"forward",hidden_nav_step:a.stepId??null});return}const{trimmedHistory:d,prevStepId:s}=Pn(a.stepId),u=s?ve.get(s):null;if(!u)return;let c=!1;if(l){const p=ve.get(a.stepId);if(!p)return;c=Ye(a.node,[u(),p()])}else c=Ye(a.node,[u()]);c&&(q=d,Z=!1,l?Q(!1):Q(!0),t.finishTrial({...i,phase:a.phase,hidden_nav:"back",hidden_nav_step:a.stepId??null,hidden_nav_target_step:s}))};document.addEventListener("keydown",e,!0),De=!0}const Nn="online-2101803-v1",An=`
...
`;function dt(){const t="consent";let e=!1;const n={type:P,stimulus:An,choices:["I consent — begin","I do not consent — exit"],button_html:(r,o)=>`<button class="jspsych-btn" data-idx="${o}"${o===0?" disabled":""}>${r}</button>`,on_load:()=>{e=!1;const r=document.getElementById("consent-checkbox"),o=document.querySelector('button.jspsych-btn[data-idx="0"]');!r||!o||r.addEventListener("change",()=>{e=r.checked,o.disabled=!r.checked})},on_finish:async r=>{r.consented=r.response===0,r.consent_acknowledged=e,r.consent_version=Nn,r.consented&&await on()},data:{phase:"consent"}};return v(t,dt),b(n,t)}function $n(){return{timeline:[{type:P,stimulus:`
          <h2>Thank you</h2>
        ...
        `,choices:["Close"],on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Consent declined.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"consent"}).last(1).values()[0];return t?t.consented===!1:!1}}}var Cn="2.1.0";const Rn={name:"survey-html-form",version:Cn,parameters:{html:{type:h.HTML_STRING,default:null},preamble:{type:h.HTML_STRING,default:null},button_label:{type:h.STRING,default:"Continue"},autofocus:{type:h.STRING,default:""},dataAsArray:{type:h.BOOL,default:!1},autocomplete:{type:h.BOOL,default:!1}},data:{response:{type:h.OBJECT},rt:{type:h.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class V{constructor(e){this.jsPsych=e}static{this.info=Rn}trial(e,n){var r="";if(n.preamble!==null&&(r+='<div id="jspsych-survey-html-form-preamble" class="jspsych-survey-html-form-preamble">'+n.preamble+"</div>"),n.autocomplete?r+='<form id="jspsych-survey-html-form">':r+='<form id="jspsych-survey-html-form" autocomplete="off">',r+=n.html,r+='<input type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" value="'+n.button_label+'"></input>',r+="</form>",e.innerHTML=r,n.autofocus!==""){var o=e.querySelectorAll("#"+n.autofocus);o.length===0?console.warn("No element found with id: "+n.autofocus):o.length>1?console.warn('The id "'+n.autofocus+'" is not unique so autofocus will not work.'):o[0].focus()}e.querySelector("#jspsych-survey-html-form").addEventListener("submit",d=>{d.preventDefault();var s=performance.now(),u=Math.round(s-a),c=e.querySelector("#jspsych-survey-html-form"),p=i(c);n.dataAsArray||(p=l(p));var m={rt:u,response:p};this.jsPsych.finishTrial(m)});var a=performance.now();function i(d){for(var s=[],u=0;u<d.elements.length;u++){var c=d.elements[u];if(!(!c.name||c.disabled||c.type==="file"||c.type==="reset"||c.type==="submit"||c.type==="button"))if(c.type==="select-multiple")for(var p=0;p<c.options.length;p++)c.options[p].selected&&s.push({name:c.name,value:c.options[p].value});else(c.type!=="checkbox"&&c.type!=="radio"||c.checked)&&s.push({name:c.name,value:c.value})}return s}function l(d){for(var s={},u=0;u<d.length;u++)s[d[u].name]=d[u].value;return s}}}const qn=`
  <style>
...
`;function pt(){const t="demographics",e={type:V,preamble:`
    ...
    `,button_label:"Continue",data:{phase:"demographics"}};return v(t,pt),b(e,t)}var zn="2.1.0";const Mn={name:"call-function",version:zn,parameters:{func:{type:h.FUNCTION,default:void 0},async:{type:h.BOOL,default:!1}},data:{value:{type:h.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class me{constructor(e){this.jsPsych=e}static{this.info=Mn}trial(e,n){let r;const o=()=>{const a={value:r};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{r=i,o()};n.func(a)}else r=n.func(),o()}}function Dn({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:r=0}={}){const o=String(t).toLowerCase(),a=Number.isFinite(r)?r:0,i=[];return/\biphone\b/.test(o)&&i.push("iphone"),/\bipod\b/.test(o)&&i.push("ipod"),/\bipad\b/.test(o)&&i.push("ipad"),/macintosh/.test(o)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(o)&&i.push("android"),/mobile/.test(o)&&!/iphone|ipad|ipod|android/.test(o)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Yn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const r=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:r}}function Bn(){return{type:me,async:!1,func:()=>Dn(Yn()),data:{phase:"desktop_gate"}}}function Fn(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Hn=85.6,Te=1.5,xe=12,Gn=100,Un=1100,ce=320,Wn=2,Be="screen_calibration",Fe="screen_calibration_retry_hint",Vn=`
  ...
  <input id="cc-slider" type="range" min="${Gn}" max="${Un}" value="${ce}"
...
`;function ht(){const t={type:P,stimulus:Vn,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),r=()=>{const o=parseInt(e.value,10);n.style.width=`${o}px`,n.style.height=`${o*(53.98/85.6)}px`};e.addEventListener("input",r),r()},on_finish:e=>{const n=document.getElementById("cc-slider"),r=n?parseInt(n.value,10):ce,o=r/Hn;e.cc_px_width=r,e.px_per_mm=o,e.px_per_mm_in_bounds=o>=Te&&o<=xe,e.px_per_mm_min=Te,e.px_per_mm_max=xe,document.documentElement.style.setProperty("--mm",`${o}px`)},data:{phase:"screen_calibration"}};return v(Be,ht),b(t,Be)}function Jn(){return{type:me,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=Te&&t.px_per_mm<=xe),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function mt(){const t={type:P,stimulus:Kn,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Fe,mt),b(t,Fe)}function Xn(t){return{timeline:[mt()],conditional_function:()=>t.count>=1}}function Qn({maxAttempts:t=Wn}={}){const e={count:0};return{timeline:[Xn(e),ht(),Jn(),Zn(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function Zn(t,e){return{type:me,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],r=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:r,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const er="72vh",tr="#000",nr="50rem",rr="95vw",or="72rem",ft=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${er};
  color: ${tr};
`.replace(/\s+/g," ").trim(),yt=`${ft} width: ${nr}; max-width: 94vw;`,ar=`${ft} width: ${rr}; max-width: ${or}; align-items: center;`,gt=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim(),ir=`
  ...
  min-height: 0;
  width: 100%;
`.replace(/\s+/g," ").trim();function bt({title:t,body:e,narration:n}){const r=typeof n=="string"&&n.trim()?` data-voiceover-script="${_t(n.trim())}"`:"";return`
    <div style="${`${yt} min-height: auto; padding-top: 0.4rem; padding-bottom: 0.4rem; font-size: 0.95rem; line-height: 1.5;`}">
      <div style="flex: 0 0 auto; width: 100%; margin: 0 0 0.5rem; display: flex; align-items: center; justify-content: center;">
        <h2 style="${je}">${t}</h2>
      </div>
      <div style="${ir}" data-voiceover-target${r}>${e}</div>
    </div>
  `}const Le=50,j=Le/2,wt=Le*Math.SQRT2/2+1,Ee=wt-j+.5,ie=Le+2*Ee,He={cx:35,cy:15},Ge={cx:15,cy:35},sr=2.5,lr=2.5,Ue=100,cr=30,ur=12,dr=12,pr=[1,2,3,7,10,11,12,13,14,17,21,22,23],se=10,hr="#FFFFFF",mr=.66;function fr(t,e,n){const o=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:o,d=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(d)},${e+l*Math.sin(d)}`)}return a.join(" ")}const yr=fr(Ge.cx,Ge.cy,lr),gr="rgba(0, 0, 0, 0.229)",br="rgba(0, 0, 0, 0.55)",We="#000",Ve="rgba(0, 0, 0, 0.85)";function wr(t,{arrowAngleDeg:e=cr}={}){const n=new Set(t),r=n.has("tone")||n.has("qmark"),o=n.has("pattern"),a=`<circle cx="${j}" cy="${j}" r="${wt}" fill="none" stroke="${gr}" stroke-width="0.5" />`,i=r||o?"":`<circle cx="${j}" cy="${j}" r="0.65" fill="${br}" />`,l=o?pr.map(y=>{const k=y%5,x=Math.floor(y/5),f=k*se,L=x*se;return`<rect x="${f}" y="${L}" width="${se}" height="${se}" fill="${hr}" opacity="${mr}" />`}).join(""):"",d=n.has("dot")?`<circle cx="${He.cx}" cy="${He.cy}" r="${sr}" fill="${We}" />`:"",s=n.has("star")?`<polygon points="${yr}" fill="${We}" />`:"",u=n.has("tone")?`<text x="${j}" y="${j}" text-anchor="middle" dominant-baseline="central" fill="${Ve}" font-size="${ur}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",c=n.has("qmark")?`<text x="${j}" y="${j}" text-anchor="middle" dominant-baseline="central" fill="${Ve}" font-size="${dr}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",p=`
    <svg viewBox="${-Ee} ${-Ee} ${ie} ${ie}"
         width="100%" height="100%" style="display: block; overflow: visible;">
      ${a}${l}${i}${d}${s}${u}${c}
    </svg>
  `,m=(e/360).toFixed(6),w=n.has("arrow")?`<img src="${_r()}" alt="rotation cue"
  ...
  `}function _r(){return"./assets/rotation-arrow.png"}function _({title:t,body:e,narration:n,exemplar:r=[],arrowAngleDeg:o}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${_t(n.trim())}"`:"",i=wr(r,typeof o=="number"?{arrowAngleDeg:o}:{});return`
    <div style="${yt} align-items: center;">
      <div style="${gt}">
        <h2 style="${je}">${t}</h2>
      </div>
  ...
  `}function _t(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const vr=bt({title:"Sit comfortably for the study",body:`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Tr(){const t=b({type:P,stimulus:vr,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:P,stimulus:kr,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function vt(){const t="speaker_volume_instruction",e={type:P,stimulus:`
    ...
    `,choices:["Continue"],data:{phase:"speaker_volume_instruction"}};return v(t,vt),b(e,t)}var xr="2.1.0";const Er={name:"fullscreen",version:xr,parameters:{fullscreen_mode:{type:h.BOOL,default:!0,array:!1},message:{type:h.HTML_STRING,default:"<p>The experiment will switch to full screen mode when you press the button below</p>",array:!1},button_label:{type:h.STRING,default:"Continue",array:!1},delay_after:{type:h.INT,default:1e3,array:!1}},data:{success:{type:h.BOOL,default:null,description:"True if the user entered fullscreen mode, false if not."},rt:{type:h.INT,default:null,description:"Time in milliseconds until the user entered fullscreen mode."}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class Or{constructor(e){this.jsPsych=e,this.rt=null,this.start_time=0}static{this.info=Er}trial(e,n){var r=typeof Element<"u"&&"ALLOW_KEYBOARD_INPUT"in Element;r?this.endTrial(e,!1,n):n.fullscreen_mode?this.showDisplay(e,n):(this.exitFullScreen(),this.endTrial(e,!0,n))}showDisplay(e,n){e.innerHTML=`
      ${n.message}
      <button id="jspsych-fullscreen-btn" class="jspsych-btn">${n.button_label}</button>
    `,e.querySelector("#jspsych-fullscreen-btn").addEventListener("click",()=>{this.rt=Math.round(performance.now()-this.start_time),this.enterFullScreen(),this.endTrial(e,!0,n)}),this.start_time=performance.now()}endTrial(e,n,r){e.innerHTML="",this.jsPsych.pluginAPI.setTimeout(()=>{var o={success:n,rt:this.rt};this.jsPsych.finishTrial(o)},r.delay_after)}enterFullScreen(){var e=document.documentElement;e.requestFullscreen?e.requestFullscreen():e.mozRequestFullScreen?e.mozRequestFullScreen():e.webkitRequestFullscreen?e.webkitRequestFullscreen():e.msRequestFullscreen&&e.msRequestFullscreen()}exitFullScreen(){(document.fullscreenElement||document.mozFullScreenElement||document.webkitFullscreenElement)&&(document.exitFullscreen?document.exitFullscreen():document.msExitFullscreen?document.msExitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen&&document.webkitExitFullscreen())}simulate(e,n,r,o){n=="data-only"&&(o(),this.simulate_data_only(e,r)),n=="visual"&&this.simulate_visual(e,r,o)}create_simulation_data(e,n){const o={success:!0,rt:this.jsPsych.randomization.sampleExGaussian(1e3,100,.005,!0)};return this.jsPsych.pluginAPI.mergeSimulationData(o,n)}simulate_data_only(e,n){const r=this.create_simulation_data(e,n);this.jsPsych.finishTrial(r)}simulate_visual(e,n,r){const o=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();o.success===!1?this.endTrial(a,!1,e):(this.trial(a,e),r(),this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-fullscreen-btn"),o.rt))}}let Ke=null;const kt=[];function Je(t){kt.push(t),ot({phase:"visibility_event",...t}).catch(e=>{console.error("[visibility] storage append failed",e),at(e)})}function Ir(){if(Ke)return;const t=()=>{Je({kind:"visibilitychange",hidden:document.hidden,ts:performance.now(),iso:new Date().toISOString()})},e=()=>{Je({kind:"fullscreenchange",in_fullscreen:!!document.fullscreenElement,ts:performance.now(),iso:new Date().toISOString()})};document.addEventListener("visibilitychange",t),document.addEventListener("fullscreenchange",e),Ke=()=>{document.removeEventListener("visibilitychange",t),document.removeEventListener("fullscreenchange",e)}}function Sr(){return kt.slice()}function Tt(){const t="enter_fullscreen",e={type:Or,fullscreen_mode:!0,message:`
      <h2>Enter fullscreen</h2>
      <p>The experiment must run in fullscreen. Click below to continue.</p>
    `,button_label:"Enter fullscreen",data:{phase:"enter_fullscreen"}};return v(t,Tt),b(e,t)}function Pr(){return{type:me,async:!1,func:()=>(Ir(),{recording:!0}),data:{phase:"visibility_recorder_start"}}}const jr=200,Lr=500,Nr=50,Ar=10,J=50,$r="#60a5fa";function ge(t,e){return new Promise(n=>{const r=()=>{const o=(e-t.currentTime)*1e3;if(o<=0){n();return}setTimeout(r,Math.min(o,10))};r()})}function Cr(t){const e=[];for(let n=0;n<t;n++)e.push(`<div class="tac-box" id="tac-box-${n}" data-idx="${n}">${n+1}</div>`);return e.join("")}function xt(){const t="tone_audibility_and_comfort";let e=!1,n=!1,r=!1,o=0,a=J;const i={type:P,stimulus:`
      <style>
        .tac-bank {
          display: grid;
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,r=!1,o=0,a=J;const l=Promise.resolve();qe(J/100);const d=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");d&&d.addEventListener("input",()=>{const f=Number(d.value);a=f,s&&(s.textContent=`${f}%`),qe(f/100)});const u=document.getElementById("tac-yes-btn");if(u&&u.addEventListener("click",()=>{n||(r=!0),e=!0},{capture:!0}),await l,e)return;const c=an(),p=lt(),m=g.tones.duration_ms/1e3,w=(g.tones.duration_ms+jr)/1e3,y=Lr/1e3,k=[];for(let f=0;f<p.length;f++)k.push(document.getElementById(`tac-box-${f}`));let x=c.currentTime+Nr/1e3;try{for(let f=0;f<Ar&&!e;f++){o=f+1;for(let L=0;L<p.length&&!e;L++){const R=x;if(sn(L,{when:R}),await ge(c,R),e)break;const G=k[L];G&&G.classList.add("playing"),await ge(c,R+m),G&&G.classList.remove("playing"),x=R+w}e||(await ge(c,x+y),x+=y)}}catch{}if(!r&&!e){n=!0;const f=document.getElementById("tac-yes-btn");f&&f.click()}},on_finish:l=>{it();const d=st();d.current&&!d.current._state?.finished&&d.current.cancel(),l.tones_audible=r&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=o},data:{phase:"tone_audibility_and_comfort"}};return v(t,xt),b(i,t)}function Rr(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"tone_audibility_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Tone audibility failed.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"tone_audibility_and_comfort"}).last(1).values()[0];return t?t.tones_audible===!1:!1}}}function qr(){return[Bn(),Fn(),dt(),$n(),pt(),Tr(),Qn(),vt(),Tt(),Pr(),xt(),Rr()]}var zr="2.1.0";const Mr={name:"instructions",version:zr,parameters:{pages:{type:h.HTML_STRING,default:void 0,array:!0},key_forward:{type:h.KEY,default:"ArrowRight"},key_backward:{type:h.KEY,default:"ArrowLeft"},allow_backward:{type:h.BOOL,default:!0},allow_keys:{type:h.BOOL,default:!0},show_clickable_nav:{type:h.BOOL,default:!1},show_page_number:{type:h.BOOL,default:!1},page_label:{type:h.STRING,default:"Page"},button_label_previous:{type:h.STRING,default:"Previous"},button_label_next:{type:h.STRING,default:"Next"},on_page_change:{type:h.FUNCTION,pretty_name:"Page change callback",default:function(t){}}},data:{view_history:{type:h.COMPLEX,array:!0,nested:{page_index:{type:h.INT},viewing_time:{type:h.INT}}},rt:{type:h.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class ee{constructor(e){this.jsPsych=e}static{this.info=Mr}trial(e,n){var r=0,o=[],a=performance.now(),i=a;function l(){this.id==="jspsych-instructions-back"?u():this.id==="jspsych-instructions-next"&&s()}function d(){var y=n.pages[r],k="";if(n.show_page_number&&(k="<span style='margin: 0 1em;' class='jspsych-instructions-pagenum'>"+n.page_label+" "+(r+1)+"/"+n.pages.length+"</span>"),n.show_clickable_nav){var x="<div class='jspsych-instructions-nav' style='padding: 10px 0px;'>";if(n.allow_backward){var f=r>0?"":"disabled='disabled'";x+="<button id='jspsych-instructions-back' class='jspsych-btn' style='margin-right: 5px;' "+f+">&lt; "+n.button_label_previous+"</button>"}n.pages.length>1&&n.show_page_number&&(x+=k),x+="<button id='jspsych-instructions-next' class='jspsych-btn'style='margin-left: 5px;'>"+n.button_label_next+" &gt;</button></div>",y+=x,e.innerHTML=y,r!=0&&n.allow_backward&&e.querySelector("#jspsych-instructions-back").addEventListener("click",l,{once:!0}),e.querySelector("#jspsych-instructions-next").addEventListener("click",l,{once:!0})}else n.show_page_number&&n.pages.length>1&&(y+="<div class='jspsych-instructions-pagenum'>"+k+"</div>"),e.innerHTML=y}function s(){c(),r++,r>=n.pages.length?p():d(),n.on_page_change(r)}function u(){c(),r--,d(),n.on_page_change(r)}function c(){var y=performance.now(),k=Math.round(y-i);o.push({page_index:r,viewing_time:k}),i=y}const p=()=>{n.allow_keys&&this.jsPsych.pluginAPI.cancelKeyboardResponse(w);var y={view_history:o,rt:Math.round(performance.now()-a)};this.jsPsych.finishTrial(y)},m=y=>{w=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1,allow_held_key:!1}),this.jsPsych.pluginAPI.compareKeys(y.key,n.key_backward)&&r!==0&&n.allow_backward&&u(),this.jsPsych.pluginAPI.compareKeys(y.key,n.key_forward)&&s()};if(d(),n.allow_keys)var w=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1})}simulate(e,n,r,o){n=="data-only"&&(o(),this.simulate_data_only(e,r)),n=="visual"&&this.simulate_visual(e,r,o)}create_simulation_data(e,n){let r=0,o=0,a=[];if(!n.data?.view_history&&!n.data?.rt)for(;r!==e.pages.length;){const d=Math.round(this.jsPsych.randomization.sampleExGaussian(3e3,300,.0033333333333333335));a.push({page_index:r,viewing_time:d}),o+=d,r==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?r++:r--}if(!n.data?.view_history&&n.data?.rt){for(o=n.data.rt;r!==e.pages.length;)a.push({page_index:r,viewing_time:null}),r==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?r++:r--;const d=n.data.rt/a.length;let s=0;for(const p of a){const m=Math.round(this.jsPsych.randomization.sampleExGaussian(d,d/10,1/(d/10)));p.viewing_time=m,s+=m}const u=n.data.rt-s,c=Math.round(u/a.length);for(const p of a)p.viewing_time+=c}if(n.data?.view_history&&!n.data?.rt){a=n.data.view_history,o=0;for(const d of n.data.view_history)o+=d.viewing_time}const i={view_history:a,rt:o},l=this.jsPsych.pluginAPI.mergeSimulationData(i,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,l),l}simulate_data_only(e,n){const r=this.create_simulation_data(e,n);this.jsPsych.finishTrial(r)}simulate_visual(e,n,r){const o=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),r();const i=u=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_forward,u):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-next"),u)},l=u=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_backward,u):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-back"),u)};let d=0,s=0;for(let u=0;u<o.view_history.length;u++)u==o.view_history.length-1?i(s+o.view_history[u].viewing_time):(o.view_history[u+1].page_index>d&&i(s+o.view_history[u].viewing_time),o.view_history[u+1].page_index<d&&l(s+o.view_history[u].viewing_time),s+=o.view_history[u].viewing_time,d=o.view_history[u+1].page_index)}}const Et='<span style="color: #0DE72E;"><strong>green</strong></span>',Ot='<span style="color: #FF1818;"><strong>red</strong></span>',It=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function St(){const t=g.memory.set_size,e="Task 1 — Remember the dots",n=[_({title:e,body:`
      ...
      `,narration:"You have 3 seconds for each test. If you answer in time, the central question mark turns green for correct or red for incorrect. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 2 demonstration.",exemplar:["tone"]})],r={type:ee,pages:n,...It,data:{phase:"instructions_memory_t_only"}};return F(r.data.phase,Pt),H(r)}const Dr='<span style="color: #0DE72E;"><strong>green</strong></span>',Yr='<span style="color: #FF1818;"><strong>red</strong></span>',Br='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',Fr=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function jt(){const t=g.imagery.stars_per_trial,e="Task 3 — Picture the pattern",n=[_({title:e,body:`
      ...
      `,narration:`Then ${t} bright stars will flash inside the circle, one at a time. For each star, decide whether it lands on the rotated pattern you are picturing. Press On-pattern, the right arrow, if the star falls on your pictured pattern. Press Not on-pattern, the left arrow, if it does not.`,exemplar:["star"]}),_({title:e,body:`
        ...
        ${Dr} for correct or
        ${Yr} for incorrect while it is still on screen.</p>
        <p>Be honest about your mental picture — if it's fuzzy, just do
        your best.</p>
        <p style="text-align: center; margin-top: 1.5rem;">
          Press <kbd>Space</kbd> for the Task 3 demonstration.
        </p>
      `,narration:"You have 3 seconds for each star. Aim for accuracy first, but don't dwell. If you answer in time, the star turns green for correct or red for incorrect while it is still on screen. Be honest about your mental picture — if it's fuzzy, just do your best. Press Space for the Task 3 demonstration.",exemplar:["star"]})],r={type:ee,pages:n,...Fr,data:{phase:"instructions_imagery_i_only"}};return F(r.data.phase,jt),H(r)}const Lt='<span style="color: #0DE72E;"><strong>green</strong></span>',Nt='<span style="color: #FF1818;"><strong>red</strong></span>',At='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',$t=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Ct(){const t=g.memory.set_size,e=g.imagery.stars_per_trial,n=t+e,r="Task 4 — Dots and pattern together",o=[_({title:r,body:`
      ...
      `,narration:`Then ${n} things appear inside the circle one at a time, mixed together. ${e} stars — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} dots — remember which locations they appear in, for the dot tests at the end of the trial.`,exemplar:["star","dot"]}),_({title:r,body:`
        ...
        ${Lt} for correct or ${Nt} for incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the dot tests begin. Press Space for the Task 4 demonstration.",exemplar:["arrow"]})],a={type:ee,pages:o,...$t,data:{phase:"instructions_dual_i_d"}};return F(a.data.phase,Ct),H(a)}function Rt(){const t=g.memory.set_size,e=g.imagery.stars_per_trial,n=t+e,r="Task 5 — Tones and pattern together",o=[_({title:r,body:`
      ...
      `,narration:`Then ${n} things happen one at a time, mixed together. ${e} stars inside the circle — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} tones — remember each tone you hear, for the tone tests at the end of the trial.`,exemplar:["star","tone"]}),_({title:r,body:`
        ...
        mark turns ${Lt} for correct or ${Nt} for
        incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 5 demonstration.",exemplar:["arrow"]})],a={type:ee,pages:o,...$t,data:{phase:"instructions_dual_i_t"}};return F(a.data.phase,Rt),H(a)}const Hr=4,qt=1e3*Hr,Gr=2e3,Ur=400,E=500,T=400,z=1200,Wr=700,Xe=450,Vr=220,M=1500,Ne=1e3,Kr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function Ae(){return Oe().pick(Kr)}const Jr="./assets/rotation-arrow.png";function Xr(t,e){return`
    <style>
  ...
  `}function Qr(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const r=ln(e);r?(cn(),t.currentNarration=st().speak(r)):t.currentNarration=null},async wait(e){return await ze(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let r=!1;const o=()=>{r||(r=!0,n())};e.done.then(o).catch(o);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),o())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await ze(Ur),t.cancelled)?!1:(this.setCaption(e),!0)},async narrate(e){return!(!await this.advanceCaption(e)||!await this.awaitNarration())}}}function Zr(t,e){const n=g.imagery.rotation_arrow_size_px,r=document.createElement("img");return r.src=Jr,r.alt="rotation cue",r.className="rotation-arrow-cue demo-arrow",r.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none","filter: brightness(0) saturate(100%)"].join("; ")+";"),t.wrapper.appendChild(r),r}function le(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function $e(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),bn(t),Me(t),!await e.awaitNarration()||!await e.wait(1e3)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;_e(t);const i=Zr(t,n);return!await e.awaitNarration()||!await e.wait(600)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(le(i),!1):(le(i),ct(t,n),Me(t),!await e.awaitNarration()||!await e.wait(1500)?!1:(_e(t),!0))}function te(){const t=wn(),e=_n();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function ne({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `;const r=n.querySelector(".demo-buttons-container"),o=n.querySelector('[data-side="left"]'),a=n.querySelector('[data-side="right"]'),i=n.querySelector(".demo-hand");return{container:r,leftBtn:o,rightBtn:a,hand:i}}function zt(t,e,n){if(!t?.leftBtn||!t?.rightBtn)return!1;const r=t.leftBtn.querySelector(".demo-btn-label"),o=t.rightBtn.querySelector(".demo-btn-label");return r&&(r.textContent=e),o&&(o.textContent=n),!0}function be(){const t=document.getElementById("demo-buttons-row");t&&(t.innerHTML="")}function Qe(t,e){if(!t?.container||!t?.hand)return;const n=e==="right"?t.rightBtn:t.leftBtn;if(!n)return;const r=t.container.getBoundingClientRect(),o=n.getBoundingClientRect(),a=o.left+o.width/2-r.left,i=o.bottom-r.top+4;t.hand.style.left=`${a}px`,t.hand.style.top=`${i}px`}async function D(t,e,n){if(!t)return!0;if(Qe(t,e==="right"?"left":"right"),t.hand.style.transition="none",t.hand.style.opacity="0",t.hand.offsetWidth,t.hand.style.transition="opacity 200ms ease-out",t.hand.style.opacity="0.95",!await n.wait(Wr)||(t.hand.style.transition=`left ${Xe}ms ease-in-out`,Qe(t,e),!await n.wait(Xe)))return!1;const r=e==="right"?t.rightBtn:t.leftBtn;return r&&(r.classList.remove("demo-btn-pressed"),r.offsetWidth,r.classList.add("demo-btn-pressed")),!!await n.wait(Vr)}function Y(t){t?.hand&&(t.hand.style.transition="opacity 200ms ease-in",t.hand.style.opacity="0")}const C=Object.freeze({left:"No",right:"Yes"}),U=Object.freeze({left:"Not on-pattern",right:"On-pattern"});function B({pressedLabel:t,correctLabel:e,isCorrect:n,stimulusName:r}){const o=`<span style="color: ${A}; font-weight: 600;">correct</span>`,a=`<span style="color: ${$}; font-weight: 600;">incorrect</span>`;return n?`We chose <strong>${t}</strong> — that was the ${o} answer, so the ${r} turns green.`:`We chose <strong>${t}</strong> — that was ${a}; the ${o} answer was <strong>${e}</strong>, so the ${r} turns red.`}async function eo(t,e){const{memCells:n,fillerCells:r,probeCells:o}=te(),a=ne({leftLabel:"No",rightLabel:"Yes"});if(!await e.narrate("3 dots will appear one at a time. Remember the location of each one.")||!await e.advanceCaption("")||!await e.wait(E))return;for(let l=0;l<3;l++){const d=pe(t,n[l]);if(!await e.wait(qt)||(S(d),!await e.wait(T)))return;const s=Ie(t,r[l],{visible:!1});if(!await e.wait(Ne))return;S(s)}if(!await e.narrate("Hold the dots in mind for a moment.")||(O(t,"?"),!await e.wait(T)))return;const i=2;for(let l=0;l<o.length;l++){const d=o[l],s=d.isTarget?"right":"left",u=l===i?s==="right"?"left":"right":s;if(!await e.narrate(`Test ${l+1} of 3: was a dot just shown in this location?`)||!await e.wait(E))return;const c=pe(t,d.cell);if(!await e.wait(z)||!await D(a,u,e))return;const p=u===s;if(c.setAttribute("fill",p?A:$),!await e.wait(M)||!await e.narrate(B({pressedLabel:C[u],correctLabel:C[s],isCorrect:p,stimulusName:"dot"}))||(Y(a),S(c),!await e.wait(T)))return}O(t,"")}async function to(t,e){const{memCells:n,fillerCells:r,probeCells:o}=te(),a=ne({leftLabel:"No",rightLabel:"Yes"});if(!await e.narrate("3 tones will play one at a time. Remember each tone you hear.")||!await e.advanceCaption("")||!await e.wait(E))return;for(let l=0;l<3;l++){if(await de(n[l]).catch(()=>{}),!await e.wait(T))return;const d=Ie(t,r[l],{visible:!1});if(!await e.wait(Ne))return;S(d)}if(!await e.narrate("Hold the tones in mind for a moment.")||(O(t,"?"),!await e.wait(T)))return;const i=2;for(let l=0;l<o.length;l++){const d=o[l],s=d.isTarget?"right":"left",u=l===i?s==="right"?"left":"right":s;if(!await e.wait(E)||(await de(d.cell).catch(()=>{}),!await e.wait(T))||!await e.narrate(`Test ${l+1} of 3: was that tone one of the ones you just heard?`)||!await e.wait(z)||!await D(a,u,e))return;const c=u===s;if(O(t,"?",{color:c?A:$}),!await e.wait(M)||!await e.narrate(B({pressedLabel:C[u],correctLabel:C[s],isCorrect:c,stimulusName:"question mark"}))||(Y(a),O(t,"?"),!await e.wait(T)))return}O(t,"")}async function no(t,e){const n=Ae(),r=ne({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await $e(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 3 stars will appear inside the circle. For each star, decide whether it falls <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{fillerCells:o,starCells:a}=te(),i=2;for(let l=0;l<3;l++){const d=Ie(t,o[l],{visible:!1});if(!await e.wait(Ne))return;S(d);const s=a[l],u=s.isOn?"right":"left",c=l===i?u==="right"?"left":"right":u;if(!await e.wait(E))return;const p=Se(t,s.cell);if(!await e.wait(z)||!await D(r,c,e))return;const m=c===u;if(Pe(p,m?A:$),!await e.wait(M)||!await e.narrate(B({pressedLabel:U[c],correctLabel:U[u],isCorrect:m,stimulusName:"star"}))||(Y(r),S(p),!await e.wait(T)))return}}async function ro(t,e){const n=Ae(),r=ne({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await $e(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 6 things appear inside the circle, mixed together: 3 dots to remember, 3 stars to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{memCells:o,starCells:a,probeCells:i}=te(),l=2;for(let s=0;s<3;s++){if(!await e.wait(E))return;const u=pe(t,o[s]);if(!await e.wait(qt)||(S(u),!await e.wait(T)))return;const c=a[s],p=c.isOn?"right":"left",m=s===l?p==="right"?"left":"right":p;if(!await e.wait(E))return;const w=Se(t,c.cell);if(!await e.wait(z)||!await D(r,m,e))return;const y=m===p;if(Pe(w,y?A:$),!await e.wait(M)||!await e.narrate(B({pressedLabel:U[m],correctLabel:U[p],isCorrect:y,stimulusName:"star"}))||(Y(r),S(w),!await e.wait(T)))return}if(!await e.narrate("The question mark means the dot tests begin. You may let the picture go and focus on the dots.")||(zt(r,"No","Yes"),O(t,"?"),!await e.wait(T)))return;const d=2;for(let s=0;s<i.length;s++){const u=i[s],c=u.isTarget?"right":"left",p=s===d?c==="right"?"left":"right":c;if(!await e.narrate(`Dot test ${s+1} of 3: was a dot shown in this location?`)||!await e.wait(E))return;const m=pe(t,u.cell);if(!await e.wait(z)||!await D(r,p,e))return;const w=p===c;if(m.setAttribute("fill",w?A:$),!await e.wait(M)||!await e.narrate(B({pressedLabel:C[p],correctLabel:C[c],isCorrect:w,stimulusName:"dot"}))||(Y(r),S(m),!await e.wait(T)))return}O(t,"")}async function oo(t,e){const n=Ae(),r=ne({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await $e(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 6 things happen, mixed together: 3 tones to remember, 3 stars (inside the circle) to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{memCells:o,starCells:a,probeCells:i}=te(),l=2;for(let s=0;s<3;s++){if(!await e.wait(E)||(await de(o[s]).catch(()=>{}),!await e.wait(T)))return;const u=a[s],c=u.isOn?"right":"left",p=s===l?c==="right"?"left":"right":c;if(!await e.wait(E))return;const m=Se(t,u.cell);if(!await e.wait(z)||!await D(r,p,e))return;const w=p===c;if(Pe(m,w?A:$),!await e.wait(M)||!await e.narrate(B({pressedLabel:U[p],correctLabel:U[c],isCorrect:w,stimulusName:"star"}))||(Y(r),S(m),!await e.wait(T)))return}if(!await e.narrate("The question mark means the tone tests begin. You may let the picture go and focus on the tones.")||(zt(r,"No","Yes"),O(t,"?"),!await e.wait(T)))return;const d=2;for(let s=0;s<i.length;s++){const u=i[s],c=u.isTarget?"right":"left",p=s===d?c==="right"?"left":"right":c;if(!await e.wait(E)||(await de(u.cell).catch(()=>{}),!await e.wait(T))||!await e.narrate(`Tone test ${s+1} of 3: was that tone one of the ones you just heard?`)||!await e.wait(z)||!await D(r,p,e))return;const m=p===c;if(O(t,"?",{color:m?A:$}),!await e.wait(M)||!await e.narrate(B({pressedLabel:C[p],correctLabel:C[c],isCorrect:m,stimulusName:"question mark"}))||(Y(r),O(t,"?"),!await e.wait(T)))return}O(t,"")}const ao=3;async function io(t,e){if(t.state.cancelled)return!1;const n=document.getElementById("demo-buttons-row");if(!n)return!1;n.innerHTML=`
    <div class="demo-buttons-container" style="
      position: relative;
      display: inline-flex;
      align-items: center;
  ...
  `;const r=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${r} Click the button below to watch it again. When you are ready to start the practice, press the <kbd>Space</kbd> key.`)?new Promise(o=>{let a=!1;const i=s=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(c=>c.removeEventListener("click",l)),o(s)},l=s=>{const u=s.currentTarget.getAttribute("data-side");i(u==="right")};n.querySelectorAll(".demo-replay-btn").forEach(s=>s.addEventListener("click",l));const d=setInterval(()=>{t.state.cancelled&&(clearInterval(d),i(!1)),a&&clearInterval(d)},100)}):!1}function re(t){return async function(n,r){let o=0;for(;!r.state.cancelled;){try{await t(n,r)}catch(l){console.error("[demo] mini-trial error",l);return}if(r.state.cancelled)return;r.state.spaceArmed=!0;const a=ao-o;if(a<=0){if(!await r.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;be();return}if(!await io(r,a)){await r.advanceCaption("Press Space when you are ready to start the practice."),be();return}o+=1;try{gn(n),be(),O(n,""),n.rotor.style.transition="",ct(n,0),_e(n)}catch{}if(!await r.advanceCaption("Replaying the demonstration…")||!await r.wait(Gr))return}}}const so=re(eo),lo=re(to),co=re(no),uo=re(ro),po=re(oo);function oe({phase:t,taskNumber:e,title:n,run:r,factory:o}){const a={type:N,stimulus:Xr(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const i=document.getElementById("demo-mount");if(!i)return;const l=yn({rotation_deg:0,fixation:"",background_shade:"gray"});i.appendChild(l.wrapper);const d=Qr(),s=window.jsPsych?.getCurrentTrial?.();s&&typeof s=="object"&&(s._demo_state=d.state);let u=!0;const c=p=>{if(u){if(p.key==="ArrowLeft"||p.key==="ArrowRight"){p.preventDefault(),p.stopPropagation();return}if(p.key===" "||p.code==="Space"){if(p.preventDefault(),p.stopPropagation(),!d.state.spaceArmed)return;u=!1,document.removeEventListener("keydown",c,!0),d.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",c,!0),s&&typeof s=="object"&&(s._demo_keydown_handler=c),r(l,d).catch(p=>{console.error(`[demo:${t}] schedule error`,p)})},on_finish:()=>{const i=window.jsPsych?.getCurrentTrial?.();i?._demo_state&&(i._demo_state.cancelled=!0),i?._demo_keydown_handler&&(document.removeEventListener("keydown",i._demo_keydown_handler,!0),i._demo_keydown_handler=null)},data:{phase:t}};return F(t,o),H(a)}function Mt(){return oe({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:so,factory:Mt})}function Dt(){return oe({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:lo,factory:Dt})}function Yt(){return oe({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:co,factory:Yt})}function Bt(){return oe({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:uo,factory:Bt})}function Ft(){return oe({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:po,factory:Ft})}const we=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function Ze(t){return typeof t!="string"?"":t.trim().toLowerCase()}function ue(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:V,preamble:"<h2>Quick check</h2>",html:`
    ...
    `,button_label:"Continue",on_finish:r=>{const o=r.response?.response??"",a=Ze(o);r.attention_check_id=t.id,r.attention_check_raw=o,r.attention_check_passed=a===Ze(t.expected_answer)},data:{phase:"attention_check"}};return v(e,()=>ue(t)),b(n,e)}function ho(t,e=g.attention_checks.instruction_max_failures){const n=(t??[]).filter(a=>a?.phase==="attention_check"),r=n.filter(a=>a.attention_check_passed===!0).length,o=n.filter(a=>a.attention_check_passed===!1).length;return{total:n.length,passed:r,failed:o,exceededThreshold:o>e,threshold:e,ids:n.map(a=>a.attention_check_id)}}function Ht(){const t="attention_check_summary",e={type:V,preamble:"<h2>Thanks — moving on.</h2>",html:`
      <div style="max-width: 36rem; margin: 0 auto;">
        <p>Press <strong>Continue</strong> to proceed to the main task.</p>
      </div>
    `,button_label:"Continue",on_finish:n=>{const r=window.jsPsych?.data?.get().values()??[],o=ho(r);n.phase="attention_check_summary",n.attention_total=o.total,n.attention_passed=o.passed,n.attention_failed=o.failed,n.attention_excluded=o.exceededThreshold,n.attention_threshold=o.threshold}};return v(t,Ht),b(e,t)}const et=Object.freeze(["d_only","t_only","i_only","i_d","i_t"]);function tt(t){let e=0,n=0;for(const r of t)typeof r.probe_correct=="boolean"&&(n+=1,r.probe_correct&&(e+=1)),typeof r.star_correct=="boolean"&&(n+=1,r.star_correct&&(e+=1));return{correct:e,total:n,accuracy:n>0?e/n:0}}function X({trialType:t,trialsPerType:e,sequencePoolLabelPrefix:n,prng:r}={}){if(!et.includes(t))throw new Error(`singleTypePractice: unknown trialType '${t}'; expected one of ${et.join(", ")}`);const o=e??g.blocks.practice_trials_per_type,a=r??Oe(),i=un({blockLabel:"practice",countsByType:{[t]:o},sequencePoolLabelPrefix:n??"practice",runLengthCap:Math.max(1,o),prng:a});return{schedule:i.schedule,trialParams:i.trialParams,nodes:i.nodes}}function mo({acc:t,passed:e,willRetry:n,criterion:r}){return fo({acc:t,passed:e,willRetry:n,criterion:r})}function fo({acc:t,passed:e,willRetry:n,criterion:r}){const o=Math.round(t.accuracy*100),a=Math.round(r*100),i=e?'<h2 style="color:#0a7c4d;">Practice complete</h2>':'<h2 style="color:#b3261e;">Practice — keep going</h2>',l=e?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
  ...
  `}function Gt(){const t=g.blocks.practice_trials_per_type,e=t*5,n=Math.round(g.practice.accuracy_criterion*100),r={type:N,stimulus:`
    ...
    `,choices:[" "],data:{phase:"instructions_overview"}};return F(r.data.phase,Gt),H(r)}function yo({trialsPerType:t,accuracyCriterion:e,maxLoops:n,prng:r}={}){if(we.length!==3)throw new Error(`assembleInstructionsAndPractice: expected exactly 3 attention-check items, got ${we.length}`);const[o,a,i]=we,l=t??g.blocks.practice_trials_per_type,d=e??g.practice.accuracy_criterion,s=n??g.practice.max_loops,u=r??Oe(),c=X({trialType:"d_only",trialsPerType:l,prng:u}),p=X({trialType:"t_only",trialsPerType:l,prng:u}),m=X({trialType:"i_only",trialsPerType:l,prng:u}),w=X({trialType:"i_d",trialsPerType:l,prng:u}),y=X({trialType:"i_t",trialsPerType:l,prng:u});let k=0,x=0,f=null;const L={type:N,stimulus:"",choices:"NO_KEYS",trial_duration:0,on_start:()=>{k+=1,x=window.jsPsych?.data?.get().count()??0},data:()=>({phase:"practice_iteration_start",practice_iteration:k})};function R(){const ae="practice_feedback",Ce={type:N,stimulus:()=>{const en=(window.jsPsych?.data?.get().values()??[]).slice(x),K=tt(en),ye=K.accuracy>=d,Re=!ye&&k<=s;return f={accuracy:K.accuracy,correct:K.correct,total:K.total,passed:ye,willRetry:Re,attemptCount:k},mo({acc:K,passed:ye,willRetry:Re,criterion:d})},choices:[" "],data:()=>({phase:"practice_feedback",practice_iteration:k,iteration_accuracy:f?.accuracy??null,iteration_correct:f?.correct??null,iteration_total:f?.total??null,iteration_passed:f?.passed??null})};return v(ae,R),b(Ce,ae)}const G=R(),Zt={timeline:[L,St(),Mt(),...c.nodes,Pt(),Dt(),...p.nodes,ue(o),jt(),Yt(),...m.nodes,ue(a),Ct(),Bt(),...w.nodes,Rt(),Ft(),...y.nodes,ue(i),G],loop_function:function(ae){return!(En()||tt(ae.values()).accuracy>=d||k>s)}};return[Gt(),Zt,Ht()]}const go=Object.freeze([Object.freeze({value:1,label:'No image at all; you only "know" that you are thinking of the object'}),Object.freeze({value:2,label:"Vague and dim"}),Object.freeze({value:3,label:"Moderately clear and vivid"}),Object.freeze({value:4,label:"Clear and reasonably vivid"}),Object.freeze({value:5,label:"Perfectly clear and as vivid as normal vision"})]),he=Object.freeze([Object.freeze({id:"vviq_v1_relative",preamble:"Think of some relative or friend whom you frequently see (but who is not with you at present) and consider carefully the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q01",text:"The exact contour of face, head, shoulders and body."}),Object.freeze({id:"vviq_q02",text:"Characteristic poses of head, attitudes of body, etc."}),Object.freeze({id:"vviq_q03",text:"The precise carriage, length of step, etc. in walking."}),Object.freeze({id:"vviq_q04",text:"The different colours worn in some familiar clothes."})])}),Object.freeze({id:"vviq_v2_sunrise",preamble:"Think of the rising sun. Consider carefully the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q05",text:"The sun is rising above the horizon into a hazy sky."}),Object.freeze({id:"vviq_q06",text:"The sky clears and surrounds the sun with blueness."}),Object.freeze({id:"vviq_q07",text:"Clouds. A storm blows up, with flashes of lightning."}),Object.freeze({id:"vviq_q08",text:"A rainbow appears."})])}),Object.freeze({id:"vviq_v3_shop",preamble:"Think of the front of a shop which you often go to. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q09",text:"The overall appearance of the shop from the opposite side of the road."}),Object.freeze({id:"vviq_q10",text:"A window display including colours, shape and details of individual items for sale."}),Object.freeze({id:"vviq_q11",text:"You are near the entrance. The colour, shape and details of the door."}),Object.freeze({id:"vviq_q12",text:"You enter the shop and go to the counter. The counter assistant serves you. Money changes hands."})])}),Object.freeze({id:"vviq_v4_country",preamble:"Think of a country scene which involves trees, mountains and a lake. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q13",text:"The contours of the landscape."}),Object.freeze({id:"vviq_q14",text:"The colour and shape of the trees."}),Object.freeze({id:"vviq_q15",text:"The colour and shape of the lake."}),Object.freeze({id:"vviq_q16",text:"A strong wind blows on the tree and on the lake causing waves."})])}),Object.freeze({id:"vviq_v5_highway",preamble:"Think of being driven in a fast-moving car by a relative or friend along a major highway. Consider the picture that comes into your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q17",text:"You observe the heavy traffic travelling at maximum speed around your car. The overall appearance of vehicles, their colours, sizes and shapes."}),Object.freeze({id:"vviq_q18",text:"Your car accelerates to overtake the traffic directly in front of you. You see an urgent expression on the face of the driver and the people in the other vehicles as you pass."}),Object.freeze({id:"vviq_q19",text:"A large truck is flashing its headlight directly behind. Your car quickly moves over to let the truck pass. The driver signals with a friendly wave."}),Object.freeze({id:"vviq_q20",text:"You see a broken-down vehicle beside the road. Its lights are flashing. The driver is looking concerned and she is using a mobile phone."})])}),Object.freeze({id:"vviq_v6_beach",preamble:"Think of the beach by the ocean on a warm summer’s day. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q21",text:"The overall appearance and colour of the water, surf, and sky."}),Object.freeze({id:"vviq_q22",text:"Bathers are swimming and splashing about in the water. Some are playing with a brightly coloured beach ball."}),Object.freeze({id:"vviq_q23",text:"An ocean liner crosses the horizon. It leaves a trail of smoke in the blue sky."}),Object.freeze({id:"vviq_q24",text:"A beautiful air balloon appears with four people aboard. The balloon drifts past you, almost directly overhead. The passengers wave and smile. You wave and smile back at them."})])}),Object.freeze({id:"vviq_v7_railway",preamble:"Think of a railway station. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q25",text:"The overall appearance of the station viewed from in front of the main entrance."}),Object.freeze({id:"vviq_q26",text:"You walk into the station. The colour, shape and details of the entrance hall."}),Object.freeze({id:"vviq_q27",text:"You approach the ticket office, go to a vacant counter and purchase your ticket."}),Object.freeze({id:"vviq_q28",text:"You walk to the platform and observe other passengers and the railway lines. A train arrives. You climb aboard."})])}),Object.freeze({id:"vviq_v8_garden",preamble:"Finally, think of a garden with lawns, bushes, flowers and shrubs. Consider the picture that comes before your mind’s eye.",items:Object.freeze([Object.freeze({id:"vviq_q29",text:"The overall appearance and design of the garden."}),Object.freeze({id:"vviq_q30",text:"The colour and shape of the bushes and shrubs."}),Object.freeze({id:"vviq_q31",text:"The colour and appearance of the flowers."}),Object.freeze({id:"vviq_q32",text:"Some birds fly down onto the lawn and start pecking for food."})])})]),nt=he.reduce((t,e)=>t+e.items.length,0);if(nt!==32)throw new Error(`VVIQ_VIGNETTES must contain exactly 32 items, got ${nt}`);function Ut(t){const e=t.items.map(a=>{const i=go.map(l=>`<option value="${l.value}">${l.value} — ${l.label}</option>`).join("");return`
        ...
        </tr>`}).join(""),n=he.findIndex(a=>a.id===t.id)+1,r=t.id,o={type:V,preamble:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return v(t,Wt),b(e,t)}function Vt(){const t=W.map(r=>{const o=r.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
    ...
    `,button_label:"Continue",on_finish:r=>{r.phase="music_experience",r.music_experience_responses=W.reduce((o,a)=>{const i=r.response?.[a.id];return o[a.id]=i===""||i===null||i===void 0?null:String(i),o},{})}};return v(e,Vt),b(n,e)}function wo(){return[Wt(),Vt()]}function Kt(){const t="questionnaire_intro",e={type:N,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,Kt),b(e,t)}function _o(){return[Kt(),...bo(),...wo()]}function Jt(){const t="main_a_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
        <h2>Main task — Block 1 of 2</h2>
        <div data-voiceover-target>
          <p>Now the main task begins. There are two blocks of 60 trials. Each
          block includes a ${g.blocks.rest_duration_s}-second rest after
          trials 20 and 40, and there is another
          ${g.blocks.rest_duration_s}-second rest between the two blocks.</p>
    ...
    `,choices:[" "],data:{phase:"main_a_intro"}};return v(t,Jt),b(e,t)}function Xt(){const t="main_b_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,Xt),b(e,t)}function Qt(){const t="end_of_task_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{dn()}};return v(t,Qt),b(e,t)}const I=tn(),vo=nn();function ko(){if(lt(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}ko();const fe=rn({display_element:void 0,on_trial_start:jn(),on_data_update:t=>{ot(t).catch(e=>{console.error("[runner] storage append failed",e),at(e)})},on_finish:()=>{const t=fe.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:I.params.session_id,prolific_pid:I.params.prolific_pid,study_id:I.params.study_id,is_preview:I.params.is_preview,is_pilot_run:I.is_pilot_run,pilot_label:I.pilot_label,prng_seed_uint32:I.prng_seed_uint32,schema_version:I.schema_version,build_id:I.build_id}),console.info("[runner] session",I,"visibility",Sr())}});window.jsPsych=fe;Ln(fe);const rt=pn(),To=[...qr(),...yo(),Jt(),...rt.mainA.nodes,hn(),Xt(),...rt.mainB.nodes,Qt(),..._o(),mn({session:I}),fn()];vo.then(()=>fe.run(To)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-C6o6dPxc.js.map
