import"./modulepreload-polyfill-B5Qt9EMX.js";import{P as p,H as N,g as Ae,i as gn,a as yn}from"./index-Vh1_s8Sq.js";import{s as te,a as ut,u as bn,g as $e,b as We,c as wn,d as ht,p as _n,F as Ce,e as Re,f as Ue,h as vn,i as kn,j as $,k as C,l as me,m as Tn,n as pt,o as xn,q as En,r as In}from"./main-blocks-C5hpChAU.js";import{i as mt,b as ft,a as gt,r as yt,c as Pn}from"./uploader-CTeutibu.js";import{c as y}from"./config--mJAAK4S.js";import{c as O,u as Sn,a as On}from"./debrief-DbGCmbzK.js";import{c as jn,a as Ln,s as I,b as bt,h as Ee,d as fe,r as j,e as De,f as ze,g as Me,i as Nn,j as Ke,o as An,k as $n}from"./pattern-d3VA_-xs.js";var Cn="2.1.0";const Rn={name:"html-button-response",version:Cn,parameters:{stimulus:{type:p.HTML_STRING,default:void 0},choices:{type:p.STRING,default:void 0,array:!0},button_html:{type:p.FUNCTION,default:function(t,e){return`<button class="jspsych-btn">${t}</button>`}},prompt:{type:p.HTML_STRING,default:null},stimulus_duration:{type:p.INT,default:null},trial_duration:{type:p.INT,default:null},button_layout:{type:p.STRING,default:"grid"},grid_rows:{type:p.INT,default:1},grid_columns:{type:p.INT,default:null},response_ends_trial:{type:p.BOOL,default:!0},enable_button_after:{type:p.INT,default:0}},data:{rt:{type:p.INT},response:{type:p.INT},stimulus:{type:p.HTML_STRING}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class P{constructor(e){this.jsPsych=e}static{this.info=Rn}trial(e,n){const o=document.createElement("div");o.id="jspsych-html-button-response-stimulus",o.innerHTML=n.stimulus,e.appendChild(o);const r=document.createElement("div");if(r.id="jspsych-html-button-response-btngroup",n.button_layout==="grid"){if(r.classList.add("jspsych-btn-group-grid"),n.grid_rows===null&&n.grid_columns===null)throw new Error("You cannot set `grid_rows` to `null` without providing a value for `grid_columns`.");const d=n.grid_columns===null?Math.ceil(n.choices.length/n.grid_rows):n.grid_columns,h=n.grid_rows===null?Math.ceil(n.choices.length/n.grid_columns):n.grid_rows;r.style.gridTemplateColumns=`repeat(${d}, 1fr)`,r.style.gridTemplateRows=`repeat(${h}, 1fr)`}else n.button_layout==="flex"&&r.classList.add("jspsych-btn-group-flex");for(const[d,h]of n.choices.entries()){r.insertAdjacentHTML("beforeend",n.button_html(h,d));const m=r.lastChild;m.dataset.choice=d.toString(),m.addEventListener("click",()=>{u(d)})}e.appendChild(r),n.prompt!==null&&e.insertAdjacentHTML("beforeend",n.prompt);var a=performance.now(),i={rt:null,button:null};const l=()=>{var d={rt:i.rt,stimulus:n.stimulus,response:i.button};this.jsPsych.finishTrial(d)};function u(d){var h=performance.now(),m=Math.round(h-a);i.button=parseInt(d),i.rt=m,o.classList.add("responded");for(const _ of r.children)_.setAttribute("disabled","disabled");n.response_ends_trial&&l()}if(n.stimulus_duration!==null&&this.jsPsych.pluginAPI.setTimeout(()=>{o.style.visibility="hidden"},n.stimulus_duration),n.enable_button_after>0){for(var s=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),c=0;c<s.length;c++)s[c].setAttribute("disabled","disabled");this.jsPsych.pluginAPI.setTimeout(()=>{for(var d=document.querySelectorAll("#jspsych-html-button-response-btngroup button"),h=0;h<d.length;h++)d[h].removeAttribute("disabled")},n.enable_button_after)}n.trial_duration!==null&&this.jsPsych.pluginAPI.setTimeout(l,n.trial_duration)}simulate(e,n,o,r){n=="data-only"&&(r(),this.simulate_data_only(e,o)),n=="visual"&&this.simulate_visual(e,o,r)}create_simulation_data(e,n){const o={stimulus:e.stimulus,rt:this.jsPsych.randomization.sampleExGaussian(500,50,.006666666666666667,!0)+e.enable_button_after,response:this.jsPsych.randomization.randomInt(0,e.choices.length-1)},r=this.jsPsych.pluginAPI.mergeSimulationData(o,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,r),r}simulate_data_only(e,n){const o=this.create_simulation_data(e,n);this.jsPsych.finishTrial(o)}simulate_visual(e,n,o){const r=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),o(),r.rt!==null&&this.jsPsych.pluginAPI.clickTarget(a.querySelector(`#jspsych-html-button-response-btngroup [data-choice="${r.response}"]`),r.rt)}}let Ve=!1,q=[];const Ie=new Map;let ne=!1,Pe=!1;function Dn(t){!t||typeof t!="string"||q[q.length-1]!==t&&(q.push(t),q.length>32&&q.shift())}function wt(t){const e=typeof t?.data=="function"?null:t?.data??null;return typeof e?.phase=="string"?e.phase:null}function zn(t,e){return t&&typeof t=="object"&&typeof t!="function"?{...t,hidden_nav_step:e}:(...n)=>({...typeof t=="function"?t(...n):{},hidden_nav_step:e})}function v(t,e){!t||typeof t!="string"||typeof e!="function"||Ie.set(t,e)}function b(t,e=wt(t)){if(!e||typeof e!="string")return t;const n=t?.on_load;return t.data=zn(t?.data,e),t._hidden_nav_checkpoint=!0,t.on_load=(...o)=>{Dn(e),n?.(...o)},t}function D(t,e){v(t,e)}function z(t){return b(t,wt(t))}function Mn(){const t=Pe;return Pe=!1,t}function qn(t){const e=t?.timeline?.getLatestNode?.();return e&&typeof e.getDataParameter=="function"?e:null}function Bn(t){try{const e=qn(t);if(!e)return null;const n=e.getDataParameter?.()??{},o=typeof n.hidden_nav_step=="string"?n.hidden_nav_step:null;return{node:e,stepId:o,phase:typeof n.phase=="string"?n.phase:null}}catch{return null}}function Yn(t){const e=t?.description?.type?.info?.name??null;return e==="html-button-response"?{response:0}:e==="survey-html-form"?{response:{}}:{}}function Hn(t){const e=q.slice();if(t)for(;e[e.length-1]===t;)e.pop();return{trimmedHistory:e,prevStepId:e[e.length-1]??null}}function Je(t,e){const n=t?.parent?.description?.timeline;if(!Array.isArray(n))return!1;const o=n.indexOf(t.description);return o<0?!1:(n.splice(o+1,0,...e),!0)}function Fn(){return function(e){if(e?._hidden_nav_checkpoint===!0){ne&&(ne=!1),te(!1);return}if(!ne){te(!1);return}!e||typeof e!="object"||(e.trial_duration=0,e.choices="NO_KEYS")}}function Gn(t){if(Ve||typeof document>"u")return;const e=n=>{const o=n.target&&n.target.tagName||"";if(o==="INPUT"||o==="TEXTAREA"||n.target?.isContentEditable||n.metaKey||n.ctrlKey||n.altKey)return;const r=n.key?.toLowerCase?.();if(r!=="u"&&r!=="r")return;const a=Bn(t);if(!a)return;n.preventDefault(),n.stopPropagation(),ut();const i=Yn(a.node),l=!!a.stepId;if(r==="u"){Pe=!0,l||(ne=!0),te(!0),t.finishTrial({...i,phase:a.phase,hidden_nav:"forward",hidden_nav_step:a.stepId??null});return}const{trimmedHistory:u,prevStepId:s}=Hn(a.stepId),c=s?Ie.get(s):null;if(!c)return;let d=!1;if(l){const h=Ie.get(a.stepId);if(!h)return;d=Je(a.node,[c(),h()])}else d=Je(a.node,[c()]);d&&(q=u,ne=!1,l?te(!1):te(!0),t.finishTrial({...i,phase:a.phase,hidden_nav:"back",hidden_nav_step:a.stepId??null,hidden_nav_target_step:s}))};document.addEventListener("keydown",e,!0),Ve=!0}const Wn="online-2101803-v1",Un=`
...
`;function _t(){const t="consent";let e=!1;const n={type:P,stimulus:Un,choices:["I consent — begin","I do not consent — exit"],button_html:(o,r)=>`<button class="jspsych-btn" data-idx="${r}"${r===0?" disabled":""}>${o}</button>`,on_load:()=>{e=!1;const o=document.getElementById("consent-checkbox"),r=document.querySelector('button.jspsych-btn[data-idx="0"]');!o||!r||o.addEventListener("change",()=>{e=o.checked,r.disabled=!o.checked})},on_finish:async o=>{o.consented=o.response===0,o.consent_acknowledged=e,o.consent_version=Wn,o.consented&&await bn()},data:{phase:"consent"}};return v(t,_t),b(n,t)}function Kn(){return{timeline:[{type:P,stimulus:`
          <h2>Thank you</h2>
        ...
        `,choices:["Close"],on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Consent declined.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"consent"}).last(1).values()[0];return t?t.consented===!1:!1}}}var Vn="2.1.0";const Jn={name:"survey-html-form",version:Vn,parameters:{html:{type:p.HTML_STRING,default:null},preamble:{type:p.HTML_STRING,default:null},button_label:{type:p.STRING,default:"Continue"},autofocus:{type:p.STRING,default:""},dataAsArray:{type:p.BOOL,default:!1},autocomplete:{type:p.BOOL,default:!1}},data:{response:{type:p.OBJECT},rt:{type:p.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class X{constructor(e){this.jsPsych=e}static{this.info=Jn}trial(e,n){var o="";if(n.preamble!==null&&(o+='<div id="jspsych-survey-html-form-preamble" class="jspsych-survey-html-form-preamble">'+n.preamble+"</div>"),n.autocomplete?o+='<form id="jspsych-survey-html-form">':o+='<form id="jspsych-survey-html-form" autocomplete="off">',o+=n.html,o+='<input type="submit" id="jspsych-survey-html-form-next" class="jspsych-btn jspsych-survey-html-form" value="'+n.button_label+'"></input>',o+="</form>",e.innerHTML=o,n.autofocus!==""){var r=e.querySelectorAll("#"+n.autofocus);r.length===0?console.warn("No element found with id: "+n.autofocus):r.length>1?console.warn('The id "'+n.autofocus+'" is not unique so autofocus will not work.'):r[0].focus()}e.querySelector("#jspsych-survey-html-form").addEventListener("submit",u=>{u.preventDefault();var s=performance.now(),c=Math.round(s-a),d=e.querySelector("#jspsych-survey-html-form"),h=i(d);n.dataAsArray||(h=l(h));var m={rt:c,response:h};this.jsPsych.finishTrial(m)});var a=performance.now();function i(u){for(var s=[],c=0;c<u.elements.length;c++){var d=u.elements[c];if(!(!d.name||d.disabled||d.type==="file"||d.type==="reset"||d.type==="submit"||d.type==="button"))if(d.type==="select-multiple")for(var h=0;h<d.options.length;h++)d.options[h].selected&&s.push({name:d.name,value:d.options[h].value});else(d.type!=="checkbox"&&d.type!=="radio"||d.checked)&&s.push({name:d.name,value:d.value})}return s}function l(u){for(var s={},c=0;c<u.length;c++)s[u[c].name]=u[c].value;return s}}}const vt=18,kt=40,Xn=`
  <style>
    .demog-form {
...
`;function Tt(){const t="demographics",e={type:X,preamble:`
      <h2>Demographics</h2>
    ...
    `,html:`
      ...
      <div class="demog-form">
        ...
        <div class="demog-section" style="border-top: none; margin-top: 0; padding-top: 0;">
          ...
          <div class="field">
            <label class="field-label" for="d-dob">Date of birth<span class="req">&bull;</span></label>
            <input id="d-dob" name="date_of_birth" type="date" required
                   min="1940-01-01" max="2026-12-31" />
          </div>
    ...
    `,button_label:"Continue",data:{phase:"demographics"},on_finish:n=>{const o=n.response??{},r=o.date_of_birth;if(r){const l=new Date(r),u=new Date;let s=u.getFullYear()-l.getFullYear();const c=u.getMonth()-l.getMonth();(c<0||c===0&&u.getDate()<l.getDate())&&s--,n.computed_age=s,n.age_disqualified=s<vt||s>kt}else n.computed_age=null,n.age_disqualified=!1;const a=o.medication;n.medication_disqualified=a==="yes";const i=o.hearing;n.hearing_disqualified=i!=="no_impairment"&&i!==void 0&&i!=="",n.demographics_disqualified=n.age_disqualified||n.medication_disqualified||n.hearing_disqualified}};return v(t,Tt),b(e,t)}function Qn(){const t=mt(ft());return{timeline:[{type:P,stimulus:()=>{const e=window.jsPsych?.data?.get().filter({phase:"demographics"}).last(1).values()[0],n=e?.age_disqualified,o=e?.medication_disqualified,r=e?.hearing_disqualified,a=[];n&&a.push("be between "+vt+" and "+kt+" years of age"),r&&a.push("have normal hearing without impairment, as the study involves auditory stimuli that require accurate tone perception"),o&&a.push("not be currently taking medication that may affect attention, vision, or sensory processing");let i="";a.length===1?i="Our eligibility criteria require participants to "+a[0]+". Based on your response, you do not meet this requirement.":i="Our eligibility criteria require participants to "+a.slice(0,-1).join("; ")+"; and "+a[a.length-1]+". Based on your responses, you do not meet these requirements.";const l=t?'<p style="margin-top: 1rem; opacity: 0.7; font-size: 0.9em;">This is a test build. No Prolific action is required.</p>':'<p style="margin-top: 1rem; line-height: 1.6;">To return the study, open <a href="https://app.prolific.com/" target="_blank" rel="noopener" style="color: #60a5fa;">your Prolific dashboard</a>, find this study under your active submissions, and click <strong>Return</strong>. Returning a study does not affect your Prolific approval rating.</p>';return'<div style="max-width: 36rem; margin: 0 auto; text-align: center;"><h2>Thank you for your interest</h2><p style="font-size: 1.05rem; line-height: 1.6;">'+i+'</p><p style="line-height: 1.6;">We sincerely appreciate your willingness to participate. Please return this study on Prolific so the slot can be made available to another participant.</p>'+l+"</div>"},choices:["Return to Prolific"],data:{phase:"demographics_disqualification"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Participant disqualified at demographics screening.")}}],conditional_function:()=>window.jsPsych?.data?.get().filter({phase:"demographics"}).last(1).values()[0]?.demographics_disqualified===!0}}var Zn="2.1.0";const eo={name:"call-function",version:Zn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class be{constructor(e){this.jsPsych=e}static{this.info=eo}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{o=i,r()};n.func(a)}else o=n.func(),r()}}function to({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,i=[];return/\biphone\b/.test(r)&&i.push("iphone"),/\bipod\b/.test(r)&&i.push("ipod"),/\bipad\b/.test(r)&&i.push("ipad"),/macintosh/.test(r)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(r)&&i.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function no(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function oo(){return{type:be,async:!1,func:()=>to(no()),data:{phase:"desktop_gate"}}}function ro(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Se="display-colour-locked";function ao(){if(typeof document>"u")return!1;const t=document.documentElement;return t.classList.contains(Se)?!1:(t.classList.add(Se),!0)}function Oe(){return typeof document>"u"?!1:document.documentElement.classList.contains(Se)}const Xe="display_mode_check",io=`
  <h2>Display check</h2>
...
`;function xt(){const t={type:P,stimulus:io,choices:["Continue"],button_html:(e,n)=>`<button class="jspsych-btn" data-idx="${n}" disabled aria-disabled="true" style="opacity: 0.55; cursor: not-allowed;">${e}</button>`,on_load:()=>{const e=document.getElementById("display-colour-lock-btn"),n=document.getElementById("display-colour-lock-status"),o=document.getElementById("display-mode-gate-hint"),r=document.querySelector('button.jspsych-btn[data-idx="0"]'),a=()=>{r&&(r.disabled=!1,r.setAttribute("aria-disabled","false"),r.style.opacity="",r.style.cursor=""),o&&(o.style.display="none")},i=()=>{e&&(e.disabled=!0,e.setAttribute("aria-disabled","true"),e.style.opacity="0.55",e.style.cursor="default",e.textContent="Light mode forced"),n&&(n.style.visibility="visible"),a(),r&&typeof r.focus=="function"&&r.focus()};Oe()?i():e&&e.addEventListener("click",()=>{ao(),i()})},on_finish:e=>{e.display_colour_locked=Oe()},data:{phase:"display_mode_check"}};return v(Xe,xt),b(t,Xe)}const so=85.6,je=1.5,Le=12,lo=100,co=1100,he=320,uo=2,Qe="screen_calibration",Ze="screen_calibration_retry_hint",ho=`
  ...
  <input id="cc-slider" type="range" min="${lo}" max="${co}" value="${he}"
...
`;function Et(){const t={type:P,stimulus:ho,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),o=()=>{const r=parseInt(e.value,10);n.style.width=`${r}px`,n.style.height=`${r*(53.98/85.6)}px`};e.addEventListener("input",o),o()},on_finish:e=>{const n=document.getElementById("cc-slider"),o=n?parseInt(n.value,10):he,r=o/so;e.cc_px_width=o,e.px_per_mm=r,e.px_per_mm_in_bounds=r>=je&&r<=Le,e.px_per_mm_min=je,e.px_per_mm_max=Le,e.display_colour_locked=Oe(),document.documentElement.style.setProperty("--mm",`${r}px`)},data:{phase:"screen_calibration"}};return v(Qe,Et),b(t,Qe)}function mo(){return{type:be,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=je&&t.px_per_mm<=Le),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function It(){const t={type:P,stimulus:po,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Ze,It),b(t,Ze)}function fo(t){return{timeline:[It()],conditional_function:()=>t.count>=1}}function go({maxAttempts:t=uo}={}){const e={count:0};return{timeline:[fo(e),Et(),mo(),yo(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function yo(t,e){return{type:be,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],o=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:o,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const bo="72vh",wo="#000",_o="50rem",vo="95vw",ko="72rem",Pt=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${bo};
  color: ${wo};
`.replace(/\s+/g," ").trim(),St=`${Pt} width: ${_o}; max-width: 94vw;`,To=`${Pt} width: ${vo}; max-width: ${ko}; align-items: center;`,Ot=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim(),xo=`
  ...
  min-height: 0;
  width: 100%;
`.replace(/\s+/g," ").trim();function jt({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${Nt(n.trim())}"`:"";return`
    <div style="${`${St} min-height: auto; padding-top: 0.4rem; padding-bottom: 0.4rem; font-size: 0.95rem; line-height: 1.5;`}">
      <div style="flex: 0 0 auto; width: 100%; margin: 0 0 0.5rem; display: flex; align-items: center; justify-content: center;">
        <h2 style="${qe}">${t}</h2>
      </div>
      <div style="${xo}" data-voiceover-target${o}>${e}</div>
    </div>
  `}const Be=50,L=Be/2,Lt=Be*Math.SQRT2/2+1,Ne=Lt-L+.5,ce=Be+2*Ne,et={cx:35,cy:15},tt={cx:15,cy:35},Eo=2.5,Io=2.5,nt=100,Po=30,So=12,Oo=12,jo=[1,2,3,7,10,11,12,13,14,17,21,22,23],de=10,Lo="#FFFFFF",No=.33;function Ao(t,e,n){const r=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:r,u=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(u)},${e+l*Math.sin(u)}`)}return a.join(" ")}const $o=Ao(tt.cx,tt.cy,Io),Co="rgba(0, 0, 0, 0.229)",Ro="rgba(0, 0, 0, 0.55)",ot="#000",rt="rgba(0, 0, 0, 0.85)";function Do(t,{arrowAngleDeg:e=Po}={}){const n=new Set(t),o=n.has("tone")||n.has("qmark"),r=n.has("pattern"),a=`<circle cx="${L}" cy="${L}" r="${Lt}" fill="none" stroke="${Co}" stroke-width="0.5" />`,i=o||r?"":`<circle cx="${L}" cy="${L}" r="0.65" fill="${Ro}" />`,l=r?jo.map(f=>{const w=f%5,x=Math.floor(f/5),g=w*de,A=x*de;return`<rect x="${g}" y="${A}" width="${de}" height="${de}" fill="${Lo}" opacity="${No}" />`}).join(""):"",u=n.has("dot")?`<circle cx="${et.cx}" cy="${et.cy}" r="${Eo}" fill="${ot}" />`:"",s=n.has("star")?`<polygon points="${$o}" fill="${ot}" />`:"",c=n.has("tone")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${rt}" font-size="${So}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",d=n.has("qmark")?`<text x="${L}" y="${L}" text-anchor="middle" dominant-baseline="central" fill="${rt}" font-size="${Oo}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
    <svg viewBox="${-Ne} ${-Ne} ${ce} ${ce}"
         width="100%" height="100%" style="display: block; overflow: visible;">
      ${a}${l}${i}${u}${s}${c}${d}
    </svg>
  `,m=(e/360).toFixed(6),_=n.has("arrow")?`<img src="${zo()}" alt="rotation cue"
  ...
  `}function zo(){return"./assets/rotation-arrow.png"}function k({title:t,body:e,narration:n,exemplar:o=[],arrowAngleDeg:r}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${Nt(n.trim())}"`:"",i=Do(o,typeof r=="number"?{arrowAngleDeg:r}:{});return`
    <div style="${St} align-items: center;">
      <div style="${Ot}">
        <h2 style="${qe}">${t}</h2>
      </div>
  ...
  `}function Nt(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Mo=jt({title:"Sit comfortably for the study",body:`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Bo(){const t=b({type:P,stimulus:Mo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:P,stimulus:qo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function At(){const t="speaker_volume_instruction",e={type:P,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=Z;const l=Promise.resolve();We(Z/100);const u=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const g=Number(u.value);a=g,s&&(s.textContent=`${g}%`),We(g/100)});const c=document.getElementById("tac-yes-btn");if(c&&c.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await l,e)return;const d=wn(),h=ht(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+Ko)/1e3,f=Vo/1e3,w=[];for(let g=0;g<h.length;g++)w.push(document.getElementById(`tac-box-${g}`));let x=d.currentTime+Jo/1e3;try{for(let g=0;g<Xo&&!e;g++){r=g+1;for(let A=0;A<h.length&&!e;A++){const M=x;if(_n(A,{when:M}),await Te(d,M),e)break;const K=w[A];K&&K.classList.add("playing"),await Te(d,M+m),K&&K.classList.remove("playing"),x=M+_}e||(await Te(d,x+f),x+=f)}}catch{}if(!o&&!e){n=!0;const g=document.getElementById("tac-yes-btn");g&&g.click()}},on_finish:l=>{ut();const u=$e();u.current&&!u.current._state?.finished&&u.current.cancel(),l.tones_audible=o&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,Rt),b(i,t)}function er(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"tone_audibility_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Tone audibility failed.")}}],conditional_function:()=>{const t=window.jsPsych?.data?.get().filter({phase:"tone_audibility_and_comfort"}).last(1).values()[0];return t?t.tones_audible===!1:!1}}}function tr(){return[oo(),ro(),_t(),Kn(),Tt(),Qn(),Bo(),xt(),go(),At(),Ct(),Uo(),Rt(),er()]}var nr="2.1.0";const or={name:"instructions",version:nr,parameters:{pages:{type:p.HTML_STRING,default:void 0,array:!0},key_forward:{type:p.KEY,default:"ArrowRight"},key_backward:{type:p.KEY,default:"ArrowLeft"},allow_backward:{type:p.BOOL,default:!0},allow_keys:{type:p.BOOL,default:!0},show_clickable_nav:{type:p.BOOL,default:!1},show_page_number:{type:p.BOOL,default:!1},page_label:{type:p.STRING,default:"Page"},button_label_previous:{type:p.STRING,default:"Previous"},button_label_next:{type:p.STRING,default:"Next"},on_page_change:{type:p.FUNCTION,pretty_name:"Page change callback",default:function(t){}}},data:{view_history:{type:p.COMPLEX,array:!0,nested:{page_index:{type:p.INT},viewing_time:{type:p.INT}}},rt:{type:p.INT}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class re{constructor(e){this.jsPsych=e}static{this.info=or}trial(e,n){var o=0,r=[],a=performance.now(),i=a;function l(){this.id==="jspsych-instructions-back"?c():this.id==="jspsych-instructions-next"&&s()}function u(){var f=n.pages[o],w="";if(n.show_page_number&&(w="<span style='margin: 0 1em;' class='jspsych-instructions-pagenum'>"+n.page_label+" "+(o+1)+"/"+n.pages.length+"</span>"),n.show_clickable_nav){var x="<div class='jspsych-instructions-nav' style='padding: 10px 0px;'>";if(n.allow_backward){var g=o>0?"":"disabled='disabled'";x+="<button id='jspsych-instructions-back' class='jspsych-btn' style='margin-right: 5px;' "+g+">&lt; "+n.button_label_previous+"</button>"}n.pages.length>1&&n.show_page_number&&(x+=w),x+="<button id='jspsych-instructions-next' class='jspsych-btn'style='margin-left: 5px;'>"+n.button_label_next+" &gt;</button></div>",f+=x,e.innerHTML=f,o!=0&&n.allow_backward&&e.querySelector("#jspsych-instructions-back").addEventListener("click",l,{once:!0}),e.querySelector("#jspsych-instructions-next").addEventListener("click",l,{once:!0})}else n.show_page_number&&n.pages.length>1&&(f+="<div class='jspsych-instructions-pagenum'>"+w+"</div>"),e.innerHTML=f}function s(){d(),o++,o>=n.pages.length?h():u(),n.on_page_change(o)}function c(){d(),o--,u(),n.on_page_change(o)}function d(){var f=performance.now(),w=Math.round(f-i);r.push({page_index:o,viewing_time:w}),i=f}const h=()=>{n.allow_keys&&this.jsPsych.pluginAPI.cancelKeyboardResponse(_);var f={view_history:r,rt:Math.round(performance.now()-a)};this.jsPsych.finishTrial(f)},m=f=>{_=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1,allow_held_key:!1}),this.jsPsych.pluginAPI.compareKeys(f.key,n.key_backward)&&o!==0&&n.allow_backward&&c(),this.jsPsych.pluginAPI.compareKeys(f.key,n.key_forward)&&s()};if(u(),n.allow_keys)var _=this.jsPsych.pluginAPI.getKeyboardResponse({callback_function:m,valid_responses:[n.key_forward,n.key_backward],rt_method:"performance",persist:!1})}simulate(e,n,o,r){n=="data-only"&&(r(),this.simulate_data_only(e,o)),n=="visual"&&this.simulate_visual(e,o,r)}create_simulation_data(e,n){let o=0,r=0,a=[];if(!n.data?.view_history&&!n.data?.rt)for(;o!==e.pages.length;){const u=Math.round(this.jsPsych.randomization.sampleExGaussian(3e3,300,.0033333333333333335));a.push({page_index:o,viewing_time:u}),r+=u,o==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?o++:o--}if(!n.data?.view_history&&n.data?.rt){for(r=n.data.rt;o!==e.pages.length;)a.push({page_index:o,viewing_time:null}),o==0||!e.allow_backward||this.jsPsych.randomization.sampleBernoulli(.9)==1?o++:o--;const u=n.data.rt/a.length;let s=0;for(const h of a){const m=Math.round(this.jsPsych.randomization.sampleExGaussian(u,u/10,1/(u/10)));h.viewing_time=m,s+=m}const c=n.data.rt-s,d=Math.round(c/a.length);for(const h of a)h.viewing_time+=d}if(n.data?.view_history&&!n.data?.rt){a=n.data.view_history,r=0;for(const u of n.data.view_history)r+=u.viewing_time}const i={view_history:a,rt:r},l=this.jsPsych.pluginAPI.mergeSimulationData(i,n);return this.jsPsych.pluginAPI.ensureSimulationDataConsistency(e,l),l}simulate_data_only(e,n){const o=this.create_simulation_data(e,n);this.jsPsych.finishTrial(o)}simulate_visual(e,n,o){const r=this.create_simulation_data(e,n),a=this.jsPsych.getDisplayElement();this.trial(a,e),o();const i=c=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_forward,c):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-next"),c)},l=c=>{e.allow_keys?this.jsPsych.pluginAPI.pressKey(e.key_backward,c):e.show_clickable_nav&&this.jsPsych.pluginAPI.clickTarget(a.querySelector("#jspsych-instructions-back"),c)};let u=0,s=0;for(let c=0;c<r.view_history.length;c++)c==r.view_history.length-1?i(s+r.view_history[c].viewing_time):(r.view_history[c+1].page_index>u&&i(s+r.view_history[c].viewing_time),r.view_history[c+1].page_index<u&&l(s+r.view_history[c].viewing_time),s+=r.view_history[c].viewing_time,u=r.view_history[c+1].page_index)}}const Dt=`<span style="color: ${Ce};"><strong>green</strong></span>`,zt=`<span style="color: ${Re};"><strong>red</strong></span>`,Mt=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function qt(){const t=y.memory.set_size,e="Task 1 — Remember the dots",n=[k({title:e,body:`
      ...
      `,narration:`After the dots, we test your memory ${t} times. Each time, a black dot appears for 3 seconds in some location. Press Yes, the right arrow, if a dot was shown in that location. Press No, the left arrow, if it was not. Keep your eyes on the centre of the circle throughout.`,exemplar:["qmark"]}),k({title:e,body:`
        ...
        ${Dt} for correct or
        ${zt} for incorrect while it is still on screen.</p>
      `,narration:"You have 3 seconds for each test. Aim for accuracy first, but don't dwell. If you answer in time, the dot turns green for correct or red for incorrect while it is still on screen.",exemplar:["qmark"]})],o={type:re,pages:n,...Mt,data:{phase:"instructions_memory_d_only"}};return D(o.data.phase,qt),z(o)}function Bt(){const t=y.memory.set_size,e="Task 2 — Remember the tones",n=[k({title:e,body:`
      ...
      `,narration:`Then we play ${t} more tones, one at a time. For each one: Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. Keep your eyes on the centre of the circle and listen.`,exemplar:["qmark"]}),k({title:e,body:`
        ...
        set earlier.</p>
      `,narration:"You have 3 seconds for each test. If you answer in time, the central question mark turns green for correct or red for incorrect. Please make sure your audio volume is still at the level you set earlier.",exemplar:["tone"]})],o={type:re,pages:n,...Mt,data:{phase:"instructions_memory_t_only"}};return D(o.data.phase,Bt),z(o)}const rr=`<span style="color: ${Ce};"><strong>green</strong></span>`,ar=`<span style="color: ${Re};"><strong>red</strong></span>`,ir='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',sr=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Yt(){const t=y.imagery.stars_per_trial,e="Task 3 — Picture the pattern",n=[k({title:e,body:`
      ...
      `,narration:`Then ${t} bright stars will flash inside the circle, one at a time. For each star, decide whether it lands on the rotated pattern you are picturing. Press On-pattern, the right arrow, if the star falls on your pictured pattern. Press Not on-pattern, the left arrow, if it does not.`,exemplar:["star"]}),k({title:e,body:`
        ...
        ${rr} for correct or
        ${ar} for incorrect while it is still on screen.</p>
        <p>Be honest about your mental picture — if it's fuzzy, just do
        your best.</p>
      `,narration:"You have 3 seconds for each star. Aim for accuracy first, but don't dwell. If you answer in time, the star turns green for correct or red for incorrect while it is still on screen. Be honest about your mental picture — if it's fuzzy, just do your best.",exemplar:["star"]})],o={type:re,pages:n,...sr,data:{phase:"instructions_imagery_i_only"}};return D(o.data.phase,Yt),z(o)}const Ht=`<span style="color: ${Ce};"><strong>green</strong></span>`,Ft=`<span style="color: ${Re};"><strong>red</strong></span>`,Gt='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',Wt=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Ut(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,o="Task 4 — Dots and pattern together",r=[k({title:o,body:`
      ...
      `,narration:`Then ${n} things appear inside the circle one at a time, mixed together. ${e} stars — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} dots — remember which locations they appear in, for the dot tests at the end of the trial.`,exemplar:["star","dot"]}),k({title:o,body:`
        ...
        ${Ht} for correct or ${Ft} for incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the dot tests begin.",exemplar:["pattern"]})],a={type:re,pages:r,...Wt,data:{phase:"instructions_dual_i_d"}};return D(a.data.phase,Ut),z(a)}function Kt(){const t=y.memory.set_size,e=y.imagery.stars_per_trial,n=t+e,o="Task 5 — Tones and pattern together",r=[k({title:o,body:`
      ...
      `,narration:`Then ${n} things happen one at a time, mixed together. ${e} stars inside the circle — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} tones — remember each tone you hear, for the tone tests at the end of the trial.`,exemplar:["star","tone"]}),k({title:o,body:`
        ...
        mark turns ${Ht} for correct or ${Ft} for
        incorrect.</p>
      `,narration:`After the ${n} things, we test your tone memory ${t} times. Each test plays a tone. Press Yes, the right arrow, if you heard this tone before. Press No, the left arrow, if you did not. You have 3 seconds for each star and each tone test. If you answer in time, the star or central question mark turns green for correct or red for incorrect.`,exemplar:["qmark"]}),k({title:o,body:`
        ...
        <p>Please make sure your audio volume is still at the level you
        set earlier.</p>
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier.",exemplar:["pattern"]})],a={type:re,pages:r,...Wt,data:{phase:"instructions_dual_i_t"}};return D(a.data.phase,Kt),z(a)}const lr=4,Vt=1e3*lr,cr=2e3,dr=400,E=500,T=400,Y=1200,ur=700,hr=450,pr=220,H=1500,Ye=1e3,mr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function He(){return Ae().pick(mr)}const fr="./assets/rotation-arrow.png";function gr(t,e){return`
    <style>
    ...
    ">
      ${O(`Press <kbd>Space</kbd> when you are ready to start the practice for Task ${t}.`)}
    </div>
  `}function yr(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setSpaceArmed(e){const n=!!e;t.spaceArmed=n;const o=typeof document<"u"?document.getElementById("demo-hint"):null;o&&(o.style.opacity=n?"1":"0",o.setAttribute("aria-hidden",n?"false":"true"))},setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const o=vn(e);o?(kn(),t.currentNarration=$e().speak(o)):t.currentNarration=null},async wait(e){return await Ue(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let o=!1;const r=()=>{o||(o=!0,n())};e.done.then(r).catch(r);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),r())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await Ue(dr),t.cancelled)?!1:(this.setCaption(e),!0)},async narrate(e){return!(!await this.advanceCaption(e)||!await this.awaitNarration())}}}function br(t,e){const n=y.imagery.rotation_arrow_size_px,o=document.createElement("img");return o.src=fr,o.alt="rotation cue",o.className="rotation-arrow-cue demo-arrow",o.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none","filter: brightness(0) saturate(100%) drop-shadow(1px 0 0 #fff) drop-shadow(-1px 0 0 #fff) drop-shadow(0 1px 0 #fff) drop-shadow(0 -1px 0 #fff)"].join("; ")+";"),t.wrapper.appendChild(o),o}function ue(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function Fe(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),Nn(t),Ke(t),!await e.awaitNarration()||!await e.wait(1e3)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;Ee(t);const i=br(t,n);return!await e.awaitNarration()||!await e.wait(600)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(ue(i),!1):(ue(i),bt(t,n),Ke(t),!await e.awaitNarration()||!await e.wait(1500)?!1:(Ee(t),!0))}function ae(){const t=An(),e=$n();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function F({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `;const o=n.querySelector(".demo-buttons-container"),r=n.querySelector('button[data-side="left"]'),a=n.querySelector('button[data-side="right"]'),i=n.querySelector('.demo-btn-key[data-side="left"]'),l=n.querySelector('.demo-btn-key[data-side="right"]'),u=n.querySelector('.demo-hand[data-side="left"]'),s=n.querySelector('.demo-hand[data-side="right"]');return{container:o,leftBtn:r,rightBtn:a,leftKey:i,rightKey:l,leftHand:u,rightHand:s}}function B(){const t=document.getElementById("demo-buttons-row");t&&(t.innerHTML="")}function ie(){const t=document.getElementById("demo-watch-banner-row");return t?(t.innerHTML=`
    <div class="demo-watch-banner" role="status" aria-live="polite">
      Just watch and listen, don't respond yet
    </div>
  `,!0):!1}function Jt(){const t=document.getElementById("demo-watch-banner-row");t&&(t.innerHTML="")}function wr(t){t&&(t.leftHand?.classList.add("is-visible"),t.rightHand?.classList.add("is-visible"))}async function G(t,e,n){if(!t)return!0;if(wr(t),!await n.wait(ur))return!1;const o=e==="right"?t.rightHand:t.leftHand;if(o&&(o.classList.remove("is-pressing"),o.offsetWidth,o.classList.add("is-pressing")),!await n.wait(Math.min(hr,220)))return!1;const r=e==="right"?t.rightBtn:t.leftBtn;return r&&(r.classList.remove("demo-btn-pressed"),r.offsetWidth,r.classList.add("demo-btn-pressed")),!!await n.wait(pr)}function W(t){t&&(t.leftHand?.classList.remove("is-visible","is-pressing"),t.rightHand?.classList.remove("is-visible","is-pressing"))}const R=Object.freeze({left:"No",right:"Yes"}),V=Object.freeze({left:"Not on-pattern",right:"On-pattern"});function U({pressedLabel:t,correctLabel:e,isCorrect:n,stimulusName:o}){const r=`<span style="color: ${$}; font-weight: 600;">correct</span>`,a=`<span style="color: ${C}; font-weight: 600;">incorrect</span>`;return n?`We chose <strong>${t}</strong> — that was the ${r} answer, so the ${o} turns green.`:`We chose <strong>${t}</strong> — that was ${a}; the ${r} answer was <strong>${e}</strong>, so the ${o} turns red.`}async function _r(t,e){const{memCells:n,fillerCells:o,probeCells:r}=ae();if(ie(),!await e.narrate("Memorize the locations of the dots that will appear inside the circle one at a time.")||!await e.advanceCaption("")||!await e.wait(E))return;for(let l=0;l<3;l++){const u=fe(t,n[l]);if(!await e.wait(Vt)||(j(u),!await e.wait(T)))return;const s=De(t,o[l],{visible:!1});if(!await e.wait(Ye))return;j(s)}if(!await e.narrate("Hold the dots in mind for a moment.")||(I(t,"?"),!await e.wait(T)))return;const a=F({leftLabel:"No",rightLabel:"Yes"}),i=2;for(let l=0;l<r.length;l++){const u=r[l],s=u.isTarget?"right":"left",c=l===i?s==="right"?"left":"right":s;if(!await e.narrate(`Test ${l+1} of 3: was a dot just shown in this location?`)||!await e.wait(E))return;const d=fe(t,u.cell);if(!await e.wait(Y)||!await G(a,c,e))return;const h=c===s;if(d.setAttribute("fill",h?$:C),!await e.wait(H)||!await e.narrate(U({pressedLabel:R[c],correctLabel:R[s],isCorrect:h,stimulusName:"dot"}))||(W(a),j(d),!await e.wait(T)))return}I(t,"")}async function vr(t,e){const{memCells:n,fillerCells:o,probeCells:r}=ae();if(ie(),!await e.narrate("Memorize each of the tones that will play one at a time.")||!await e.advanceCaption("")||!await e.wait(E))return;for(let l=0;l<3;l++){if(await me(n[l]).catch(()=>{}),!await e.wait(T))return;const u=De(t,o[l],{visible:!1});if(!await e.wait(Ye))return;j(u)}if(!await e.narrate("Hold the tones in mind for a moment.")||(I(t,"?"),!await e.wait(T)))return;const a=F({leftLabel:"No",rightLabel:"Yes"}),i=2;for(let l=0;l<r.length;l++){const u=r[l],s=u.isTarget?"right":"left",c=l===i?s==="right"?"left":"right":s;if(!await e.wait(E)||(await me(u.cell).catch(()=>{}),!await e.wait(T))||!await e.narrate(`Test ${l+1} of 3: was that tone one of the ones you just heard?`)||!await e.wait(Y)||!await G(a,c,e))return;const d=c===s;if(I(t,"?",{color:d?$:C}),!await e.wait(H)||!await e.narrate(U({pressedLabel:R[c],correctLabel:R[s],isCorrect:d,stimulusName:"question mark"}))||(W(a),I(t,"?"),!await e.wait(T)))return}I(t,"")}async function kr(t,e){const n=He();if(ie(),!await e.narrate("Picture the pattern, turn it in your mind, then judge whether each star falls on the rotated pattern.")||!await Fe(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 3 stars will appear inside the circle. For each star, decide whether it falls <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const o=F({leftLabel:"Not on-pattern",rightLabel:"On-pattern"}),{fillerCells:r,starCells:a}=ae(),i=2;for(let l=0;l<3;l++){const u=De(t,r[l],{visible:!1});if(!await e.wait(Ye))return;j(u);const s=a[l],c=s.isOn?"right":"left",d=l===i?c==="right"?"left":"right":c;if(!await e.wait(E))return;const h=ze(t,s.cell);if(!await e.wait(Y)||!await G(o,d,e))return;const m=d===c;if(Me(h,m?$:C),!await e.wait(H)||!await e.narrate(U({pressedLabel:V[d],correctLabel:V[c],isCorrect:m,stimulusName:"star"}))||(W(o),j(h),!await e.wait(T)))return}}async function Tr(t,e){const n=He();if(ie(),!await e.narrate("Picture the rotated pattern, memorize the dot locations, and judge whether each star falls on the rotated pattern.")||!await Fe(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 6 things appear inside the circle, mixed together: 3 dots to remember, 3 stars to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{memCells:o,starCells:r,probeCells:a}=ae(),i=2;for(let s=0;s<3;s++){if(B(),!await e.wait(E))return;const c=fe(t,o[s]);if(!await e.wait(Vt)||(j(c),!await e.wait(T)))return;const d=r[s],h=d.isOn?"right":"left",m=s===i?h==="right"?"left":"right":h,_=F({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await e.wait(E))return;const f=ze(t,d.cell);if(!await e.wait(Y)||!await G(_,m,e))return;const w=m===h;if(Me(f,w?$:C),!await e.wait(H)||!await e.narrate(U({pressedLabel:V[m],correctLabel:V[h],isCorrect:w,stimulusName:"star"}))||(W(_),j(f),!await e.advanceCaption(""))||!await e.wait(T))return}if(B(),!await e.narrate("The question mark means the dot tests begin. You may let the picture go and focus on the dots.")||!await e.advanceCaption(""))return;const l=F({leftLabel:"No",rightLabel:"Yes"});if(I(t,"?"),!await e.wait(T))return;const u=2;for(let s=0;s<a.length;s++){const c=a[s],d=c.isTarget?"right":"left",h=s===u?d==="right"?"left":"right":d;if(!await e.narrate(`Dot test ${s+1} of 3: was a dot shown in this location?`)||!await e.wait(E))return;const m=fe(t,c.cell);if(!await e.wait(Y)||!await G(l,h,e))return;const _=h===d;if(m.setAttribute("fill",_?$:C),!await e.wait(H)||!await e.narrate(U({pressedLabel:R[h],correctLabel:R[d],isCorrect:_,stimulusName:"dot"}))||(W(l),j(m),!await e.wait(T)))return}I(t,"")}async function xr(t,e){const n=He();if(ie(),!await e.narrate("Picture the rotated pattern, memorize each tone, and judge whether each star falls on the rotated pattern.")||!await Fe(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 6 things happen, mixed together: 3 tones to remember, 3 stars (inside the circle) to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{memCells:o,starCells:r,probeCells:a}=ae(),i=2;for(let s=0;s<3;s++){if(B(),!await e.wait(E)||(await me(o[s]).catch(()=>{}),!await e.wait(T)))return;const c=r[s],d=c.isOn?"right":"left",h=s===i?d==="right"?"left":"right":d,m=F({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await e.wait(E))return;const _=ze(t,c.cell);if(!await e.wait(Y)||!await G(m,h,e))return;const f=h===d;if(Me(_,f?$:C),!await e.wait(H)||!await e.narrate(U({pressedLabel:V[h],correctLabel:V[d],isCorrect:f,stimulusName:"star"}))||(W(m),j(_),!await e.advanceCaption(""))||!await e.wait(T))return}if(B(),!await e.narrate("The question mark means the tone tests begin. You may let the picture go and focus on the tones.")||!await e.advanceCaption(""))return;const l=F({leftLabel:"No",rightLabel:"Yes"});if(I(t,"?"),!await e.wait(T))return;const u=2;for(let s=0;s<a.length;s++){const c=a[s],d=c.isTarget?"right":"left",h=s===u?d==="right"?"left":"right":d;if(!await e.wait(E)||(await me(c.cell).catch(()=>{}),!await e.wait(T))||!await e.narrate(`Tone test ${s+1} of 3: was that tone one of the ones you just heard?`)||!await e.wait(Y)||!await G(l,h,e))return;const m=h===d;if(I(t,"?",{color:m?$:C}),!await e.wait(H)||!await e.narrate(U({pressedLabel:R[h],correctLabel:R[d],isCorrect:m,stimulusName:"question mark"}))||(W(l),I(t,"?"),!await e.wait(T)))return}I(t,"")}const Er=3;async function Ir(t,e){if(t.state.cancelled)return!1;Jt();const n=document.getElementById("demo-buttons-row");if(!n)return!1;n.innerHTML=`
    <div class="demo-buttons-container" style="
      position: relative;
      display: inline-flex;
      align-items: center;
  ...
  `;const o=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${o} Click the button below to watch it again.`)?new Promise(r=>{let a=!1;const i=s=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(d=>d.removeEventListener("click",l)),r(s)},l=s=>{const c=s.currentTarget.getAttribute("data-side");i(c==="right")};n.querySelectorAll(".demo-replay-btn").forEach(s=>s.addEventListener("click",l));const u=setInterval(()=>{t.state.cancelled&&(clearInterval(u),i(!1)),a&&clearInterval(u)},100)}):!1}function se(t){return async function(n,o){let r=0;for(;!o.state.cancelled;){try{await t(n,o)}catch(l){console.error("[demo] mini-trial error",l);return}if(o.state.cancelled)return;o.setSpaceArmed(!0);const a=Er-r;if(a<=0){if(Jt(),!await o.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;B();return}if(!await Ir(o,a)){await o.advanceCaption("Press Space when you are ready to start the practice."),B();return}r+=1,o.setSpaceArmed(!1);try{Ln(n),B(),I(n,""),n.rotor.style.transition="",bt(n,0),Ee(n)}catch{}if(!await o.advanceCaption("Replaying the demonstration…")||!await o.wait(cr))return}}}const Pr=se(_r),Sr=se(vr),Or=se(kr),jr=se(Tr),Lr=se(xr);function le({phase:t,taskNumber:e,title:n,run:o,factory:r}){const a={type:N,stimulus:gr(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const i=document.getElementById("demo-mount");if(!i)return;const l=jn({rotation_deg:0,fixation:"",background_shade:"gray"});i.appendChild(l.wrapper);const u=yr(),s=window.jsPsych?.getCurrentTrial?.();s&&typeof s=="object"&&(s._demo_state=u.state);let c=!0;const d=h=>{if(c){if(h.key==="ArrowLeft"||h.key==="ArrowRight"){h.preventDefault(),h.stopPropagation();return}if(h.key===" "||h.code==="Space"){if(h.preventDefault(),h.stopPropagation(),!u.state.spaceArmed)return;c=!1,document.removeEventListener("keydown",d,!0),u.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",d,!0),s&&typeof s=="object"&&(s._demo_keydown_handler=d),o(l,u).catch(h=>{console.error(`[demo:${t}] schedule error`,h)})},on_finish:()=>{const i=window.jsPsych?.getCurrentTrial?.();i?._demo_state&&(i._demo_state.cancelled=!0),i?._demo_keydown_handler&&(document.removeEventListener("keydown",i._demo_keydown_handler,!0),i._demo_keydown_handler=null);try{$e().cancel()}catch{}},data:{phase:t}};return D(t,r),z(a)}function Xt(){return le({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:Pr,factory:Xt})}function Qt(){return le({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:Sr,factory:Qt})}function Zt(){return le({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:Or,factory:Zt})}function en(){return le({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:jr,factory:en})}function tn(){return le({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:Lr,factory:tn})}const xe=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function st(t){return typeof t!="string"?"":t.trim().toLowerCase()}function pe(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:X,preamble:"<h2>Quick check</h2>",html:`
    ...
    `,button_label:"Continue",on_finish:o=>{const r=o.response?.response??"",a=st(r);o.attention_check_id=t.id,o.attention_check_raw=r,o.attention_check_passed=a===st(t.expected_answer)},data:{phase:"attention_check"}};return v(e,()=>pe(t)),b(n,e)}function Nr(t,e=y.attention_checks.instruction_max_failures){const n=(t??[]).filter(a=>a?.phase==="attention_check"),o=n.filter(a=>a.attention_check_passed===!0).length,r=n.filter(a=>a.attention_check_passed===!1).length;return{total:n.length,passed:o,failed:r,exceededThreshold:r>e,threshold:e,ids:n.map(a=>a.attention_check_id)}}function nn(){const t="attention_check_summary",e={type:X,preamble:"<h2>Thanks — moving on.</h2>",html:`
      <div style="max-width: 36rem; margin: 0 auto;">
        <p>Press <strong>Continue</strong> to proceed to the main task.</p>
      </div>
    `,button_label:"Continue",on_finish:n=>{const o=window.jsPsych?.data?.get().values()??[],r=Nr(o);n.phase="attention_check_summary",n.attention_total=r.total,n.attention_passed=r.passed,n.attention_failed=r.failed,n.attention_excluded=r.exceededThreshold,n.attention_threshold=r.threshold}};return v(t,nn),b(e,t)}const lt=Object.freeze(["d_only","t_only","i_only","i_d","i_t"]);function ct(t){let e=0,n=0;for(const o of t)typeof o.probe_correct=="boolean"&&(n+=1,o.probe_correct&&(e+=1)),typeof o.star_correct=="boolean"&&(n+=1,o.star_correct&&(e+=1));return{correct:e,total:n,accuracy:n>0?e/n:0}}function ee({trialType:t,trialsPerType:e,sequencePoolLabelPrefix:n,prng:o}={}){if(!lt.includes(t))throw new Error(`singleTypePractice: unknown trialType '${t}'; expected one of ${lt.join(", ")}`);const r=e??y.blocks.practice_trials_per_type,a=o??Ae(),i=Tn({blockLabel:"practice",countsByType:{[t]:r},sequencePoolLabelPrefix:n??"practice",runLengthCap:Math.max(1,r),prng:a});return{schedule:i.schedule,trialParams:i.trialParams,nodes:i.nodes}}function Ar({acc:t,passed:e,willRetry:n,criterion:o}){return $r({acc:t,passed:e,willRetry:n,criterion:o})}function $r({acc:t,passed:e,willRetry:n,criterion:o}){const r=Math.round(t.accuracy*100),a=Math.round(o*100),i=e?'<h2 style="color:#0a7c4d;">Practice complete</h2>':n?`<h2 style="color:#b3261e;">Practice — let's try again</h2>`:'<h2 style="color:#b3261e;">Practice — below criterion</h2>',l=e?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
       (${r}%), above the ${a}% criterion.</p>
       ${O("Press <kbd>Space</kbd> to start the main task.")}`:n?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
         (${r}%), below the ${a}% criterion. Let's try the practice
         once more.</p>
         ${O("Press <kbd>Space</kbd> to begin.")}`:`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
         (${r}%), below the ${a}% criterion.</p>
         ${O("Press <kbd>Space</kbd> to continue.")}`;return`
    <div style="display: grid; place-items: center; gap: 1rem; max-width: 36rem; margin: 0 auto;">
      ${i}
      ${l}
    </div>
  `}function on(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:N,stimulus:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return v(t,sn),b(e,t)}function ln(){const t=J.map(o=>{const r=o.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
    ...
    `,button_label:"Continue",on_finish:o=>{o.phase="music_experience",o.music_experience_responses=J.reduce((r,a)=>{const i=o.response?.[a.id];return r[a.id]=i===""||i===null||i===void 0?null:String(i),r},{})}};return v(e,ln),b(n,e)}function Br(){return[sn(),ln()]}function cn(){const t="questionnaire_intro",e={type:N,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,cn),b(e,t)}function Yr(){return[cn(),...qr(),...Br()]}function dn(){const t="main_a_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
        ...
        <div data-voiceover-target>
          ...
          what to expect.</p>
          ${O("Press <kbd>Space</kbd> to begin Block 1.")}
        </div>
      </div>
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{pt()}};return v(t,dn),b(e,t)}function un(){const t="main_b_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
        ...
        <div data-voiceover-target>
          ...
          and 40.</p>
          ${O("Press <kbd>Space</kbd> to begin Block 2.")}
        </div>
      </div>
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,un),b(e,t)}function hn(){const t="end_of_task_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{xn(),pt()}};return v(t,hn),b(e,t)}const S=gn(),Hr=Pn();function Fr(){if(ht(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}Fr();const we=yn({display_element:void 0,on_trial_start:Fn(),on_data_update:t=>{gt(t).catch(e=>{console.error("[runner] storage append failed",e),yt(e)})},on_finish:()=>{const t=we.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:S.params.session_id,prolific_pid:S.params.prolific_pid,study_id:S.params.study_id,is_preview:S.params.is_preview,is_pilot_run:S.is_pilot_run,pilot_label:S.pilot_label,prng_seed_uint32:S.prng_seed_uint32,schema_version:S.schema_version,build_id:S.build_id}),console.info("[runner] session",S,"visibility",Wo())}});window.jsPsych=we;new URLSearchParams(window.location.search).has("devnav")&&Gn(we);const dt=En(),Gr=[...tr(),...Cr(),dn(),...dt.mainA.nodes,In({session:S}),un(),...dt.mainB.nodes,hn(),...Yr(),Sn({session:S}),On()];Hr.then(()=>we.run(Gr)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-CpwpLLis.js.map
