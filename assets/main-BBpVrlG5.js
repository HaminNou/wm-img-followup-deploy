...
`;function pt(){const t="consent";let e=!1;const n={type:P,stimulus:Rn,choices:["I consent — begin","I do not consent — exit"],button_html:(r,o)=>`<button class="jspsych-btn" data-idx="${o}"${o===0?" disabled":""}>${r}</button>`,on_load:()=>{e=!1;const r=document.getElementById("consent-checkbox"),o=document.querySelector('button.jspsych-btn[data-idx="0"]');!r||!o||r.addEventListener("change",()=>{e=r.checked,o.disabled=!r.checked})},on_finish:async r=>{r.consented=r.response===0,r.consent_acknowledged=e,r.consent_version=$n,r.consented&&await sn()},data:{phase:"consent"}};return v(t,pt),b(n,t)}function Cn(){return{timeline:[{type:P,stimulus:`
          <h2>Thank you</h2>
...
`;function mt(){const t="demographics",e={type:K,preamble:`
      <h2>Demographics</h2>
    ...
    `,button_label:"Continue",data:{phase:"demographics"}};return v(t,mt),b(e,t)}var qn="2.1.0";const Bn={name:"call-function",version:qn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class ye{constructor(e){this.jsPsych=e}static{this.info=Bn}trial(e,n){let r;const o=()=>{const a={value:r};this.jsPsych.finishTrial(a)};if(n.async){const a=i=>{r=i,o()};n.func(a)}else r=n.func(),o()}}function Yn({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:r=0}={}){const o=String(t).toLowerCase(),a=Number.isFinite(r)?r:0,i=[];return/\biphone\b/.test(o)&&i.push("iphone"),/\bipod\b/.test(o)&&i.push("ipod"),/\bipad\b/.test(o)&&i.push("ipad"),/macintosh/.test(o)&&a>1&&i.push("ipad_macos_disguised"),/android/.test(o)&&i.push("android"),/mobile/.test(o)&&!/iphone|ipad|ipod|android/.test(o)&&i.push("mobile_ua"),e===!1&&n===!1&&i.push("no_hover_no_fine_pointer"),{isDesktop:i.length===0,reasons:i,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Fn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const r=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:r}}function Hn(){return{type:ye,async:!1,func:()=>Yn(Fn()),data:{phase:"desktop_gate"}}}function Gn(){return{timeline:[{type:P,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Wn=85.6,Ee=1.5,Ie=12,Un=100,Kn=1100,ue=320,Vn=2,He="screen_calibration",Ge="screen_calibration_retry_hint",Jn=`
  ...
  <div id="cc-stage" style="margin: 1.5rem auto; height: 14rem; position: relative;">
    <div id="cc-rect"
         style="position: absolute; left: 50%; top: 1rem; transform: translateX(-50%);
                width: ${ue}px; height: ${ue*(53.98/85.6)}px; border: 2px solid #000; border-radius: 6px;
                background: linear-gradient(135deg, #1f3a8a 0%, #1e40af 100%);">
    </div>
  </div>
  <input id="cc-slider" type="range" min="${Un}" max="${Kn}" value="${ue}"
...
`;function ft(){const t={type:P,stimulus:Jn,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),r=()=>{const o=parseInt(e.value,10);n.style.width=`${o}px`,n.style.height=`${o*(53.98/85.6)}px`};e.addEventListener("input",r),r()},on_finish:e=>{const n=document.getElementById("cc-slider"),r=n?parseInt(n.value,10):ue,o=r/Wn;e.cc_px_width=r,e.px_per_mm=o,e.px_per_mm_in_bounds=o>=Ee&&o<=Ie,e.px_per_mm_min=Ee,e.px_per_mm_max=Ie,document.documentElement.style.setProperty("--mm",`${o}px`)},data:{phase:"screen_calibration"}};return v(He,ft),b(t,He)}function Qn(){return{type:ye,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=Ee&&t.px_per_mm<=Ie),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function yt(){const t={type:P,stimulus:Xn,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Ge,yt),b(t,Ge)}function Zn(t){return{timeline:[yt()],conditional_function:()=>t.count>=1}}function er({maxAttempts:t=Vn}={}){const e={count:0};return{timeline:[Zn(e),ft(),Qn(),tr(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function tr(t,e){return{type:ye,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],r=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:r,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const nr="72vh",rr="#000",or="50rem",ar="95vw",ir="72rem",gt=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${nr};
  color: ${rr};
`.replace(/\s+/g," ").trim(),bt=`${gt} width: ${or}; max-width: 94vw;`,sr=`${gt} width: ${ar}; max-width: ${ir}; align-items: center;`,wt=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim(),lr=`
  ...
  min-height: 0;
  width: 100%;
`.replace(/\s+/g," ").trim();function _t({title:t,body:e,narration:n}){const r=typeof n=="string"&&n.trim()?` data-voiceover-script="${kt(n.trim())}"`:"";return`
    <div style="${`${bt} min-height: auto; padding-top: 0.4rem; padding-bottom: 0.4rem; font-size: 0.95rem; line-height: 1.5;`}">
  ...
  `}const Ae=50,j=Ae/2,vt=Ae*Math.SQRT2/2+1,Se=vt-j+.5,se=Ae+2*Se,We={cx:35,cy:15},Ue={cx:15,cy:35},cr=2.5,ur=2.5,Ke=100,dr=30,hr=12,pr=12,mr=[1,2,3,7,10,11,12,13,14,17,21,22,23],le=10,fr="#FFFFFF",yr=.33;function gr(t,e,n){const o=n*.382,a=[];for(let i=0;i<10;i++){const l=i%2===0?n:o,d=-Math.PI/2+i*Math.PI/5;a.push(`${t+l*Math.cos(d)},${e+l*Math.sin(d)}`)}return a.join(" ")}const br=gr(Ue.cx,Ue.cy,ur),wr="rgba(0, 0, 0, 0.229)",_r="rgba(0, 0, 0, 0.55)",Ve="#000",Je="rgba(0, 0, 0, 0.85)";function vr(t,{arrowAngleDeg:e=dr}={}){const n=new Set(t),r=n.has("tone")||n.has("qmark"),o=n.has("pattern"),a=`<circle cx="${j}" cy="${j}" r="${vt}" fill="none" stroke="${wr}" stroke-width="0.5" />`,i=r||o?"":`<circle cx="${j}" cy="${j}" r="0.65" fill="${_r}" />`,l=o?mr.map(y=>{const k=y%5,x=Math.floor(y/5),f=k*le,L=x*le;return`<rect x="${f}" y="${L}" width="${le}" height="${le}" fill="${fr}" opacity="${yr}" />`}).join(""):"",d=n.has("dot")?`<circle cx="${We.cx}" cy="${We.cy}" r="${cr}" fill="${Ve}" />`:"",s=n.has("star")?`<polygon points="${br}" fill="${Ve}" />`:"",u=n.has("tone")?`<text x="${j}" y="${j}" text-anchor="middle" dominant-baseline="central" fill="${Je}" font-size="${hr}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",c=n.has("qmark")?`<text x="${j}" y="${j}" text-anchor="middle" dominant-baseline="central" fill="${Je}" font-size="${pr}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",h=`
    <svg viewBox="${-Se} ${-Se} ${se} ${se}"
         width="100%" height="100%" style="display: block; overflow: visible;">
      ${a}${l}${i}${d}${s}${u}${c}
    </svg>
  `,m=(e/360).toFixed(6),w=n.has("arrow")?`<img src="${kr()}" alt="rotation cue"
            style="position: absolute; top: 50%; left: 50%; width: ${Ke}px; height: ${Ke}px;
    ...
    <div style="position: relative; width: calc(var(--mm) * ${se}); height: calc(var(--mm) * ${se}); margin: 0 auto;">
      ${h}${w}
    </div>
  `}function kr(){return"./assets/rotation-arrow.png"}function _({title:t,body:e,narration:n,exemplar:r=[],arrowAngleDeg:o}){const a=typeof n=="string"&&n.trim()?` data-voiceover-script="${kt(n.trim())}"`:"",i=vr(r,typeof o=="number"?{arrowAngleDeg:o}:{});return`
  ...
  `}function kt(t){return t.replace(/&/g,"&amp;").replace(/"/g,"&quot;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}const Tr=_t({title:"Sit comfortably for the study",body:`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function Er(){const t=b({type:P,stimulus:Tr,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=b({type:P,stimulus:xr,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function Tt(){const t="speaker_volume_instruction",e={type:P,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:l=>`<button class="jspsych-btn" id="tac-yes-btn">${l}</button>`,on_load:async()=>{e=!1,n=!1,r=!1,o=0,a=J;const l=Promise.resolve();Me(J/100);const d=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");d&&d.addEventListener("input",()=>{const f=Number(d.value);a=f,s&&(s.textContent=`${f}%`),Me(f/100)});const u=document.getElementById("tac-yes-btn");if(u&&u.addEventListener("click",()=>{n||(r=!0),e=!0},{capture:!0}),await l,e)return;const c=ln(),h=ct(),m=g.tones.duration_ms/1e3,w=(g.tones.duration_ms+Nr)/1e3,y=Ar/1e3,k=[];for(let f=0;f<h.length;f++)k.push(document.getElementById(`tac-box-${f}`));let x=c.currentTime+$r/1e3;try{for(let f=0;f<Rr&&!e;f++){o=f+1;for(let L=0;L<h.length&&!e;L++){const C=x;if(cn(L,{when:C}),await we(c,C),e)break;const G=k[L];G&&G.classList.add("playing"),await we(c,C+m),G&&G.classList.remove("playing"),x=C+w}e||(await we(c,x+y),x+=y)}}catch{}if(!r&&!e){n=!0;const f=document.getElementById("tac-yes-btn");f&&f.click()}},on_finish:l=>{st();const d=lt();d.current&&!d.current._state?.finished&&d.current.cancel(),l.tones_audible=r&&!n,l.user_playback_pct=a,l.user_playback_gain=a/100,l.sweeps_completed=o},data:{phase:"tone_audibility_and_comfort"}};return v(t,It),b(i,t)}function zr(){return{timeline:[{type:P,stimulus:`
      ...
      `,narration:"You have 3 seconds for each star. Aim for accuracy first, but don't dwell. If you answer in time, the star turns green for correct or red for incorrect while it is still on screen. Be honest about your mental picture — if it's fuzzy, just do your best. Press Space for the Task 3 demonstration.",exemplar:["star"]})],r={type:te,pages:n,...Gr,data:{phase:"instructions_imagery_i_only"}};return F(r.data.phase,Nt),H(r)}const At='<span style="color: #0DE72E;"><strong>green</strong></span>',$t='<span style="color: #FF1818;"><strong>red</strong></span>',Rt='<p style="border-left: 3px solid #772139; padding: 0.5rem 0.75rem; margin: 1rem 0; background: rgba(119, 33, 57, 0.08);">',Ct=Object.freeze({key_forward:" ",key_backward:"ArrowLeft",allow_backward:!0,allow_keys:!0,show_clickable_nav:!0,show_page_number:!0,page_label:"Page",button_label_previous:"Previous",button_label_next:"Next"});function Dt(){const t=g.memory.set_size,e=g.imagery.stars_per_trial,n=t+e,r="Task 4 — Dots and pattern together",o=[_({title:r,body:`
      ...
      `,narration:`Then ${n} things appear inside the circle one at a time, mixed together. ${e} stars — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} dots — remember which locations they appear in, for the dot tests at the end of the trial.`,exemplar:["star","dot"]}),_({title:r,body:`
        ...
        ${At} for correct or ${$t} for incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the dot tests begin. Press Space for the Task 4 demonstration.",exemplar:["pattern"]})],a={type:te,pages:o,...Ct,data:{phase:"instructions_dual_i_d"}};return F(a.data.phase,Dt),H(a)}function zt(){const t=g.memory.set_size,e=g.imagery.stars_per_trial,n=t+e,r="Task 5 — Tones and pattern together",o=[_({title:r,body:`
      ...
      `,narration:`Then ${n} things happen one at a time, mixed together. ${e} stars inside the circle — for each star, press On-pattern, the right arrow, if it lands on your rotated pattern, or Not on-pattern, the left arrow, if it does not. And ${t} tones — remember each tone you hear, for the tone tests at the end of the trial.`,exemplar:["star","tone"]}),_({title:r,body:`
        ...
        mark turns ${At} for correct or ${$t} for
        incorrect.</p>
      ...
      `,narration:"Very important: keep the picture of the rotated pattern in mind during the entire trial. You may drop it only when the central question mark appears — that is when the tone tests begin. Please make sure your audio volume is still at the level you set earlier. Press Space for the Task 5 demonstration.",exemplar:["pattern"]})],a={type:te,pages:o,...Ct,data:{phase:"instructions_dual_i_t"}};return F(a.data.phase,zt),H(a)}const Wr=4,Mt=1e3*Wr,Ur=2e3,Kr=400,E=500,T=400,z=1200,Vr=700,Ze=450,Jr=220,M=1500,$e=1e3,Xr=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function Re(){return Oe().pick(Xr)}const Qr="./assets/rotation-arrow.png";function Zr(t,e){return`
    <style>
    ...
    <div class="demo-frame" style="${sr}">
      <div style="${wt}">
        <h2 style="${Ne}">Demonstration of Task ${t} — ${e}</h2>
      </div>
  ...
  `}function eo(){const t={cancelled:!1,spaceArmed:!1,currentNarration:null};return{state:t,setCaption(e){const n=document.getElementById("demo-caption");if(!n)return;n.innerHTML=e,n.classList.remove("demo-caption-bump"),n.offsetWidth,n.classList.add("demo-caption-bump");const r=un(e);r?(dn(),t.currentNarration=lt().speak(r)):t.currentNarration=null},async wait(e){return await qe(e),!t.cancelled},async awaitNarration(){const e=t.currentNarration;return e?.done&&await new Promise(n=>{let r=!1;const o=()=>{r||(r=!0,n())};e.done.then(o).catch(o);const a=setInterval(()=>{t.cancelled&&(clearInterval(a),o())},100);e.done.finally(()=>clearInterval(a))}),!t.cancelled},async advanceCaption(e){return t.cancelled||!await this.awaitNarration()||e!==""&&(await qe(Kr),t.cancelled)?!1:(this.setCaption(e),!0)},async narrate(e){return!(!await this.advanceCaption(e)||!await this.awaitNarration())}}}function to(t,e){const n=g.imagery.rotation_arrow_size_px,r=document.createElement("img");return r.src=Qr,r.alt="rotation cue",r.className="rotation-arrow-cue demo-arrow",r.setAttribute("style",["position: absolute","top: 50%","left: 50%",`width: ${n}px`,`height: ${n}px`,`transform: translate(-50%, -50%) rotate(${e}deg)`,"pointer-events: none","z-index: 10","user-select: none","filter: brightness(0) saturate(100%)"].join("; ")+";"),t.wrapper.appendChild(r),r}function ce(t){t&&t.parentNode&&t.parentNode.removeChild(t)}async function Ce(t,e,n){if(e.setCaption("Step 1 of 3 — Here is the pattern. Picture it in your mind."),_n(t),Be(t),!await e.awaitNarration()||!await e.wait(1e3)||!await e.advanceCaption(`Step 2 of 3 — An arrow tells you which way to turn the pattern in your mind (here, by ${n>0?"+":""}${n}°).`))return!1;ke(t);const i=to(t,n);return!await e.awaitNarration()||!await e.wait(600)||!await e.advanceCaption("Step 3 of 3 — This is how your rotated mental image should look. Hold this picture in your mind.")?(ce(i),!1):(ce(i),dt(t,n),Be(t),!await e.awaitNarration()||!await e.wait(1500)?!1:(ke(t),!0))}function ne(){const t=vn(),e=kn();return{memCells:[t[0],e[1],t[2]],fillerCells:[e[0],t[1],e[2]],probeCells:[{cell:t[0],isTarget:!0,label:"on"},{cell:e[1],isTarget:!0,label:"off"},{cell:e[4],isTarget:!1,label:"off"}],starCells:[{cell:t[5],isOn:!0},{cell:e[5],isOn:!1},{cell:t[6],isOn:!0}]}}function re({leftLabel:t,rightLabel:e}){const n=document.getElementById("demo-buttons-row");if(!n)return null;n.innerHTML=`
  ...
  `;const r=n.querySelector(".demo-buttons-container"),o=n.querySelector('button[data-side="left"]'),a=n.querySelector('button[data-side="right"]'),i=n.querySelector('.demo-btn-key[data-side="left"]'),l=n.querySelector('.demo-btn-key[data-side="right"]'),d=n.querySelector(".demo-hand");return{container:r,leftBtn:o,rightBtn:a,leftKey:i,rightKey:l,hand:d}}function qt(t,e,n){if(!t?.leftBtn||!t?.rightBtn)return!1;const r=t.leftBtn.querySelector(".demo-btn-label"),o=t.rightBtn.querySelector(".demo-btn-label");return r&&(r.textContent=e),o&&(o.textContent=n),!0}function _e(){const t=document.getElementById("demo-buttons-row");t&&(t.innerHTML="")}function et(t,e){if(!t?.container||!t?.hand)return;const n=(e==="right"?t.rightKey:t.leftKey)??(e==="right"?t.rightBtn:t.leftBtn);if(!n)return;const r=t.container.getBoundingClientRect(),o=n.getBoundingClientRect(),a=o.left+o.width/2-r.left,i=o.bottom-r.top+4;t.hand.style.left=`${a}px`,t.hand.style.top=`${i}px`}async function q(t,e,n){if(!t)return!0;if(et(t,e==="right"?"left":"right"),t.hand.style.transition="none",t.hand.style.opacity="0",t.hand.offsetWidth,t.hand.style.transition="opacity 200ms ease-out",t.hand.style.opacity="0.95",!await n.wait(Vr)||(t.hand.style.transition=`left ${Ze}ms ease-in-out`,et(t,e),!await n.wait(Ze)))return!1;const r=e==="right"?t.rightBtn:t.leftBtn;return r&&(r.classList.remove("demo-btn-pressed"),r.offsetWidth,r.classList.add("demo-btn-pressed")),!!await n.wait(Jr)}function B(t){t?.hand&&(t.hand.style.transition="opacity 200ms ease-in",t.hand.style.opacity="0")}const R=Object.freeze({left:"No",right:"Yes"}),W=Object.freeze({left:"Not on-pattern",right:"On-pattern"});function Y({pressedLabel:t,correctLabel:e,isCorrect:n,stimulusName:r}){const o=`<span style="color: ${A}; font-weight: 600;">correct</span>`,a=`<span style="color: ${$}; font-weight: 600;">incorrect</span>`;return n?`We chose <strong>${t}</strong> — that was the ${o} answer, so the ${r} turns green.`:`We chose <strong>${t}</strong> — that was ${a}; the ${o} answer was <strong>${e}</strong>, so the ${r} turns red.`}async function no(t,e){const{memCells:n,fillerCells:r,probeCells:o}=ne(),a=re({leftLabel:"No",rightLabel:"Yes"});if(!await e.narrate("Memorize the locations of the dots that will appear inside the circle one at a time.")||!await e.advanceCaption("")||!await e.wait(E))return;for(let l=0;l<3;l++){const d=pe(t,n[l]);if(!await e.wait(Mt)||(O(d),!await e.wait(T)))return;const s=Pe(t,r[l],{visible:!1});if(!await e.wait($e))return;O(s)}if(!await e.narrate("Hold the dots in mind for a moment.")||(I(t,"?"),!await e.wait(T)))return;const i=2;for(let l=0;l<o.length;l++){const d=o[l],s=d.isTarget?"right":"left",u=l===i?s==="right"?"left":"right":s;if(!await e.narrate(`Test ${l+1} of 3: was a dot just shown in this location?`)||!await e.wait(E))return;const c=pe(t,d.cell);if(!await e.wait(z)||!await q(a,u,e))return;const h=u===s;if(c.setAttribute("fill",h?A:$),!await e.wait(M)||!await e.narrate(Y({pressedLabel:R[u],correctLabel:R[s],isCorrect:h,stimulusName:"dot"}))||(B(a),O(c),!await e.wait(T)))return}I(t,"")}async function ro(t,e){const{memCells:n,fillerCells:r,probeCells:o}=ne(),a=re({leftLabel:"No",rightLabel:"Yes"});if(!await e.narrate("Memorize each of the tones that will play one at a time.")||!await e.advanceCaption("")||!await e.wait(E))return;for(let l=0;l<3;l++){if(await he(n[l]).catch(()=>{}),!await e.wait(T))return;const d=Pe(t,r[l],{visible:!1});if(!await e.wait($e))return;O(d)}if(!await e.narrate("Hold the tones in mind for a moment.")||(I(t,"?"),!await e.wait(T)))return;const i=2;for(let l=0;l<o.length;l++){const d=o[l],s=d.isTarget?"right":"left",u=l===i?s==="right"?"left":"right":s;if(!await e.wait(E)||(await he(d.cell).catch(()=>{}),!await e.wait(T))||!await e.narrate(`Test ${l+1} of 3: was that tone one of the ones you just heard?`)||!await e.wait(z)||!await q(a,u,e))return;const c=u===s;if(I(t,"?",{color:c?A:$}),!await e.wait(M)||!await e.narrate(Y({pressedLabel:R[u],correctLabel:R[s],isCorrect:c,stimulusName:"question mark"}))||(B(a),I(t,"?"),!await e.wait(T)))return}I(t,"")}async function oo(t,e){const n=Re(),r=re({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await e.narrate("Picture the pattern, turn it in your mind, then judge whether each star falls on the rotated pattern.")||!await Ce(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 3 stars will appear inside the circle. For each star, decide whether it falls <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{fillerCells:o,starCells:a}=ne(),i=2;for(let l=0;l<3;l++){const d=Pe(t,o[l],{visible:!1});if(!await e.wait($e))return;O(d);const s=a[l],u=s.isOn?"right":"left",c=l===i?u==="right"?"left":"right":u;if(!await e.wait(E))return;const h=je(t,s.cell);if(!await e.wait(z)||!await q(r,c,e))return;const m=c===u;if(Le(h,m?A:$),!await e.wait(M)||!await e.narrate(Y({pressedLabel:W[c],correctLabel:W[u],isCorrect:m,stimulusName:"star"}))||(B(r),O(h),!await e.wait(T)))return}}async function ao(t,e){const n=Re(),r=re({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await e.narrate("Picture the rotated pattern, memorize the dot locations, and judge whether each star falls on the rotated pattern.")||!await Ce(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 6 things appear inside the circle, mixed together: 3 dots to remember, 3 stars to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{memCells:o,starCells:a,probeCells:i}=ne(),l=2;for(let s=0;s<3;s++){if(!await e.wait(E))return;const u=pe(t,o[s]);if(!await e.wait(Mt)||(O(u),!await e.wait(T)))return;const c=a[s],h=c.isOn?"right":"left",m=s===l?h==="right"?"left":"right":h;if(!await e.wait(E))return;const w=je(t,c.cell);if(!await e.wait(z)||!await q(r,m,e))return;const y=m===h;if(Le(w,y?A:$),!await e.wait(M)||!await e.narrate(Y({pressedLabel:W[m],correctLabel:W[h],isCorrect:y,stimulusName:"star"}))||(B(r),O(w),!await e.wait(T)))return}if(!await e.narrate("The question mark means the dot tests begin. You may let the picture go and focus on the dots.")||(qt(r,"No","Yes"),I(t,"?"),!await e.wait(T)))return;const d=2;for(let s=0;s<i.length;s++){const u=i[s],c=u.isTarget?"right":"left",h=s===d?c==="right"?"left":"right":c;if(!await e.narrate(`Dot test ${s+1} of 3: was a dot shown in this location?`)||!await e.wait(E))return;const m=pe(t,u.cell);if(!await e.wait(z)||!await q(r,h,e))return;const w=h===c;if(m.setAttribute("fill",w?A:$),!await e.wait(M)||!await e.narrate(Y({pressedLabel:R[h],correctLabel:R[c],isCorrect:w,stimulusName:"dot"}))||(B(r),O(m),!await e.wait(T)))return}I(t,"")}async function io(t,e){const n=Re(),r=re({leftLabel:"Not on-pattern",rightLabel:"On-pattern"});if(!await e.narrate("Picture the rotated pattern, memorize each tone, and judge whether each star falls on the rotated pattern.")||!await Ce(t,e,n)||!await e.narrate("Now keep picturing the turned pattern. 6 things happen, mixed together: 3 tones to remember, 3 stars (inside the circle) to judge as <strong>on-pattern</strong> or <strong>not on-pattern</strong>.")||!await e.wait(E)||!await e.advanceCaption(""))return;const{memCells:o,starCells:a,probeCells:i}=ne(),l=2;for(let s=0;s<3;s++){if(!await e.wait(E)||(await he(o[s]).catch(()=>{}),!await e.wait(T)))return;const u=a[s],c=u.isOn?"right":"left",h=s===l?c==="right"?"left":"right":c;if(!await e.wait(E))return;const m=je(t,u.cell);if(!await e.wait(z)||!await q(r,h,e))return;const w=h===c;if(Le(m,w?A:$),!await e.wait(M)||!await e.narrate(Y({pressedLabel:W[h],correctLabel:W[c],isCorrect:w,stimulusName:"star"}))||(B(r),O(m),!await e.wait(T)))return}if(!await e.narrate("The question mark means the tone tests begin. You may let the picture go and focus on the tones.")||(qt(r,"No","Yes"),I(t,"?"),!await e.wait(T)))return;const d=2;for(let s=0;s<i.length;s++){const u=i[s],c=u.isTarget?"right":"left",h=s===d?c==="right"?"left":"right":c;if(!await e.wait(E)||(await he(u.cell).catch(()=>{}),!await e.wait(T))||!await e.narrate(`Tone test ${s+1} of 3: was that tone one of the ones you just heard?`)||!await e.wait(z)||!await q(r,h,e))return;const m=h===c;if(I(t,"?",{color:m?A:$}),!await e.wait(M)||!await e.narrate(Y({pressedLabel:R[h],correctLabel:R[c],isCorrect:m,stimulusName:"question mark"}))||(B(r),I(t,"?"),!await e.wait(T)))return}I(t,"")}const so=3;async function lo(t,e){if(t.state.cancelled)return!1;const n=document.getElementById("demo-buttons-row");if(!n)return!1;n.innerHTML=`
    <div class="demo-buttons-container" style="
      position: relative;
      display: inline-flex;
      align-items: center;
  ...
  `;const r=e===1?" (this is the last replay you can request)":` (you can watch up to ${e} more time${e===1?"":"s"})`;return await t.advanceCaption(`Would you like to watch the demonstration again?${r} Click the button below to watch it again. When you are ready to start the practice, press the <kbd>Space</kbd> key.`)?new Promise(o=>{let a=!1;const i=s=>{if(a)return;a=!0,n.querySelectorAll(".demo-replay-btn").forEach(c=>c.removeEventListener("click",l)),o(s)},l=s=>{const u=s.currentTarget.getAttribute("data-side");i(u==="right")};n.querySelectorAll(".demo-replay-btn").forEach(s=>s.addEventListener("click",l));const d=setInterval(()=>{t.state.cancelled&&(clearInterval(d),i(!1)),a&&clearInterval(d)},100)}):!1}function oe(t){return async function(n,r){let o=0;for(;!r.state.cancelled;){try{await t(n,r)}catch(l){console.error("[demo] mini-trial error",l);return}if(r.state.cancelled)return;r.state.spaceArmed=!0;const a=so-o;if(a<=0){if(!await r.advanceCaption("That was the last demonstration. Press Space when you are ready to start the practice."))return;_e();return}if(!await lo(r,a)){await r.advanceCaption("Press Space when you are ready to start the practice."),_e();return}o+=1;try{wn(n),_e(),I(n,""),n.rotor.style.transition="",dt(n,0),ke(n)}catch{}if(!await r.advanceCaption("Replaying the demonstration…")||!await r.wait(Ur))return}}}const co=oe(no),uo=oe(ro),ho=oe(oo),po=oe(ao),mo=oe(io);function ae({phase:t,taskNumber:e,title:n,run:r,factory:o}){const a={type:N,stimulus:Zr(e,n),choices:"NO_KEYS",response_ends_trial:!1,on_load:()=>{const i=document.getElementById("demo-mount");if(!i)return;const l=bn({rotation_deg:0,fixation:"",background_shade:"gray"});i.appendChild(l.wrapper);const d=eo(),s=window.jsPsych?.getCurrentTrial?.();s&&typeof s=="object"&&(s._demo_state=d.state);let u=!0;const c=h=>{if(u){if(h.key==="ArrowLeft"||h.key==="ArrowRight"){h.preventDefault(),h.stopPropagation();return}if(h.key===" "||h.code==="Space"){if(h.preventDefault(),h.stopPropagation(),!d.state.spaceArmed)return;u=!1,document.removeEventListener("keydown",c,!0),d.state.cancelled=!0,window.jsPsych?.finishTrial?.({demo_advanced_via_space:!0})}}};document.addEventListener("keydown",c,!0),s&&typeof s=="object"&&(s._demo_keydown_handler=c),r(l,d).catch(h=>{console.error(`[demo:${t}] schedule error`,h)})},on_finish:()=>{const i=window.jsPsych?.getCurrentTrial?.();i?._demo_state&&(i._demo_state.cancelled=!0),i?._demo_keydown_handler&&(document.removeEventListener("keydown",i._demo_keydown_handler,!0),i._demo_keydown_handler=null)},data:{phase:t}};return F(t,o),H(a)}function Bt(){return ae({phase:"demo_d_only",taskNumber:1,title:"Remember the dots",run:co,factory:Bt})}function Yt(){return ae({phase:"demo_t_only",taskNumber:2,title:"Remember the tones",run:uo,factory:Yt})}function Ft(){return ae({phase:"demo_i_only",taskNumber:3,title:"Picture the pattern",run:ho,factory:Ft})}function Ht(){return ae({phase:"demo_i_d",taskNumber:4,title:"Dots and pattern together",run:po,factory:Ht})}function Gt(){return ae({phase:"demo_i_t",taskNumber:5,title:"Tones and pattern together",run:mo,factory:Gt})}const ve=Object.freeze([Object.freeze({id:"ac1_direct_instruction",prompt:"To show you are reading carefully, please type the word <strong>paper</strong> into the box below (lowercase, no punctuation).",expected_answer:"paper"}),Object.freeze({id:"ac2_third_word",prompt:"In the sentence “Click the third word in this sentence”, what is the third word? Type just that word into the box below.",expected_answer:"third"}),Object.freeze({id:"ac3_arrow_mapping",prompt:"When a star points right, you press the right-arrow key. To show you understood, type the word <strong>right</strong> into the box below.",expected_answer:"right"})]);function tt(t){return typeof t!="string"?"":t.trim().toLowerCase()}function de(t){if(!t?.id||!t?.prompt||!t?.expected_answer)throw new Error(`typedAttentionCheckNode: item must have {id, prompt, expected_answer}, got ${JSON.stringify(t)}`);const e=`attention_check_${t.id}`,n={type:K,preamble:"<h2>Quick check</h2>",html:`
    ...
    `,button_label:"Continue",on_finish:r=>{const o=r.response?.response??"",a=tt(o);r.attention_check_id=t.id,r.attention_check_raw=o,r.attention_check_passed=a===tt(t.expected_answer)},data:{phase:"attention_check"}};return v(e,()=>de(t)),b(n,e)}function fo(t,e=g.attention_checks.instruction_max_failures){const n=(t??[]).filter(a=>a?.phase==="attention_check"),r=n.filter(a=>a.attention_check_passed===!0).length,o=n.filter(a=>a.attention_check_passed===!1).length;return{total:n.length,passed:r,failed:o,exceededThreshold:o>e,threshold:e,ids:n.map(a=>a.attention_check_id)}}function Wt(){const t="attention_check_summary",e={type:K,preamble:"<h2>Thanks — moving on.</h2>",html:`
      <div style="max-width: 36rem; margin: 0 auto;">
        <p>Press <strong>Continue</strong> to proceed to the main task.</p>
      </div>
    `,button_label:"Continue",on_finish:n=>{const r=window.jsPsych?.data?.get().values()??[],o=fo(r);n.phase="attention_check_summary",n.attention_total=o.total,n.attention_passed=o.passed,n.attention_failed=o.failed,n.attention_excluded=o.exceededThreshold,n.attention_threshold=o.threshold}};return v(t,Wt),b(e,t)}const nt=Object.freeze(["d_only","t_only","i_only","i_d","i_t"]);function rt(t){let e=0,n=0;for(const r of t)typeof r.probe_correct=="boolean"&&(n+=1,r.probe_correct&&(e+=1)),typeof r.star_correct=="boolean"&&(n+=1,r.star_correct&&(e+=1));return{correct:e,total:n,accuracy:n>0?e/n:0}}function X({trialType:t,trialsPerType:e,sequencePoolLabelPrefix:n,prng:r}={}){if(!nt.includes(t))throw new Error(`singleTypePractice: unknown trialType '${t}'; expected one of ${nt.join(", ")}`);const o=e??g.blocks.practice_trials_per_type,a=r??Oe(),i=hn({blockLabel:"practice",countsByType:{[t]:o},sequencePoolLabelPrefix:n??"practice",runLengthCap:Math.max(1,o),prng:a});return{schedule:i.schedule,trialParams:i.trialParams,nodes:i.nodes}}function yo({acc:t,passed:e,willRetry:n,criterion:r}){return go({acc:t,passed:e,willRetry:n,criterion:r})}function go({acc:t,passed:e,willRetry:n,criterion:r}){const o=Math.round(t.accuracy*100),a=Math.round(r*100),i=e?'<h2 style="color:#0a7c4d;">Practice complete</h2>':'<h2 style="color:#b3261e;">Practice — keep going</h2>',l=e?`<p>You got <strong>${t.correct} / ${t.total}</strong> correct
  ...
  `}function Ut(){const t=g.blocks.practice_trials_per_type,e=t*5,n=Math.round(g.practice.accuracy_criterion*100),r={type:N,stimulus:`
    ...
    `,choices:[" "],data:{phase:"instructions_overview"}};return F(r.data.phase,Ut),H(r)}function bo({trialsPerType:t,accuracyCriterion:e,maxLoops:n,prng:r}={}){if(ve.length!==3)throw new Error(`assembleInstructionsAndPractice: expected exactly 3 attention-check items, got ${ve.length}`);const[o,a,i]=ve,l=t??g.blocks.practice_trials_per_type,d=e??g.practice.accuracy_criterion,s=n??g.practice.max_loops,u=r??Oe(),c=X({trialType:"d_only",trialsPerType:l,prng:u}),h=X({trialType:"t_only",trialsPerType:l,prng:u}),m=X({trialType:"i_only",trialsPerType:l,prng:u}),w=X({trialType:"i_d",trialsPerType:l,prng:u}),y=X({trialType:"i_t",trialsPerType:l,prng:u});let k=0,x=0,f=null;const L={type:N,stimulus:"",choices:"NO_KEYS",trial_duration:0,on_start:()=>{k+=1,x=window.jsPsych?.data?.get().count()??0},data:()=>({phase:"practice_iteration_start",practice_iteration:k})};function C(){const ie="practice_feedback",De={type:N,stimulus:()=>{const nn=(window.jsPsych?.data?.get().values()??[]).slice(x),V=rt(nn),be=V.accuracy>=d,ze=!be&&k<=s;return f={accuracy:V.accuracy,correct:V.correct,total:V.total,passed:be,willRetry:ze,attemptCount:k},yo({acc:V,passed:be,willRetry:ze,criterion:d})},choices:[" "],data:()=>({phase:"practice_feedback",practice_iteration:k,iteration_accuracy:f?.accuracy??null,iteration_correct:f?.correct??null,iteration_total:f?.total??null,iteration_passed:f?.passed??null})};return v(ie,C),b(De,ie)}const G=C(),tn={timeline:[L,jt(),Bt(),...c.nodes,Lt(),Yt(),...h.nodes,de(o),Nt(),Ft(),...m.nodes,de(a),Dt(),Ht(),...w.nodes,zt(),Gt(),...y.nodes,de(i),G],loop_function:function(ie){return!(Sn()||rt(ie.values()).accuracy>=d||k>s)}};return[Ut(),tn,Wt()]}const me=Object.freeze([Object.freeze({value:"1",label:"1 — Strongly disagree",score:1}),Object.freeze({value:"2",label:"2 — Disagree",score:2}),Object.freeze({value:"3",label:"3 — Neither agree nor disagree",score:3}),Object.freeze({value:"4",label:"4 — Agree",score:4}),Object.freeze({value:"5",label:"5 — Strongly agree",score:5})]);if(me.length!==5)throw new Error(`STRATEGY_SCALE must have 5 levels, got ${me.length}`);const fe=Object.freeze([Object.freeze({id:"strategy_q01",section:"memory_only",construct:"geometric_pattern_formation",text:"I tried to connect the remembered dots with imaginary lines to form a shape.",provenance:"round1_kept",round1_evidence:"rho_acc = +0.54, p < .001 (strongest accuracy predictor)"}),Object.freeze({id:"strategy_q02",section:"memory_only",construct:"pattern_recognition",text:"I noticed common shapes or symmetrical arrangements in the dot configurations and remembered them by that shape.",provenance:"round1_kept",round1_evidence:"rho_acc = +0.45, p = .006; rho_dual_cost = -0.48, p = .003"}),Object.freeze({id:"strategy_q03",section:"memory_only",construct:"chunking",text:"I grouped several dots together into clusters to make them easier to remember.",provenance:"round1_kept",round1_evidence:"Structural Chunking composite: GLM β = 0.415, z = 7.68, p < .001"}),Object.freeze({id:"strategy_q04",section:"memory_only",construct:"relational_positioning",text:"I noted spatial relationships between the dots — which were adjacent, opposite, or close to each other.",provenance:"round1_kept",round1_evidence:"rho_dual_cost = -0.34, p = .041"}),Object.freeze({id:"strategy_q05",section:"memory_only",construct:"sequential_pathways",text:"I mentally retraced the dots in the order they appeared, as if drawing a line from one to the next.",provenance:"round1_kept",round1_evidence:"rho_acc = -0.37, p = .024 (negative predictor — informative)"}),Object.freeze({id:"strategy_q06",section:"tone_only",construct:"pitch_labeling",text:'I gave each tone a label (e.g., "high", "medium", "low", or a musical note name) and used the labels to remember the sequence.',provenance:"followup_new",literature_anchor:"Williamson et al. 2010 — verbal/phonological coding of pitch"}),Object.freeze({id:"strategy_q07",section:"tone_only",construct:"auditory_imagery_rehearsal",text:"I silently sang or hummed the tones to myself between hearing them and the tone tests.",provenance:"followup_new",literature_anchor:"Hubbard 2010 — auditory imagery / echoic rehearsal in auditory STM"}),Object.freeze({id:"strategy_q08",section:"tone_only",construct:"contour_encoding",text:'I remembered the tones by their up-and-down direction — e.g., "higher, then lower, then higher".',provenance:"followup_new",literature_anchor:"Dowling 1978 — melodic contour encoding in tonal memory"}),Object.freeze({id:"strategy_q09",section:"tone_only",construct:"tonal_chunking",text:"I grouped adjacent tones into short melodic phrases or pairs to make them easier to remember.",provenance:"followup_new",literature_anchor:"Tone-domain analogue of Chunking (strategy_q03)"}),Object.freeze({id:"strategy_q10",section:"imagery_only",construct:"contrast_enhancement",text:"I imagined the pattern in a bright or high-contrast colour to make it stand out vividly in my mind.",provenance:"round1_kept",round1_evidence:"rho_dual_cost = -0.34, p = .041"}),Object.freeze({id:"strategy_q11",section:"imagery_only",construct:"error_correction_feedback",text:"I adjusted the position or shape of the pattern in my mind based on whether earlier star responses were marked correct or incorrect.",provenance:"round1_kept",round1_evidence:"rho_dual_cost = -0.37, p = .023"}),Object.freeze({id:"strategy_q12",section:"imagery_only",construct:"probe_rotation_alternative",text:"On some trials, instead of rotating the pattern in my mind, I left the pattern in its original orientation and mentally turned each star to match it.",provenance:"followup_new",literature_anchor:"Cooper 1975 / Carpenter & Just 1985 — probe-rotation strategy alternative; construct-validity check for imagery maintenance"}),Object.freeze({id:"strategy_q13",section:"i_d",construct:"continuous_visualization",text:"During the image+dot trials, I continued to hold the rotated pattern vividly in mind while responding to the dot tests.",provenance:"round1_kept",round1_evidence:"Regression β = -0.012/Likert point, p = .038 (controlling for single-task accuracy)"}),Object.freeze({id:"strategy_q14",section:"i_d",construct:"selective_attention_switching",text:"During the image+dot trials, I switched my attention between visualizing the rotated pattern and tracking the dots, depending on what was on screen.",provenance:"round1_kept",round1_evidence:"rho_acc = +0.40, p = .015"}),Object.freeze({id:"strategy_q15",section:"i_d",construct:"phase_specific_focus",text:"During the image+dot trials, even when it was not required, I kept a residual image of the rotated pattern in my mind while doing the dot tests.",provenance:"round1_kept",round1_evidence:"rho_dual_cost = +0.23, p = .16 (borderline; retained for theoretical centrality)"}),Object.freeze({id:"strategy_q16",section:"i_t",construct:"continuous_visualization",text:"During the image+tone trials, I continued to hold the rotated pattern vividly in mind while responding to the tone tests.",provenance:"round1_kept",round1_evidence:"Same construct as strategy_q13; applied to the new I+T condition to test cross-modal generalisation of the imagery-maintenance cost"}),Object.freeze({id:"strategy_q17",section:"i_t",construct:"selective_attention_switching",text:"During the image+tone trials, I switched my attention between visualizing the rotated pattern and tracking the tones, depending on the stimulus.",provenance:"round1_kept",round1_evidence:"Same construct as strategy_q14; applied to the new I+T condition"}),Object.freeze({id:"strategy_q18",section:"i_t",construct:"phase_specific_focus",text:"During the image+tone trials, even when it was not required, I kept a residual image of the rotated pattern in my mind while doing the tone tests.",provenance:"round1_kept",round1_evidence:"Same construct as strategy_q15; applied to the new I+T condition"}),Object.freeze({id:"strategy_q19",section:"i_t",construct:"concurrent_auditory_rehearsal",text:"While visualizing the rotated pattern, I silently rehearsed (sang or hummed) the tones at the same time.",provenance:"followup_new",literature_anchor:"Auditory analogue of Continuous Visualization; tests concurrent loading of visuospatial and phonological buffers (Logie 1995; Baddeley 2000)"})]);if(fe.length!==19)throw new Error(`STRATEGY_ITEMS must contain exactly 19 items, got ${fe.length}`);const ee=Object.freeze([Object.freeze({id:"memory_only",phase:"strategy_memory_only",header:"Strategies — dot-memory trials",blurb:"Think about the trials where you only had to remember and judge the locations of <strong>dots</strong> (no pattern, no tones). For each statement, rate how much it describes the way you approached those trials."}),Object.freeze({id:"tone_only",phase:"strategy_tone_only",header:"Strategies — tone-memory trials",blurb:"Think about the trials where you only had to remember and judge a sequence of <strong>tones</strong> (no pattern, no dots). For each statement, rate how much it describes the way you approached those trials."}),Object.freeze({id:"imagery_only",phase:"strategy_imagery_only",header:"Strategies — pattern-imagery trials",blurb:"Think about the trials where you had to <strong>picture the rotated pattern</strong> and judge stars as on-pattern or not on-pattern (no dots, no tones). For each statement, rate how much it describes the way you approached those trials."}),Object.freeze({id:"i_d",phase:"strategy_i_d",header:"Strategies — pattern + dots (dual) trials",blurb:"Think about the trials where you had to <strong>both</strong> picture the rotated pattern <strong>and</strong> remember dot locations at the same time. For each statement, rate how much it describes the way you approached those dual trials."}),Object.freeze({id:"i_t",phase:"strategy_i_t",header:"Strategies — pattern + tones (dual) trials",blurb:"Think about the trials where you had to <strong>both</strong> picture the rotated pattern <strong>and</strong> remember a sequence of tones at the same time. For each statement, rate how much it describes the way you approached those dual trials."})]);if(ee.length!==5)throw new Error(`STRATEGY_SECTIONS must contain exactly 5 sections, got ${ee.length}`);const wo=new Set(ee.map(t=>t.id));for(const t of fe)if(!wo.has(t.section))throw new Error(`STRATEGY_ITEMS: item ${t.id} has unknown section "${t.section}"`);const _o=(()=>{const t={};for(const e of ee)t[e.id]=[];for(const e of fe)t[e.section].push(e);return Object.freeze(Object.fromEntries(Object.entries(t).map(([e,n])=>[e,Object.freeze(n)])))})();function vo(t){return _o[t]??[]}(()=>{const t={};for(const e of me)t[e.value]=e.score;return Object.freeze(t)})();function Kt(t){const e=vo(t.id),n=me.map(i=>`<option value="${i.value}">${i.label}</option>`).join(""),r=e.map(i=>`
      ...
      </tr>`).join(""),o=t.phase,a={type:K,preamble:`
    ...
    `,html:'<div style="text-align: center; padding: 1rem 0;"><em>Click Continue to begin.</em></div>',button_label:"Continue",on_finish:n=>{n.phase="music_experience_intro"}};return v(t,Vt),b(e,t)}function Jt(){const t=U.map(r=>{const o=r.options.map(a=>`<option value="${a.value}">${a.label}</option>`).join("");return`
      <tr>
      ...
      </tr>`}).join(""),e="music_experience",n={type:K,preamble:`
    ...
    `,button_label:"Continue",on_finish:r=>{r.phase="music_experience",r.music_experience_responses=U.reduce((o,a)=>{const i=r.response?.[a.id];return o[a.id]=i===""||i===null||i===void 0?null:String(i),o},{})}};return v(e,Jt),b(n,e)}function To(){return[Vt(),Jt()]}function Xt(){const t="questionnaire_intro",e={type:N,stimulus:`
      <div style="max-width: 38rem; margin: 0 auto; text-align: left;">
    ...
    `,choices:[" "],data:{phase:"questionnaire_intro"}};return v(t,Xt),b(e,t)}function xo(){return[Xt(),...ko(),...To()]}function Qt(){const t="main_a_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_a_intro"},on_load:()=>{ut()}};return v(t,Qt),b(e,t)}function Zt(){const t="main_b_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"main_b_intro"}};return v(t,Zt),b(e,t)}function en(){const t="end_of_task_intro",e={type:N,stimulus:`
      <div style="max-width: 36rem; margin: 0 auto;">
    ...
    `,choices:[" "],data:{phase:"end_of_task_intro"},on_load:()=>{pn(),ut()}};return v(t,en),b(e,t)}const S=rn(),Eo=on();function Io(){if(ct(),typeof Image<"u"){const t=new Image;t.src="./assets/rotation-arrow.png"}}Io();const ge=an({display_element:void 0,on_trial_start:Nn(),on_data_update:t=>{at(t).catch(e=>{console.error("[runner] storage append failed",e),it(e)})},on_finish:()=>{const t=ge.data?.get?.();t&&typeof t.addProperties=="function"&&t.addProperties({session_id:S.params.session_id,prolific_pid:S.params.prolific_pid,study_id:S.params.study_id,is_preview:S.params.is_preview,is_pilot_run:S.is_pilot_run,pilot_label:S.pilot_label,prng_seed_uint32:S.prng_seed_uint32,schema_version:S.schema_version,build_id:S.build_id}),console.info("[runner] session",S,"visibility",jr())}});window.jsPsych=ge;An(ge);const ot=mn(),So=[...Mr(),...bo(),Qt(),...ot.mainA.nodes,fn(),Zt(),...ot.mainB.nodes,en(),...xo(),yn({session:S}),gn()];Eo.then(()=>ge.run(So)).catch(t=>{console.error("[runner] fatal startup failure",t);const e=document.body;e.innerHTML=`
    ...
    `});
//# sourceMappingURL=main-BBpVrlG5.js.map
