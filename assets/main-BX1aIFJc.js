...
`;function ht(){const t="consent";let e=!1;const n={type:S,stimulus:An,choices:["I consent — begin","I do not consent — exit"],button_html:(o,r)=>`<button class="jspsych-btn" data-idx="${r}"${r===0?" disabled":""}>${o}</button>`,on_load:()=>{e=!1;const o=document.getElementById("consent-checkbox"),r=document.querySelector('button.jspsych-btn[data-idx="0"]');!o||!r||o.addEventListener("change",()=>{e=o.checked,r.disabled=!o.checked})},on_finish:async o=>{o.consented=o.response===0,o.consent_acknowledged=e,o.consent_version=Ln,o.consented&&await an()},data:{phase:"consent"}};return v(t,ht),w(n,t)}function Cn(){return{timeline:[{type:S,stimulus:`
          <h2>Thank you</h2>
...
`;function pt(){const t="demographics",e={type:V,preamble:`
    ...
    `,button_label:"Continue",data:{phase:"demographics"}};return v(t,pt),w(e,t)}var Mn="2.1.0";const Dn={name:"call-function",version:Mn,parameters:{func:{type:p.FUNCTION,default:void 0},async:{type:p.BOOL,default:!1}},data:{value:{type:p.COMPLEX,default:void 0}},citations:{apa:"de Leeuw, J. R., Gilbert, R. A., & Luchterhandt, B. (2023). jsPsych: Enabling an Open-Source Collaborative Ecosystem of Behavioral Experiments. Journal of Open Source Software, 8(85), 5351. https://doi.org/10.21105/joss.05351 ",bibtex:'@article{Leeuw2023jsPsych, 	author = {de Leeuw, Joshua R. and Gilbert, Rebecca A. and Luchterhandt, Bj{\\" o}rn}, 	journal = {Journal of Open Source Software}, 	doi = {10.21105/joss.05351}, 	issn = {2475-9066}, 	number = {85}, 	year = {2023}, 	month = {may 11}, 	pages = {5351}, 	publisher = {Open Journals}, 	title = {jsPsych: Enabling an {Open}-{Source} {Collaborative} {Ecosystem} of {Behavioral} {Experiments}}, 	url = {https://joss.theoj.org/papers/10.21105/joss.05351}, 	volume = {8}, }  '}};class he{constructor(e){this.jsPsych=e}static{this.info=Dn}trial(e,n){let o;const r=()=>{const a={value:o};this.jsPsych.finishTrial(a)};if(n.async){const a=l=>{o=l,r()};n.func(a)}else o=n.func(),r()}}function Bn({userAgent:t="",hasHover:e=null,hasFinePointer:n=null,maxTouchPoints:o=0}={}){const r=String(t).toLowerCase(),a=Number.isFinite(o)?o:0,l=[];return/\biphone\b/.test(r)&&l.push("iphone"),/\bipod\b/.test(r)&&l.push("ipod"),/\bipad\b/.test(r)&&l.push("ipad"),/macintosh/.test(r)&&a>1&&l.push("ipad_macos_disguised"),/android/.test(r)&&l.push("android"),/mobile/.test(r)&&!/iphone|ipad|ipod|android/.test(r)&&l.push("mobile_ua"),e===!1&&n===!1&&l.push("no_hover_no_fine_pointer"),{isDesktop:l.length===0,reasons:l,userAgent:String(t),hasHover:e,hasFinePointer:n,maxTouchPoints:a}}function Yn(){const t=typeof navigator<"u"?navigator.userAgent??"":"";let e=null,n=null;if(typeof window<"u"&&typeof window.matchMedia=="function"){try{e=window.matchMedia("(hover: hover)").matches}catch{e=null}try{n=window.matchMedia("(pointer: fine)").matches}catch{n=null}}const o=typeof navigator<"u"&&Number.isFinite(navigator.maxTouchPoints)?navigator.maxTouchPoints:0;return{userAgent:t,hasHover:e,hasFinePointer:n,maxTouchPoints:o}}function Hn(){return{type:he,async:!1,func:()=>Bn(Yn()),data:{phase:"desktop_gate"}}}function Fn(){return{timeline:[{type:S,stimulus:`
        ...
        `,choices:["Close"],data:{phase:"desktop_gate_fail"},on_finish:()=>{typeof window<"u"&&window.jsPsych?.abortExperiment&&window.jsPsych.abortExperiment("Desktop required.")}}],conditional_function:()=>{const e=window.jsPsych?.data?.get().filter({phase:"desktop_gate"}).last(1).values()[0]?.value;return e?!e.isDesktop:!1}}}const Wn=85.6,xe=1.5,Oe=12,Gn=100,Un=1100,se=320,Vn=2,He="screen_calibration",Fe="screen_calibration_retry_hint",Kn=`
...
`;function mt(){const t={type:S,stimulus:Kn,choices:["This matches my card"],on_load:()=>{const e=document.getElementById("cc-slider"),n=document.getElementById("cc-rect"),o=()=>{const r=parseInt(e.value,10);n.style.width=`${r}px`,n.style.height=`${r*(53.98/85.6)}px`};e.addEventListener("input",o),o()},on_finish:e=>{const n=document.getElementById("cc-slider"),o=n?parseInt(n.value,10):se,r=o/Wn;e.cc_px_width=o,e.px_per_mm=r,e.px_per_mm_in_bounds=r>=xe&&r<=Oe,e.px_per_mm_min=xe,e.px_per_mm_max=Oe,document.documentElement.style.setProperty("--mm",`${r}px`)},data:{phase:"screen_calibration"}};return v(He,mt),w(t,He)}function Xn(){return{type:he,async:!1,func:()=>{const t=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0];return{passed:!!(t&&t.px_per_mm>=xe&&t.px_per_mm<=Oe),px_per_mm:t?.px_per_mm??null}},data:{phase:"screen_calibration_gate"}}}function ft(){const t={type:S,stimulus:Jn,choices:["Continue"],data:{phase:"screen_calibration_retry_hint"}};return v(Fe,ft),w(t,Fe)}function Qn(t){return{timeline:[ft()],conditional_function:()=>t.count>=1}}function Zn({maxAttempts:t=Vn}={}){const e={count:0};return{timeline:[Qn(e),mt(),Xn(),eo(e,t)],loop_function:()=>(e.count+=1,e.count>=t?!1:!!!window.jsPsych?.data?.get().filter({phase:"screen_calibration_gate"}).last(1).values()[0]?.value?.passed)}}function eo(t,e){return{type:he,async:!1,func:()=>{const n=window.jsPsych?.data?.get().filter({phase:"screen_calibration"}).last(1).values()[0],o=Number.isFinite(n?.px_per_mm)?n.px_per_mm:null;return{attempts_used:t.count,max_attempts:e,retried:t.count>1,px_per_mm:o,px_per_mm_in_bounds:n?.px_per_mm_in_bounds===!0}},data:{phase:"screen_calibration_outcome"}}}const to="72vh",no="#000",oo="40rem",ro="95vw",ao="72rem",yt=`
  margin: 0 auto;
  display: flex;
  ...
  min-height: ${to};
  color: ${no};
`.replace(/\s+/g," ").trim(),gt=`${yt} width: ${oo}; max-width: 90vw;`,io=`${yt} width: ${ro}; max-width: ${ao}; align-items: center;`,bt=`
  flex: 0 0 auto;
  min-height: 3rem;
  width: 100%;
  margin: 0 0 1.25rem;
...
`.replace(/\s+/g," ").trim();function wt({title:t,body:e,narration:n}){const o=typeof n=="string"&&n.trim()?` data-voiceover-script="${_t(n.trim())}"`:"";return`
  ...
  `}const $e=50,P=$e/2,vt=$e*Math.SQRT2/2+1,Ee=vt-P+.5,ie=$e+2*Ee,We={cx:35,cy:15},Ge={cx:15,cy:35},lo=2.5,co=2.5,Ue=100,uo=12,ho=12;function po(t,e,n){const r=n*.382,a=[];for(let l=0;l<10;l++){const i=l%2===0?n:r,u=-Math.PI/2+l*Math.PI/5;a.push(`${t+i*Math.cos(u)},${e+i*Math.sin(u)}`)}return a.join(" ")}const mo=po(Ge.cx,Ge.cy,co),fo="rgba(0, 0, 0, 0.229)",yo="rgba(0, 0, 0, 0.55)",Ve="#000",Ke="rgba(0, 0, 0, 0.85)";function go(t){const e=new Set(t),n=e.has("tone")||e.has("qmark"),o=`<circle cx="${P}" cy="${P}" r="${vt}" fill="none" stroke="${fo}" stroke-width="0.5" />`,r=n?"":`<circle cx="${P}" cy="${P}" r="0.65" fill="${yo}" />`,a=e.has("dot")?`<circle cx="${We.cx}" cy="${We.cy}" r="${lo}" fill="${Ve}" />`:"",l=e.has("star")?`<polygon points="${mo}" fill="${Ve}" />`:"",i=e.has("tone")?`<text x="${P}" y="${P}" text-anchor="middle" dominant-baseline="central" fill="${Ke}" font-size="${uo}" font-family="Arial, sans-serif" font-weight="bold">♪</text>`:"",u=e.has("qmark")?`<text x="${P}" y="${P}" text-anchor="middle" dominant-baseline="central" fill="${Ke}" font-size="${ho}" font-family="Arial, sans-serif" font-weight="bold">?</text>`:"",s=`
  ...
  `,narration:"Next, let's set up your hands. Throughout the study you will respond with the two horizontal arrow keys on your keyboard, the left arrow and the right arrow. The demonstrations will label them No or Yes, and Not on-pattern or On-pattern. How you place your hands matters. Use both hands, and only your index fingers. Place one index finger on each of the two horizontal arrow keys, one finger per hand. Keep them resting on those two keys throughout the study. Do not use two fingers of the same hand — one index finger per hand, on its own response key. When both index fingers are resting on the two response keys, click the button below to continue."});function _o(){const t=w({type:S,stimulus:wo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"viewing_distance"}},"viewing_distance"),e=w({type:S,stimulus:vo,choices:["I am ready"],button_html:n=>`<button class="jspsych-btn" style="margin-top: 1rem;">${n}</button>`,data:{phase:"hand_placement"}},"hand_placement");return{timeline:[t,e]}}function kt(){const t="speaker_volume_instruction",e={type:S,stimulus:`
    ...
    `,choices:["I'm comfortable — continue"],button_html:i=>`<button class="jspsych-btn" id="tac-yes-btn">${i}</button>`,on_load:async()=>{e=!1,n=!1,o=!1,r=0,a=J;const i=Promise.resolve();ze(J/100);const u=document.getElementById("tac-slider"),s=document.getElementById("tac-slider-readout");u&&u.addEventListener("input",()=>{const f=Number(u.value);a=f,s&&(s.textContent=`${f}%`),ze(f/100)});const c=document.getElementById("tac-yes-btn");if(c&&c.addEventListener("click",()=>{n||(o=!0),e=!0},{capture:!0}),await i,e)return;const d=sn(),h=ct(),m=y.tones.duration_ms/1e3,_=(y.tones.duration_ms+Io)/1e3,g=So/1e3,k=[];for(let f=0;f<h.length;f++)k.push(document.getElementById(`tac-box-${f}`));let E=d.currentTime+Po/1e3;try{for(let f=0;f<No&&!e;f++){r=f+1;for(let F=0;F<h.length&&!e;F++){const C=E;if(ln(F,{when:C}),await ge(d,C),e)break;const W=k[F];W&&W.classList.add("playing"),await ge(d,C+m),W&&W.classList.remove("playing"),E=C+_}e||(await ge(d,E+g),E+=g)}}catch{}if(!o&&!e){n=!0;const f=document.getElementById("tac-yes-btn");f&&f.click()}},on_finish:i=>{st();const u=lt();u.current&&!u.current._state?.finished&&u.current.cancel(),i.tones_audible=o&&!n,i.user_playback_pct=a,i.user_playback_gain=a/100,i.sweeps_completed=r},data:{phase:"tone_audibility_and_comfort"}};return v(t,Ot),w(l,t)}function Ao(){return{timeline:[{type:S,stimulus:`
      ...
      `,narration:`Then ${n} things will appear inside the circle one at a time, all mixed together. ${e} stars — for each star, decide whether it lands in a location that would be covered by the rotated pattern you are picturing, just like Task 3. Press On-pattern if the star falls on your pictured pattern, or Not on-pattern if it does not. And ${t} dots — try to remember which locations the dots appear in, so you can answer the dot tests at the end of the trial, just like Task 1.`,exemplar:["star","dot"]}),b({title:o,body:`
        ...
        ${$t} if you were correct or
        ${Lt} if you were not while it is still on the screen,
      ...
      `,narration:`Then ${n} things will happen one at a time, all mixed together. ${e} stars inside the circle — for each star, decide whether it lands in a location that would be covered by the rotated pattern you are picturing. Press On-pattern if the star falls on your pictured pattern, or Not on-pattern if it does not. And ${t} tones — try to remember each tone you hear, so you can answer the tone tests at the end of the trial, just like Task 2.`,exemplar:["star","tone"]}),b({title:o,body:`
        ...
        mark can turn ${$t} if you were correct or
        ${Lt} if you were not while it is still on the screen,
        so you can learn from each response.</p>
      ...
      `,narration:"One last thing, and this is very important. Keep the picture of the rotated pattern in your mind during the entire trial. The only moment you may let the picture go is when the central question mark appears — that is when the tone tests begin, and at that point you can drop the image and focus only on the tone tests. Please make sure your audio volume is still at the level you set earlier. When you're ready, press Space to see a demonstration of Task 5.",exemplar:["arrow"]})],a={type:ee,pages:r,...Ct,data:{phase:"instructions_dual_i_t"}};return Y(a.data.phase,Rt),H(a)}const pe=4,zt=1e3*pe,Yo=4e3*pe,Ho=2e3*pe,Fo=8e3,me=2e3*pe,Wo=2e3,Go=400,T=500,O=400,R=1200,Uo=700,Qe=450,Vo=220,z=1500,Le=1e3,Ko=Object.freeze([-90,-75,-60,-45,-30,-15,15,30,45,60,75,90]);function Ae(){return je().pick(Ko)}const Jo="./assets/rotation-arrow.png";function Xo(t,e){return`
    <style>
  ...
  `}function Gt(){const t=y.blocks.practice_trials_per_type,e=t*5,n=Math.round(y.practice.accuracy_criterion*100),o={type:N,stimulus:`
    ...
    `});
//# sourceMappingURL=main-BX1aIFJc.js.map
