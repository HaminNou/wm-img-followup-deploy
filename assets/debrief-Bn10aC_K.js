import{H as g,d as h,e as w,f as v,h as _,u as k,j as b,k as S}from"./index-D84Ls8co.js";const $=["display: inline-block","margin: 1.25rem auto 0.25rem","padding: 0.7rem 1.4rem","background: #FFFFFF","color: #000000","font-size: 1.2rem","font-weight: 600","line-height: 1.3","border: 1.5px solid #000000","border-radius: 0.55rem","box-shadow: 0 1px 2px rgba(0,0,0,0.10)","text-align: center","max-width: 38rem"].join("; ");function c(e){return`<div style="text-align: center; width: 100%;"><div style="${$}">${e}</div></div>`}const m="upload-progress-mount",P=5e3,R=1e3;function A({session:e,endpoint:t,label:i}={}){if(!e)throw new Error("uploadProgressNode: session is required");return{type:g,stimulus:`
...
//# sourceMappingURL=debrief-Bn10aC_K.js.map
